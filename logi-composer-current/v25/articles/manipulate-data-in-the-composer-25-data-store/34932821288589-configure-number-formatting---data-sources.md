...
2. Select **Sources** on the UI menu (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374808079117)). The [Sources](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932895238669-Data-Sources-Page) page appears.
...
5. In the sidebar menu, select the settings (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374808079885)) button to open the **Settings** work area. Select the edit (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374808080397)) button in the **Format** work area to edit the date and time format for this field.

   ![Update the format of your number field here](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373651739789 "Format Number Attributes - Data Source")
