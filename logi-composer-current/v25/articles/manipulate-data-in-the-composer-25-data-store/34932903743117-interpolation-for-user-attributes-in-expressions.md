...
[Derived Fields](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932837821709-Create-and-Modify-Derived-Fields): Change parts of the expression based on the user who is opening a dashboard.

[Custom Metrics](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932813034765-Create-and-Modify-Custom-Metrics): Change metric-level calculations based on the user, such as using a different aggregation function with the same custom metric.
...
For more information, see:  [Use Interpolations in Expressions](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932903861773--Use-Interpolations-in-Expressions)
