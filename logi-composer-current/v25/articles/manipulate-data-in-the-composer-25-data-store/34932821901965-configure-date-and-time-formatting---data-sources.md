...
2. Select **Sources** on the UI menu (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374840101901)). The [Sources](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932895238669-Data-Sources-Page) page appears.
...
5. In the Settings sidebar menu, select the edit (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374823942029)) button to open the **Format** work area.

   ![Set the format options for your data source date and time](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373685638413 "Format date and time work area")
