...
6. Select **Convert** in the Data Type area of the Settings tab for the field and select **Convert to Time**.  
   ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167319026701)
7. Rename the field in the **Label** field, and define time granularity in the **Origin Field Format**.  
   ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167334724493)
...
6. Select **Convert** in the Data Type area of the Settings tab for the field and select **Convert to Time**.  
   ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167273784717)
7. Rename the field in the **Label** field, and select an available time granularity in the **Origin Field Format**.  
   ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167319415565)
