---
title: "Modify Row Security Definitions"
id: 34932925639309
section: "Connect to Data in Composer 25"
product: "Logi Composer v25"
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932925639309-Modify-Row-Security-Definitions
...
3. Locate the data source for which you want to restrict data access and select the icon in the **Row** column for the data source. The Row Security dialog appears.
   ...
   ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373494336013)
...
5. Modify any of the information for the row security definition, as described in [Add Row Security Definitions](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932925209101-Add-Row-Security-Definitions). When you are finished, select **Save** to save the row security settings.
