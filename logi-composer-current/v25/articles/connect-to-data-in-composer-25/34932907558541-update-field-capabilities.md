...
**Note:** In this release, the user interface and workflows have changed from previous releases. If you are running an earlier release, see [Update the field capabilities for your source (earlier releases)](#25.3).
...
4. Enable or disable the field capabilities for all visible fields in the source. Capabilities include: **Details**, **Filtering**, **Grouping**, **Metrics**, **Playing**, and **Raw Data**. See [Field Capabilities Options](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932887622285-Field-Capabilities#Field).
5. **Save** your changes.
