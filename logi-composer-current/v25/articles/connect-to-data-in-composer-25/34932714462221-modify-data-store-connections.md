...
6. If the **Do As User** option is available, optionally specify the custom user attributes you set up to enable user delegation. See [Apply User Delegation to a Connection](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932694331917-Apply-User-Delegation-to-a-Connection).
...
11. Select **Back** at the top of the page to return to the [Connections page](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932690166541-Connections-Page) that lists the connection definitions.
