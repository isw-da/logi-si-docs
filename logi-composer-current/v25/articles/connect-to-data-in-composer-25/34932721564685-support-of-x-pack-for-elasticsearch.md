...
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932721564685-Support-of-X-Pack-for-Elasticsearch
...
2. Update the `loader.path` property value in the appropriate Elasticsearch connector property file to point to the directory path containing all the libraries you downloaded or to a comma-separated list combining all library paths. For example:
   ...
   See [Connector Properties and Property Files](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932637143949-Connector-Properties-and-Property-Files) to determine the correct Elasticsearch property file to use and where to save it.
