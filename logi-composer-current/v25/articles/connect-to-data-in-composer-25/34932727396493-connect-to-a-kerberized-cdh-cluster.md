...
6. Select **Validate**. After successful validation, the values are saved. Select **Next**.
   ...
   **Note:** 
   If you run into connection issues, verify that the Composer Server was restarted successfully. Access the troubleshooting topic [Verify the Composer Server Restart](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933206540045-Verify-the-Composer-Server-Restart)
   for assistance.
...
See [Connect to Impala with TLS (SSL) Enabled](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932696350221-Connect-to-Impala-with-TLS-SSL-Enabled) for more details.
