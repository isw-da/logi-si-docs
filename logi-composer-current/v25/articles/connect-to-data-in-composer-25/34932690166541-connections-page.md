...
**Note:** 
You must be logged in as a user with the [group privilege](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932577846157-Group-Privilege-Reference) **Manage Connections** to see the Connections page.
...
If there are many connections listed, you may need to search for the connection you need. Use the search bar to search for a connection in the list. See [Search and Filter Lists](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932690388621-Search-and-Filter-Lists).
