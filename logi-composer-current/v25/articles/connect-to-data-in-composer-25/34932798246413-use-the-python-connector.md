...
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932798246413-Use-the-Python-Connector
...
Python script types conversion, in versions 23.3+ of Logi Composer, converts all values returned from public functions to [Pandas Dataframe](https://pandas.pydata.org/docs/reference/frame.html "Pandas dataframe link"). To resolve the type, the connector relies on [DataFrame.dtypes.kind](https://numpy.org/doc/stable/reference/generated/numpy.dtype.kind.html#numpy.dtype.kind "DataFrame.dtypes.kind link").
