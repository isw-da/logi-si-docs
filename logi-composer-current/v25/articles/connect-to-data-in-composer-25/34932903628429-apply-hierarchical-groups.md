...
2. Select the Settings sidebar menu, then select **Edit Row Groups** (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374822253965)).

   ![Select a hierarchy group](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373672839437 "Edit row groups work area")
...
4. Optionally, select **Edit Column Group** (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374822253965)) to add a field or fields to column groups.
