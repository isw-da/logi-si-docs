...
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932728210189-Connect-to-Elasticsearch-Using-Amazon-Web-Services-Authentication
...
2. Edit the [Elasticsearch properties file](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932637143949-Connector-Properties-and-Property-Files) ( `edc-elasticsearch-7.0.properties`) and locate or add the `elasticsearch.aws.show-aws-connection-params` property to the file. This property indicates whether AWS-specific connection parameters should be shown when a new connector is created or the connection properties of an existing connector are refreshed. Valid values are `true` or `false`. The default is `false` (users will *not* see new AWS connection parameters).
...
3. Create a new Elasticsearch connection or edit an existing one (see [Add Data Store Connections](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932713955597-Add-Data-Store-Connections)).
