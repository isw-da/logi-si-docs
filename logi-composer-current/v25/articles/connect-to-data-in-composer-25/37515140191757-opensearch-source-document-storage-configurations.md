---
title: "OpenSearch Source Document Storage Configurations"
id: 37515140191757
section: "Connect to Data in Composer 25"
product: "Logi Composer v25"
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/37515140191757-OpenSearch-Source-Document-Storage-Configurations
updated_at: 2026-08-24T20:28:49Z
---
...
Composer OpenSearch connectors support OpenSearch data stores with any of the following source document configurations:
...
* **Raw data presentation will vary, depending on the source from which the raw field data is fetched.** In particular, fused data sources may be affected where OpenSearch indices with different mappings are joined (for example, when such indices are joined by an IP field and one of them allows Composer to fetch the data from the original documents but another requires Composer to fetch the data from doc values). See [Raw Data Differences](#Raw) .
...
The following Composer functions are impacted by the source document storage configuration of your OpenSearch data stores:
