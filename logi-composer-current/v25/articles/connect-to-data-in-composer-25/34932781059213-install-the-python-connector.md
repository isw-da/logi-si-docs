...
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932781059213-Install-the-Python-Connector
...
The [python connector](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932738470925-Manage-the-Python-Connector) is available as a Docker image only. Docker must be installed on the Composer server running the Python connector.
...
For more information on using the Python connector and how it works, see [Use the Python Connector](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932798246413-Use-the-Python-Connector).
