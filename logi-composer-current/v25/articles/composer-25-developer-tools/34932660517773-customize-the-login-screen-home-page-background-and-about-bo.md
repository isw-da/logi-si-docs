---
title: "Customize the Login Screen, Home Page Background, and About Box"
id: 34932660517773
section: "Composer 25 Developer Tools"
product: "Logi Composer v25"
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932660517773-Customize-the-Login-Screen-Home-Page-Background-and-About-Box
...
You can customize the copyright information, terms of service link, Login screen logo, the Login screen background, and the Home screen background. The logo, copyright, and terms of service appear in the [About box](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933070707469-About-Dialog) of the UI. The copyright information, Login screen logo, and Login screen background appear with the Login screen. The Home screen background appears on the Home page.

## Customize the Copyright Information

The copyright information appears on both the [About box](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933070707469-About-Dialog) and the [Login screen](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932611816845-Log-Into-the-Logi-Composer-UI). By default, standard Composer copyright information is displayed.
...
2. Select **Customize UI** from the menu (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167975092365)). The Customize UI page appears.
3. Under Login and About , locate the **Copyright** slider and box. To enable your custom copyright, slide the **Copyright** slider to the right (on). To disable your custom copyright, slide the **Copyright** slider to the left (off). By default the **Copyright** slider is on.
   ...
   ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167460741389)s
...
The terms of service link appears on the [About box](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933070707469-About-Dialog).

1. Log in as a system [admin](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932621360909-Supplied-Users-and-User-Groups#The2) or a member of the Supervisors group.

   **Note:** 
   The default **supervisor** user is no longer installed; add users to the **Supervisors** group instead.
2. Select **Customize UI** on the [supervisor menu](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933119921933-The-Composer-Supervisor-Menu) (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167975092365)). The Customize UI page appears.
3. Under Login and About , locate the **Terms of Service Link** slider and box. To enable your custom link, slide the **Terms of Service Link** slider to the right (on). To disable your custom link, slide the **Terms of Service Link** slider to the left (off). By default the **Terms of Service Link** slider is on.
   ...
   ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167460741389)
...
The logo appears on both the [About box](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933070707469-About-Dialog) and the [Login screen](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932611816845-Log-Into-the-Logi-Composer-UI).
...
The background image appears on the [Login screen](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932611816845-Log-Into-the-Logi-Composer-UI).

1. Log in as a system [admin](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932621360909-Supplied-Users-and-User-Groups#The2) or a member of the Supervisors group.

   **Note:** 
   The default **supervisor** user is no longer installed; add users to the **Supervisors** group instead.
2. Select **Customize UI** from the main menu (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167975092365)). The Customize UI page appears.
...
The background image appears on the [Home page](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933063528717-Home-Page).
