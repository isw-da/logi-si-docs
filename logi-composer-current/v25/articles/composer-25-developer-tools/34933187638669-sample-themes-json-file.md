...
Here is a sample JSON file for themes. Use it as a template to start creating your own themes. See [Create a Theme](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933156720141-Create-a-Theme).
...
You can also download the JSON files provided with the supplied **modern** and **dark** themes and use those as templates for your own themes. See [Review and Download the Theme JSON Code](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933157355405-Review-and-Download-the-Theme-JSON-Code).
...
| `<color-palette-name>` | Specify the name of a [supplied color palette](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933098877581-Supplied-Color-Palettes) or a color palette defined in this JSON file. |
