...
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932634888077-Controller
...
For more information about the `controller` properties and methods, visit the [individual guides](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932676398989-Custom-Chart-API) for tips on how to use custom chart API.
