...
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932771236493-multilist
...
1. If the `values` property is provided, the variable is represented by a multi-select tag input.
   ...
   ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167415173261)
