...
You can also pass sensitive property values to Composer using Linux environment variables, rather than hard coding the values in Composer property files. See [Pass Sensitive Data Using Linux Environment Variables](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932679227789-Pass-Sensitive-Data-Using-Linux-Environment-Variables).
