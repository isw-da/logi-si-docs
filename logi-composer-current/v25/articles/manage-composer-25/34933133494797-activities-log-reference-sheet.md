...
The following table lists the activities that are logged by default and those that are not. Activities that are not logged by default must have logging manually enabled. See [Activity Logging](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933086348813-Activity-Logging).
...
| userGroups | list of the groups to which the user belong |
