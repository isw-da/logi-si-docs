...
| **Disable User** | No | not checked | This option appears only for administrators or users who are assigned to a group with [user management privileges](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932577846157-Group-Privilege-Reference). Use the **Disable User** checkbox to disable the user.  See [Enable and Disable Users](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932642763021-Enable-and-Disable-Users) . |
