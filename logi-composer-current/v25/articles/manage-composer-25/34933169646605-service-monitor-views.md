...
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933169646605-Service-Monitor-Views
...
![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167058716429)
...
![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167044778381)
...
![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167052414093)
...
![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167073943693)
...
![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167074076685)

The Downloads view can be used to collect a diagnostics bundle for you to send to Composer Support when necessary. See [Download the Diagnostics Bundle](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932926822157-Download-the-Diagnostics-Bundle) for more information.

## Properties View

Select **Properties** to access the Properties view.

This view allows you to review and maintain the properties for each of the other Composer microservices. It requires that the Composer configuration microservice be installed and started first. See [Use the Composer  Configuration Microservice to Maintain Application Properties](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933169279757-Use-the-Composer-Configuration-Microservice-to-Maintain-Application-Properties).
