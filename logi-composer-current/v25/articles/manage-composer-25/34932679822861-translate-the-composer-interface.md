...
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932679822861-Translate-the-Composer-Interface
...
3. Translate the JSON values to the right of the JSON keys (after the colon) in the file. All values should be specified in quotes. The JSON keys should not be translated because the keys are used by the Composer code.
   ...
   ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167429078797)
...
5. Contact your insightsoftware [technical support](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932980712461-Contact-Technical-Support) representative for additional steps.
