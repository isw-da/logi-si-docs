...
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932671654797-Query-Engine-Properties
...
| qe.max.allowed.time.groups | 10000 | The maximum amount of time in which groups can be generated by the **Include Blanks** function.  For information on even time intervals, see [Even Time Intervals](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932833532429-Even-Time-Intervals) . |
...
| sharpening.enabled | true | Enables or disables [Data Sharpening](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932821554701-Use-Data-Sharpening).  Set this property to `true` to enable Data Sharpening; set it to `false` to disable it. |
