...
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933045381133-Screenshot-Microservice-Upgrade-Notes
...
`screenshot.daemon.enabled` property in the `zoomdata.properties` file is set to `true`. Remember to restart the Composer server microservice after the change (see  [Restart Microservices](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/35385540487565-About-Microservices#Restart)).
