...
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932999035405-Optimize-Composer-s-Metadata-Store-Performance
...
ORDER BY n\_dead\_tup
/ (n\_live\_tup
current\_setting('autovacuum\_vacuum\_scale\_factor')::float8
+ current\_setting('autovacuum\_vacuum\_threshold')::float8)
DESC;
...
For information about vacuuming your Composer PostgreSQL metadata store, see [Vacuum Composer's Metadata Store](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933044105485-Vacuum-Composer-s-Metadata-Store).
