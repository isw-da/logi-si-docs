...
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932791412749-Disable-Sending-Scheduled-Reports-to-External-Users
...
You can send scheduled dashboard reports, by default, to both users with Composer accounts, and email addresses outside of Composer.

Disable the sending of scheduled dashboard reports by working with [Technical Support](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932980712461-Contact-Technical-Support) to disable the toggle `allow-sending-reports-to-external-emails`.
