...
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933326502413-Waterfall
...
Waterfall visuals are based on at least one time attribute and one or multiple metrics, and can incorporate positive and negative values. You can include a [reference line](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933255521677-Use-Reference-Lines), [grid lines](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933261876493-Use-Rulers), and a Totals bar. Waterfall visuals with multiple metrics are supported by all Composer [data connectors.](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933117968525-Data-Connector-Reference)
...
1. Edit the waterfall visual you want to modify. See [Edit Visuals](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933280606989-Edit-Visuals).
...
3. Select the settings icon (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46166868697485)) on the [sidebar menu](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933295031181-Use-the-Visual-Sidebar-Menu). The Waterfall Settings sidebar for the visual appears.

   ![use this menu to change the settings fo ryour waterfall visual](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46166897260813 "Settings sidebar menu, waterfall visual")
...
6. Select the save icon (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167820717837)) to save the visual, or dashboard and the visual with updated settings.
...
2. If you are editing the visual in a dashboard, select **Settings** from the [visual drop-down menu](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933290868621-Use-the-Visual-Menu). The [sidebar menu](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933295031181-Use-the-Visual-Sidebar-Menu) for the visual appears. If you are editing the visual from the Visual Gallery, the sidebar appears to the right of the visual.
   ...
   Select the color icon (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167820721037)) on the [sidebar menu](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933295031181-Use-the-Visual-Sidebar-Menu). The Color sidebar for the visual appears.
3. Configure the color settings as described below. As you change the color settings, the legend at the top of the Color sidebar shows how the legend will appear on the visual. Supported color specifications are described in [Specify Colors](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932703126541-Specify-Colors).
   ...
   | Total Color | Manually select a color for the Total using the color selector, or select the **Inherit from theme** checkbox to use the color palette specified by the [theme](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933172226573-Manage-UI-Themes). |
...
5. Select the save icon (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167820717837)) to save the dashboard and the visual with its updated settings.
