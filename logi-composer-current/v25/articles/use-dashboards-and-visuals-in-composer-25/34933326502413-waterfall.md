...
3. Select the settings icon on the [sidebar menu](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933295031181-Use-the-Visual-Sidebar-Menu). The Waterfall Settings sidebar for the visual appears.

   ![use this menu to change the settings fo ryour waterfall visual](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48372911811981 "Settings sidebar menu, waterfall visual")
...
6. Select the save icon (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48372895484685)) to save the visual, or dashboard and the visual with updated settings.
