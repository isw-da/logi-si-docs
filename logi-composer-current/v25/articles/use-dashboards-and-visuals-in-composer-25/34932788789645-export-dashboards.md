...
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932788789645-Export-Dashboards
...
You can export your dashboards in a variety of formats. Exported dashboards enable you to share your data with others. JSON configuration exports allow you to transfer a dashboard to another Composer environment. See [Import Dashboards](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932814514061-Import-Dashboards).
...
**Note:** 
To export a dashboard, you must be a user belonging to a group with the **Export Dashboards** [privilege](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932577846157-Group-Privilege-Reference).

Dashboards can be exported in the following formats:

* PNG Screenshot (as an image).
* PDF file (as an image).
* JSON configuration (for one or more entire dashboards). JSON exports include [dashboard interactivity profile](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932814650893-Control-How-Users-Interact-With-a-Dashboard) settings to allow import of the same interactivity profile.
* XLSX format - as a spreadsheet with Raw Data or Visual Data. Each visual is included on its own sheet.

**Export a dashboard**

1. On the dashboard, select ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167942842253) on the dashboard icon bar. A drop-down menu appears.

   ![Select how you want your dashboard data exported](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167400895117 "Export Dashboard Menu")
2. Select an export file format.
   ...
   * When you select **PDF** format, the Export as PDF dialog appears.
     ...
     ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167396408717)
...
1. Log in as a user with the [**Export Dashboards** privilege](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932577846157-Group-Privilege-Reference#Export_Dashboards). Open the Library to view a list of the dashboards you can access.
