...
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933303418509-Add-Visuals-to-a-Dashboard
updated_at: 2026-08-24T20:31:51Z
---
...
When you [create](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932763355021-Create-Dashboards) or edit a dashboard, you can create and add a new local visual, or add an existing visual from the [Visual Gallery](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933265735565-Use-the-Visual-Gallery). Local visuals use the dashboard's permission set. See [Add Local Visuals to a Dashboard](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933273131405-Add-Local-Visuals-to-a-Dashboard) and [Add Existing Visuals to a Dashboard](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933272990989-Add-Existing-Visuals-to-a-Dashboard).
...
2. Select the Add Visual icon ![add icon](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374712090637 "add icon") from the [dashboard icon bar](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932842163469-Use-the-Dashboard-Icon-Bars). A drop-down menu appears with two options: Add New Visual and Add Existing Visual.
...
6. Optionally, click on the display name and change it. See [Visual Names and Display Names](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933292345997-Visual-Names-and-Display-Names).
...
7. [Modify](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933280606989-Edit-Visuals) and make any other changes to the visual you need.
8. [Save](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932815496845-Save-a-Dashboard) your dashboard. If you close the dashboard without saving it, the local visual is not saved.

**Add an existing visual to a dashboard from the Visual Gallery**

1. [Create](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932763355021-Create-Dashboards) or [edit](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932763603597-Edit-a-Dashboard) a dashboard.

   * Users with the [**Administer Dashboards** privilege](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932577846157-Group-Privilege-Reference) can create dashboards and add visuals to dashboards.
   * Users with Owner and Editor access levels to a dashboard can add visuals they can access to the dashboard.
2. Select Add Visual icon ![Add Visual icon](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374712090637 "Add Visual icon") from the [dashboard icon bar](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932842163469-Use-the-Dashboard-Icon-Bars). A drop-down menu appears with two options: Add New Visual and Add Existing Visual.
...
5. [Modify](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933280606989-Edit-Visuals) the visual as needed.
6. [Save](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932815496845-Save-a-Dashboard) your dashboard.
