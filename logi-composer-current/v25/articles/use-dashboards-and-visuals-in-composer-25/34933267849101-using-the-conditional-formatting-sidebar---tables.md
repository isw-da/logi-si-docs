...
3. Select the conditional formatting option ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373103193613) on the [sidebar menu](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933295031181-Use-the-Visual-Sidebar-Menu) for the visual. The Conditional Formatting sidebar opens.

   ![Use to create conditional formatting rules](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373086568589 "Conditional Formatting work area - table")
...
![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374700690189)
...
* Select an existing rule to edit the rule, or the delete icon ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374700690957) to delete the rule.
* Select and drag rules to change their order.

### Add or Edit Conditional Formatting Rule

![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373086819469)

### Select When To Apply Formatting

Select the add icon ![add icon](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374700691469 "add icon") in **Select When To Apply Formatting** to define the conditions to apply your formatting.
...
Select the add icon ![add icon](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374700691469 "add icon") for **Formatting** to define the formatting for your condition.

Select the delete icon ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374700690957) to delete a formatting option.

### Select When To Apply Formatting

* **Row** attribute: Select a row attribute to define the values for formatting by this data. Optionally, select the add icon ![add icon](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374700691469 "add icon") to add a derived field or custom metric.

  ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373094023309)

  Example: Apply a background color to a specific **State** condition.

  ![example of conditional formatting by row attribute](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373094301069 "Conditional Formatting summary")
* **Group** attribute: Select an attribute that you’ve grouped your data by to define values for that aggregated data. Optionally, select the add icon ![add icon](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374700691469 "add icon") to add a derived field or custom metric.

  ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373078933133)
  ...
  ![example of formatting applied to a group condition](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373041895309 "Group Conditional Formatting work area")
...
![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373072981901)
...
Select the add icon ![add icon](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374700691469 "add icon") to add a formatting option you'll apply to your condition. Select the delete icon ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374700690957) to remove the formatting option.
...
![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373105368205)
