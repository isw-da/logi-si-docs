...
3. Select ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374715974797) on the [sidebar menu](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933295031181-Use-the-Visual-Sidebar-Menu). The Donut Chart Settings sidebar for the visual appears.

   ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373145436045)
...
6. Select ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374715976077) to save the dashboard and the visual with its updated settings.
...
2. If you are editing the visual in a dashboard, select **Settings** from the [visual drop-down menu](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933290868621-Use-the-Visual-Menu). The [sidebar menu](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933295031181-Use-the-Visual-Sidebar-Menu) for the visual appears. If you are editing the visual from the Visual Gallery, the sidebar appears to the right of the visual.
   ...
   ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374720374541)
