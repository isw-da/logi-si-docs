...
1. Select the filter icon on the [visual](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932931145741-Apply-a-Row-Level-Filter-to-a-Visual-or-Filter-Snippet) or [dashboard](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932922987533-Apply-a-Row-Level-Filter-to-a-Dashboard) to access the appropriate filter sidebar.
   ...
   * To access the filter sidebar, select its filter icon ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374751414285) or select**Settings** from the Show More [menu](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933290868621-Use-the-Visual-Menu)![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374751415949) and then select the filter icon ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374784175629) on the [sidebar menu](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933295031181-Use-the-Visual-Sidebar-Menu).
   * To access the dashboard filter sidebar, select its filter icon ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374784176653). The dashboard-level filter icon is available only when all the visuals are from the same data source.
...
5. On the Range tab, you can optionally apply a null filter to the full time range. Select an **Operator** option as needed:
   ...
   * Apply `Is not NULL` to hide null values
   ...
   ![set a time range, or apply appropriate NULL filter](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373443667981 "Filter Time Range")
6. If you did not apply a `Null` filter, you can use the**From** and**To** boxes to specify the time range for the filter. You can set the range in static time, dynamic time, use variables, or use preset ranges provided.
   ...
   * Select**Static Time**,**Dynamic Time**, or**Variables** in the drop-down menu.
     ...
     ![select a time range value](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373495720845 "Select time values options")
     ...
     ![Define condtions and offset of dynamic time ranges here](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373467483661 "Dynamic time work area")
   ...
   * Alternatively, select**Presets** to fill the**From** and**To** boxes with predefined time ranges provided.
     ...
     ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373444126221)
