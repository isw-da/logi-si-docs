...
3. Select the settings icon (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374685953549)) on the [sidebar menu](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933295031181-Use-the-Visual-Sidebar-Menu). The Heat Map Settings sidebar for the visual appears.

   ![use this work area to define settings for this visual](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373134842765 "Heat Map Settings Sidebar Menu")
...
6. Select the save icon (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374685956493)) to save the dashboard and the visual with its updated settings.
