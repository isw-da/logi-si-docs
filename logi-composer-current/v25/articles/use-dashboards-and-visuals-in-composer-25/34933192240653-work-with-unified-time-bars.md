...
If you have several visuals from the same data source or your visuals contain [cross-source links](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932758491405-Use-Cross-Source-Links), you can use different time bar settings for different visuals.
...
2. Do one of the following:
   ...
   * Select the range setting on the time bar and select a new static time range, dynamic time range, or preset time range for the time bar. See [Adjust the Time Bar Range](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933203901965-Adjust-the-Time-Bar-Range).
