...
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933279573645-How-Visual-Permissions-Are-Determined
...
The creator of a visual always has permission to read, write, and delete the visual. If the creating user is removed from the Composers environment, the visuals created by the user are retained and the [supplied `supervisor` user](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932621360909-Supplied-Users-and-User-Groups) becomes the creator of these orphaned visuals.
