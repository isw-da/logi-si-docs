...
1. Log in as a user with the [**Export Visuals** privilege](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932577846157-Group-Privilege-Reference#Export_Visuals). Open the Visual Gallery to view a list of the available visuals.
