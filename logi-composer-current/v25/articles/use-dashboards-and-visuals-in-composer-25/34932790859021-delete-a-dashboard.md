...
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932790859021-Delete-a-Dashboard
...
4. Select delete (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374826865805)) icon in the **Actions** column.
5. Confirm by selecting the
   **Delete** button on the warning dialog.

**Delete a dashboard from the dashboard itself**

1. [Edit](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932763603597-Edit-a-Dashboard) the dashboard.
2. Select delete (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374826865805)) icon from the [dashboard icon bar](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932842163469-Use-the-Dashboard-Icon-Bars).
