...
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933186690701-Export-Rich-Text-Snippets
...
1. Select **Export** from the [rich text snippet drop-down menu](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933176360589-Use-the-Rich-Text-Snippet-Menu). A submenu opens: select an export format.

   ![select an option to export rich text snippets](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373212696461 "Rich Text Format Export Menu")
2. Select a format on the submenu.
   ...
   * If you select **PDF**, the Export as PDF dialog opens.
     ...
     ![enter export options to export your rich text snippet](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373182818573 "Export as PDF work area")
