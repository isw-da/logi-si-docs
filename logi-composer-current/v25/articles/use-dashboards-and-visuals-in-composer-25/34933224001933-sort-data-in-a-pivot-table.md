---
title: "Sort Data in a Pivot Table"
id: 34933224001933
section: "Use Dashboards and Visuals in Composer 25"
product: "Logi Composer v25"
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933224001933-Sort-Data-in-a-Pivot-Table
...
* Alternatively, hover over the header and select the table context menu (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374684947469)) then select **Reset [name]** to clear all sorting options.
...
* Select the column again to sort the data in descending order. A down arrow is shown in the heading.
* Select the column again to clear the sort. No arrows are shown in the heading.
* Alternatively, hover over the header and select the table context menu (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374684947469)) then select **Reset [name] sorting** to clear all sorting options.
...
To clear sorting, hover over a column or row label, select the table context menu (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374684947469)) and select one of the following options:
...
[Save](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932815496845-Save-a-Dashboard) the dashboard or visual when the data is sorted to your satisfaction.
