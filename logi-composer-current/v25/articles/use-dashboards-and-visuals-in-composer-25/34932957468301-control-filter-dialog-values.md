...
You can control the behavior of filter dialogs by data source. These controls are set on the [Fields tab](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932906721933-Manage-Fields) of the [data source](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932941009037-Manage-Data-Sources).
...
1. Edit the data source for which you want to control attribute field filters. See [Edit a Data Source](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932890384781-Edit-a-Data-Source).
2. Select the Output in your source, then **Expand View** of the [Fields tab](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932906721933-Manage-Fields) to access the Filter Values panel.
...
1. Edit the data source for which you want to control number field filters. See [Edit a Data Source](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932890384781-Edit-a-Data-Source).
2. Select the Output in your source, then **Expand View** of the [Fields tab](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932906721933-Manage-Fields) to access the Filter Values panel.
...
For more information about setting numeric filters, see [Set a Numeric Field Filter](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932957895565-Set-a-Numeric-Field-Filter).

## Control Time Field Filters

**Control the default time field filter and time bar ranges**

1. Edit the data source for which you want to control time field filters. See [Edit a Data Source](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932890384781-Edit-a-Data-Source).
2. Select the Output in your source, then **Expand View** of the [Fields tab](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932906721933-Manage-Fields) to access the Filter Values panel.
...
1. Edit the data source configuration for which you want to control attribute field filters. See [Edit a Data Source](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932890384781-Edit-a-Data-Source).
2. Select the [Fields tab](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932906721933-Manage-Fields) in the data source work area.
...
1. Edit the data source configuration for which you want to control number field filters. See [Edit a Data Source](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932890384781-Edit-a-Data-Source).
2. Select the [Fields tab](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932906721933-Manage-Fields) in the data source creation work area.
...
1. Edit the data source configuration for which you want to control time field filters. See [Edit a Data Source](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932890384781-Edit-a-Data-Source).
2. Select the [Fields tab](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932906721933-Manage-Fields) in the data source configuration.
