...
1. Select ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374774130189) cross-link icon on the [dashboard icon bar](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932842163469-Use-the-Dashboard-Icon-Bars). The Dashboard Interactions dialog appears. In the following image, no cross-source links are defined for the dashboard.

   ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374728239629)
2. Select the **Cross-Visual Filtering** tab.

   ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374774131853)
3. Select a visual in the **Visuals** list on the left of the tab. The right side of the tab show the link filters available to be published in the **Published filters** table.
   ...
   ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374774135053)
