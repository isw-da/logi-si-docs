...
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933246573837-Using-the-Conditional-Formatting-Sidebar-Pivot-Tables
...
3. Select the conditional formatting option ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167823705997) on the [sidebar menu](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933295031181-Use-the-Visual-Sidebar-Menu) for the visual. The Conditional Formatting sidebar opens.

   ![Use to create conditional formatting rules](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167823707405 "Conditional Formatting work area - table")
4. Using the Conditional Formatting sidebar, you can configure formatting options for your pivot table visuals. See [Configure Conditional Formatting](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933259271309-Configure-Conditional-Formatting).
...
![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167830132365)
...
* Select an existing rule to edit the rule, or the delete icon ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167830132621) to delete the rule.
* Select and drag rules to change their order.

### Add or Edit Conditional Formatting Rule

![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167007199373)

### Select When To Apply Formatting

Select the add icon ![add icon](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167830134157 "add icon") in **Select When To Apply Formatting** to define the conditions to apply your formatting.

### Select Where To Apply Formatting

Select the add icon ![add icon](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167830134157 "add icon") for **Formatting** to define the formatting for your condition.

Select the delete icon ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167830132621) to delete a formatting option.

### Select When To Apply Formatting

**Group** attribute: Select a group of data to define values for that aggregated data. Optionally, select the add icon ![add icon](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167830134157 "add icon") to add a derived field or custom metric.

![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46166978589709)
...
![example of formatting applied to a group condition](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46166968195341 "Group Conditional Formatting work area")
...
Select the add icon ![add icon](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167830134157 "add icon") to add a formatting option you'll apply to your condition. Select the delete icon ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167830132621) to remove the formatting option.
...
![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167823709453)
