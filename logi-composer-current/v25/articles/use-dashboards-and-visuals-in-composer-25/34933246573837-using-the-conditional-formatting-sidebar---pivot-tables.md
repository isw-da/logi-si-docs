...
3. Select the conditional formatting option ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374700846861) on the [sidebar menu](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933295031181-Use-the-Visual-Sidebar-Menu) for the visual. The Conditional Formatting sidebar opens.

   ![Use to create conditional formatting rules](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374700847885 "Conditional Formatting work area - table")
...
![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374687323533)
...
* Select an existing rule to edit the rule, or the delete icon ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374687326605) to delete the rule.
* Select and drag rules to change their order.

### Add or Edit Conditional Formatting Rule

![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373096232461)

### Select When To Apply Formatting

Select the add icon ![add icon](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374700850829 "add icon") in **Select When To Apply Formatting** to define the conditions to apply your formatting.

### Select Where To Apply Formatting

Select the add icon ![add icon](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374700850829 "add icon") for **Formatting** to define the formatting for your condition.

Select the delete icon ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374687326605) to delete a formatting option.

### Select When To Apply Formatting

**Group** attribute: Select a group of data to define values for that aggregated data. Optionally, select the add icon ![add icon](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374700850829 "add icon") to add a derived field or custom metric.

![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373096496525)
...
![example of formatting applied to a group condition](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373074705421 "Group Conditional Formatting work area")
...
Select the add icon ![add icon](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374700850829 "add icon") to add a formatting option you'll apply to your condition. Select the delete icon ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374687326605) to remove the formatting option.
...
![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374687331981)
