...
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933107698573-Mute-a-Subscribed-Link-for-a-Visual
...
1. Select the link icon ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373310079501) on the [dashboard icon bar](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932842163469-Use-the-Dashboard-Icon-Bars). The Dashboard Interactions dialog appears. In the following image, no cross-source links are defined for the dashboard.

   ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373310288909)
2. Select the **Cross-Visual Filtering** tab.

   ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373344652045)
3. Select a visual in the **Visuals** list on the left of the tab. The right side of the tab show the link filters to which the visual can subscribe in the **Subscribed filters** table.
   ...
   ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373361111565)
