...
1. Log in as a user with the **Manage Connections**, **Administer Sources**, **Administer Visuals**  [privilege](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932577846157-Group-Privilege-Reference). If you are logged in as a tenant admin, verify you're in or switch to the appropriate tenant.
2. Select **Visual Gallery** on the [top-level navigation banner](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933120256397-The-Top-Level-Navigation-Banner) or the [UI menu](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933143886477-The-Composer-UI-Menu), or select the **Visual Gallery** box on the [Home page](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933063528717-Home-Page). The visual gallery work area opens.
...
See [Export Visual Gallery Visuals](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933265294349-Export-Visual-Gallery-Visuals).
