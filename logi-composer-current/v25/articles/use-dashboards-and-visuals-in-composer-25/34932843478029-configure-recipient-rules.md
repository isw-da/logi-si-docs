...
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932843478029-Configure-Recipient-Rules
updated_at: 2026-08-24T20:29:59Z
---
...
Logi Composer enables you and your users [to schedule and send](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932823729293-Schedule-a-Dashboard-Report) dashboard reports, and [share dashboards](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932824740749-Share-a-Dashboard-with-Users) with other Logi Composer users as needed.
...
**Note:** 
Users you add to scheduled reports using a full email address are not affected by recipient rules. See [Schedule a Dashboard Report](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932823729293-Schedule-a-Dashboard-Report).

## Recipient Rules Prerequisites

* Recipient rules can only be defined by an administrator or a user assigned to a group with the **[Administer Users](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932577846157-Group-Privilege-Reference)** privilege.
* Recipient rules rely on the use of custom attributes in your environment. See [Specify Custom User Attributes](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932642529293-Specify-Custom-User-Attributes).
