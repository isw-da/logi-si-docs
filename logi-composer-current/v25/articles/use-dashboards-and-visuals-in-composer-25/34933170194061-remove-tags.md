...
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933170194061-Remove-Tags
...
Users with the [privileges](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932577846157-Group-Privilege-Reference) **Administer Tags**, **Create Tags** or who have READ + WRITE permissions to dashboards, data sources, and visual gallery visuals can remove tags from these resources.

**Remove a tag from a**  **dashboard**

1. Open a dashboard you have permissions to access and edit, then select the manage tags icon (![manage tags icon](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167058603405 "manage tags icon")). The Manage Tags work area opens.
...
1. Open a visual you have permissions to access and edit, then select the manage tags icon (![manage tags icon](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167058603405 "manage tags icon")). The Manage Tags work area opens.
2. Select a tag in the **Tags** field; select the **x** icon to remove the tag.
