...
![a combo chart with multiple axes and options enabled](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373146378765 "Combo Chart example")
...
3. Select the settings icon (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374716080781)) on the [sidebar menu](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933295031181-Use-the-Visual-Sidebar-Menu). The Combo Chart Settings sidebar for the visual appears.

   ![Use this work area to define settings for the combo chart visual](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373121173901 "Combo Chart Settings sidebar")
...
5. Select the save icon (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374720453901)) to save the dashboard and the visual with its updated settings.
...
2. If you are editing the visual in a dashboard, select **Settings** from the [visual drop-down menu](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933290868621-Use-the-Visual-Menu). The [sidebar menu](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933295031181-Use-the-Visual-Sidebar-Menu) for the visual appears. If you are editing the visual from the Visual Gallery, the sidebar appears to the right of the visual.
   ...
   ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373146747789)
...
| Y2, Y3, Y4 Color | Select colors for the Y2, Y3, and Y4 dependent variables plotted on the combo chart. Select to clear the **Inherit from theme** checkbox to define a different color manually. |
| Color Palette | Select the color palette for the Y1 axis for this specific combo chart. Select to clear the **Inherit from theme** checkbox to define a different color manually. |

3. Close the Color sidebar and the color settings are dynamically applied to the visual.
4. Select the save icon to save the dashboard and the visual with its updated settings.
