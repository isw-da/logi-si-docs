...
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933267849101-Using-the-Conditional-Formatting-Sidebar-Tables
updated_at: 2026-05-26T22:08:54Z
---
...
3. Select the conditional formatting option ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46166961938061) on the [sidebar menu](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933295031181-Use-the-Visual-Sidebar-Menu) for the visual. The Conditional Formatting sidebar opens.

   ![Use to create conditional formatting rules](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46166962046605 "Conditional Formatting work area - table")
4. Use the Conditional Formatting sidebar to configure formatting options for your table visuals. See [Configure Conditional Formatting](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933259271309-Configure-Conditional-Formatting).
...
![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167818229261)

* Select **Add Rule** to add a conditional formatting rule. See [Configure Conditional Formatting](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933259271309-Configure-Conditional-Formatting).
* Select an existing rule to edit the rule, or the delete icon ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167807243277) to delete the rule.
* Select and drag rules to change their order.

### Add or Edit Conditional Formatting Rule

![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46166977411597)

### Select When To Apply Formatting

Select the add icon ![add icon](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167807247501 "add icon") in **Select When To Apply Formatting** to define the conditions to apply your formatting.
...
Select the add icon ![add icon](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167807247501 "add icon") for **Formatting** to define the formatting for your condition.

Select the delete icon ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167807243277) to delete a formatting option.

### Select When To Apply Formatting

* **Row** attribute: Select a row attribute to define the values for formatting by this data. Optionally, select the add icon ![add icon](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167807247501 "add icon") to add a derived field or custom metric.

  ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46166977516301)

  Example: Apply a background color to a specific **State** condition.

  ![example of conditional formatting by row attribute](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167006286861 "Conditional Formatting summary")
* **Group** attribute: Select an attribute that you’ve grouped your data by to define values for that aggregated data. Optionally, select the add icon ![add icon](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167807247501 "add icon") to add a derived field or custom metric.

  ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46166982570125)
  ...
  ![example of formatting applied to a group condition](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46166977916685 "Group Conditional Formatting work area")
...
![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46166967497229)
...
| From, To | Define a value range for **Between**, using **Static Time** or **Dynamic Time**. See [Set a Time Field Filter](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932958685197-Set-a-Time-Field-Filter). |
| Presets ... | Select an available **Preset...** for **Between**.  See [Set a Time Field Filter](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932958685197-Set-a-Time-Field-Filter). |

## Formatting

Select the add icon ![add icon](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167807247501 "add icon") to add a formatting option you'll apply to your condition. Select the delete icon ![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46167807243277) to remove the formatting option.
...
![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46166963005453)
