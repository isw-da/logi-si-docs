...
3. Select the settings icon (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374704172941)) on the [sidebar menu](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933295031181-Use-the-Visual-Sidebar-Menu). The Histogram Settings sidebar for the visual appears.

   ![define the settings for this visual](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373133410573 "Settings side bar menu for a histogram visual")
...
6. Select the save icon (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48374704175757)) to save the dashboard and the visual with its updated settings.
...
2. If you are editing the visual in a dashboard, select **Settings** from the [visual drop-down menu](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933290868621-Use-the-Visual-Menu). The [sidebar menu](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933295031181-Use-the-Visual-Sidebar-Menu) for the visual appears. If you are editing the visual from the Visual Gallery, the sidebar appears to the right of the visual.
   ...
   ![define the color properties for this visual](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373166282509 "Color properties sidebar menu")
3. Configure the color settings as described below. Supported color specifications are described in [Specify Colors](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932703126541-Specify-Colors).
   ...
   | Setting | Description |
   | --- | --- |
   | Bins Color | Select the color for the bins on the visual. By default, this is inherited from the theme. Select to clear the **Inherit from theme** checkbox to define a different color manually. |
