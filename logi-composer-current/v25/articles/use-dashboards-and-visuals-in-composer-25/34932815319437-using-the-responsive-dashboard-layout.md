...
![make changes to your dashboard in edit mode](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373766116237 "Dashboard in Edit Mode")

**View mode:**

![view your responsive dashboard layout](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373781896333 "Dashboard in View Mode")
...
Select the Dashboard Layout icon (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/48373752710925)) to open the Dashboard Layout work area. Here you can enable and disable locking mode, the responsive layout, and manage the minimum widget widths and heights.
