...
Formats for Number attributes [are set at the source](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932906721933-Manage-Fields#Settings). You can override source formats by changing a visual directly, without affecting the underlying source format. For information on other settings that may apply to Number attributes, see [Configure Number Formatting - Data Sources](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932821288589-Configure-Number-Formatting-Data-Sources).

**Note:** 
You can also override formatting for the Time attribute at the visual level. See [Configure Date and Time Formatting for Visuals](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933263048077-Configure-Date-and-Time-Formatting-for-Visuals).
