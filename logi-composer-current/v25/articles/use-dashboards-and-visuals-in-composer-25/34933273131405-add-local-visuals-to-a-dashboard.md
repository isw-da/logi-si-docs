...
To create local visuals, you need to be a user with Owner or Editor access to a dashboard, or a user with the [**Administer Dashboards** privilege](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932577846157-Group-Privilege-Reference).
...
Convert a local visual to a visual gallery visual to share it with other users. See [Convert Visual Gallery Visuals and Local Visuals](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933290437005-Convert-Visual-Gallery-Visuals-and-Local-Visuals).
