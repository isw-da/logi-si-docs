...
For even more control, use JavaScript to embed the dashboard. See [Embed Composer Components Using JavaScript and Trusted Access](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932930219405-Embed-Composer-Components-Using-JavaScript-and-Trusted-Access).
