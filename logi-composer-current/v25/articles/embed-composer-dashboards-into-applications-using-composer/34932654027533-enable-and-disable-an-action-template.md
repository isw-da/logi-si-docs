---
title: "Enable and Disable an Action Template"
id: 34932654027533
section: "Embed Composer Dashboards Into Applications Using Composer"
product: "Logi Composer v25"
url: https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34932654027533-Enable-and-Disable-an-Action-Template
...
Only enabled action templates can be invoked from Composer. You can [enable](#Enabling) and [disable](#Disablin) action templates using the Composer UI.
...
2. Select **Actions** on the [UI menu](https://logi-composer-v25.insightsoftware.com/hc/en-us/articles/34933143886477-The-Composer-UI-Menu) (![](https://logi-composer-v25.insightsoftware.com/hc/article_attachments/46168002917517)). The Actions page appears.
