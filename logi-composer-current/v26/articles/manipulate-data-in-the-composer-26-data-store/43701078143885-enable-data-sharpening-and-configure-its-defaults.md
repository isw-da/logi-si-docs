...
4. Select the **Global Settings** tab. The time bar, search, and Data Sharpening settings for the data source appears.
   ...
   ![](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/46243278647821)
5. Make sure **Time Bar** is enabled to access Data Sharpening settings. If Time Bar is disabled, you can't configure Data Sharpening settings. For more information about time bar default settings, see [Configure Time Bar Defaults](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701080606477-Configure-Time-Bar-Defaults).
