...
url: https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701030979853-S-Define-a-Fiscal-Calendar
...
Once you've created one or more fiscal calendars, users who can create and update sources can [select appropriate calendars](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701085233549-Global-Settings-Tab#calendar) to use for a source, and define a derived field **Time (FISCAL)** field that uses a selected calendar.
