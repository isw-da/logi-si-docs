...
2. Select **Sources** on the UI menu (![](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/46243286745357)). The [Sources](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701081381901-Data-Sources-Page) page appears.
...
5. In the Settings sidebar menu, select the edit (![](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/46243286746509)) button to open the **Format** work area.

   ![Set the format options for your data source date and time](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/46242640219277 "Format date and time work area")
