...
2. Select a data point in the visual. The context menu appears:
   ...
   ![Select a data point to open the context menu](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/46242489813133 "Context Menu for a data point in a visual")
3. Select **Keyset**. The Save Keyset dialog appears.

   ![Use this work area to define a keyset for your source](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/46242479695117 "Save Keyset work area")
