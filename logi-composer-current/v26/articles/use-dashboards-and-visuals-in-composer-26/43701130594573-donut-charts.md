...
url: https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701130594573-Donut-Charts
...
Donut charts are based on one metric and one attribute. They are supported by all Composer [data connectors](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701113495693-Data-Connector-Reference).

This topic describes:

* [Configure Settings for a Specific Donut Chart](#Configur3)
* [Configure Colors for a Specific Donut Chart](#Configur2)

## Configure Settings for a Specific Donut Chart

**Change the settings for a specific donut chart**

1. Edit the donut chart you want to modify. See [Edit Visuals](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701214480525-Edit-Visuals).
...
3. Select ![](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/46243152949517) on the [sidebar menu](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701215106445-Use-the-Visual-Sidebar-Menu). The Donut Chart Settings sidebar for the visual appears.

   ![](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/46242316403981)
...
6. Select ![](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/46243152951821) to save the dashboard and the visual with its updated settings.

## Configure Colors for a Specific Donut Chart

**Specify the color settings for a specific donut chart using the Color sidebar**
...
2. If you are editing the visual in a dashboard, select **Settings** from the [visual drop-down menu](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701184743565-Use-the-Visual-Menu). The [sidebar menu](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701215106445-Use-the-Visual-Sidebar-Menu) for the visual appears. If you are editing the visual from the Visual Gallery, the sidebar appears to the right of the visual.
   ...
   Select the color icon (![](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/46243152952845)) on the [sidebar menu](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701215106445-Use-the-Visual-Sidebar-Menu). The Color sidebar for the visual appears.

   ![](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/46243152953229)
...
5. Select the save icon (![](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/46243152951821)) to save the dashboard and the visual with its updated settings.
