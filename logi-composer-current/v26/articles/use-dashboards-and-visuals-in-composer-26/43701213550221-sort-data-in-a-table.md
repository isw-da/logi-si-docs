...
Remember to [save](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701047225613-Save-a-Dashboard) the dashboard to retain the sort order.
...
5. To clear sorting, hover over a column label, select the table context menu (![](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/46243145744781)) and select one of the following options:
