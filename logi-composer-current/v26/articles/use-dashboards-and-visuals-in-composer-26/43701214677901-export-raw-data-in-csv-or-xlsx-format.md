...
1. Select **Export** from the [visual drop-down menu](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701184743565-Use-the-Visual-Menu). Select an export option for your visual.
2. Select a file format on the submenu, **Raw Data > CSV**.
3. The Export as CSV dialog opens.

   ![Enter csv options here](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/46242272086925 "Export as CSV work area")
...
3. The Export as XLSX dialog opens.
   ...
   ![Enter XLSX options here](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/46242255009805 "Export as XLSX work area")
4. Accept or change the default settings:
