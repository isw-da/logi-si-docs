...
![use the context menu to drill deeper into text for any available data element](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/46242335201165 "Context Menu in a bar chart")
...
![view the details that make up this element](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/46242316684813 "Data Details work area")
...
Use **Keyset** to create a keyset from the selected data point. See [Create a Keyset](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701135635213-Create-a-Keyset).
...
![](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/46242316826765 "Zoomed in data element")

## Link

Use **Link** to quickly access a dashboard that has been linked to this visual. **Link** is only available if a dashboard link has been defined for a visual. See [Link a Dashboard](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701094383885-Link-a-Dashboard).
...
**Note:** 
You must be logged in as an administrator or as a user with the **Invoke Actions** [privilege](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701005611789-Group-Privilege-Reference).

To invoke an action, see [Invoke an Action](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43700988347533-Invoke-an-Action).
...
Select **Settings** to open the [visual sidebar menu](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701215106445-Use-the-Visual-Sidebar-Menu).
