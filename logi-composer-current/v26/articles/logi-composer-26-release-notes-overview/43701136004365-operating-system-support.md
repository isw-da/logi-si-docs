...
url: https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701136004365-Operating-System-Support
...
Composer is designed to run on a number of current, secure, and actively maintained operating systems. As operating systems approach their end-of-life (EOL), we will sunset support for those operating systems in your software environment. For more information on the software components that go into your environment, see [Supported Technologies Reference](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/48298359669517-Supported-Technologies-Reference).
