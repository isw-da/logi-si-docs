...
1. Set up the JSON file that describes your theme. Download and use the JSON files provided with the supplied **modern** and **dark** themes to get started or create your own.
   ...
   * You can create a JSON file that describes your theme. A sample is provided in [Sample Themes JSON File](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701210155405-Sample-Themes-JSON-File).
