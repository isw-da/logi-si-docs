...
url: https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43700988646541-Edit-Alerts
...
Edit alerts directly on the dashboard. To edit alerts, you must be logged in as a user belonging to a group with the [privilege](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701005611789-Group-Privilege-Reference) **Administer Alerts** or **Create Alerts**.
...
2. Select **Manage Alerts** from the dashboard. The Alerts work area opens, listing existing alerts for this dashboard. Some columns in this work area can be resized or sorted as needed; select the column header break to resize, or select the column name to change the sort.
   ...
   ![Create, enable, disable, edit, or delete alerts for a dashboard](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48528071933837 "Manage Alerts work area")
...
4. You can edit any of the sections of the alert definition as needed. After you select **Apply** to apply your changes to the definition, you must save your edits for the alert.
   ...
   **Note:** 
   See [Alert Definition Fields and Options](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701022616717-Alert-Definition-Fields-and-Options) information about adjusting these fields to suit your organization's needs
