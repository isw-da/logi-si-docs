...
url: https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701023076109-Configure-Data-Source-Refresh-Rates-Using-the-API
updated_at: 2026-08-31T04:12:36Z
---
...
You can modify source refresh rates using Composer's REST APIs. Only live data sources have refresh rates. Consequently, you can only modify the refresh rate of a live data source.
...
curl --user <name>:<password> -X GET 'https://<yourserver\_path>/api/sources/<123456789>
...
'https://<yourserver\_path>/api/sources/<123456789>' -H "Content-Type: application/vnd.composer.v3+json;"
