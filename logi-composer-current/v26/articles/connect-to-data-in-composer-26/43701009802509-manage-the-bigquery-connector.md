...
url: https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701009802509-Manage-the-BigQuery-Connector
...
3. Make sure that current account is linked to a billing account. To check this, select the menu (![](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48527953411469)) icon and then select
   **Billing**.
4. On the API Manager page, select **Credentials**:

   ![](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48527965316109)
...
6. On the Service Accounts page, select **Create Service Account** and specify the following:
   ...
   * Service account ID
   ...
   ![](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48527942236941)
7. Select **Create**.
