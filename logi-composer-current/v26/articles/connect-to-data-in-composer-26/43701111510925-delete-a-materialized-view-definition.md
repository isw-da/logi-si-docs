...
2. List the materialized views for the data source. See [List Materialized View Definitions](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701111671949-List-Materialized-View-Definitions).
   ...
   ![](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48418136825741)
3. Locate the materialized view definition you want to delete and select ![](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48418136826253) in the Delete column for the definition.
