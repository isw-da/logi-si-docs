...
url: https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701116834957-Remove-Column-Security-Definitions
updated_at: 2026-05-29T14:10:58Z
---
...
2. Select **Sources** on the [top-level navigation banner](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701115577869-The-Top-Level-Navigation-Banner) or in the [UI menu](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701160499853-The-Composer-UI-Menu) (![](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/46243268235917)). The Sources page appears.
3. Locate the data source and select the icon in the **Column** column for the data source. The Fields Security dialog appears.

   ![Fields security work area](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/46242591544845 "Fields Security")
4. Locate the column security definition you want to remove (delete) on the left side of the Column Security dialog and select ![](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/46243249334029) next to its name.
