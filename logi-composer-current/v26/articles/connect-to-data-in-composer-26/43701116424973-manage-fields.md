...
**Note:** In this release, when your admin enables the Enhanced Experience user interface, you will see changes to workflows you may have used in previous releases. If you are running an earlier release or your admin has not enabled the new interface, see [Fields Tab (Earlier Releases)](#v25.3).
...
![use this work area to manage the visibility of fields and other information related to your data](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48527918513165 "Fields Tab")
...
![Use this work area to define how your data is formatted and used and perform bulk changes to your data layout](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48527911156365 "Fields tab expanded work area")

**Note:** Fields Metadata is not available for Custom Metrics.
...
| --- | --- | --- |
| **Default** |  | Select to inherit values from the data source.  Select **Reset** to reset any changes you have made, even saved changes, to **Default**. |
...
| **Static Override** |  | Select to manually enter filter values.  You can enable **Custom Value**, **Custom Range**, or both. If the values you define are invalid, you can not save your settings. |
...
![Add Field Metadata work area](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48528041993357 "Add Field Metadata work area")
...
The Custom Metrics table lists custom metrics you have defined for the data and allows you to define others. You can also select **Add Custom Metric** from the **Options** menu to add a [custom metric](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701094537869-Create-and-Modify-Custom-Metrics) to this table.
...
![Use this work area to define how your data is formatted and used and perform bulk changes to your data layout](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48527949728269 "Source Fields Tab Work Area")
...
The following table describes the settings you can alter for individual data fields. To refresh your data source metadata, select the refresh ![](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48528028030349) button for Manual Refresh on the [Cache tab](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701085337997-Cache-Tab). See [Trigger Refresh Jobs](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701192120205-Trigger-Refresh-Jobs) for more information.
...
![Search for fields, or adjust fields or field settings as needed.](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48527924437005 "Data options work area for your data source")
...
![Search for fields, or create a custom metric](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48527924452621 "Data options work area for your data source")
