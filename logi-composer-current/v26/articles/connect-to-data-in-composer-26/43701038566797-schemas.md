...
If you would like to make a default schema available to your users, or hide a schema from your users, update the properties file of your connector. See [Select Schemas](#Select) .
