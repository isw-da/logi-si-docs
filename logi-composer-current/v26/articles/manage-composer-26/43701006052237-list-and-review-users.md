...
2. Select a user name on the left side of the page. A work area opens that includes three tabs of user details you can edit as needed.
   ...
   * Modify the user information on the **Info** tab. See [Specify General User Information](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701005878797-Specify-General-User-Information).
   * Review and assign the user to specific Composer tenants and select a primary tenant for this user on the **Tenants(s)** tab. See [Assign and Remove Users in Tenants](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701035684493-Assign-and-Remove-Users-in-Tenants).
   * Specify regional settings for the user on the **Regional Settings** tab. See [Specify A User's Regional Settings](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701005924493-Specify-A-User-s-Regional-Settings).
...
3. Select a user name on the left side of the page. A work area opens that includes three tabs of user details you can edit as needed.
   ...
   * Modify the user information on the **Info** tab. See [Specify General User Information](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701005878797-Specify-General-User-Information).
   * Review and assign the user to specific Composer tenant and select a primary tenant for this user on the **Tenants(s)** tab. See [Assign and Remove Users in Tenants](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701035684493-Assign-and-Remove-Users-in-Tenants).
   * Specify regional settings for the user on the **Regional Settings** tab. See [Specify A User's Regional Settings](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701005924493-Specify-A-User-s-Regional-Settings).
