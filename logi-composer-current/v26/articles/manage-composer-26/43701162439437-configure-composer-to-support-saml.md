...
* [Use the Network Time Protocol to Synchronize Time](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701073403021-Use-the-Network-Time-Protocol-to-Synchronize-Time) (avoids potential failure by the identity provider to authenticate SAML users)
* [Implement Single Sign-On (SSO) via SAML](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701194343565-Implement-Single-Sign-On-SSO-via-SAML)
...
See also [Implement Single Sign-On (SSO) via SAML](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701194343565-Implement-Single-Sign-On-SSO-via-SAML).
...
For help on accessing and editing the `zoomdata.properties` file, see [Configuration Property Files](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43700991919117-Configuration-Property-Files).
...
For guidance on accessing and editing the `zoomdata.properties` file, see [Configuration Property Files](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43700991919117-Configuration-Property-Files).

## Troubleshooting

For basic SAML troubleshooting, see [Basic SAML Troubleshooting](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701164330509-Basic-SAML-Troubleshooting). If additional assistance is needed, reach out to our [Technical Support](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701072313613-Contact-Technical-Support) team.
