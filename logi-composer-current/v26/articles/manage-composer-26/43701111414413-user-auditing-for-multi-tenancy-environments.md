...
Composer supports two different levels of separation for user audit data. By default, user audit data is separated between tenant accounts. If needed, you can further separate user audit data within a Composer tenant account by adding and using a custom attribute to separate the data.
