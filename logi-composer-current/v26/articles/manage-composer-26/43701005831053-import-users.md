...
6. On the Import Users tab, select the users to be imported.
   ...
   ![](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/46242774214925)
7. Select **Import**. When the import completes, you will see the users added to the user list.
8. On the **Info** tab of the user editor, select groups for each user. See [Specify General User Information](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701005878797-Specify-General-User-Information).
