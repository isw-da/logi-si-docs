...
url: https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701128164493-Trusted-Access
...
Trusted Access tokens are encrypted when stored in Composer metadata. The encryption mode used can be set as described in [Change the Encryption Mode](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701175423245-Change-the-Encryption-Mode).
...
* [Trusted Access API Endpoints](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701148717453-Trusted-Access-API-Endpoints)
* [Trusted Access Client Properties](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701175838349-Trusted-Access-Client-Properties)

## Trusted Access Prerequisites

* Every end user must have Composer user account defined, unless you are using LDAP autoprovisioning with Composer. See [Manage Users](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701051820941-Manage-Users).
* Trusted Access is enabled by default. If it is disabled, enable Trusted Access by selecting the **Trusted Access** option on the Security page. See [Enable Trusted Access](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701148451213-Enable-Trusted-Access).
