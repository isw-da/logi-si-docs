...
updated_at: 2026-08-31T04:14:55Z
---
...
| To | Read |
| --- | --- |
| Add an SSL Certificate.  By default, Composer enables an *http* port. To enable *https*, you must add an SSL certificate to the Composer server. | [Add an SSL Certificate](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701162572941-Add-an-SSL-Certificate) |
