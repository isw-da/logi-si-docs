...
3. Select the settings icon on the [sidebar menu](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701215106445-Use-the-Visual-Sidebar-Menu). The Waterfall Settings sidebar for the visual appears.
   ...
   ![use this menu to change the settings fo ryour waterfall visual](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48417921104653 "Settings sidebar menu, waterfall visual")
