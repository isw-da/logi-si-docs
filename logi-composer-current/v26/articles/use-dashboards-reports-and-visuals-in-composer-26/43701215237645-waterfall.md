...
updated_at: 2026-08-31T04:15:58Z
---
...
3. Select the settings icon on the [sidebar menu](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701215106445-Use-the-Visual-Sidebar-Menu). The Waterfall Settings sidebar for the visual appears.

   ![use this menu to change the settings fo ryour waterfall visual](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48527853791757 "Settings sidebar menu, waterfall visual")
...
3. Configure the color settings as described below. As you change the color settings, the legend at the top of the Color sidebar shows how the legend will appear on the visual. Supported color specifications are described in [Specify Colors](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43700990058381-Specify-Colors).
   ...
   | Total Color | Manually select a color for the Total using the color selector, or select the **Inherit from theme** checkbox to use the color palette specified by the [theme](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701163831053-Manage-User-Interface-Themes). |
