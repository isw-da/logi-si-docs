...
url: https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701164113293-Adjust-the-Time-Bar-Range-Using-the-Time-Range-Dialog
...
1. Select the visual.
2. Select the range setting icon (![](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48417976006669)) on the time bar. The Time Range dialog appears.

   ![](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48417964584589)
3. Use the **From** and **To** boxes to specify the default time bar range.
   ...
   * Select **Static Time** or **Dynamic Time** in the **fx** drop-down menu.
     ...
     ![](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48417976050957)
     ...
     ![](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48417976077581)
   * Alternatively, select **Presets...** to fill the **From** and **To** boxes with predefined time ranges provided by Composer:

     ![](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48417976104845)
...
4. Select **Apply** to apply the new time range setting. It is applied to the visual. If the visual is using a unified time bar, the new time range setting is applied to all the visuals using the unified time bar. See [Work with Unified Time Bars](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701164251917-Work-with-Unified-Time-Bars).
