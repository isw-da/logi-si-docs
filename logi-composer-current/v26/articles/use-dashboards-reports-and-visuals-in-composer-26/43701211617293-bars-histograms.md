...
3. Select the settings icon on the [sidebar menu](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701215106445-Use-the-Visual-Sidebar-Menu). The Histogram Settings sidebar for the visual appears.
   ...
   ![define the settings for this visual](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48527893426573 "Settings side bar menu for a histogram visual")
...
2. If you are editing the visual in a dashboard, select **Settings** from the [visual drop-down menu](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701184743565-Use-the-Visual-Drop-Down-Menu). The [sidebar menu](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701215106445-Use-the-Visual-Sidebar-Menu) for the visual appears. If you are editing the visual from the Visual Gallery, the sidebar appears to the right of the visual.
   ...
   ![define the color properties for this visual](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48527845327757 "Color properties sidebar menu")
