...
3. Select the settings icon on the [sidebar menu](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701215106445-Use-the-Visual-Sidebar-Menu). The Heat Map Settings sidebar for the visual appears.
   ...
   ![use this work area to define settings for this visual](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48527844621581 "Heat Map Settings Sidebar Menu")
