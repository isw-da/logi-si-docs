...
1. Open a dashboard you have permissions to access and edit, then select the manage tags icon ![manage tags icon](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48528021307661 "manage tags icon"). The Manage Tags work area opens.
...
4. If a matching tag does not exist, and you have appropriate privileges, you can select the add icon ![add icon](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48528021308557 "add icon") to add the tag to the dashboard. Your software returns a success message.
...
4. If a matching tag does not exist, and you have appropriate privileges, you can select the add icon ![add icon](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48528021308557 "add icon") to add the tag to the data source. Your software returns a success message.
...
5. If a matching tag does not exist, and you have appropriate privileges, you can select the add icon ![add icon](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48528021308557 "add icon") to add the tag to the visual. Your software returns a success message.
