...
Composer supports a variety of tile providers which offer an overlay design for the map visual types available in the program. These include: OpenStreetMap, MapQuest, and MapBox. MapQuest and MapBox require an API key.
...
Composer supports a variety of tile providers which offer an overlay design for the map visual types available in the program.
