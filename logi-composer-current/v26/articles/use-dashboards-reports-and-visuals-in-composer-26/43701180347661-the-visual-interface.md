...
6. **X-** and **Y- Axis Labels** and the **Color Metric** (availability varies, depending on the visual type): Select an axis label to change an attribute or metric. See [Change the Axes](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701130310797-Change-the-Axes) and [Change the Visual Color Metric](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701165465741-Change-the-Visual-Color-Metric).
