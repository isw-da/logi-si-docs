---
title: "Schedule a Self Service Report or Dashboard Report"
id: 43701093791245
...
Use Logi Composer to send [self service reports and](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/46982003580173-Manage-Self-Service-Reports) dashboard reports to yourself, to internal users, or external users. Set up these reports for sending on a schedule when you use the Scheduled Reports feature. This topic describes how to generate these reports on a schedule. Limit each scheduled report to fewer than 10 users, and plan time gaps between consecutive runs.
