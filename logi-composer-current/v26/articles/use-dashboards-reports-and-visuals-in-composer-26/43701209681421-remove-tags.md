...
1. Open a dashboard you have permissions to access and edit, then select the manage tags icon (![manage tags icon](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48417944880653 "manage tags icon")). The Manage Tags work area opens.
...
1. Open a visual you have permissions to access and edit, then select the manage tags icon (![manage tags icon](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48417944880653 "manage tags icon")). The Manage Tags work area opens.
2. Select a tag in the **Tags** field; select the **x** icon to remove the tag.
