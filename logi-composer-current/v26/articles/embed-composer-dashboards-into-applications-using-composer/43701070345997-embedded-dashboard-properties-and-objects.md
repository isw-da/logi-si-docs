...
Properties can be passed as parameters to the [`createComponent` method](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701117892237-EmbedManager-Methods#top) when embedding Composer dashboards.
...
| Property/Object | Default | Description |
| --- | --- | --- |
| `"application.banner": true` | `false` | Indicates whether the Composer [top-level navigation banner](https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701115577869-The-Top-Level-Navigation-Banner) should be shown with the embedded dashboard. Valid values are `true` or `false`.  Type: boolean  This property is deprecated and will be removed in a future release. |
