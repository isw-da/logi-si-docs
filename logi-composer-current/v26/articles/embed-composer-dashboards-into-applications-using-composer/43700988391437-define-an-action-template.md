...
3. Select the add icon ![add icon](https://logi-composer-v26.insightsoftware.com/hc/article_attachments/48418157440013 "add icon"). Action properties are listed on the right side of the page.
