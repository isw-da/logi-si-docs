...
url: https://logi-composer-v26.insightsoftware.com/hc/en-us/articles/43701164732301-Address-Safari-Browser-Connection-Lost-Error-When-Rendering-a-Visual
...
2. Configure your Composer server to use a new, valid SSL certificate instead of using the default, self-signed certificate. This can be done by
   adding an SSL certificate to your Composer server
