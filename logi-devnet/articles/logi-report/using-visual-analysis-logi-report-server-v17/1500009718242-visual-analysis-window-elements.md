...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009718242-Visual-Analysis-Window-Elements
updated_at: 2021-07-25T07:20:27Z
---

# Visual Analysis Window Elements

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404936712471/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009744081-Starting-a-Visual-Analysis-Session)[Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404942444695/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009744041-Performing-Visual-Analysis)
...
**![Menu button](https://devnet.logianalytics.com/hc/article_attachments/4404936966039/btn_va_menu.gif) Menu**
...
* **Open**  
   Opens an existing analysis template in a new Visual Analysis window via the [Open](https://devnet.logianalytics.com/hc/en-us/articles/1500009721082-Open) dialog box.
* **Save**  
   Saves the changes to the current analysis template.
* **Save As**  
   Saves the current analysis template with a different name or location or [as a new version](https://devnet.logianalytics.com/hc/en-us/articles/1500009750221-Creating-Versions#Save) in the [Save As](https://devnet.logianalytics.com/hc/en-us/articles/1500009721142-Save-As) dialog box.
* **Undo**  
...
![Undo button](https://devnet.logianalytics.com/hc/article_attachments/4404942446103/btn_undo.gif)**Undo**

Undoes the last operation.

![Redo button](https://devnet.logianalytics.com/hc/article_attachments/4404936716567/btn_redo.gif)**Redo**
...
Saves the current analysis template with a different name or location or [as a new version](https://devnet.logianalytics.com/hc/en-us/articles/1500009750221-Creating-Versions#Save) in the Save As dialog box.

![Swap button](https://devnet.logianalytics.com/hc/article_attachments/4404942448663/btn_rotate.gif)**Swap**

Exchanges the columns and rows in the data presentation area.

**![View mode list](https://devnet.logianalytics.com/hc/article_attachments/4404942612631/btn_va_view.gif) View mode**
...
![Presentation Area](https://devnet.logianalytics.com/hc/article_attachments/4404936966295/va_wndw_prst.gif)

The following are details about the Column and Row control boxes:

* ![Column box](https://devnet.logianalytics.com/hc/article_attachments/4404936966551/btn_va_drpgrpclmn.gif)  
   Group fields can be added to this control box to become column headers.
* ![Column box](https://devnet.logianalytics.com/hc/article_attachments/4404936966807/btn_va_drpaggclmn.gif)  
...
* ![Row box](https://devnet.logianalytics.com/hc/article_attachments/4404936967063/btn_va_drpgrprw.gif)  
   Group fields can be added to this control box to become row headers.
* ![Row box](https://devnet.logianalytics.com/hc/article_attachments/4404936967319/btn_va_drpaggrw.gif)  
...
* ![Text Type](https://devnet.logianalytics.com/hc/article_attachments/4404942612887/btn_va_dsplytyp_txt.gif)**Text**  
   The data values are displayed in text. This type requires that a data field is defined by the label legend ![Label button](https://devnet.logianalytics.com/hc/article_attachments/4404942613143/btn_va_lbl.gif) in the legend section.
* ![Bar Type](https://devnet.logianalytics.com/hc/article_attachments/4404936967575/btn_va_dsplytyp_bar.gif)**Bar**  
   The data values are displayed in bar chart.
* ![Line Type](https://devnet.logianalytics.com/hc/article_attachments/4404942613399/btn_va_dsplytyp_ln.gif)**Line**  
   The data values are displayed in line chart.
* ![Pie Type](https://devnet.logianalytics.com/hc/article_attachments/4404936967831/btn_va_dsplytyp_pie.gif)**Pie**  
   The data values are displayed in pie chart.
* ![Shape Type](https://devnet.logianalytics.com/hc/article_attachments/4404936968087/btn_va_dsplytyp_shp.gif)**Shape**  
...
* **![Color button](https://devnet.logianalytics.com/hc/article_attachments/4404942613655/btn_va_clr.gif) Color**  
...
* **![Label button](https://devnet.logianalytics.com/hc/article_attachments/4404942613143/btn_va_lbl.gif) Label**  
   The label legend can be bound with multiple data fields to provide label text to the members of the data fields.
* **![Size button](https://devnet.logianalytics.com/hc/article_attachments/4404936968471/btn_va_sz.gif) Size**  
   The size legend can be bound with at most one data field to identify the members of the data field by sizes.
* **![Slice button](https://devnet.logianalytics.com/hc/article_attachments/4404942613911/btn_va_angl.gif) Slice**  
...
* **![Shape button](https://devnet.logianalytics.com/hc/article_attachments/4404936968727/btn_va_shp.gif) Shape**  
