...
url: https://devnet.logianalytics.com/hc/en-us/articles/5741483999127-Configuring-the-LDAP-Server
updated_at: 2022-10-31T17:18:26Z
---

# Configuring the LDAP Server

[![Back](https://devnet.logianalytics.com/hc/article_attachments/9905574448535/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/5741439835159-Using-an-LDAP-Server-s-Security-System)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/9905574466839/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/5741484061591-Using-LDAP-Server-s-Security-Information)
...
| [Enable Auto-Import of Users from LDAP Server](https://devnet.logianalytics.com/hc/en-us/articles/5741484061591-Using-LDAP-Server-s-Security-Information#Import) | Select if you want to enable Logi Report Server to import LDAP users automatically. If you select this option, Logi Report Server's security system will import security information from the LDAP server automatically when an LDAP user signs in to Logi Report Server for the first time. |
...
4. Input the following information:
   ...
   * **Group Schema**
   ...
   ![Novell Directory Server](https://devnet.logianalytics.com/hc/article_attachments/9905635663127/scrty_rsc_srv_ldap_config_ui1.gif)
...
4. Input the following information:
   ...
   * **Import LDAP Groups to**: Group
   ...
   ![Microsoft Site Server](https://devnet.logianalytics.com/hc/article_attachments/9905635692311/scrty_rsc_srv_ldap_config_ui3.gif)
...
4. Input the following information:
   ...
   * **Import LDAP Groups to**: Group
   ...
   ![iPlanet Directory Server](https://devnet.logianalytics.com/hc/article_attachments/9905657103639/scrty_rsc_srv_ldap_config_ui4.gif)
...
4. Input the following information:
   ...
   * **Group Schema**
   ...
   ![Active Directory Advanced Server](https://devnet.logianalytics.com/hc/article_attachments/9905657130519/scrty_rsc_srv_ldap_config_ui5.gif)
...
4. Input the following information:
   ...
   * **Group Schema**
   ...
   ![Lotus Domino Server on NT](https://devnet.logianalytics.com/hc/article_attachments/9905657149463/scrty_rsc_srv_ldap_config_ui6.gif)
...
4. Input the following information:
   ...
   * **Group Schema** 
   ...
   ![OpenLDAP Directory Server](https://devnet.logianalytics.com/hc/article_attachments/9905635806871/scrty_rsc_srv_ldap_config_ui7.gif)
5. Select **Save** to save all settings in this page. You can then get all users and groups from the developer organization unit.
