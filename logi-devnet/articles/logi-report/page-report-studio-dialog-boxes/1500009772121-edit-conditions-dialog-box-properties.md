...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009772121-Edit-Conditions-Dialog-Box-Properties
updated_at: 2021-07-24T00:49:19Z
---

# Edit Conditions Dialog Box Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404880134167/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009772101-Edit-Aggregation-Dialog-Box-Properties)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404880134423/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009744262-Edit-Filter-Control-Dialog-Box-Properties)

# Edit Conditions Dialog Box Properties

You can use the Edit Conditions dialog box to [edit a condition for adding conditional format](https://devnet.logianalytics.com/hc/en-us/articles/1500009777581-Adding-Conditional-Formats-to-Fields-in-Page-Report).
...
The basic mode provides function for creating simple filter conditions that you can connect by the AND and OR operators.
...
Specifies the field that you want to filter.
...
![Edit Conditions dialog - Advanced mode](https://devnet.logianalytics.com/hc/article_attachments/4404880541719/edtcndtn_adv.gif)
...
You can also add condition lines to an existing group by selecting the condition lines and the group while holding the Ctrl button, and then selecting the Group button.
...
Specifies the logic operator of a condition group. Each time you select the logic button, Studio displays the next item following the order below.

* **AND**  
   Logic operator AND which is used to connect all the condition lines in the group.
* **OR**  
   Logic operator OR which is used to connect all the condition lines in the group.
* **AND NOT**   
   Logic operator AND NOT which is used to connect all the condition lines in the group.
* **OR NOT**   
   Logic operator OR NOT which is used to connect all the condition lines in the group.

**Field**

Specifies the field you want to filter.
