...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009744522-Format-Pointer-Label-Dialog-Box-Properties
updated_at: 2021-07-24T00:49:14Z
---

# Format Pointer Label Dialog Box Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404880134167/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009772421-Format-Platform-Dialog-Box-Properties)[Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404880134423/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009744542-Format-Radar-Dialog-Box-Properties)

# Format Pointer Label Dialog Box Properties

You can use the Format Pointer Label dialog box to format the pointer labels in a gauge chart (excluding bubble gauge chart). This topic describes the options in the dialog box.
...
![Format Pointer Label - General](https://devnet.logianalytics.com/hc/article_attachments/4404880512663/fmtpntlbl_gnrl.gif)
...
* **X**  
   Specifies the horizontal coordinate of the top left corner of the labels, relative to their parent container. It takes effect when you have selected the Show Pointer Value option and set Position to customized in the Pointer tab of the gauge's corresponding Format XXX Gauge dialog box.
* **Y**  
   Specifies the vertical coordinate of the top left corner of the labels, relative to their parent container. It takes effect when you have selected the Show Pointer Value option and set Position to customized in the Pointer tab of the gauge's corresponding Format XXX Gauge dialog box.
* **Alignment**  
...
![Format Pointer Label - Font](https://devnet.logianalytics.com/hc/article_attachments/4404880513559/fmtpntlbl_font.gif)
...
![Format Pointer Label - Format](https://devnet.logianalytics.com/hc/article_attachments/4404885572759/fmtpntlbl_fmt.gif)
