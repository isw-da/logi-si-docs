...
4. Server displays the Start Page which provides quick entries to some key functions.
   ...
   ![Server Start Page](https://devnet.logianalytics.com/hc/article_attachments/4420402735255/admin_lsn1_startpg.gif)
5. Select **Public Folder** in the **Open** category to go to the public report directory on the Server Console.

   By default, Server hides the User Directory panel on the left, which shows the folders of the published resources available to the current user.

   ![Server Console](https://devnet.logianalytics.com/hc/article_attachments/4420402735511/admin_lsn1_cnsl.gif)
...
7. Focus on any of the resource rows. Server displays a floating toolbar, which would contain all or some of the following commands, depending on the type of the resource.
   ...
   ![Resource Commands](https://devnet.logianalytics.com/hc/article_attachments/4420395015703/admin_lsn1_cntrl.gif)

   * **Run**![Run button](https://devnet.logianalytics.com/hc/article_attachments/4420402733591/btn_run.gif)
   ...
   * **Advanced Run**![Advanced Run button](https://devnet.logianalytics.com/hc/article_attachments/4420411064343/btn_advrun.gif)  
   ...
   * **Edit**![Edit button](https://devnet.logianalytics.com/hc/article_attachments/4420411064983/btn_edit.gif)
   ...
   * **Schedule**![Schedule button](https://devnet.logianalytics.com/hc/article_attachments/4420395009175/btn_schdl.gif)  
     You can use this command to run the report based on a schedule. When you use Schedule to run a report, Server places the request into a queue and processes it in the submitted order. You can configure the size of the queue and priority of the queue to make the most efficient use of resources. [Lesson 4](https://devnet.logianalytics.com/hc/en-us/articles/4405661260183-Lesson-4-Scheduling-Reports) describes scheduled reports.
   * **Version**![Version button](https://devnet.logianalytics.com/hc/article_attachments/4420411062679/btn_vrsn.gif)  
     You can use this command to view the resource version and scheduled/advanced run result version information.
   * **Properties**![Properties button](https://devnet.logianalytics.com/hc/article_attachments/4420402732055/btn_prpty.gif)  
     You can use this command to define the archive policy, security, and a description associated with the resource. [Lesson 6](https://devnet.logianalytics.com/hc/en-us/articles/4405661262743-Lesson-6-Security) describes security.
   * **Parameter Settings**![Parameter Settings button](https://devnet.logianalytics.com/hc/article_attachments/4420395016215/btn_prm.gif)  
     You can use this command to customize the default parameter values for the report.
   * **NLS Editor**![Parameter Settings button](https://devnet.logianalytics.com/hc/article_attachments/4420402735767/btn_nlsedtr.gif)  
     You can use this command to translate a report or dashboard into another language.
   * **Share**![Share button](https://devnet.logianalytics.com/hc/article_attachments/4420402736023/btn_share.gif)  
     You can use this command to share a web report added by you in the server resource tree with other users.
   * **Delete**![Delete button](https://devnet.logianalytics.com/hc/article_attachments/4420402736279/btn_delete.gif)  
