...
2. Select the **ShipmentDetailsbyCustomer.cls** link to run the report.
   ...
   ![Shipment Report](https://devnet.logianalytics.com/hc/article_attachments/4420447433879/admin_lsn3_rpt.gif)
...
1. In the JinfonetGourmetJava folder, select the **OrderListbyDate\_Parameter.cls** link.
   ...
   ![Enter Parameter Values](https://devnet.logianalytics.com/hc/article_attachments/4420453755031/admin_lsn3_prm.gif)
2. Server displays the requested report showing only order details from May 1, 2016 to June 1, 2016.

   ![Parameter Report](https://devnet.logianalytics.com/hc/article_attachments/4420453755287/admin_lsn3_prmrpt.gif)
...
1. In the JinfonetGourmetJava folder, point to the **CustomerContactCard.cls** report row, then select **Advanced Run**![Advanced Run button](https://devnet.logianalytics.com/hc/article_attachments/4420461814679/btn_advrun.gif) on the floating toolbar.
2. In the Advanced Run dialog box, select the **Format** tab and select **PDF** from the **Select Format** drop-down list.

   ![Run in PDF](https://devnet.logianalytics.com/hc/article_attachments/4420461814935/admin_lsn3_vwpdf.gif)
