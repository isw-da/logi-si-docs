...
A catalog file stores all of the object definitions that you have created while developing the reports that are stored in the same catalog folder. This includes data object definitions, component customizations, style definitions, and more.

The following illustration summarizes the contents of a catalog file.

![Catalog Contents](https://devnet.logianalytics.com/hc/article_attachments/4420402667287/devbasic_ctlg_cntnt.gif)
...
* **Queries and Business Views**  
  [Queries](https://devnet.logianalytics.com/hc/en-us/articles/4405661291543-Queries) and [business views](https://devnet.logianalytics.com/hc/en-us/articles/4405664338967-Business-Views) are the data sources used for creating reports in Logi Report.
* **Parameters**  
...
* **Publishing resources to Server**   
  Designer provides a convenient way to publish an entire catalog along with all of the required reports and referenced resources such as image files to Server in one action.

## Catalog Manager

The Catalog Manager is a useful interface which simplifies the management of the resources in a catalog. It contains a toolbar, the left data resource tree, and the right Properties sheet.

![Catalog Manager](https://devnet.logianalytics.com/hc/article_attachments/4420411005719/devbasic_ctlg_mngr.gif)
