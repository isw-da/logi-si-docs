...
2. Point to the **OrderListbyDate\_Parameter.cls** report row, then select **Schedule**![Schedule button](https://devnet.logianalytics.com/hc/article_attachments/4420447432599/btn_schdl.gif) on the floating toolbar.

   Server displays the Schedule dialog box.

   ![Schedule - General](https://devnet.logianalytics.com/hc/article_attachments/4420453754135/admin_lsn4_rpttab.gif)
...
5. In the **Publish** tab, select **To Version**, then select **Publish to Versioning System**.
   ...
   ![Publish to Version](https://devnet.logianalytics.com/hc/article_attachments/4420461813655/admin_lsn4_2vrsn.gif)
...
1. Point to the **OrderListbyDate\_Parameter.cls** report row, then select **Version**![Version button](https://devnet.logianalytics.com/hc/article_attachments/4420453754391/btn_vrsn.gif) on the floating toolbar.
2. In the **Report Result Versions** table, select the **Page Report Result** link in the **Result** column. Server displays the full page report.
   ...
   ![port Result Version](https://devnet.logianalytics.com/hc/article_attachments/4420461813911/admin_lsn4_rst.gif)
...
1. In the Resources page of the Server Console, go to the **Public Reports** > **JinfonetGourmetJava** folder.
2. Point to the **CustomerContactCard.cls** report row, then select **Schedule**![Schedult button](https://devnet.logianalytics.com/hc/article_attachments/4420447432599/btn_schdl.gif) on the floating toolbar.
...
5. Select **PDF**. Server displays the PDF options.
   ...
   ![Publish to Disk](https://devnet.logianalytics.com/hc/article_attachments/4420461814167/admin_lsn4_2pdf.gif)
...
8. In the **Time** subtab, choose **Run this task periodically** from the **Time Type** drop-down list. Select **Weekly** from the **Date** drop-down list and define to repeat every one week on **Sunday**. Select **At** from the **Time** drop-down list and specify the time as **8:00 PM**.
   ...
   ![Time Condition](https://devnet.logianalytics.com/hc/article_attachments/4420447433111/admin_lsn4_time.gif)
...
2. Point to the task and select **Run**![Run button](https://devnet.logianalytics.com/hc/article_attachments/4420453754647/btn_run.gif) on the floating toolbar to immediately schedule the report.

   ![Scheduled Task Table](https://devnet.logianalytics.com/hc/article_attachments/4420447433367/admin_lsn4_task.gif)
...
1. In the Resources page of the Server Console, go to the **Public Reports** > **JinfonetGourmetJava** folder.
2. Point to the **ProductSalesAnalysis.cls** report row, then select **Schedule**![Schedule button](https://devnet.logianalytics.com/hc/article_attachments/4420447432599/btn_schdl.gif) on the floating toolbar.
...
5. Fill out the tab according to your requirements and the printer settings.
   ...
   ![Publish to Printer](https://devnet.logianalytics.com/hc/article_attachments/4420447433623/admin_lsn4_prntr.gif)
...
7. From the **Time Type** drop-down list, choose **Run this task periodically**, select **Monthly** from the **Date** drop-down list and select to run the task on **The 1st day of every 2 months** at **7:00 AM**.
   ...
   ![Time Condition](https://devnet.logianalytics.com/hc/article_attachments/4420461814423/admin_lsn4_monthly.gif)
