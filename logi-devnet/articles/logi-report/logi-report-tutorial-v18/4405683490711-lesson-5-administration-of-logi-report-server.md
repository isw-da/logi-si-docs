...
* **License Key**  
  You can use it to update the server license with a new one.
* **Cache**  
...
* **Custom Fields**  
  You can use it to manage user-defined fields which can be used as resource properties on Server.
