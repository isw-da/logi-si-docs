...
![Report Sketch](https://devnet.logianalytics.com/hc/article_attachments/4420394991895/rpt_lsn5_model.gif)
...
4. In the Add Tables/Views/Queries dialog box, expand the JDBC connection node and then the **Tables** node, then select the tables **Customers** and **Orders** and select **Add**![Add button](https://devnet.logianalytics.com/hc/article_attachments/4420394986903/btn_addarw.gif) to add them to the query. Select **OK** to close the dialog box.
5. In the Query Editor dialog box,
   ...
   ![Join Between Tables](https://devnet.logianalytics.com/hc/article_attachments/4420411035159/rpt_lsn5_addtbl.gif)
...
2. In the Sort Fields By dialog box, select **Orders\_Order ID** in the **Resources** box and select **Add**![Add button](https://devnet.logianalytics.com/hc/article_attachments/4420394986903/btn_addarw.gif) to add it as the sort-by field, then select **OK** to return back to the Table Wizard dialog box.

   ![Add Sort-by Field](https://devnet.logianalytics.com/hc/article_attachments/4420394992151/rpt_lsn5_srtfld.gif)
...
1. Add the DBFields **Customers\_Territory** as the first group-by field and **Customer Name** the second one.
   ...
   ![Add Groups](https://devnet.logianalytics.com/hc/article_attachments/4420411035671/rpt_lsn5_grptb.gif)
...
4. Select the **View** tab to preview the report.
   ...
   ![Preview Report Draft](https://devnet.logianalytics.com/hc/article_attachments/4420402703255/rpt_lsn5_draft.gif)
...
5. In the Display Type dialog box, select in the **Value** column and then select the **ellipsis**![Ellipsis button](https://devnet.logianalytics.com/hc/article_attachments/4420402692119/btn_chsr.gif) in it.
6. In the Insert Fields dialog box, select **Customers\_Territory** in the **DBField List** box and select **Insert** to add it as value of the drop-down list.
   ...
   ![Define Drop-down List Value](https://devnet.logianalytics.com/hc/article_attachments/4420411035927/rpt_lsn5_drplstvlu.gif)
7. In the **Web Behaviors** box of the Display Type dialog box, select **Data Change** from the drop-down list in the **Events** column, then select the **ellipsis**![Ellipsis button](https://devnet.logianalytics.com/hc/article_attachments/4420402692119/btn_chsr.gif) in the **Actions** column.

   ![Select Drop-down List Web Action](https://devnet.logianalytics.com/hc/article_attachments/4420411036823/rpt_lsn5_optn.gif)
...
9. In the Filter - Web Action Builder dialog box, specify to apply the action to **TableComp**, select in the **Filter On** column and select **CUSTOMERS\_TERRITORY** from the drop-down list, then select in the **Value** column and select **Multi-Value Container** from the drop-down list. Select **OK** to apply the settings.
   ...
   ![Define the Filter Web Action](https://devnet.logianalytics.com/hc/article_attachments/4420411037207/rpt_lsn5_fltrbldr.gif)
...
1. Drag the **Label** icon ![Label button](https://devnet.logianalytics.com/hc/article_attachments/4420411029783/btn_label.gif) twice from the **Components** panel to the page header panel to add two labels in it.
...
3. Resize the two labels and arrange the three objects in the page header panel as follows:
   ...
   ![Arrange Objects in Page Header](https://devnet.logianalytics.com/hc/article_attachments/4420402703895/rpt_lsn5_lbl.gif)
4. Select the two labels and navigate to **Format** > **Bold**![Bold button](https://devnet.logianalytics.com/hc/article_attachments/4420411037591/btn_bold.gif).
5. Select the **Shipment Details by Customer** label, then in the Report Inspector, set its **Font Size** property to **18** and **Foreground** property to **Red**.
   ...
   ![Set Label Properties](https://devnet.logianalytics.com/hc/article_attachments/4420411037847/rpt_lsn5_lblprpty.gif)
...
7. Select the four objects in the two group header rows, then set their **Bold** property to **true** and **Foreground** property to **0xcc0000** in the Report Inspector.
   ...
   ![Edit Group Field Properties](https://devnet.logianalytics.com/hc/article_attachments/4420402704151/rpt_lsn5_grpfld.gif)
...
2. In the Report Inspector, select the **Table Group Header** and **Table Group Header 1** nodes in the report structure tree, then set their **Background** property to **0xc0c0c0**.
   ...
   ![Edit Group Header Background Color](https://devnet.logianalytics.com/hc/article_attachments/4420411038103/rpt_lsn5_grphdr.gif)
3. Right-click on the second group footer row (GF) and select **Hide** from the shortcut menu to hide it.

   ![Hide Group Footer](https://devnet.logianalytics.com/hc/article_attachments/4420411038487/rpt_lsn5_hide.gif)
4. On the report tab bar, right-click the report tab and select **Rename** to rename it to **ShipmentDetails**.

   ![Rename Report Tab](https://devnet.logianalytics.com/hc/article_attachments/4420394987671/renmrpttb.gif)
5. Navigate to **File** > **Save** to save the report as **ShipmentDetailsbyCustomer.cls**.
6. Select the **View** tab to preview the report.

   ![Preview Report](https://devnet.logianalytics.com/hc/article_attachments/4420402704535/rpt_lsn5_prvw.gif)

   ![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4420394642839/noteicon.jpg) If the report does not look correct, you can compare it to the final version of the report included in Designer. To do this, save and close your current catalog, and then open the **JinfonetGourmetJava.cat** catalog file in `<install_root>\Demo\Reports\TutorialReports`.
...
![Preview in Page Report Studio](https://devnet.logianalytics.com/hc/article_attachments/4420402705047/rpt_lsn5_pgstd.gif)

You can go to [Creating and Performing Data Analysis on Page Reports](https://devnet.logianalytics.com/hc/en-us/articles/4405661298967-Lesson-3-Creating-and-Performing-Data-Analysis-on-Page-Reports) in the Quick Start part to get more information about working with Page Report Studio.
