...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009687782-Quick-Schedule
updated_at: 2021-11-03T06:58:03Z
---

# Quick Schedule

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4412131374359/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009713701-Query-Filter)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4412139481879/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009687802-Rename-Report-Tab)

# Quick Schedule

The Quick Schedule dialog helps you to specify the information for [scheduling a report task](https://devnet.logianalytics.com/hc/en-us/articles/1500009718181-General-Operations-in-a-Report#Schedule) based on the current page report tab in Page Report Studio. This dialog appears when you select the Quick Schedule button ![Quick Schedule button](https://devnet.logianalytics.com/hc/article_attachments/4412139508887/btn_schdl.gif) on the toolbar in the Basic View mode of Page Report Studio.
...
* **E-mail**  
  ...
  + **Attachment in**  
    ...
    - **Page Report Result**  
      Sends the report result in a [page report result file](https://devnet.logianalytics.com/hc/en-us/articles/1500009715061-Schedule#RSD) (RSD file) as attachment in the e-mail.
    - **PDF**  
...
* **Version System**  
  ...
  + **Format**  
    ...
    - **JReport Result**  
       Publishes the report result to a Logi JReport result file (RST file). RST files can be exported to HTML, PDF, Text, Excel, XML, RTF and Postscript formats via
      Logi JReport Server.
    - **Page Report Result**  
...
* **FTP**  
  ...
  + **Format**  
    ...
    - **JReport Result**  
       Sends the report result in a Logi JReport result file (RST file) to the specified FTP site.
    - **Page Report Result**  
