...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009687022-Banded-Object-Properties
...
The Banded Object Properties dialog helps you to edit the properties of a banded object. It contains the following tabs: [General](#General), [Border](#Border) and [Others](#Others).
...
![Banded Object Properties dialog - General tab](https://devnet.logianalytics.com/hc/article_attachments/4412139605783/bdobjprpty_gnrl.gif)
...
![Banded Object Properties dialog - Border tab](https://devnet.logianalytics.com/hc/article_attachments/4412139609239/bdobjprpty_border.gif)

**Color**

Specifies the border color. To change the color, select the color indicator to access the [Select Color](https://devnet.logianalytics.com/hc/en-us/articles/1500009713741-Select-Color) dialog and then specify a new color, or input a color string in the format #RRGGBB.
...
![Banded Object Properties dialog - Others tab](https://devnet.logianalytics.com/hc/article_attachments/4412131507607/bdobjprpty_other.gif)
...
Specifies whether to add the node that represents the banded object to the TOC tree that is displayed in the TOC Browser.
...
If true, the banded object will be exported when you save the report result as an XLS file (make sure to check Data Format in the Export dialog).
