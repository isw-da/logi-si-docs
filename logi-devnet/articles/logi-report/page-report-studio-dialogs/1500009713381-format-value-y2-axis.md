...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009713381-Format-Value-Y2-Axis
updated_at: 2021-11-03T06:58:09Z
---

# Format Value (Y2) Axis

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4412131374359/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009713361-Format-Value-Y-Axis)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4412139481879/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009687222-Formula-Editor)

# Format Value (Y2) Axis

The Format Value (Y2) Axis dialog helps you to format the value (Y2) axis of a chart (unavailable to pie or indicator chart). It contains the following tabs: [Axis](#Axis), [Tick Mark](#Tick), [Font](#Font), [Orientation](#Orientation) and [Format](#Format).
...
![Format Value (Y2) Axis dialog - Axis tab](https://devnet.logianalytics.com/hc/article_attachments/4412131497111/fmtvalueaxis2_axis.gif)
...
![Format Value (Y2) Axis dialog - Major Tick Mark](https://devnet.logianalytics.com/hc/article_attachments/4412112619415/fmtvalueaxis2_mark_major.gif)
...
![Format Value (Y2) Axis dialog - Minor Tick Mark](https://devnet.logianalytics.com/hc/article_attachments/4412139582103/fmtvalueaxis2_mark_minor.gif)
...
![Format Value (Y2) Axis dialog - Font tab](https://devnet.logianalytics.com/hc/article_attachments/4412131497367/fmtvalueaxis2_font.gif)
...
![Format Value (Y2) Axis dialog - Orientation tab](https://devnet.logianalytics.com/hc/article_attachments/4412131497623/fmtvalueaxis2_orntatn.gif)
...
![Format Value (Y2) Axis dialog - Format tab](https://devnet.logianalytics.com/hc/article_attachments/4412139582359/fmtvalueaxis2_fmt.gif)
