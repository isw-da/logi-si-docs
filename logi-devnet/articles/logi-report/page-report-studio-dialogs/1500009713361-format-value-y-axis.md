...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009713361-Format-Value-Y-Axis
updated_at: 2021-11-03T06:58:09Z
---

# Format Value (Y) Axis

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4412131374359/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009687482-Format-Target-Label)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4412139481879/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009713381-Format-Value-Y2-Axis)

# Format Value (Y) Axis

The Format Value (Y) Axis dialog helps you to format the value (Y) axis of a chart (unavailable to pie or indicator chart). It contains the following tabs: [Axis](#Axis), [Tick Mark](#Tick), [Font](#Font), [Orientation](#Orientation) and [Format](#Format).
...
![Format Value (Y) Axis dialog - Axis tab](https://devnet.logianalytics.com/hc/article_attachments/4412112619671/fmtvalueaxis_axis.gif)
...
![Format Value (Y) Axis dialog - Major Tick Mark tab](https://devnet.logianalytics.com/hc/article_attachments/4412139582743/fmtvalueaxis_mark_major.gif)
...
![Format Value (Y) Axis dialog - Minor Tick Mark tab](https://devnet.logianalytics.com/hc/article_attachments/4412139582999/fmtvalueaxis_mark_minor.gif)
...
![Format Value (Y) Axis dialog - Font tab](https://devnet.logianalytics.com/hc/article_attachments/4412131497879/fmtvalueaxis_font.gif)
...
![Format Value (Y) Axis dialog - Orientation tab](https://devnet.logianalytics.com/hc/article_attachments/4412139583255/fmtvalueaxis_orntatn.gif)
...
![Format Value (Y) Axis dialog - Format tab](https://devnet.logianalytics.com/hc/article_attachments/4412139583511/fmtvalueaxis_fmt.gif)
