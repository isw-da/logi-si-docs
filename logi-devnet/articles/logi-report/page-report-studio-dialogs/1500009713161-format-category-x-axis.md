...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009713161-Format-Category-X-Axis
updated_at: 2021-11-03T06:58:12Z
---

# Format Category (X) Axis

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4412131374359/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009713141-Format-Bubble-Gauge)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4412139481879/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009687302-Format-Dial-Gauge)

# Format Category (X) Axis

The Format Category (X) Axis dialog helps you to format the category (X) axis of a chart (unavailable to pie or indicator chart). It contains the following tabs: [Axis](#Axis), [Tick, Mark](#Tick), [Font](#Font), [Orientation](#Orientation) and [Format](#Format).
...
![Format Category (X) Axis dialog - Axis](https://devnet.logianalytics.com/hc/article_attachments/4412131501847/fmtctgryaxis_axis.gif)
...
![Format Category (X) Axis dialog - Tick Mark - Major Tick Mark](https://devnet.logianalytics.com/hc/article_attachments/4412139593111/fmtctgryaxis_mark_major.gif)
...
![Format Category (X) Axis dialog - Tick Mark - Minor Tick Mark](https://devnet.logianalytics.com/hc/article_attachments/4412139593367/fmtctgryaxis_mark_minor.gif)
...
![Format Category (X) Axis dialog - Tick Mark - Scale](https://devnet.logianalytics.com/hc/article_attachments/4412139593623/fmtctgryaxis_mark_scale.gif)
...
* **Fixed**  
   If checked, you can define the minimum value as required. Input the value in the text box, or specify it in the calendar if the field on the category axis is of Date, DateTime or Time type.
...
* **Fixed**  
   If checked, you can define the maximum value as required. Input the value in the text box, or specify it in the calendar if the field on the category axis is of Date, DateTime or Time type.
...
![Format Category (X) Axis dialog - Font - Major Label](https://devnet.logianalytics.com/hc/article_attachments/4412139593879/fmtctgryaxis_font_major.gif)
...
![Format Category (X) Axis dialog - Font - Minor Label](https://devnet.logianalytics.com/hc/article_attachments/4412131502103/fmtctgryaxis_font_minor.gif)
...
![Format Category (X) Axis dialog - Orientation - Major Label](https://devnet.logianalytics.com/hc/article_attachments/4412139594135/fmtctgryaxis_orntatn_major.gif)
...
![Format Category (X) Axis dialog - Orientation - Minor Label](https://devnet.logianalytics.com/hc/article_attachments/4412139594391/fmtctgryaxis_orntatn_minor.gif)
...
![Format Category (X) Axis dialog - Format - Major Label](https://devnet.logianalytics.com/hc/article_attachments/4412139594647/fmtctgryaxis_fmt_major.gif)
...
![Format Category (X) Axis dialog - Format - Minor Label](https://devnet.logianalytics.com/hc/article_attachments/4412112624791/fmtctgryaxis_fmt_minor.gif)
