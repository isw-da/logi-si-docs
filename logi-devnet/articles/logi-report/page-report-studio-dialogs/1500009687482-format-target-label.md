---
title: "Format Target Label"
id: 1500009687482
section: "Page Report Studio Dialogs"
category: "Logi Report"
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009687482-Format-Target-Label
updated_at: 2021-11-03T06:58:09Z
---

# Format Target Label

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4412131374359/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009687442-Format-Surface)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4412139481879/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009713361-Format-Value-Y-Axis)

# Format Target Label

The Format Target Label dialog helps you to format the target labels in a gauge chart (excluding bubble gauge chart). It contains the following tabs: [General](#General), [Font](#Font) and [Format](#Format).
...
![Format Target Label - General](https://devnet.logianalytics.com/hc/article_attachments/4412131498135/fmttgtlbl_gnrl.gif)
...
* **X**  
   Specifies the horizontal coordinate of the top left corner of the labels, relative to their parent container. It takes effect when the Show Target Value option is checked and Position is set to customized in the Target tab of the gauge's corresponding Format XXX Gauge dialog.
* **Y**  
   Specifies the vertical coordinate of the top left corner of the labels, relative to their parent container. It takes effect when the Show Target Value option is checked and Position is set to customized in the Target tab of the gauge's corresponding Format XXX Gauge dialog.
* **Alignment**  
...
![Format Target Label - Font](https://devnet.logianalytics.com/hc/article_attachments/4412139583767/fmttgtlbl_font.gif)
...
![Format Target Label - Format](https://devnet.logianalytics.com/hc/article_attachments/4412139584023/fmttgtlbl_fmt.gif)
...
automatically scale the target labels that are of the Number data type when the label values fall into the two ranges:
