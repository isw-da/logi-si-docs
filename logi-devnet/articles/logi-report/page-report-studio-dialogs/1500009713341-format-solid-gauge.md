---
title: "Format Solid Gauge"
id: 1500009713341
section: "Page Report Studio Dialogs"
category: "Logi Report"
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009713341-Format-Solid-Gauge
updated_at: 2021-11-03T06:58:10Z
---

# Format Solid Gauge

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4412131374359/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009687422-Format-Scatter)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4412139481879/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009687462-Format-Stock)

# Format Solid Gauge

The Format Solid Gauge dialog helps you to format a solid gauge chart. It contains the following tabs: [Circular Graph](#Circular), [Axis](#Axis), [Pointer](#Pointer), [Target](#Target), [Frame](#Frame), [Range Color](#Range) and [Hint](#Hint).
...
![Format Solid Gauge dialog - Circular Graph](https://devnet.logianalytics.com/hc/article_attachments/4412139584535/fmtsldgauge_crculr.gif)
...
* **Angle**  
   Specifies the degree for angles of the arcs. Select the angle of the gauge from the drop-down list or select Customized to open the [Customize Gauge Angle](https://devnet.logianalytics.com/hc/en-us/articles/1500009712901-Customize-Gauge-Angle) dialog to specify the start angle and end angle.
* **Thickness**  
...
* **Color**  
   Specifies the color of the arcs.
* **Color List**  
   Opens the [Color List](https://devnet.logianalytics.com/hc/en-us/articles/1500009712841-Color-List) dialog to specify the color of the arcs.
* **Transparency**  
...
![Format Solid Gauge dialog - Axis - Axis tab](https://devnet.logianalytics.com/hc/article_attachments/4412139585175/fmtsldgauge_axis_axis.gif)
...
![Format Solid Gauge dialog - Axis - Tick Mark](https://devnet.logianalytics.com/hc/article_attachments/4412112620439/fmtsldgauge_axis_tkmk.gif)
...
![Format Solid Gauge dialog - Axis - Label](https://devnet.logianalytics.com/hc/article_attachments/4412131498647/fmtsldgauge_axis_lbl.gif)
...
* **Normal**  
  ...
  + **Number of Major Labels**  
    ...
    - **Fixed**  
       If checked, you can specify the number of major tick mark labels to be displayed on the axis.
* **Range Value**  
...
![Format Solid Gauge dialog - Axis - Format](https://devnet.logianalytics.com/hc/article_attachments/4412131498903/fmtsldgauge_axis_fmt.gif)
...
By default it is set to auto which means that the setting follows [that of the chart platform](https://devnet.logianalytics.com/hc/en-us/articles/1500009687382-Format-Platform#AutoScale). When it is true, the specified format applies to the integer part of the values after scaled, but if the specified format conflicts with Auto Scale in Number, for example, the values are displayed in percentage, then the Auto Scale in Number setting is ignored.
...
![Format Solid Gauge dialog - Pointer](https://devnet.logianalytics.com/hc/article_attachments/4412139585687/fmtsldgauge_pnt.gif)
...
* **Arrow**  
  ...
  + **Value Pointer**  
     Specifies the style of the value pointers. Select a style from the drop-down list or select Customized to specify another image as the value pointers in the [Insert Image](https://devnet.logianalytics.com/hc/en-us/articles/1500009713461-Insert-Image#Gauge) dialog.
  + **Width**   
...
* **Style List**  
   Opens the [Style List](https://devnet.logianalytics.com/hc/en-us/articles/1500009713821-Style-List) dialog to specify the style for pointers in the same data series respectively.
...
* **Color List**   
   Opens the [Color List](https://devnet.logianalytics.com/hc/en-us/articles/1500009712841-Color-List) dialog for you to specify the pointer color.
* **Transparency**  
...
![Format Solid Gauge dialog - Target](https://devnet.logianalytics.com/hc/article_attachments/4412112620695/fmtsldgauge_tgt.gif)
...
* **Target Pointer**  
   Specifies the style of the target pointer. Select a style from the drop-down list or select Customized to specify another image as the target pointer in the [Insert Image](https://devnet.logianalytics.com/hc/en-us/articles/1500009713461-Insert-Image#Gauge) dialog.
* **Width**  
...
![Format Solid Gauge dialog - Range Color](https://devnet.logianalytics.com/hc/article_attachments/4412139585943/fmtsldgauge_rgclr.gif)
...
Specifies the color schema of the range. Select in the color cell to specify a new color in the [Select Color](https://devnet.logianalytics.com/hc/en-us/articles/1500009713741-Select-Color) dialog.
...
![Format Solid Gauge dialog - Hint](https://devnet.logianalytics.com/hc/article_attachments/4412131499159/fmtsldgauge_hint.gif)
