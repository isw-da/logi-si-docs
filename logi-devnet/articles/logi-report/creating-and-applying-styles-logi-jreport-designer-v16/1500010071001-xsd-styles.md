...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010071001-XSD-Styles
updated_at: 2021-07-24T10:37:43Z
---

# XSD Styles

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404901108631/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010034902-Creating-and-Applying-Styles) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404901037591/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010070981-CSS-Styles)
...
This topic explains how to manage XSD styles using the [Style Editor](https://devnet.logianalytics.com/hc/en-us/articles/1500010068041-Style-Editor-Dialog) as follows (to display the editor, [open the catalog](https://devnet.logianalytics.com/hc/en-us/articles/1500010063141-Creating-Opening-and-Saving-Catalogs#Open) to which you want to add the style groups, then on the Catalog Manager toolbar, select **Style**).
...
1. In the Style Editor, right-click any of the existing groups and select **New Style Group**  from the shortcut menu to display the New Style Group dialog.
   ...
   ![New Style Group](https://devnet.logianalytics.com/hc/article_attachments/4404901120023/style_xsd_crt1.gif)
...
3. Right-click the group and select **New Style** to display the New Style dialog.
   ...
   ![New Style](https://devnet.logianalytics.com/hc/article_attachments/4404901120279/style_xsd_crt2.gif)
...
5. In the [Save Style](https://devnet.logianalytics.com/hc/en-us/articles/1500010068161-Save-Style-Dialog) dialog, add the properties to be included in the style and change the property values as required.

   ![Save Style](https://devnet.logianalytics.com/hc/article_attachments/4404901120535/svstyl.gif)

   To add a property, select it from the All Properties box and select **![Add button](https://devnet.logianalytics.com/hc/article_attachments/4404901120791/btn_addarrow.gif)**. To add all the available properties to the style at a time, select ![Add All button](https://devnet.logianalytics.com/hc/article_attachments/4404909117591/btn_addall.gif).
   ...
   To remove a property that has been added, select it from the Selected Properties box and select ![Remove button](https://devnet.logianalytics.com/hc/article_attachments/4404901121047/btn_rmvarrow.gif). To remove all the added properties at a time, select ![Remove All button](https://devnet.logianalytics.com/hc/article_attachments/4404909117847/btn_rmvall.gif).
...
* **Editing an XSD style**
  1. Right-click the style group and select **Edit Group** from the shortcut menu. The [Edit Style Group](https://devnet.logianalytics.com/hc/en-us/articles/1500010030582-Edit-Style-Group-Dialog) dialog appears.

     ![Edit Style Group](https://devnet.logianalytics.com/hc/article_attachments/4404901121303/edtstylgrp.gif)
  2. In the All Styles List, specify the styles that are to be included in the group, and select ![Add button](https://devnet.logianalytics.com/hc/article_attachments/4404901120791/btn_addarrow.gif) to add them to the Selected Styles List (or, you can remove some existing styles from the group by selecting ![Remove button](https://devnet.logianalytics.com/hc/article_attachments/4404901121047/btn_rmvarrow.gif)).
