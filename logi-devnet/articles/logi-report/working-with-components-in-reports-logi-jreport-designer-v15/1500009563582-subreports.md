...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009563582-Subreports
updated_at: 2021-07-24T05:55:58Z
---

# Subreports

[![](https://devnet.logianalytics.com/hc/article_attachments/4404889273495/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009563762-Text-Boxes)  [Next Topic![](https://devnet.logianalytics.com/hc/article_attachments/4404889273751/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009583941-Drawing-Objects)
...
**To insert a subreport into a page report:**

1. Open the primary report.
2. Position the mouse pointer at the destination where you want to insert the subreport. A subreport can be inserted in the page report areas listed in [Component placement](https://devnet.logianalytics.com/hc/en-us/articles/1500009583241-Working-with-Components-in-Reports#Relationship).
3. Select **Insert** > **Subreport**, **Home** > **Insert** > **Subreport**, or drag the **Insert Subreport** button ![Subreport button](https://devnet.logianalytics.com/hc/article_attachments/4404893981463/btn_instsbrpt.gif) from the Components panel. Then,
   * If the destination is the report body or a tabular cell, the [Subreport](https://devnet.logianalytics.com/hc/en-us/articles/1500009567722-Subreport-Dialog) dialog appears.
   * If the destination is a banded panel, select the mouse button in the panel to open the Subreport dialog.

   ![Subreport dialog](https://devnet.logianalytics.com/hc/article_attachments/4404893851671/subrpt_fld.gif)
...
6. In the Field tab, select the **Add** button beside the Component in Report Tab box. In the Choose Component dialog, add the components in the subreport you want to be interlinked with the primary report with conditions. If the required components use different datasets, you need to add them respectively, however, as long as the components are based on the same dataset, you can add them all at the same time.
   ...
   ![Choose Component dialog](https://devnet.logianalytics.com/hc/article_attachments/4404893981719/cmpnt_label_link.gif)
...
> * [Creating Sublinks](#Link)
> * [Setting up Parameter Links](#Parameter)
> * [Returning Values to the Primary Report](#Value)
...
9. Preview the customer report tab. You will find that a crosstab is generated for each customer based on the customer ID.
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4404893981975/cmpnt_sbrpt_link.gif)
...
4. Select the value drop-down list where the available fields of Date type in the dataset of Report Tab A are listed. Here, we select **MYTODAY** which is a predefined formula and returns a value CurrentDate().
   ...
   ![Subreport dialog - Parameter](https://devnet.logianalytics.com/hc/article_attachments/4404893982231/cmpnt_sbrpt_prmtr.gif)
...
1. In the Subreport dialog, select the **Return Value** tab.
   ...
   ![Subreport dialog - Return Value](https://devnet.logianalytics.com/hc/article_attachments/4404889319447/subrpt_value.gif)
...
3. Select the field that you want to assign to a parameter in the primary report, select ![](https://devnet.logianalytics.com/hc/article_attachments/4404893789463/btn_addarrow.gif), and a parameter in the primary report of the same data type will be displayed in the Parameters column of the Return Value box. If the automatically assigned parameter is not what you need, select the required one from the parameter drop-down list.
