...
> * [Inserting a Text Box into a Report](#Insert)
> * [Formatting Paragraphs in a Text Box](#Paragraph)
> * [Formatting the Text in a Text Box](#Text)
> * [Finding or Replacing a Text String](#Find)
> * [Importing and Exporting Text](#Import)

## Inserting a Text Box into a Report

A text box can be inserted in the report areas listed in [Component placement](https://devnet.logianalytics.com/hc/en-us/articles/1500009583241-Working-with-Components-in-Reports#Relationship).
...
* From the Components panel, drag the **Text Box**  button ![Insert Text Box button](https://devnet.logianalytics.com/hc/article_attachments/4404889402775/btn_insttxtbx.gif) to the desired location in the report which allows the insertion of a text box, and a text box will then be created.

After a text box has been inserted into a report, you can double-click it to input text.
...
1. Right-click anywhere in the paragraph and select **Paragraph** on the shortcut menu. The [Format Text](https://devnet.logianalytics.com/hc/en-us/articles/1500009566142-Format-Text-Dialog#Paragraph) dialog appears.
...
* To create a first-line indent or hanging indent, drag ![](https://devnet.logianalytics.com/hc/article_attachments/4404893977239/btn_lnindnt.gif) to the position where you want the text to start.
* To change the left indent, drag ![](https://devnet.logianalytics.com/hc/article_attachments/4404893977495/btn_lftindnt.gif) to the position where you want the paragraph to start.
* To change the right indent, drag ![](https://devnet.logianalytics.com/hc/article_attachments/4404893977879/btn_rtindnt.gif) to the position where you want the paragraph to end.
...
2. In the Font tab of the Format Text dialog, specify the [font settings](https://devnet.logianalytics.com/hc/en-us/articles/1500009566142-Format-Text-Dialog#Font).
...
2. In the Find tab of the Find and Replace dialog, specify the string you want to search for and set the other settings as required.
   ...
   ![Find and Replace dialog - Find](https://devnet.logianalytics.com/hc/article_attachments/4404893978263/cmpnt_txtbx_find.gif)
...
1. Right-click anywhere in the text box and select **Replace** from the shortcut menu, the Find and Replace dialog will then be displayed with the Replace tab selected.
   ...
   ![Find and Replace dialog - Replace](https://devnet.logianalytics.com/hc/article_attachments/4404893978519/cmpnt_txtbx_rplc.gif)
