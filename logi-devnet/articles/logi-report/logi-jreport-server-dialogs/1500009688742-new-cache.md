...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009688742-New-Cache
updated_at: 2021-11-03T06:57:42Z
---

# New Cache

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4412131374359/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009714981-Multiple-Type-Properties)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4412139481879/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009714721-New-Cube)

# New Cache

The New Cache dialog helps admin users to create a schedule task for generating [cached report data](https://devnet.logianalytics.com/hc/en-us/articles/1500009717701-Managing-Cached-Report-Data#Schedule) for the specified data resources. It appears when an admin user selects the New Cache link in the Administration > Configuration > Cache > Data Cache page in the server console.
...
![New Cache dialog - Select Data Resource](https://devnet.logianalytics.com/hc/article_attachments/4412131439895/nwcache_query.gif)
...
* ![Add button](https://devnet.logianalytics.com/hc/article_attachments/4412131380631/btn_add1.gif)  
   Opens the [Select Queries](https://devnet.logianalytics.com/hc/en-us/articles/1500009715181-Select-Queries) dialog to select the data resources that you are going to create data caches for.
...
![New Cache dialog - General tab](https://devnet.logianalytics.com/hc/article_attachments/4412112564631/nwcache_gen.gif)
...
Specifies values of the parameters applied in the selected data resource. [You may specify parameter values in these ways](https://devnet.logianalytics.com/hc/en-us/articles/1500009692442-Specifying-Parameter-Values).
...
![New Cache dialog - Conditions - Time subtab](https://devnet.logianalytics.com/hc/article_attachments/4412131440151/nwcache_cndtn_time.gif)
...
* **Run this task periodically**  
  ...
  + **Do not generate cached result until a report requests**  
     This option is unchecked by default, which means the task will be performed to generate the cached report data according to the specified time condition. If it is checked,
...
![New Cache dialog - Conditions - Trigger subtab](https://devnet.logianalytics.com/hc/article_attachments/4412112564887/nwcache_cndtn_trgr.gif)
...
![New Cache dialog - Notification tab](https://devnet.logianalytics.com/hc/article_attachments/4412112565143/nwcache_notif.gif)
