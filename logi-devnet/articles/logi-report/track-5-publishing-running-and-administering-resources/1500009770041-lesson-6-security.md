...
1. In the Server Console, point to **Administration** on the system toolbar, and then select **Security** > **User** from the drop-down menu.
   ...
   ![Server Security](https://devnet.logianalytics.com/hc/article_attachments/4404880712983/admin_lsn6_tlbr.gif)
2. In the User page, select the **New User** link.

   ![New User](https://devnet.logianalytics.com/hc/article_attachments/4404880713239/admin_lsn6_user.gif)
3. Complete the New User dialog box with any user information you would like to use and select **OK** to create the user.

   ![New User dialog box](https://devnet.logianalytics.com/hc/article_attachments/4404885697687/admin_lsn6_adduser.gif)
...
2. In the Auditing dialog box, select the **OK** button to accept the supplied defaults.
   ...
   ![Audit User](https://devnet.logianalytics.com/hc/article_attachments/4404880713495/admin_lsn6_audit.gif)
...
2. Put the mouse pointer over the resource row, then select the **Properties** button ![Properties button](https://devnet.logianalytics.com/hc/article_attachments/4404880713879/btn_prpty.gif) on the floating toolbar.
3. In the Properties dialog box, switch to the **Permission** tab, select **Enable Setting Permissions**, then select the role/user/group in the **Selected** box and select or clear the required permissions. If the role/user/group is not listed in the Selected box, select the corresponding radio button below the **Available** box, add the role/user/group to the Selected box and then assign the permissions accordingly.
   ...
   ![Assign Permission](https://devnet.logianalytics.com/hc/article_attachments/4404880715287/admin_lsn6_pmsn.gif)
