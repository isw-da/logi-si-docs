...
url: https://devnet.logianalytics.com/hc/en-us/articles/5735512833815-Creating-JDBC-Connections-via-Plug-ins
updated_at: 2022-11-02T04:29:01Z
---

# Creating JDBC Connections via Plug-ins

[![Back](https://devnet.logianalytics.com/hc/article_attachments/9898402961815/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/5735521536663-Setting-Up-JDBC-Connections-in-a-Catalog)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/9898402971543/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/5735521475095-Using-DBMS-Objects-via-JDBC-Connections)
...
1. Do one of the following:
   * In the Start Page, select **Oracle**, **MySQL**, **SQL Server**, **InterSystems IRIS**, or **PostgreSQL** in the **Connect** category. In the [Create Connection dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5735528726551-Create-Connection-Dialog-Box), specify an existing catalog or create a new one and select **OK**.
...
6. In the **Port** text box, type the port of the database server. Then,
...
7. In the **User** and **Password** text boxes, specify the user ID and password used for accessing the database.
8. Select **Show URL** if you want to view the URL that is formulated by the information you have provided. You can see the URL in the **URL** text box. You can also specify the valid JDBC URL in the URL text box to establish the connection to the database server. The URL format is regulated by the driver itself.
9. Select **Test Connection** to test whether the specified information is correct for setting up the connection.
10. Select **More Options** if your database has special requirements to modify the [options](https://devnet.logianalytics.com/hc/en-us/articles/5735530237847-Get-JDBC-Connection-Information-Dialog-Box#Options) accordingly.
11. Select **OK** and Designer adds the connection in the specified catalog data source in the Catalog Manager. You can then [add objects](https://devnet.logianalytics.com/hc/en-us/articles/5735521475095-Using-DBMS-Objects-via-JDBC-Connections) from the database into the catalog via the connection.
...
* If you want to use alias to specify TNS, you need to add the `-Doracle.net.tns_admin=<directory_containing_tnsnames.org>` JVM option to the CLASSPATH environment variable of Designer's startup file JReport.bat in `<designer_install_root>\bin` before starting Designer.
...
3. Use the `-Doracle.net.tns_admin` and `-Doracle.net.wallet_location` JVM options to add the locations of tnsnames.ora and the wallet file to the CLASSPATH environment variable of Designer's startup file **JReport.bat** in the `<designer_install_root>\bin` directory.
   ...
   ![Add Classpth](https://devnet.logianalytics.com/hc/article_attachments/9898533783319/cnctn_jdbc_plgin_clspth.gif)
...
5. Add the connection identifier name in the URL used for connecting to the Oracle database. You can then connect to the database without having to provide the user name and password.
   ...
   ![Set Up the Connection Using the Wallet](https://devnet.logianalytics.com/hc/article_attachments/9898533788183/cnctn_jdbc_plgin_cnct.gif)
