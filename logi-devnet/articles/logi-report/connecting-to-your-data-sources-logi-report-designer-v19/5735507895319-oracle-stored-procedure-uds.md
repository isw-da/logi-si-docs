...
url: https://devnet.logianalytics.com/hc/en-us/articles/5735507895319-Oracle-Stored-Procedure-UDS
updated_at: 2022-11-02T04:14:06Z
---

# Oracle Stored Procedure UDS

[![Back](https://devnet.logianalytics.com/hc/article_attachments/9898402961815/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/5735499573911-Adding-User-Defined-Data-Sources-to-a-Catalog)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/9898402971543/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/5735507886999-EnterpriseDB-Stored-Procedure-UDS)
...
* [Example 1: Stored Procedures Defined Outside a Package](#Example1)
* [Example 2: Stored Procedures Declared and Defined in a Package and Package Body](#Example2)
* [Example 3: Functions Defined Outside a Package](#Example3)
...
1. [Create a catalog](https://devnet.logianalytics.com/hc/en-us/articles/5735563628951-Creating-Opening-and-Saving-Catalogs) or [open a catalog](https://devnet.logianalytics.com/hc/en-us/articles/5735563628951-Creating-Opening-and-Saving-Catalogs#Open) to which you want to add the Oracle stored procedure.
...
2. Highlight the UDS column name that you are having the problem with and select **Show Properties** on the toolbar to show the Properties sheet.
3. You can change the property values, such as SQL type, Precision, and Scale to the correct values. For instance, you can change the negative scale of the problematic column to the correct value.
...
5. In the **Parameters** box, type one of the following:
   ...
   * `OWNER=SCOTT&PROCNAME=empquery&SQL={call empquery(?,?)}&REFCURSORINDEX=2&INPARAMVALUE="SALESMAN",varchar,1`
   ...
   ![New UDS Example](https://devnet.logianalytics.com/hc/article_attachments/9898517157271/cnctn_uds_orcl_eg1.gif)
6. Select **OK** to add the UDS class into the catalog.
...
5. In the **Parameter** box, type one of the following:
   ...
   * `OWNER=SCOTT&PROCNAME=demo_pkg.empquery_proc&SQL={call demo_pkg.empquery_proc(?,?)}&REFCURSORINDEX=2&INPARAMVALUE="SALESMAN",varchar,1`
   ...
   ![New UDS Example](https://devnet.logianalytics.com/hc/article_attachments/9898517165079/cnctn_uds_orcl_eg2.gif)
6. Select **OK** to add the UDS class into the catalog.
...
5. In the **Parameter** box, type one of the following:
   ...
   * `OWNER=SCOTT&PROCNAME=deptquery&SQL={? = call deptquery(?)}&REFCURSORINDEX=1&INPARAMVALUE=@p_dname,varchar,2`
   ...
   ![New UDS Example](https://devnet.logianalytics.com/hc/article_attachments/9898533679511/cnctn_uds_orcl_eg3.gif)
6. Select **OK** to add the UDS class into the catalog.
...
5. In the Parameter box, type one of the following:
   ...
   * `OWNER=SCOTT&PROCNAME=shdemo_pkg.deptquery_func&SQL={? = call shdemo_pkg.deptquery_func(?)}&REFCURSORINDEX=1&INPARAMVALUE="SALES",varchar,2`
   ...
   ![New UDS Example](https://devnet.logianalytics.com/hc/article_attachments/9898517189911/cnctn_uds_orcl_eg4.gif)
6. Select **OK** to add the UDS class into the catalog.
