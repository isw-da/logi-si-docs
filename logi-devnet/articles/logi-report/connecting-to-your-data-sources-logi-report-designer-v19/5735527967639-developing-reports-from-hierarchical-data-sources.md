...
7. [Create a page report](https://devnet.logianalytics.com/hc/en-us/articles/5735569787671-Creating-Reports#Page) with the imported HDS. When you view the report, specify the URI of the XML file which matches the XSD file in the parameter. The report then shows the corresponding data.
...
2. Create a parameter as described in the previous procedure.
...
![HDS structure diagram](https://devnet.logianalytics.com/hc/article_attachments/9898533946903/cnctn_hds_rpt_prlel1.gif)
...
* **Branch**  
  ...
  ![Branch diagram](https://devnet.logianalytics.com/hc/article_attachments/9898533953943/cnctn_hds_rpt_prlel2.gif)
* **Parallel branches**  
...
* When you want to publish reports created from XML hierarchical data sources to Server, the following method is recommended:
  ...
  4. Navigate to **File** > **Publish** > **Publish Report to Server** to publish the folder (for more information, see [Publishing Resources Remotely](https://devnet.logianalytics.com/hc/en-us/articles/5735576653207-Publishing-and-Downloading-Resources#Remotely)).
