...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010033482-Imported-APE-Column-Properties
updated_at: 2021-07-24T10:38:08Z
---

# Imported APE Column Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404901108631/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010033462-Imported-APE-Properties) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404901037591/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010069381-Imported-SQL-Properties)

# Imported APE Column Properties

This topic lists the properties of an Imported APE Column object in a catalog.
...
| Column Name | Specifies the name of the column in the MongoDB connection. The qualified name like Nations.Cities.CityName will be shown here. The qualified path starts from the name of the top level document to the last element name of the column, excluding the collection name. Data type: String |
| Currency | Specifies whether to control the SQL type of formulas or summaries in which the BigDecimal type fields are imported when the column is used in formulas or summaries.  * **true** - The formula or summary which is built with the BigDecimal type field will be BigDecimal type, and its [SQL Type](https://devnet.logianalytics.com/hc/en-us/articles/1500010069121-Formula-Properties#SQL) value will be set to 3. * **false** - The normal data type will be used for the formula or summary.   Data type: Boolean |
...
| [Nullable](https://devnet.logianalytics.com/hc/en-us/articles/1500010033622-HDS-Column-Properties#Nullable) | Specifies the nullability of the column's value. Choose an option from the drop-down list. Data type: Enumeration |
