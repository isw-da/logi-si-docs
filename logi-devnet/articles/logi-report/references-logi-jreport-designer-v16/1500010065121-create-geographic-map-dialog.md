---
title: "Create Geographic Map Dialog"
id: 1500010065121
section: "References - Logi JReport Designer v16"
category: "Logi Report"
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010065121-Create-Geographic-Map-Dialog
updated_at: 2021-07-24T10:39:03Z
---

# Create Geographic Map Dialog

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404901108631/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010030122-Create-Data-Mapping-File-Dialog) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404901037591/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010030142-Create-KPI-Chart-Dialog)

# Create Geographic Map Dialog

The Create Geographic Map wizard helps you to [insert a geographic map](https://devnet.logianalytics.com/hc/en-us/articles/1500010029142-Inserting-Geographic-Maps-in-a-Report) into a report. It appears when you select Insert > Map > Geographic Map, or drag ![Geographic Map button](https://devnet.logianalytics.com/hc/article_attachments/4404909233175/btn_instgmp.gif) from the Components panel into a report.
...
## Create Geographic Map - for Web Report and Library Component

When the wizard is used for creating a geographic map in a web report or library component, it consists of the following screens: [Data](#Data), [Display](#Display) and [Filter](#Filter).

### Data

The screen lists all the predefined business views in the current catalog. Select the one using which to create the geographic map.

![Create Geographic Map - Data](https://devnet.logianalytics.com/hc/article_attachments/4404901278487/crtgmp_dt_wb.gif)

### Display

Specifies the data fields that you want to display in the geographic map.

![Create Geographic Map - Display](https://devnet.logianalytics.com/hc/article_attachments/4404909233431/crtgmp_dsply_wb.gif)
...
Lists all the group objects and aggregation objects in the specified business view, as well as the dynamic formulas for the business view in the current report. You can use them to create the geographic map.
...
Opens the [Select N](https://devnet.logianalytics.com/hc/en-us/articles/1500010067821-Select-N-Dialog) dialog to specify the Select N condition for the selected group level.

**Web Behaviors**

Opens the [Web Behaviors](https://devnet.logianalytics.com/hc/en-us/articles/1500010032962-Web-Behaviors-Dialog) dialog to specify web behaviors to the markers and areas of the selected group level. Available only when creating the geographic map in a library component.
...
* **Shape By**  
  ...
  + ![Shape button](https://devnet.logianalytics.com/hc/article_attachments/4404909190039/btn_shp.gif)  
     Specifies the shapes of the markers.
    - If no field is added, select a shape from the shape list, or check and select the Advanced option to open the [Advanced](https://devnet.logianalytics.com/hc/en-us/articles/1500010064781-Advanced-Dialog#Map) dialog to specify an image as the shape of the markers.
    - If a field is added, opens the [Edit Shapes](https://devnet.logianalytics.com/hc/en-us/articles/1500010065741-Edit-Shapes-Dialog) dialog to specify shapes for the markers.
* **Color By**  
  ...
  + ![Color button](https://devnet.logianalytics.com/hc/article_attachments/4404901214487/btn_colr.gif)  
     Specifies the colors of the markers.
    - If no field is added, select a color from the [color palette](https://devnet.logianalytics.com/hc/en-us/articles/1500010035022-Menu-Tabs#Palette) for the markers.
    - If one or more group fields are added, opens the [Edit Color](https://devnet.logianalytics.com/hc/en-us/articles/1500010030382-Edit-Color-Dialog) dialog to specify colors for the markers.
    - If an aggregation field is added, opens the [Edit Gradient Color](https://devnet.logianalytics.com/hc/en-us/articles/1500010030442-Edit-Gradient-Color-Dialog) dialog to specify a gradient color for the markers.
* **Size By**  
  ...
  + ![Size button](https://devnet.logianalytics.com/hc/article_attachments/4404909190295/btn_size.gif)  
...
* **Label By**  
  ...
  + ![Label button](https://devnet.logianalytics.com/hc/article_attachments/4404901214743/btn_lbl.gif)  
     Specifies the font format of the label text.

    ![Label By](https://devnet.logianalytics.com/hc/article_attachments/4404901215127/geomap_labelby.gif)

    - ![Font Face button](https://devnet.logianalytics.com/hc/article_attachments/4404901109143/btn_fntface.gif)  
       Specifies the font of the label text.
    - ![Font Size button](https://devnet.logianalytics.com/hc/article_attachments/4404901109399/btn_fntsize.gif)  
       Specifies the font size of the label text.
    - ![Bold button](https://devnet.logianalytics.com/hc/article_attachments/4404909111063/btn_bold.gif)  
       Specifies whether to make the label text bold.
    - ![Itelic button](https://devnet.logianalytics.com/hc/article_attachments/4404901109911/btn_italic.gif)  
       Specifies whether to make the label text italic.
    - ![Underline button](https://devnet.logianalytics.com/hc/article_attachments/4404909111319/btn_underline.gif)  
       Specifies whether to underline the text.
    - ![Font Color button](https://devnet.logianalytics.com/hc/article_attachments/4404901215383/btn_fntcolr.gif)  
       Specifies the color of the label text.
    - ![Font Format button](https://devnet.logianalytics.com/hc/article_attachments/4404901215639/btn_fntfmt.gif)  
...
* **Fill By**  
  ...
  + ![Color button](https://devnet.logianalytics.com/hc/article_attachments/4404901214487/btn_colr.gif)  
    ...
    - If no field is added, select a color from the [color palette](https://devnet.logianalytics.com/hc/en-us/articles/1500010035022-Menu-Tabs#Palette) for the areas.
    - If one or more group fields are added, opens the [Edit Color](https://devnet.logianalytics.com/hc/en-us/articles/1500010030382-Edit-Color-Dialog) dialog to specify colors for the areas.
    - If an aggregation field is added, opens the [Edit Gradient Color](https://devnet.logianalytics.com/hc/en-us/articles/1500010030442-Edit-Gradient-Color-Dialog) dialog to specify a gradient color for the areas.
* **Label By**  
  Specifies the field to control the label shown above the areas for the selected group level. You can add more than one field. When several fields are added, you can adjust the order of the fields by dragging and dropping them in the text box.
  + ![Label button](https://devnet.logianalytics.com/hc/article_attachments/4404901214743/btn_lbl.gif)  
...
Specifies to filter the data used in the geographic map. The options in the screen are the same as those in the [Edit Filter](https://devnet.logianalytics.com/hc/en-us/articles/1500010065601-Edit-Filter-Dialog) dialog.

![Create Geographic Map - Filter](https://devnet.logianalytics.com/hc/article_attachments/4404901278743/crtgmp_fltr_wb.gif)

## Create Geographic Map - for Page Report

When the wizard is used for creating a geographic map in the page report, it consists of the following screens: [Data](#PageData), [Group](#PageGroup), [Filter](#PageFilter), [Layout](#PageLayout), and [Marker](#PageMarker).

### Data

Specifies the dataset of the geographic map.

![Create Geographic Map - Data](https://devnet.logianalytics.com/hc/article_attachments/4404909233687/crtgmp_dt.gif)
...
![Create Geographic Map - Group](https://devnet.logianalytics.com/hc/article_attachments/4404909234071/crtgmp_grp.gif)
...
Specifies to filter the group-by fields that have been added to the geographic map to reduce the data. The options in the screen are the same as those in the [Edit Filter](https://devnet.logianalytics.com/hc/en-us/articles/1500010065601-Edit-Filter-Dialog) dialog.

![Create Geographic Map - Filter](https://devnet.logianalytics.com/hc/article_attachments/4404901279127/crtgmp_fltr.gif)

### Layout

Specifies the layout of the geographic map elements.

![Create Geographic Map - Layout](https://devnet.logianalytics.com/hc/article_attachments/4404901279383/crtgmp_layout.gif)
...
![Create Geographic Map - Marker](https://devnet.logianalytics.com/hc/article_attachments/4404909234327/crtgmp_mkr.gif)
