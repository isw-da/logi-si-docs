---
title: "Format Paper Dialog"
id: 1500010066441
section: "References - Logi JReport Designer v16"
category: "Logi Report"
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010066441-Format-Paper-Dialog
updated_at: 2021-07-24T10:38:47Z
---

# Format Paper Dialog

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404901108631/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010031042-Format-Line-Dialog) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404901037591/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010066501-Format-Pattern-Dialog)

# Format Paper Dialog

The Format Paper dialog helps you to [format the paper in a chart](https://devnet.logianalytics.com/hc/en-us/articles/1500010063501-Formatting-the-Paper). It appears when you right-click a chart and select Format Paper from the shortcut menu, or double-click the paper of a chart.

The dialog contains the following tabs: [General](#General) (for 2-D charts), [Rotation](#Rotation) (for 3-D charts), [Fill](#Fill) and [Border](#Border).
...
## General (for 2-D charts)

Specifies the general options for formatting the 2-D chart paper.

![Format Paper - General](https://devnet.logianalytics.com/hc/article_attachments/4404901227543/fmtpapr_gnrl.gif)
...
## Rotation (for 3-D charts)

Specifies the rotation properties for formatting the 3-D chart paper.

![Format Paper - Rotation](https://devnet.logianalytics.com/hc/article_attachments/4404901227799/fmtpapr_rotate.gif)

![No Rotation button](https://devnet.logianalytics.com/hc/article_attachments/4404909204503/btn_plot1.gif)

If selected, rotate the chart on the basis of the X, Y, Z axes.

![Angle X button](https://devnet.logianalytics.com/hc/article_attachments/4404901228055/btn_plot2.gif)

If selected, rotate the chart just on the basis of the X axis.

![Angle Y button](https://devnet.logianalytics.com/hc/article_attachments/4404901228311/btn_plot3.gif)

If selected, rotate the chart just on the basis of the Y axis.

![Angle Z button](https://devnet.logianalytics.com/hc/article_attachments/4404901228567/btn_plot4.gif)
...
![Format Paper - Fill](https://devnet.logianalytics.com/hc/article_attachments/4404909204759/fmtpapr_fill.gif)

**Color**

Specifies the color to fill the paper. To edit the color, select the color indicator and select a color from the [color palette](https://devnet.logianalytics.com/hc/en-us/articles/1500010035022-Menu-Tabs#Palette) or input the hexadecimal value (for example, 0xff0000) of a color directly in the text box.
...
![Format Paper - Border](https://devnet.logianalytics.com/hc/article_attachments/4404901228823/fmtpapr_brdr.gif)
