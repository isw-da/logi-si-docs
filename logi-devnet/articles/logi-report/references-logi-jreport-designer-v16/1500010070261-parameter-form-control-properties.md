...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010070261-Parameter-Form-Control-Properties
updated_at: 2021-07-24T10:37:52Z
---

# Parameter Form Control Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404901108631/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010070241-Parameter-Field-Properties) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404901037591/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010070321-Report-Body-Properties)

# Parameter Form Control Properties

This topic lists the properties of a Parameter Form Control object. The availabilities of the properties vary for the [supported report types](https://devnet.logianalytics.com/hc/en-us/articles/1500010069521-Report-Object-Properties#ReportType): Page Report, Web Report and Library Component.
...
| Title | | |
| Background | Page Report, Web Report, Library Component | Specifies the background color of the title bar. Choose a color from the drop-down list or select Custom to customize a color, or enter a hexadecimal RGB value (for example, 0xff0000) to specify a color. For page report, you can also use a formula or edit an expression that returns a color. Data type: String |
...
| Font Size | Page Report, Web Report, Library Component | Specifies the font size of the text in the title bar. Enter an integer value to change the size. Data type: Integer |
| Foreground | Page Report, Web Report, Library Component | Specifies the foreground color of the title bar. Choose a color from the drop-down list or select Custom to customize a color, or enter a hexadecimal RGB value (for example, 0xff0000) to specify a color. For page report, you can also use a formula or edit an expression that returns a color. Data type: String |
...
| Text | Page Report, Web Report, Library Component | Specifies the text displayed in the title bar. Enter a string to change the text. Data type: String |
