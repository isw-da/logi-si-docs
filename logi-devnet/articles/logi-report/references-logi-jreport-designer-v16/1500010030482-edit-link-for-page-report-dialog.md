---
title: "Edit Link (for Page Report) Dialog"
id: 1500010030482
section: "References - Logi JReport Designer v16"
category: "Logi Report"
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010030482-Edit-Link-for-Page-Report-Dialog
updated_at: 2021-07-24T10:38:57Z
---

# Edit Link (for Page Report) Dialog

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404901108631/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010065661-Edit-Line-Style-Dialog) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404901037591/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010030502-Edit-Node-Style-Dialog)

# Edit Link Dialog

The Edit Link dialog helps you to [edit the link](https://devnet.logianalytics.com/hc/en-us/articles/1500010034822-Adding-Links-in-Reports#Edit) on an object. It appears when you select an object in a report which is defined with a link, right-click it and select Edit Link from the shortcut menu.
...
![Edit Link dialog for Report](https://devnet.logianalytics.com/hc/article_attachments/4404901267095/edtlnk_rpt.gif)

**Report**

Specifies the target report. Select the Browse button to modify the desired report in the [Select a Report](https://devnet.logianalytics.com/hc/en-us/articles/1500010032362-Select-a-Report-Dialog) dialog.
...
![Edit Link dialog for Master/Detail Report](https://devnet.logianalytics.com/hc/article_attachments/4404901267351/edtlnk_dtl.gif)

**Report**

Specifies the report in which the detail report tab is. Select the Browse button to modify the desired report in the [Select a Report](https://devnet.logianalytics.com/hc/en-us/articles/1500010032362-Select-a-Report-Dialog) dialog.
...
Specifies the component in the detail report tab that will be interlinked with the master report. Select ![](https://devnet.logianalytics.com/hc/article_attachments/4404901122967/btn_chsr.gif) to add the components. You can add more than one component as long as the components are based on the same dataset.
...
![Edit Link dialog for URL](https://devnet.logianalytics.com/hc/article_attachments/4404909224471/edtlnk_url.gif)
...
* **<Server Setting>**  
   Loads the linked file according to setting on Logi JReport Server. For page report, you can set the Pop Up New Window for Links option in the Profile > Configure Profile > Page Report Studio > Properties > Default; for web report and library component, you can set the Target of Detail Table Report and Links option in the Profile > Configure Profile > Web Report Studio > Properties.
* **Same Frame**  
...
![Edit Link dialog for E-mail](https://devnet.logianalytics.com/hc/article_attachments/4404909224727/edtlnk_mail.gif)
...
![Edit Link dialog for Content](https://devnet.logianalytics.com/hc/article_attachments/4404901267735/edtlnk_cntnt.gif)
...
Specifies the content type for the Blob type data. You can select the button ![Formula button](https://devnet.logianalytics.com/hc/article_attachments/4404901133335/btn_fmla.gif) to bind it with a field column or a record level pass one formula in the selected query, or with a dynamic formula in the current report (available to web report and library component only).

**File Name**

Specifies the file name for the linked Blob type data. You can select the button ![Formula button](https://devnet.logianalytics.com/hc/article_attachments/4404901133335/btn_fmla.gif) to bind it with a field column or a record level pass one formula in the selected query.
