---
title: "Horizontal Banded Wizard Dialog"
id: 1500010066821
section: "References - Logi JReport Designer v16"
category: "Logi Report"
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010066821-Horizontal-Banded-Wizard-Dialog
updated_at: 2021-07-24T10:38:41Z
---

# Horizontal Banded Wizard Dialog

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404901108631/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010031322-Group-Options-Dialog) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404901037591/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010031342-HTML-Option-Dialog)

# Horizontal Banded Wizard Dialog

The Horizontal Banded Wizard helps you to [create a page report with a horizontal banded object](https://devnet.logianalytics.com/hc/en-us/articles/1500010034782-Creating-Reports#Page) in it. It appears when you select the Horizontal Banded layout in the [Select Component for Page Report](https://devnet.logianalytics.com/hc/en-us/articles/1500010032502-Select-Component-for-Page-Report-Dialog) dialog or [Select Component for Page Report Tab](https://devnet.logianalytics.com/hc/en-us/articles/1500010067781-Select-Component-for-Page-Report-Tab-Dialog) dialog and then select OK.

The wizard consists of the following screens: [Data](#Data), [Display](#Display), [Group](#Group), [Summary](#Summary), [Chart](#Chart), [Filter](#Filter) and [Style](#Style).
...
![Horizontal Banded Wizard - Data](https://devnet.logianalytics.com/hc/article_attachments/4404901207191/hrztlbdwzd_dt.gif)
...
Shows or hide the dataset selection panel to choose a dataset for the banded object.
...
![Horizontal Banded Wizard - Display](https://devnet.logianalytics.com/hc/article_attachments/4404901211031/hrztlbdwzd_dsply.gif)
...
Specifies the labels of the detail columns, which by default are the display names of the added fields. You can select in text boxes to edit the labels if required.
...
![Horizontal Banded Wizard - Group](https://devnet.logianalytics.com/hc/article_attachments/4404901211287/hrztlbdwzd_grp.gif)
...
![Horizontal Banded Wizard - Summary](https://devnet.logianalytics.com/hc/article_attachments/4404909186711/hrztlbdwzd_sum.gif)
...
![Horizontal Banded Wizard - Chart](https://devnet.logianalytics.com/hc/article_attachments/4404901211543/hrztlbdwzd_cht.gif)
...
![Horizontal Banded Wizard - Filter](https://devnet.logianalytics.com/hc/article_attachments/4404901211799/hrztlbdwzd_fltr.gif)

## Style

Specifies the style of the banded object.

![Horizontal Banded Wizard - Style](https://devnet.logianalytics.com/hc/article_attachments/4404901212311/hrztlbdwzd_sty.gif)
...
Creates a restricted version of a flow layout report, one that can contain a single horizontal banded object only. This layout option is intended to provide compatibility with Logi JReport Version 7 report templates.

**Create a Flow Layout Report Containing a Banded Object**

Creates a report that contains a horizontal banded object mapped to the specified dataset. This layout option is specified by default.

**Page Setup**

Opens the [Page Setup](https://devnet.logianalytics.com/hc/en-us/articles/1500010067381-Page-Setup-Dialog) dialog to specify page properties.
