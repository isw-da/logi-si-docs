---
title: "Format Solid Gauge Dialog"
id: 1500010066581
section: "References - Logi JReport Designer v16"
category: "Logi Report"
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010066581-Format-Solid-Gauge-Dialog
updated_at: 2021-07-24T10:38:45Z
---

# Format Solid Gauge Dialog

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404901108631/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010066561-Format-Series-Z-Gridline-Dialog) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404901037591/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010066621-Format-Stock-Dialog)

# Format Solid Gauge Dialog

The Format Solid Gauge dialog helps you to [format the solid gauge](https://devnet.logianalytics.com/hc/en-us/articles/1500010028842-Formatting-the-Gauge-in-a-Gauge-Chart#Solid). It appears when you right-click any arc in a solid gauge and select Format Solid Gauge from the shortcut menu, or double-click any arc in a solid gauge.
...
Specifies properties for the arcs in the solid gauge.
...
* **Angle**  
   Specifies the degree for angles of the arcs. Select the angle of the gauge from the drop-down list or select Customized to open the [Customize Gauge Angle](https://devnet.logianalytics.com/hc/en-us/articles/1500010030242-Customize-Gauge-Angle-Dialog) dialog to specify the start angle and stop angle.
* **Thickness**  
   Specifies the thickness of the arcs, in pixels.
* **Hole Size**  
...
* **Color**  
   Specifies the color of the arcs.
* **Color List**  
   Opens the [Color List](https://devnet.logianalytics.com/hc/en-us/articles/1500010030022-Color-List-Dialog) dialog to modify the color patter for arcs in the same data series respectively.
* **Transparency**  
   Specifies the transparency for color of the arcs.
* **Self Settings**Specifies whether to edit the color pattern for the arcs themselves. When unchecked, the color settings defined here will be synchronized to the [Pattern List property](https://devnet.logianalytics.com/hc/en-us/articles/1500010069721-Chart-Properties#Pattern) on the chart object in the Report Inspector, which can also be applied by data markers of other subtypes if the chart is a combo chart.
* **Background**  
  Specifies the background color of the arcs.
* **Use Range Color**  
  Specifies whether to use the color you defined for the ranges as the color of the arcs. If checked, the Color, Color List and Transparency options will be disabled.
...
* **Outside**  
   If selected, the axis will be will be outside the arcs.
* **Center**  
...
* **Minimum**  
   Specifies the minimum value on the axis. You can also [use a formula to control the value](https://devnet.logianalytics.com/hc/en-us/articles/1500010033202-Using-Formulas-to-Control-Object-Properties).
* **Maximum**  
  Specifies the maximum value on the axis. You can also [use a formula to control the value](https://devnet.logianalytics.com/hc/en-us/articles/1500010033202-Using-Formulas-to-Control-Object-Properties).
...
Specifies the gap between the axis and the arcs if the axis is displayed inside or outside of the arcs.
...
* **Label Axis Gap**  
   Specifies the distance between the data labels and the axis, in pixels.
* **Best Effect**  
...
Specifies properties for the pointers in the solid gauge.
...
* **Arrow**  
  ...
  + **Value Pointer**  
     Specifies the style of the value pointer. Select a style from the drop-down list or select Customized and specified another image as the value pointer.
  + **Width**   
...
* **Mark**  
  ...
  + **Gap**   
     Specifies the distance between the mark and the arc, in pixels.
* **Style List**  
...
* **Color List**   
   Opens the [Color List](https://devnet.logianalytics.com/hc/en-us/articles/1500010030022-Color-List-Dialog) dialog to modify the color pattern for pointers in the same data series respectively.
* **Transparency**  
...
Specifies whether to use target value for the solid gauge.
...
* **Show Pointer Value**  
  ...
  + **Position**  
     Specifies the position of the target value relative to the arc. Select the position from the drop-down list or select customized to customize the position by dragging the target value in the design area.

## Frame

Specifies properties for the frame of the solid gauge.
...
* **Show Gauge Group Name**   
  ...
  + **Position**  
     Specifies the position of the names relative to the arcs.

## Range Color

Specifies different colors to fill the arcs in different ranges.
...
Specifies properties for the hint of the solid gauge.
...
Specifies whether to include the category and series values in the int.
...
Specifies web behaviors to the solid gauge. This tab is only available to charts in library components.
