...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010069701-Box-Properties
updated_at: 2021-07-24T10:37:59Z
---

# Box Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404901108631/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010069681-Body-Properties) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404901037591/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010069721-Chart-Properties)

# Box Properties

This topic lists the properties of a Box object, which is supported in page reports only.

| Property Name | Description |
| --- | --- |
| General (only supported on boxes in page reports created using query resources) | |
...
| Excel | |
| [Bottom Attach Column](#Attach) | Specifies the X coordinate of the lower right corner of the drawing object in the exported Excel file, measured in cells. Data type: Float |
| [Bottom Attach Row](#Attach) | Specifies the Y coordinate of the lower right corner of the drawing object in the exported Excel file, measured in cells. Data type: Float |
| [Top Attach Column](#Attach) | Specifies the X coordinate of the upper left corner of the drawing object in the exported Excel file, measured in cells. Data type: Float |
| [Top Attach Row](#Attach) | Specifies the Y coordinate of the upper left corner of the drawing object in the exported Excel file, measured in cells. Data type: Float |
| Box Property | |
...
| Accessibility (only supported on boxes in page reports created using query resources) | |
...
The four properties work together to control the position of a drawing object in the exported Excel file. They take effect when the [Columned](https://devnet.logianalytics.com/hc/en-us/articles/1500010070201-Page-Report-Tab-Properties#Column) property at the report tab level is set to true.
