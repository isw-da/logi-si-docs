...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010069321-Parameter-Properties
updated_at: 2021-07-24T10:38:04Z
---

# Parameter Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404901108631/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010033662-MongoDB-Element-Properties) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404901037591/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010069341-Query-Properties)
...
| Import SQL | Displays the SQL statement for retrieving values of the bound column and display column for the parameter. You can edit the statement if required. Data type: String  **Notes**:   * If you have made changes to the SQL statement, the later changes for Bind Column and Display Column of the parameter will not take effect unless you remove the SQL lines or bind the parameter all over again. * The special field User Name can also be used in the SQL statement as *@username*. |
...
| [Format](https://devnet.logianalytics.com/hc/en-us/articles/1500010069841-DBField-Properties#Format) | Specifies the display format of the parameter's value. The format varies with the parameter's data type and can be defined manually. Data type: String |
