...
| [Format](https://devnet.logianalytics.com/hc/en-us/articles/1500010069841-DBField-Properties#Format) | Specifies the display format of the formula's returned value. The format varies with the formula's data type and can be defined manually. Data type: String |
