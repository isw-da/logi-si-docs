...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405683538583-Visual-Analysis-Window-Elements
updated_at: 2022-01-27T07:58:28Z
---

# Visual Analysis Window Elements

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420453372695/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405690466839-Starting-a-Visual-Analysis-Session)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420453372951/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405683537175-Performing-Visual-Analysis)
...
**![Menu button](https://devnet.logianalytics.com/hc/article_attachments/4420447359255/btn_va_menu.gif) Menu**
...
* **Open**  
   Select to open an existing analysis template in a new Visual Analysis window using the [Open](https://devnet.logianalytics.com/hc/en-us/articles/4405683782551-Open-Dialog-Box-Properties) dialog box.
* **Save**  
   Select to save the changes you made to the current analysis template.
* **Save As**  
   Select to save the current analysis template with a different name or location or [as a new version](https://devnet.logianalytics.com/hc/en-us/articles/4405683940759-Creating-Versions#Save) using the [Save As](https://devnet.logianalytics.com/hc/en-us/articles/4405683785751-Save-As-Dialog-Box-Properties) dialog box.
* **Undo**  
...
* **View**  
  ...
  + **Normal View**  
     The Logi Report smart layout. A scrollbar appears horizontally or vertically if the available space cannot hold all the data.
  + **Fit Height**  
...
![Undo button](https://devnet.logianalytics.com/hc/article_attachments/4420447053079/btn_undo.gif)**Undo**

Select to undo the last operation.

![Redo button](https://devnet.logianalytics.com/hc/article_attachments/4420461455639/btn_redo.gif)**Redo**
...
![Save As button](https://devnet.logianalytics.com/hc/article_attachments/4420447052311/btn_saveas.gif)**Save As**

Select to save the current analysis template with a different name or location or [as a new version](https://devnet.logianalytics.com/hc/en-us/articles/4405683940759-Creating-Versions#Save) using the Save As dialog box.

![Swap button](https://devnet.logianalytics.com/hc/article_attachments/4420461461143/btn_rotate.gif)**Swap**

Select to exchange the columns and rows in the data presentation area.

**![View mode list](https://devnet.logianalytics.com/hc/article_attachments/4420447359511/btn_va_view.gif) View mode**
...
This is where you perform visual analysis operations. Follow the instructions in this area to drag data fields from the Resources panel to the desired positions in the presentation area. As you start to drag a field, Server highlights the possible places where you can drop it, with an orange border. When you add a group as a row or column, the crosstab expands to include the new group and recalculates all the aggregations.

You can only add group and aggregation fields into the data presentation area.

![Presentation Area](https://devnet.logianalytics.com/hc/article_attachments/4420453678103/va_wndw_prst.gif)

The following describes the Column and Row control boxes:

* ![Column box](https://devnet.logianalytics.com/hc/article_attachments/4420447359767/btn_va_drpgrpclmn.gif)  
   You can add group fields to this control box to become column headers.
* ![Column box](https://devnet.logianalytics.com/hc/article_attachments/4420453678359/btn_va_drpaggclmn.gif)  
...
* ![Row box](https://devnet.logianalytics.com/hc/article_attachments/4420461731095/btn_va_drpgrprw.gif)  
   You can add group fields to this control box to become row headers.
* ![Row box](https://devnet.logianalytics.com/hc/article_attachments/4420447360407/btn_va_drpaggrw.gif)  
...
* ![Text Type](https://devnet.logianalytics.com/hc/article_attachments/4420447360791/btn_va_dsplytyp_txt.gif)**Text**  
   Select to display the data values as text. You should add a data field to the label legend ![Label button](https://devnet.logianalytics.com/hc/article_attachments/4420461732247/btn_va_lbl.gif) in the legend section.
* ![Bar Type](https://devnet.logianalytics.com/hc/article_attachments/4420453679383/btn_va_dsplytyp_bar.gif)**Bar**  
   Select to display the data values in bar chart.
* ![Line Type](https://devnet.logianalytics.com/hc/article_attachments/4420447361047/btn_va_dsplytyp_ln.gif)**Line**  
   Select to display the data values in line chart.
* ![Pie Type](https://devnet.logianalytics.com/hc/article_attachments/4420461734167/btn_va_dsplytyp_pie.gif)**Pie**  
   Select to display the data values in pie chart.
* ![Shape Type](https://devnet.logianalytics.com/hc/article_attachments/4420461734551/btn_va_dsplytyp_shp.gif)**Shape**  
...
* **![Color button](https://devnet.logianalytics.com/hc/article_attachments/4420461735703/btn_va_clr.gif) Color**  
...
* **![Label button](https://devnet.logianalytics.com/hc/article_attachments/4420461732247/btn_va_lbl.gif) Label**  
   You can bind the label legend with multiple data fields to provide label text to the members of the data fields.
* **![Size button](https://devnet.logianalytics.com/hc/article_attachments/4420453681303/btn_va_sz.gif) Size**  
   You can bind the size legend with at most one data field to identify the members of the data field by sizes.
* **![Slice button](https://devnet.logianalytics.com/hc/article_attachments/4420453682455/btn_va_angl.gif) Slice**  
...
* **![Shape button](https://devnet.logianalytics.com/hc/article_attachments/4420447361687/btn_va_shp.gif) Shape**  
