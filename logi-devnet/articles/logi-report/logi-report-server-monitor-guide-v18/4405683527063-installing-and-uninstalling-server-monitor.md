...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405683527063-Installing-and-Uninstalling-Server-Monitor
updated_at: 2022-01-27T07:58:25Z
---

# Installing and Uninstalling Server Monitor

[Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405683483031-Logi-Report-Server-Monitor-Guide-v18-Overview)   [Next Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405690463255-Launching-and-Accessing-Server-Monitor)
...
1. Download the Server Monitor installation file from the [download center](https://clm.logianalytics.com/rdPage.aspx?rdReport=ProductDownloads).
...
11. In the **Select JDK** screen, select the JDK version you want to use with Server Monitor. The Installation Wizard collects and lists all the available JDK versions that you have installed on your machine, you can then select one of the JDK versions from the list.
    ...
    **![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4420447034135/noteicon.jpg)**The Installation Wizard does not list JRE versions on your machine. The lowest JDK version that Server Monitor supports is JDK 1.8.0.
12. Select **Next**.
...
**![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4420447034135/noteicon.jpg)**The uninstaller removes all the files that the installer generated, while Server Monitor retains the files that the program created later. You need to remove the latter manually.
