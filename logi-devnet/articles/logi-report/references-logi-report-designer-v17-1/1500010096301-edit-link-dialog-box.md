...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010096301-Edit-Link-Dialog-Box
updated_at: 2021-07-23T19:15:17Z
---

# Edit Link Dialog Box

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404856790679/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010096321-Edit-Line-Style-Dialog-Box)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404856790935/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010058782-Edit-Node-Style-Dialog-Box)

# Edit Link Dialog Box

You can use the Edit Link dialog box to [edit the link](https://devnet.logianalytics.com/hc/en-us/articles/1500010101261-Adding-Links-in-Reports#Edit) on an object. This topic describes the options in the dialog box.

Designer displays the Edit Link dialog box when you select an object in a report on which you have added a link, right-click it and select Edit Link from the shortcut menu, and provides different options in the dialog box according to the type of the link (some types are available to specific report types only):
...
![Edit Link dialog box for Report](https://devnet.logianalytics.com/hc/article_attachments/4404856975895/edtlnk_rpt.gif)
...
![Edit Link dialog box for Master/Detail Report](https://devnet.logianalytics.com/hc/article_attachments/4404848583703/edtlnk_dtl.gif)
...
Specify the component in the detail report tab to interlink with the master report. Select the ellipsis button ![Ellipsis button](https://devnet.logianalytics.com/hc/article_attachments/4404848397591/btn_ellipsis.gif) to add the components. You can add more than one component as long as the components are based on the same dataset.
...
![Edit Link dialog box for URL](https://devnet.logianalytics.com/hc/article_attachments/4404848583959/edtlnk_url.gif)
...
![Edit Link dialog box for E-mail](https://devnet.logianalytics.com/hc/article_attachments/4404848584215/edtlnk_mail.gif)
...
![Edit Link dialog box for Content](https://devnet.logianalytics.com/hc/article_attachments/4404848584471/edtlnk_cntnt.gif)
...
Select the content type for the Blob type data. Select ![Formula button](https://devnet.logianalytics.com/hc/article_attachments/4404848413975/btn_fmla.gif) if you want to bind the content type with a field in the selected data resource, or [use a formula to control](https://devnet.logianalytics.com/hc/en-us/articles/1500010061002-Using-Formulas-to-Control-Object-Properties) the type.

**File Name**

Specify the file name for the linked Blob type data. Select ![Formula button](https://devnet.logianalytics.com/hc/article_attachments/4404848413975/btn_fmla.gif) if you want to specify a field or formula to control the name.
