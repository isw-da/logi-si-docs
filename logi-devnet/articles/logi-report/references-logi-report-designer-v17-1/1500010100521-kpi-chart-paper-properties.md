...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010100521-KPI-Chart-Paper-Properties
updated_at: 2021-07-23T19:16:35Z
---

# KPI Chart Paper Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404856790679/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010062202-KPI-Chart-Label-Properties)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404856790935/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010100541-Label-Properties)
...
| X | Specifies the horizontal coordinate of the top left corner of the object, relative to its parent container. This property is ignored if the [Position](https://devnet.logianalytics.com/hc/en-us/articles/1500010100501-KPI-Chart-Properties#Position) property of the KPI chart is set to static. Type a numeric value to change the position. Data type: Float |
...
| [Border End Caps](https://devnet.logianalytics.com/hc/en-us/articles/1500010061902-Chart-Properties#EndCaps) | Specifies the ending style of the paper border line. Choose an option from the drop-down list. Data type: Enumeration |
| [Border Joint](https://devnet.logianalytics.com/hc/en-us/articles/1500010061902-Chart-Properties#Joint) | Specifies the joint style of the paper border line. Choose an option from the drop-down list. Data type: Enumeration |
...
| [Border End Caps](https://devnet.logianalytics.com/hc/en-us/articles/1500010061902-Chart-Properties#EndCaps) | Specifies the ending style for the border, not applying to line charts. Choose an option from the drop-down list. Data type: Enumeration |
| [Border Joint](https://devnet.logianalytics.com/hc/en-us/articles/1500010061902-Chart-Properties#Joint) | Specifies the line joint style for the border, not applying to line charts. Choose an option from the drop-down list. Data type: Enumeration |
...
| [Font Effect](https://devnet.logianalytics.com/hc/en-us/articles/1500010100301-Chart-Paper-Properties#FontEffect) | Specifies the special effect for the hint text. Choose an option from the drop-down list. Data type: Integer |
...
| [Outline End Caps](https://devnet.logianalytics.com/hc/en-us/articles/1500010061902-Chart-Properties#EndCaps) | Specifies the ending style for the hint text outline. Choose an option from the drop-down list. Data type: Enumeration |
| [Outline Joint](https://devnet.logianalytics.com/hc/en-us/articles/1500010061902-Chart-Properties#Joint) | Specifies the joint style for the hint text outline. Choose an option from the drop-down list. Data type: Enumeration |
...
| Series Name | Specifies the name of the series field to be displayed in the data marker hint. By default the display name of the series field is used in the hint to label the series value. You can customize the name to help the report users better understand the value. This property is available only when [Customize Category and Series Names](#CustomizeCategory) is set to true. Data type: String |
...
| Show Tips | Specifies whether to show the hint that displays the values a data marker represents when the mouse pointer points at the data marker in Designer view mode, in HTML output, or at runtime. If this property is set to false, all the other hint properties will be ignored. Data type: Boolean |
...
| [Threshold Line Style](https://devnet.logianalytics.com/hc/en-us/articles/1500010100301-Chart-Paper-Properties#ThresholdLineStyle) | Specifies the style for the threshold lines. Choose an option from the drop-down list. Data type: Enumeration |
...
![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4404856814359/noteicon.jpg) For combo chart, the graph properties will respectively apply to the corresponding chart types.
