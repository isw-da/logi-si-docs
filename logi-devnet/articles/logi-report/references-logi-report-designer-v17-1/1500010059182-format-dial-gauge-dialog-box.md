...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010059182-Format-Dial-Gauge-Dialog-Box
updated_at: 2021-07-23T19:15:28Z
---

# Format Dial Gauge Dialog Box

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404856790679/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010059142-Format-Cell-Dialog-Box)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404856790935/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010097041-Format-Donut-Dialog-Box)

# Format Dial Gauge Dialog Box

You can use the Format Dial Gauge dialog box to [format a dial gauge chart](https://devnet.logianalytics.com/hc/en-us/articles/1500010056922-Formatting-the-Gauge-in-a-Gauge-Chart#Dial). This topic describes the options in the dialog box.
...
* **Angle**  
  Select the degree for angles of the dials. If you select "Customized", Designer displays the [Customize Gauge Angle dialog box](https://devnet.logianalytics.com/hc/en-us/articles/1500010096061-Customize-Gauge-Angle-Dialog-Box) for you to customize the angle.
* **Thickness**  
...
Select to show the names of the ranges that you define in the [Range Color](#Range) tab in the dials. Designer enables the Font and Effects boxes in this tab after you select the option.
...
![Format Dial Gauge dialog box - Axis - Axis tab](https://devnet.logianalytics.com/hc/article_attachments/4404848557207/fmtdlgauge_axis_axis1.gif)
...
* **Correlate with Axis**  
  ...
  + **Transparency**  
    Specify the transparency for the color of the minor tick mark line. Designer disables the option if you select Use Range Color in the Axis sub tab.
  + **Thickness**  
