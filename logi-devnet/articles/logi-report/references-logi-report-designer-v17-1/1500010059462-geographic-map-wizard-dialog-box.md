...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010059462-Geographic-Map-Wizard-Dialog-Box
updated_at: 2021-07-23T19:15:35Z
---

# Geographic Map Wizard Dialog Box

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404856790679/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010096921-Formula-Editor-Dialog-Box)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404856790935/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010097761-Get-JDBC-Connection-Information-Dialog-Box)

# Geographic Map Wizard Dialog Box

You can use the Geographic Map Wizard dialog box to [edit a geographic map](https://devnet.logianalytics.com/hc/en-us/articles/1500010057362-Modifying-Geographic-Maps#Edit). This topic describes the options in the dialog box.
...
Select to finish editing the geographic map and close the dialog box.
...
![Geographic Map Wizard - Data](https://devnet.logianalytics.com/hc/article_attachments/4404848529175/gmpwzd_dt_wb.gif)

### Display Screen

Use this screen to specify the data fields that you want to display in the geographic map.

![Geographic Map Wizard - Display](https://devnet.logianalytics.com/hc/article_attachments/4404856923287/gmpwzd_dsply_wb.gif)
...
![Geographic Map Wizard - Data](https://devnet.logianalytics.com/hc/article_attachments/4404856926103/gmpwzd_dt.gif)

**Dataset box**

The box lists the datasets in the current page report. Select the dataset you want to use for the geographic map. You can select the Edit button to edit the specified dataset in the [Dataset Editor dialog box](https://devnet.logianalytics.com/hc/en-us/articles/1500010058622-Dataset-Editor-Dialog-Box), or select <New Dataset...> to create a dataset in the page report using the [New Dataset dialog box](https://devnet.logianalytics.com/hc/en-us/articles/1500010098001-New-Dataset-Dialog-Box).
...
![Geographic Map Wizard - Group](https://devnet.logianalytics.com/hc/article_attachments/4404856926359/gmpwzd_grp.gif)
...
![Geographic Map Wizard - Layout](https://devnet.logianalytics.com/hc/article_attachments/4404848531607/gmpwzd_layout.gif)
...
![Geographic Map Wizard - Marker](https://devnet.logianalytics.com/hc/article_attachments/4404856926615/gmpwzd_mkr.gif)
