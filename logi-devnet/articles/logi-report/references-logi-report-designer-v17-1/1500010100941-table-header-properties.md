...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010100941-Table-Header-Properties
updated_at: 2021-07-23T19:16:43Z
---

# Table Header Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404856790679/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010100921-Table-Group-Header-Properties)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404856790935/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010100821-Tabular-Properties)

# Table Header Properties

This topic lists the properties of a Table Header object. The availabilities of the properties vary for the [supported report types](https://devnet.logianalytics.com/hc/en-us/articles/1500010061682-Report-Object-Properties#ReportType): Page Report, Web Report and Library Component.
...
| Repeat Header for Excel | Page Report, Web Report, Library Component | Specifies whether to make the object appear in every page of the report's Excel output. Data type: Boolean |
| Repeat Header for TXT | Page Report, Web Report, Library Component | Specifies whether to make the object appear in every page of the report's Text result. Data type: Boolean |
| Repeat Header for XML | Page Report, Web Report, Library Component | Specifies whether to make the object appear in every page of of the report's XML result. Data type: Boolean |
| Repeat on Pages | Page Report, Web Report, Library Component | Specifies whether to make the object appear in every page of the report result. Data type: Boolean |
| Suppress | Page Report, Web Report, Library Component | Specifies whether to show the object in the design area and in the result. All formulas and calculations will be skipped if the property is set to true. Data type: Boolean  Note icon When you set both the Invisible and Suppress properties of an object to true, Suppress has the higher priority. |
| Suppress When No Records | Page Report, Web Report, Library Component | Specifies whether to display the object in theresults when no record is returned to its parent data component. Data type: Boolean |
| Border | | |
...
![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4404856814359/noteicon.jpg) For the Table Header object in web reports and library components, only the properties available in the Web Report Studio Inspector panel can be rendered in Web Report Studio and JDashboard.
