...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010098361-Rank-Expert-Dialog-Box
updated_at: 2021-07-23T19:15:52Z
---

# Rank Expert Dialog Box

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404856790679/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010060242-Query-Options-Dialog-Box)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404856790935/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010098441-RealPlayer-Parameter-Dialog-Box)

# Rank Expert Dialog Box

You can use the Rank Expert dialog box to [insert a rank](https://devnet.logianalytics.com/hc/en-us/articles/1500010094841-Working-with-Ranks) into a report. This topic describes the options in the dialog box.

Designer displays the Rank Expert dialog box when you select Insert > Rank, or drag and drop the Insert Rank icon ![Rank icon](https://devnet.logianalytics.com/hc/article_attachments/4404848501015/icon_rank.gif) from the Components panel to a query-based page report.

![Rank Expert dialog box](https://devnet.logianalytics.com/hc/article_attachments/4404856900375/rank.gif)

You see the following options in the dialog box:

**Rank Resources**

The drop-down list displays the dataset available for the current insertion of the rank, and the list box below shows its fields, including DBFields, formulas, summaries, and parameters.
