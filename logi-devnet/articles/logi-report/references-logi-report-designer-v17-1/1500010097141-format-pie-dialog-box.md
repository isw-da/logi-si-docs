...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010097141-Format-Pie-Dialog-Box
updated_at: 2021-07-23T19:15:30Z
---

# Format Pie Dialog Box

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404856790679/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010097161-Format-Pattern-Dialog-Box)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404856790935/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010059282-Format-Platform-Dialog-Box)

# Format Pie Dialog Box

You can use the Format Pie dialog box to [format the pies of a pie chart](https://devnet.logianalytics.com/hc/en-us/articles/1500010056982-Formatting-the-Pies-Donuts-and-KPI-Value-Labels-in-a-Pie-Donut-Chart). This topic describes the options in the dialog box.
...
![Format Pie - General](https://devnet.logianalytics.com/hc/article_attachments/4404848545559/fmtpie_gnrl.gif)

**Option**

You can specifies the options of the pies in this box.
...
* **KPI Value**  
  Specify the KPI value to display on each pie. Type the value in the text box or select the button ![Formula button](https://devnet.logianalytics.com/hc/article_attachments/4404848413975/btn_fmla.gif) and select a formula or summary from the drop-down list to use its value as the KPI value.
  + **Auto**  
    Select to use the total value of each pie as the KPI value.
* **Position**  
  Select the position of the KPI value relative to the pies: top, bottom, center, or customized. If you select "customized", you can specify the position by dragging any KPI value in the pie chart in the design area.

## Fill Tab

Use this tab to specify the color pattern to fill the pie sections.

![Format Pie - Fill](https://devnet.logianalytics.com/hc/article_attachments/4404856940951/fmtpie_fill.gif)

**Use Single Color**

Select to apply single color pattern to the pie sections.

* **Self Settings**  
  Select to apply the color pattern to the pies themselves only. If you do not select the option, Designer synchronizes the color settings you define here to the [Pattern List property](https://devnet.logianalytics.com/hc/en-us/articles/1500010061902-Chart-Properties#Pattern) on the chart object in the Report Inspector, which the data markers of other subtypes can also apply if the chart is a combo chart.
* **Color**  
  Specify the color for the selected pie section if the chart has no series field, or the color of the pie sections in the current data series if the chart has series field. To edit the color, select the color indicator and select a color from the [color palette](https://devnet.logianalytics.com/hc/en-us/articles/1500010062922-Menu-Tabs#Palette) or input the hexadecimal value (for example, 0xff0000) of a color in the text box.
* **Transparency**  
  Specify the transparency of the color.
* **Color List**  
  Select to open the [Color List dialog box](https://devnet.logianalytics.com/hc/en-us/articles/1500010058302-Color-List-Dialog-Box) to modify the color pattern for pie sections in the same data series respectively.

**Use Single Color with Condition**

Select to apply different color patterns to the pie sections based on different conditions. You can select the Advanced or Normal button to switch between the two editing modes to edit the conditions.
...
Designer does not support this fill type on pie charts.
...
Use this tab to specify the properties for the border of the pie sections.

![Format Pie - Border](https://devnet.logianalytics.com/hc/article_attachments/4404856941207/fmtpie_border.gif)

**Show Border**

Select to show the border of the pie sections. Designer enables the other border properties in this tab after you select the option.
...
Use this tab to specify the properties of the data labels on the pies.

![Format Pie - Data Label](https://devnet.logianalytics.com/hc/article_attachments/4404856941463/fmtpie_data.gif)

**Static Data Label**

You can specify the properties of the static data labels on the pies in this box.
...
Use this tab to specify the properties for the hint of the pie sections.
...
![Format Pie - Behaviors](https://devnet.logianalytics.com/hc/article_attachments/4404856941975/fmtpie_bhvr.gif)
