...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010062022-Contents-Properties
updated_at: 2021-07-23T19:16:32Z
---

# Contents Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404856790679/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010100341-Configuration-Properties)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404856790935/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010062042-Crosstab-Properties)
...
| --- | --- |
| General | |
| Select Priority | Specifies the priority of the actions that will be triggered at runtime when you select on certain objects in the library component which are bound with some actions. Select the ellipsis button Ellipsis button in the value cell to set the priority in the [Select Priority dialog box](https://devnet.logianalytics.com/hc/en-us/articles/1500010095721-Click-Priority-Dialog-Box). Data type: String |
...
| CSS | |
| [Class](https://devnet.logianalytics.com/hc/en-us/articles/1500010100541-Label-Properties#CSS) | Indicates the CSS class that will be applied to the object. This property is read only. The style of the contents is controlled by the JDashboard theme, which can only be edited in the CSS file. Data type: String |
| Other | |
