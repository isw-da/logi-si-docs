...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010059422-Format-Value-Y2-Axis-Dialog-Box
updated_at: 2021-07-23T19:15:34Z
---

# Format Value(Y2) Axis Dialog Box

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404856790679/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010059442-Format-Value-Y-Gridline-Dialog-Box)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404856790935/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010097321-Format-Value-Y2-Gridline-Dialog-Box)

# Format Value (Y2) Axis Dialog Box

You can use the Format Value (Y2) Axis dialog box to [format the value (Y2) axis of a combo chart](https://devnet.logianalytics.com/hc/en-us/articles/1500010094441-Formatting-the-Axes#Value). This topic describes the options in the dialog box.

Designer displays the Format Value (Y2) Axis dialog box when you right-click a combo chart and select Format Axes > Format Value (Y2) Axis from the shortcut menu, or double-click the Y2 axis of a combo chart.
...
Use this tab to specify the general properties of the value (Y2) axis.

![Format Value (Y2) Axis - Axis](https://devnet.logianalytics.com/hc/article_attachments/4404848533271/fmtvalueaxis2_axis.gif)
...
* **Show Percent**  
  Select to show the value labels on the axis in percent. Designer applies this option only if the chart is a bar/bench, line, or area chart that is not of the 100% Stacked type.
...
Use this sub tab to specify the properties of the major tick marks on the value (Y2) axis.

![Format Value (Y2) Axis - Major Tick Mark](https://devnet.logianalytics.com/hc/article_attachments/4404856927895/fmtvalueaxis2_mark_major.gif)
...
Use this sub tab to specify the properties of the minor tick marks on the value (Y2) axis.

![Format Value (Y2) Axis - Minor Tick Mark](https://devnet.logianalytics.com/hc/article_attachments/4404848533527/fmtvalueaxis2_mark_minor.gif)
...
Use this tab to specify the font format of the major tick mark labels on the value (Y2) axis.

![Format Value (Y2) Axis - Font](https://devnet.logianalytics.com/hc/article_attachments/4404848533783/fmtvalueaxis2_font.gif)
...
Use this tab to specify the rotation angle of the major tick mark labels on the value (Y2) axis.

![Format Value (Y2) Axis - Orientation](https://devnet.logianalytics.com/hc/article_attachments/4404848534039/fmtvalueaxis2_orntatn.gif)
...
Use this tab to specify the data format of the major tick mark labels on the value (Y2) axis.

![Format Value (Y2) Axis - Format](https://devnet.logianalytics.com/hc/article_attachments/4404856928663/fmtvalueaxis2_fmt.gif)
