...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010096941-Format-Area-Dialog-Box
updated_at: 2021-07-23T19:15:26Z
---

# Format Area Dialog Box

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404856790679/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010059082-Format-Activity-Gauge-Dialog-Box)[Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404856790935/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010096961-Format-Bar-Dialog-Box)

# Format Area Dialog Box

You can use the Format Area dialog box to [format the areas of an area chart](https://devnet.logianalytics.com/hc/en-us/articles/1500010094421-Formatting-the-Areas-in-an-Area-Chart). This topic describes the options in the dialog box.
...
Use this tab to specify the general properties of the areas. Designer displays different options in the tab for a [2-D area chart](#2D) and a [3-D area chart](#3D).

### For 2-D Area Chart

![Format Area dialog box - General 2-D](https://devnet.logianalytics.com/hc/article_attachments/4404856967319/fmtarea_gnrl_1.gif)
...
* **Use Depth**  
  Specify whether to make the areas three-dimensional. You can select the button ![Formula button](https://devnet.logianalytics.com/hc/article_attachments/4404848413975/btn_fmla.gif) to [use a formula to control the property](https://devnet.logianalytics.com/hc/en-us/articles/1500010061002-Using-Formulas-to-Control-Object-Properties) if the chart uses a query resource.
  + **Depth**  
...
Select to ignore null data values when drawing the areas. If you select the option, when a null data value appears, Designer ignores it and draws the area from the previous data value to the next data value directly; otherwise, the area is broken at the point of the null data value.

### For 3-D Area Chart

![Format Area dialog box - General 3-D](https://devnet.logianalytics.com/hc/article_attachments/4404856967831/fmtarea_gnrl_2.gif)
...
![Format Area dialog box - Fill](https://devnet.logianalytics.com/hc/article_attachments/4404856968087/fmtarea_fill.gif)
...
* **Color**  
  Specify the color for the selected area. To edit the color, select the color indicator and select a color from the [color palette](https://devnet.logianalytics.com/hc/en-us/articles/1500010062922-Menu-Tabs#Palette) or input the hexadecimal value (for example, 0xff0000) of a color in the text box.
* **Transparency**  
  Specify the transparency of the color.
* **Color List**  
  Select to open the [Color List dialog box](https://devnet.logianalytics.com/hc/en-us/articles/1500010058302-Color-List-Dialog-Box) to modify the color pattern for each area.
...
Use this tab to specify the properties for the border of the areas.

![Format Area dialog box - Border](https://devnet.logianalytics.com/hc/article_attachments/4404856968343/fmtarea_border.gif)

**Show Border**

Select to show the border of the areas. Designer enables the other border properties in this tab after you select the option.
...
Use this tab to specify the properties of the data labels for the area nodes.

![Format Area dialog box - Data Label](https://devnet.logianalytics.com/hc/article_attachments/4404856968599/fmtarea_data.gif)

**Static Data Label**

You can specify the properties of the static data labels for the area nodes in this box. Designer disables the options in the box for a 3-D area chart.
...
Use this tab to specify the properties for the hint of the areas.
...
![Format Area dialog box - Behaviors](https://devnet.logianalytics.com/hc/article_attachments/4404848574103/fmtarea_bhvr.gif)
