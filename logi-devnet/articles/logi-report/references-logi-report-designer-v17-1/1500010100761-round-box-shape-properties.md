...
![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4404856814359/noteicon.jpg) When a report is exported to HTML or PostScript, round boxes in it cannot be shown. There is no such problem for PDF, RTF, and other output formats.
