...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010100661-Page-Footer-Panel-Properties
updated_at: 2021-07-23T19:16:38Z
---

# Page Footer Panel Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404856790679/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010100681-Export-Page-Setting-Object-Properties)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404856790935/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010062262-Page-Header-Panel-Properties)

# Page Footer Panel Properties

This topic lists the properties of a Page Footer Panel object. The availabilities of the properties vary for the [supported report types](https://devnet.logianalytics.com/hc/en-us/articles/1500010061682-Report-Object-Properties#ReportType): Page Report and Web Report.

| Property Name | Available For | Description |
| --- | --- | --- |
| General | | |
| Class Type | Page Report, Web Report | Indicates the class type of the object. This property is read only. |
...
| Width | Page Report, Web Report | Displays the width of the object. This property is read only. |
| Color | | |
...
| Suppress | Page Report, Web Report | Specifies whether to show the object in the design area and in the report result. All formulas and calculations will be skipped if the property is set to true. Not supported in Web Report Studio. Data type: Boolean  Note icon When you set both the Invisible and Suppress properties of an object to true, Suppress has the higher priority. |
...
| Suppress When No Records | Page Report, Web Report | Specifies whether to display the object in the report result when no record is returned to its parent data component. Not supported in Web Report Studio. Data type: Boolean |
...
| Border Thickness | Page Report, Web Report | Specifies the width of the border of the object. Type a numeric value to change the thickness. Data type: Float |
