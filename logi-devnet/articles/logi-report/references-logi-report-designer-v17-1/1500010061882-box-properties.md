...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010061882-Box-Properties
updated_at: 2021-07-23T19:16:30Z
---

# Box Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404856790679/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010061862-Body-Properties)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404856790935/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010061902-Chart-Properties)
...
| Excel | |
| [Bottom Attach Column](#Attach) | Specifies the X coordinate of the lower right corner of the drawing object in the Excel output, measured in cells. Data type: Float |
| [Bottom Attach Row](#Attach) | Specifies the Y coordinate of the lower right corner of the drawing object in the Excel output, measured in cells. Data type: Float |
| [Top Attach Column](#Attach) | Specifies the X coordinate of the upper left corner of the drawing object in the Excel output, measured in cells. Data type: Float |
| [Top Attach Row](#Attach) | Specifies the Y coordinate of the upper left corner of the drawing object in the Excel output, measured in cells. Data type: Float |
| Box Property | |
...
The four properties work together to control the position of a drawing object in the Excel output. They take effect when the [Columned](https://devnet.logianalytics.com/hc/en-us/articles/1500010100701-Page-Report-Tab-Properties#Column) property at the report tab level is set to true.
...
![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4404856814359/noteicon.jpg) The value you set for the Top Attach Column (Top Attach Row) property should be always larger than that for the Bottom Attach Column (Bottom Attach Row) property.
