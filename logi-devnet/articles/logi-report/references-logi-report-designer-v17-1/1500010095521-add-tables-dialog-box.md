...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010095521-Add-Tables-Dialog-Box
updated_at: 2021-07-23T19:15:02Z
---

# Add Tables Dialog Box

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404856790679/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010057982-Add-Stored-Procedures-Dialog-Box)[Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404856790935/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010058002-Add-Tables-Views-Queries-Dialog-Box)
...
For an [XML](https://devnet.logianalytics.com/hc/en-us/articles/1500010095381-Working-with-XML-Connections-in-a-Catalog#Add), [JSON](https://devnet.logianalytics.com/hc/en-us/articles/1500010057762-Working-with-JSON-Connections-in-a-Catalog#Add), or [Elasticsearch](https://devnet.logianalytics.com/hc/en-us/articles/1500010095381-Working-with-XML-Connections-in-a-Catalog#Add) connection, Designer displays the following options in the dialog box:

![Add Tables dialog box - XML/JSON](https://devnet.logianalytics.com/hc/article_attachments/4404857014039/addtbl_xml.gif)

**Database Catalogs**

The drop-down list is disabled for an XML, JSON, or Elasticsearch connection.

**Schemas**

The box lists the schemas transformed from the corresponding data source.

**Tables**

The box displays the tables contained in the selected schema after you select the Refresh button.

**Connection**

The option shows the name of the current connection.
...
For a [web service](https://devnet.logianalytics.com/hc/en-us/articles/1500010057862-Connecting-via-SOAP-Web-Service-Connections#Table) connection, Designer displays the following options in the dialog box:

![Add Tables dialog box - web service connection](https://devnet.logianalytics.com/hc/article_attachments/4404848638615/addtbl_wbsvc.gif)

**Service Name**

The drop-down list contains all the service information defined in the WSDL file. Select the service to use.
...
The drop-down list contains all the operation information for the selected service. Select the operation to use. An operation is an abstract description of an action supported by the service. Each operation refers to an input message and output messages.
...
The column shows the values for the input messages. You can type the value, or define a constant level formula or a parameter to be the value.
...
For a [MongoDB](https://devnet.logianalytics.com/hc/en-us/articles/1500010057802-Working-with-MongoDB-Connections-in-a-Catalog#AddTable) connection, Designer displays the following options in the dialog box:

![Add Tables dialog box - MongoDB connection](https://devnet.logianalytics.com/hc/article_attachments/4404848639255/addtbl_mngodb.gif)

**Tables**

The box lists the tables transformed from the relational schemas.

**Added Tables**

The box lists the tables that you select to add to the catalog.
