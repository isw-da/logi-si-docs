...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010095221-Creating-JDBC-Connections-via-Plug-ins
updated_at: 2021-07-23T19:14:55Z
---

# Creating JDBC Connections via Plug-ins

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404856790679/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010057702-Setting-Up-JDBC-Connections-in-a-Catalog)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404856790935/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010095161-Using-DBMS-Objects-via-JDBC-Connections)
...
1. Do one of the following:
   * In the Start Page, select **Oracle**, **MySQL**, **SQL Server**, **InterSystems IRIS**, or **PostgreSQL** in the **Connect** category. In the [Create Connection dialog box](https://devnet.logianalytics.com/hc/en-us/articles/1500010095881-Create-Connection-Dialog-Box), specify an existing catalog or create a new one and select **OK**.
...
10. Select the **Test Connection** button to test whether the specified information is correct for setting up the connection.
11. Select the **More Options** button if your database has special requirements to modify the [options](https://devnet.logianalytics.com/hc/en-us/articles/1500010097761-Get-JDBC-Connection-Information-Dialog-Box#Options) accordingly.
12. Select **OK** and Designer adds the connection in the specified catalog data source in the Catalog Manager.

    You can then [add DBMS objects](https://devnet.logianalytics.com/hc/en-us/articles/1500010095161-Using-DBMS-Objects-via-JDBC-Connections) from the database into the catalog via the connection.
...
## Marks content and feature updates for Logi Report v17.1. New feature new content.Connecting to Oracle Databases via Wallets
...
3. Add the locations of **tnsnames.ora** and the wallet file to the CLASSPATH variable of **JReport.bat** in the `<designer_install_root>\bin` directory by using the Java VM properties "-Doracle.net.tns\_admin" and "-Doracle.net.wallet\_location".
   ...
   ![Add Classpth](https://devnet.logianalytics.com/hc/article_attachments/4404857020951/cnctn_jdbc_plgin_clspth.gif)
...
5. Add the connection identifier name in the URL used for connecting to the Oracle database. You can then connect to the database without having to provide the user name and password.
   ...
   ![Set Up the Connection Using the Wallet](https://devnet.logianalytics.com/hc/article_attachments/4404857021207/cnctn_jdbc_plgin_cnct.gif)
