...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009629101-Formula-Fields
updated_at: 2021-07-24T16:05:15Z
---

# Formula Fields

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404911578903/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009629241-Summary-Fields-) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404911579543/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009606442-Special-Fields)

# Formula Fields

[Formulas](https://devnet.logianalytics.com/hc/en-us/articles/1500009611122-Formulas) are calculated from DBFields, other formulas, summaries, and parameters. This topic introduces how to insert a formula field in a report and how to manage the inserted formula field.
...
Formula fields can be inserted in the report areas listed in [Component Placement](https://devnet.logianalytics.com/hc/en-us/articles/1500009605422-Working-with-Components-in-Reports#Relationship).

* **For a business view based report**  
   Select the formula from the [Dynamic Resources > Formulas](https://devnet.logianalytics.com/hc/en-us/articles/1500009636201-Using-Dynamic-Resources-and-Local-Parameters-in-Reports#Formula) node in the Data panel and drag it to the destination.
* **For a query based report**  
   You have two ways to insert a formula into a query based report.
  + **By dragging and dropping**
    Select the formula from the Formulas node in the Data panel, then drag it to the destination. If the given formulas are not what you want, select the **<New Formula...>** item to [create one](https://devnet.logianalytics.com/hc/en-us/articles/1500009634201-Creating-Formulas-in-a-Catalog) as required.
  + **Using dialog**
...
To add conditional format to a formula field, right-click it and select **Conditional Formatting**  from the shortcut menu, then take the same procedure as described in [Adding Conditional Formats to DBFields](https://devnet.logianalytics.com/hc/en-us/articles/1500009629081-DBFields#Format).
