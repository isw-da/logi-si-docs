...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010094961-Working-with-Tabulars
updated_at: 2021-07-23T19:14:50Z
---

# Working with Tabulars

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404856790679/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010094881-Working-with-Special-Fields)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404856790935/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010057502-Working-with-Web-Controls)
...
![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4404856814359/noteicon.jpg) You cannot use tabulars in page reports that use business views and in library components. A web report is initially a tabular with a single cell; you cannot insert another tabular into a web report.

This topic contains the following sections:

* [Inserting Tabulars in a Report](#Insert)
...
## Inserting Tabulars in a Report

You can insert tabulars in the page report areas listed in [Component Placement](https://devnet.logianalytics.com/hc/en-us/articles/1500010094261-Working-with-Components-in-Reports#Relationship).

To insert a tabular into a page report, use either of the following methods:

* **Using dialog box**
  1. Position the mouse pointer at the destination where you want to insert the tabular.
  2. Select **Insert** > **Tabular**, or **Home** > **Insert** > **Tabular**.

     Designer displays the [Insert Tabular dialog box](https://devnet.logianalytics.com/hc/en-us/articles/1500010097721-Insert-Tabular-Dialog-Box).

     ![Insert Tabular dialog box](https://devnet.logianalytics.com/hc/article_attachments/4404848519831/insttblr.gif)
  ...
  4. Select the **OK** button to close the dialog box.
     ...
     If the mouse pointer is in the report body or a cell of another tabular, Designer inserts the tabular there when you select OK; otherwise, you need to select the mouse button in the desired location to place the tabular there.
* **By dragging and dropping**  
  From the **Components** panel, drag the **Tabular** icon ![Tabular icon](https://devnet.logianalytics.com/hc/article_attachments/4404848519575/icon_tabular.gif) to the desired location in the report which allows the insertion of a tabular, Designer then inserts a tabular with two rows and columns by default there.

## Inserting Components into a Tabular

The components that you can insert into a tabular cell are listed in [Component Placement](https://devnet.logianalytics.com/hc/en-us/articles/1500010094261-Working-with-Components-in-Reports#Relationship). The most common component to place into a tabular cell is a data component, and it is usually best to only place one single data component into one tabular cell. When you insert a component whose default size is bigger than that of the tabular cell, the component fits into the cell by default. If you place multiple components into one cell, you should make sure their [Position](https://devnet.logianalytics.com/hc/en-us/articles/1500010062762-Editing-Reports#Position) property is static, so that the components flow one after another and do not overlap. Then at runtime,
...
* To merge adjacent cells, select them, right-click and select **Merge** from the shortcut menu, or select **Home** > **Merge**. Designer then merges these cells into one cell.
* To split a cell:
  ...
  2. In the Split Cell dialog box, specify how many rows/columns you want to split the cell into.
     ...
     ![Split Cell dialog box](https://devnet.logianalytics.com/hc/article_attachments/4404848663575/cmpnt_tblr.gif)
...
* To insert a column/row into a tabular, select a cell and right-click it. On the shortcut menu, select the corresponding inserting column/row item and Designer inserts a column/row according to your selection.
