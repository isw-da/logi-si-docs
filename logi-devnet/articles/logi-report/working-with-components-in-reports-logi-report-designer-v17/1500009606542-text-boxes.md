...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009606542-Text-Boxes
updated_at: 2021-07-24T16:05:11Z
---

# Text Boxes

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404911578903/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009606362-Multimedia-Objects) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404911579543/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009606422-Subreports)
...
**See an example:** The SampleComponents catalog, included with Logi Report Designer, contains reports that have examples of how each component type could be used in a report. For the text box example, open `<install_root>\Demo\Reports\SampleComponents\ForTextBox.cls`.

## Inserting Text Boxes in a Page Report

A text box can be inserted in the page report areas listed in [Component Placement](https://devnet.logianalytics.com/hc/en-us/articles/1500009605422-Working-with-Components-in-Reports#Relationship).
...
* From the Components panel, drag ![Text Box button](https://devnet.logianalytics.com/hc/article_attachments/4404916827799/btn_insttxtbx.gif) to the desired location in the page report which allows the insertion of a text box, and a text box will then be created.
...
1. Right-click anywhere in the paragraph and select **Paragraph** on the shortcut menu. The [Format Text](https://devnet.logianalytics.com/hc/en-us/articles/1500009631681-Format-Text-Dialog#Paragraph) dialog appears.

   ![Format Text dialog - Paragraph](https://devnet.logianalytics.com/hc/article_attachments/4404904287255/fmttext_prgrph.gif)
...
* To create a first-line indent or hanging indent, drag ![](https://devnet.logianalytics.com/hc/article_attachments/4404904423831/btn_lnindnt.gif) to the position where you want the text to start.
* To change the left indent, drag ![](https://devnet.logianalytics.com/hc/article_attachments/4404916828055/btn_lftindnt.gif) to the position where you want the paragraph to start.
* To change the right indent, drag ![](https://devnet.logianalytics.com/hc/article_attachments/4404904424087/btn_rtindnt.gif) to the position where you want the paragraph to end.
...
2. In the Font tab of the Format Text dialog, specify the [font settings](https://devnet.logianalytics.com/hc/en-us/articles/1500009631681-Format-Text-Dialog#Font).

   ![Format Text dialog - Font](https://devnet.logianalytics.com/hc/article_attachments/4404904287511/fmttext_font.gif)
...
2. In the Find tab of the Find and Replace dialog, specify the string you want to search for and set the other settings as required.
   ...
   ![Find and Replace dialog - Find](https://devnet.logianalytics.com/hc/article_attachments/4404916828311/cmpnt_txtbx_find.gif)
...
1. Right-click anywhere in the text box and select **Replace** from the shortcut menu, the Find and Replace dialog will then be displayed with the Replace tab selected.
   ...
   ![Find and Replace dialog - Replace](https://devnet.logianalytics.com/hc/article_attachments/4404904424343/cmpnt_txtbx_rplc.gif)
