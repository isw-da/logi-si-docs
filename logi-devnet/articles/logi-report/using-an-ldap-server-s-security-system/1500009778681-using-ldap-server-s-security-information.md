...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009778681-Using-LDAP-Server-s-Security-Information
updated_at: 2021-07-24T00:47:32Z
---

# Using LDAP Server's Security Information

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404880134167/back.png) Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009749882-Configuring-the-LDAP-Server)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404880134423/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009749902-SSL-Support-in-the-LDAP-System)
...
The diagram below illustrates the two working modes:

![Working Mode](https://devnet.logianalytics.com/hc/article_attachments/4404880208279/scrty_rsc_srv_ldap_use1.gif)
...
1. In the Server Console, point to **Administration** on the system toolbar, and then select **Security** >  **LDAP** from the drop-down menu to open the LDAP page.
2. Select the **Import** tab.

   ![LDAP page](https://devnet.logianalytics.com/hc/article_attachments/4404880209559/scrty_rsc_srv_ldap_use_impt.gif)
...
4. To view the LDAP users and groups that have the same names as the users and groups in Logi Report Server, select the **List Users** and **List Groups** buttons.
...
1. In the Administration > Security > LDAP page, go to the **Synchronize** tab.
   ...
   ![Synchronize tab](https://devnet.logianalytics.com/hc/article_attachments/4404880210327/scrty_rsc_srv_ldap_use_sync.gif)
2. Select the **Edit** link in the LDAP Synchronization Schedule Settings table.
3. From the **Select time type to synchronize** drop-down list, specify the time for when to perform the task.

   ![Specify Time](https://devnet.logianalytics.com/hc/article_attachments/4404885354647/scrty_rsc_srv_ldap_use_schdl.gif)
...
You can also manually start the synchronization by selecting the **Synchronize Now** button. Then when the synchronization is completed, Logi Report Server displays the Synchronization Information table showing which users and roles/groups have been modified and removed. Select **Back** to return to the Synchronize tab.
...
1. In the Administration > Security > LDAP page, go to the **Role Map** tab.
   ...
   ![Role Map tab](https://devnet.logianalytics.com/hc/article_attachments/4404885354903/scrty_rsc_srv_ldap_use_role.gif)
2. Select **Create New Role Map**.
3. In the **Search Filter String** text box, type the search filter criteria.

   ![Search Filter String](https://devnet.logianalytics.com/hc/article_attachments/4404880211095/scrty_rsc_srv_ldap_use_map.gif)
4. From the **Corresponding Role** drop-down list, select a role to which you want to assign the matching users.
5. Select **Test** to test the content of the filter. The result of the test does not affect the creation of the new role map.
...
* To test the content of the filter of a role map, select **Test** in the role map row.
...
In order to use LDAP security providers, a valid admin user is required to access the Server Console in order to manage Logi Report Server. A user that meets one of the following two rules is regarded as an admin user:
