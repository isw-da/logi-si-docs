...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009751241-Managing-Permissions
updated_at: 2021-07-25T07:18:38Z
---

# Managing Permissions

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404936712471/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009724522-Managing-Aliases)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404942444695/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009751361-Multitenancy-Supported-via-Organizations)

# Managing Permissions

Permissions, associated with resources (including folders) located in the public folders in the server resource tree, are the rules that are granted to users to control their access to resources. This topic describes the permissions Logi Report Server reserves, and how to manage the permissions for the users, groups, and roles in the server security system.
...
| Execute | Allows or denies:  * Basic View of Page Report Studio when running [page reports](https://devnet.logianalytics.com/hc/en-us/articles/1500009724222-Running-Reports#Direct) and [page report results](https://devnet.logianalytics.com/hc/en-us/articles/1500009751161-Viewing-Scheduled-Report-Results#RSD) in Page Report Studio. * View Mode of Web Report Studio when running [web reports](https://devnet.logianalytics.com/hc/en-us/articles/1500009724222-Running-Reports#Direct) in Web Report Studio. * View mode of JDashboard when [running dashboards](https://devnet.logianalytics.com/hc/en-us/articles/1500009745101-Running-Dashboards). * [Opening analysis templates](https://devnet.logianalytics.com/hc/en-us/articles/1500009744081-Starting-a-Visual-Analysis-Session#Run). * [Running reports in Advanced mode](https://devnet.logianalytics.com/hc/en-us/articles/1500009724222-Running-Reports#Advanced).   Running reports, dashboards or analysis templates via [URL](https://devnet.logianalytics.com/hc/en-us/articles/1500009724942-Working-on-Logi-Report-Server-via-URLs-Logi-Report-Server-v17) is also under the permission control. |
...
3. Select a role, user, or group in the Selected box, then select or clear the required permissions.
   ...
   If a role, user, or group is not listed in the Selected box, select it in the Available box and select the **Add** button ![Add button](https://devnet.logianalytics.com/hc/article_attachments/4404942476823/btn_add.gif) to add it to the Selected box first, then assign the permissions accordingly.
...
4. To remove all the enabled permissions from a role, user, or group, first select it in the Selected table, then select ![Remove button](https://devnet.logianalytics.com/hc/article_attachments/4404936763159/btn_rmv.gif). The role, user, or group will be added back to the Available box with no permissions.
...
* You may require more than one permission in order to complete a task. For example, you must have both the Visible and Read permissions
