...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009718662-Logi-Report-Server-Cluster-Main-Features
updated_at: 2021-07-25T07:20:19Z
---

# Logi Report Server Cluster Main Features

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404936712471/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009744601-Logi-Report-Server-Cluster)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404942444695/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009744621-Setting-Up-and-Starting-a-Logi-Report-Server-Cluster)
...
* **Weighted Min-load (loadbalance.type=2)**  
  ...
  Performance weight is a positive floating-point number that you set to each server in a cluster on any clustered server. Use the Administration > Configuration > Cluster > Weight page in the Logi Report Server console and measure the performance of a typical report on each node of the cluster. The higher performance weight you set to a clustered server, the higher chance it may get selected by the server that holds the active scheduler during load balancing. See [Configuring Performance Weight](https://devnet.logianalytics.com/hc/en-us/articles/1500009718682-Managing-a-Logi-Report-Server-Cluster#Weight) for how to set performance weight and how this algorithm works.
