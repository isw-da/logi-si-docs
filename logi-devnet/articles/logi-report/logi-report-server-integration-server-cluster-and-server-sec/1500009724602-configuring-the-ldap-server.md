...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009724602-Configuring-the-LDAP-Server
updated_at: 2021-07-25T07:18:37Z
---

# Configuring the LDAP Server

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404936712471/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009751321-Using-an-LDAP-Server-s-Security-System)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404942444695/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009724622-Using-LDAP-Server-s-Security-Information)

# Configuring the LDAP Server

To use an LDAP server's security system, you should first enable Logi Report Server to adapt to a directory server. You can configure either via the Logi Report Server UI or using the file LDAPProperties.xml.
...
| Enable Direct Authentication to LDAP Server | Specifies to enable Logi Report Server to directly access an LDAP server and obtain LDAP security information without having to import it. When enabled, the users from the LDAP server will be assigned the *everyone* role in the Logi Report Server security system automatically. By default this option is not activated and in order to use an LDAP server's security system you have to import the security information from the LDAP server. |
| [Enable Auto-Import of Users from LDAP Server](https://devnet.logianalytics.com/hc/en-us/articles/1500009724622-Using-LDAP-Server-s-Security-Information#Import) | Specifies to enable Logi Report Server to import LDAP users automatically. If activated, Logi Report Server's security system will import security information from the LDAP server automatically when an LDAP user logs into Logi Report Server for the first time. |
...
2. Select the **Enable LDAP** check box, and input the following information:
   ...
   * **Group Schema**
   ...
   ![Novell Directory Server](https://devnet.logianalytics.com/hc/article_attachments/4404936760215/scrty_rsc_srv_ldap_config_ui1.gif)
...
2. Select the **Enable LDAP** check box and input the following information:
   ...
   * **Import LDAP Groups to**: Group
   ...
   ![Microsoft Site Server](https://devnet.logianalytics.com/hc/article_attachments/4404942473751/scrty_rsc_srv_ldap_config_ui3.gif)
...
2. Select the **Enable LDAP** check box and input the following information:
   ...
   * **Import LDAP Groups to**: Group
   ...
   ![iPlanet Directory Server](https://devnet.logianalytics.com/hc/article_attachments/4404936760471/scrty_rsc_srv_ldap_config_ui4.gif)
...
2. Select the **Enable LDAP** check box and input the following information:
   ...
   * **Group Schema**
   ...
   ![Active Directory Advanced Server](https://devnet.logianalytics.com/hc/article_attachments/4404936760727/scrty_rsc_srv_ldap_config_ui5.gif)
...
2. Select the **Enable LDAP** check box and input the following information:
   ...
   * **Group Schema**
   ...
   ![Lotus Domino Server on NT](https://devnet.logianalytics.com/hc/article_attachments/4404942474007/scrty_rsc_srv_ldap_config_ui6.gif)
...
2. Select the **Enable LDAP** check box and input the following information:
   ...
   * **Group Schema** 
   ...
   ![OpenLDAP Directory Server](https://devnet.logianalytics.com/hc/article_attachments/4404936760983/scrty_rsc_srv_ldap_config_ui7.gif)
3. Select **Save** to save all settings in this page. You can then get all users and groups from the developer organization unit.
...
An admin user may fail to carry out LDAP configuration properly, and thus cannot log onto the Logi Report Server console to manage the server. If this happens, you should follow the below steps:
