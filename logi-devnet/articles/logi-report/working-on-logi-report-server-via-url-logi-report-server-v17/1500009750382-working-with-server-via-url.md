...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009750382-Working-with-Server-via-URL
updated_at: 2021-07-24T00:47:26Z
---

# Working with  Server via URL

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404880134167/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009750302-Using-the-Authentication-Properties-in-URL)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404880134423/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009750342-Working-with-Dashboards-via-URL)
...
* [Viewing Report Results via URL](#ViewResult)
* [Specifying the Application Language via URL](#NLS)
* [Adding and Deleting Users/Roles via URL](#User)
...
* [Logging in and out of Logi Report Server via URL](#Log)

## Viewing Report Results via URL

You can view the report results that Server generated when [advanced running](https://devnet.logianalytics.com/hc/en-us/articles/1500009778381-Running-Reports#Advanced) or scheduling reports to [publish to the versioning system](https://devnet.logianalytics.com/hc/en-us/articles/1500009778441-Examples-of-Scheduling-Reports#Version) via URL by either of the following two ways.

* **Using JSP**
  + **For the Page Report Result type (RSD)**   
    You can view page report result files in Page Report Studio by running **runReport.jsp**. The URL can call one of the following three groups of properties:
    ...
    - **jrs.file** for specifying a file path on the disk
...
For more information, see [Properties for Viewing Report Results](https://devnet.logianalytics.com/hc/en-us/articles/1500009743382-Appendix-1-URL-Properties-for-Running-Scheduling-and-Viewing-Reports-via-URL#Result).
...
Admin users can run the following JSPs to add or remove users/roles to the security system on Logi Report Server. However, before they can do this, they should have [logged onto the Server Console](https://devnet.logianalytics.com/hc/en-us/articles/1500009777061-Accessing-Logi-Report-Server-via-a-Web-Browser) to run the URL successfully.
...
For more information, see [Properties for adding and deleting users/roles](https://devnet.logianalytics.com/hc/en-us/articles/1500009743382-Appendix-1-URL-Properties-for-Running-Scheduling-and-Viewing-Reports-via-URL#User).
