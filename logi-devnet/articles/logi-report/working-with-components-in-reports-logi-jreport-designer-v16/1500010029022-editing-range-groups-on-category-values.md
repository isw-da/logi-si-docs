...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010029022-Editing-Range-Groups-on-Category-Values
updated_at: 2021-07-24T10:39:24Z
---

# Editing Range Groups on Category Values

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404901108631/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010028982-Labeling-Time-Series-Data-by-Constant-Interval) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404901037591/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010063661-Creating-Scrollable-Charts)
...
4. Save the report and select the **View** tab to preview the chart. The chart appears as follows:
   ...
   ![Result of Clustered Bar 2-D](https://devnet.logianalytics.com/hc/article_attachments/4404909283735/cmpnt_cht_range2.gif)
...
7. Go to the **Range** > **Properties** tab, check the **Enable Range** option and then select the **Special Group** button to display the [User Defined Group](https://devnet.logianalytics.com/hc/en-us/articles/1500010068301-User-Defined-Group-Dialog) dialog.
8. Define two range groups as follows and select **OK**.

   ![Define Range Groups](https://devnet.logianalytics.com/hc/article_attachments/4404909283991/cmpnt_cht_range3.gif)
9. In the Gridline box, specify the line color as **#FF0000** and thickness as **2 px** for the separating line, then in the Fill box, specify the background colors of the 2015 and 2016 range groups as **#FFFFCC** and **#CCFFFF**.
   ...
   ![Set Range Properties](https://devnet.logianalytics.com/hc/article_attachments/4404901333143/cmpnt_cht_range4.gif)
10. Select the **Data Label**  sub tab, check the **Show Data Label** option and then select the **Edit Data Labels** button to display the [Data Label Editor](https://devnet.logianalytics.com/hc/en-us/articles/1500010030302-Data-Label-Editor-Dialog). You can see there are three data labels which represent the category ranges, the summary field names and values respectively by default. Select **OK**.

    ![Data Label Editor](https://devnet.logianalytics.com/hc/article_attachments/4404901333399/cmpnt_cht_range5.gif)
...
12. Select the **View** tab to preview the chart. The category values are now divided into two range groups with different background colors. In each range group, the data labels display the year information and the total sales of each year as well as the percentage of the total sales each year occupies.
    ...
    ![Result of Clustered Bar 2-D with Category Values in Two Range Groups](https://devnet.logianalytics.com/hc/article_attachments/4404901333783/cmpnt_cht_range6.gif)
...
15. Go to the **Range** > **Data Label**  tab, in the Border box, specify Color as **#606060**, select the first item from the Line Style drop-down list, set Thickness to **2 px**.
    ...
    ![Set Data Label for Range](https://devnet.logianalytics.com/hc/article_attachments/4404901334039/cmpnt_cht_range7.gif)
...
18. Select on the right of the last drop-down list to select the last iterator, then right-click the iterator and
    ...
    ![Data Label Editor](https://devnet.logianalytics.com/hc/article_attachments/4404901334295/cmpnt_cht_range8.gif)
19. Check the **Category** option in the Iterated By box and select **OK**.

    ![Chart Iterator dialog - Iteration](https://devnet.logianalytics.com/hc/article_attachments/4404901334551/cmpnt_cht_range9.gif)
...
21. Resize the chart and preview it again. The border of the data label areas is displayed and the data labels now show the total sales of each month and the percentage each month occupies. You can put the mouse over the data labels when they cannot be completely displayed to get the full text.
    ...
    ![Clustered Bar 2-D Result](https://devnet.logianalytics.com/hc/article_attachments/4404909284247/cmpnt_cht_range10.gif)
