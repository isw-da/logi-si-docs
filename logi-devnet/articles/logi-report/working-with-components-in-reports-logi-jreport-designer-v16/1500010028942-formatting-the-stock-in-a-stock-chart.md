...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010028942-Formatting-the-Stock-in-a-Stock-Chart
...
1. Right-click any stock line in the stock chart and select **Format Stock** on the shortcut menu, or double-click any stock line. The [Format Stock](https://devnet.logianalytics.com/hc/en-us/articles/1500010066621-Format-Stock-Dialog) dialog appears.

   ![Format Stock dialog - General](https://devnet.logianalytics.com/hc/article_attachments/4404909195671/fmtstck_gnrl.gif)
2. In the General tab, set the color and thickness of the stock lines (to change the color, select the color indicator and select a color from the [color palette](https://devnet.logianalytics.com/hc/en-us/articles/1500010035022-Menu-Tabs#Palette) or input the hexadecimal value of a color directly in the text box).
