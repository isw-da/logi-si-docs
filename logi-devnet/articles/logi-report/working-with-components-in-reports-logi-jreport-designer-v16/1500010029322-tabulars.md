...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010029322-Tabulars
updated_at: 2021-07-24T10:39:19Z
---

# Tabulars

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404901108631/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010029242-Special-Fields) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404901037591/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010029362-Web-Controls)
...
A tabular can be inserted in the page report areas listed in [Component Placement](https://devnet.logianalytics.com/hc/en-us/articles/1500010063261-Working-with-Components-in-Reports-#Relationship).
...
* **Using dialog**
  ...
  2. Select **Insert** > **Tabular** or **Home** > **Insert** > **Tabular**. The [Insert Tabular](https://devnet.logianalytics.com/hc/en-us/articles/1500010031522-Insert-Tabular-Dialog) dialog appears.

     ![Insert Tabular dialog](https://devnet.logianalytics.com/hc/article_attachments/4404901202327/insttblr.gif)
...
* **By dragging and dropping**
  ...
  From the Components panel, drag the **Tabular** button ![Tabular button](https://devnet.logianalytics.com/hc/article_attachments/4404909271447/btn_tblr.gif) to the desired location in the report which allows the insertion of a tabular, and a tabular with two rows and columns by default will then be created there.

## Inserting Components into a Tabular

The components that can be inserted into a tabular cell are listed in [Component Placement](https://devnet.logianalytics.com/hc/en-us/articles/1500010063261-Working-with-Components-in-Reports-#Relationship). The most common component to place into a tabular cell is a data component. You can insert a table, crosstab or chart and for a page report a banded object in a tabular cell. It is usually best to only place a single data component into a tabular cell. Then at runtime,
...
If you place multiple components into a cell you should change the [Position](https://devnet.logianalytics.com/hc/en-us/articles/1500010070821-Editing-Reports#Position) property to static, then the components will flow one after the other and will not overlap which is usually the desired result.
...
* To split a cell:
  ...
  2. In the Split Cell dialog, check whether the cell will be split into rows or columns, and then specify how many rows/columns the cell will be split into.
     ...
     ![Split Cell dialog](https://devnet.logianalytics.com/hc/article_attachments/4404901313815/cmpnt_tblr.gif)
