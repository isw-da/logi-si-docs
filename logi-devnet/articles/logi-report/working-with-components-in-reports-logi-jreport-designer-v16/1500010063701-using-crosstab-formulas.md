...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010063701-Using-Crosstab-Formulas
updated_at: 2021-07-24T10:39:24Z
---

# Using Crosstab Formulas

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404901108631/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010063741-Modifying-Crosstabs) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404901037591/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010063281-Banded-Objects)

# Using Crosstab Formulas

Crosstab formulas are a type of extended [formulas](https://devnet.logianalytics.com/hc/en-us/articles/1500010068521-Formulas) used only in crosstabs that are created using query resources. By using crosstab formulas, you can create custom aggregate functions in a crosstab to get the desired results. Crosstab formulas are private resources on the crosstab level. They cannot be used beyond its crosstab.
...
* A crosstab formula can reference summary expression which follows the syntax of [custom aggregation expression](https://devnet.logianalytics.com/hc/en-us/articles/1500010034582-Business-View-Elements#Expression). Below are some summary expression examples:
...
6. Select **<New Crosstab Formula...>** in the Crosstab Formulas node in the Resources box.
   ...
   ![Add Fields to the Crosstab](https://devnet.logianalytics.com/hc/article_attachments/4404901324055/cmpnt_crstb_fmla1.gif)
7. In the Enter Crosstab Formula Name dialog, input **CustomAgg** and select **OK**. The [Crosstab Formula Editor](https://devnet.logianalytics.com/hc/en-us/articles/1500010030042-Crosstab-Formula-Editor-Dialog) is displayed.

   ![Create a Crosstab Formula](https://devnet.logianalytics.com/hc/article_attachments/4404909277847/cmpnt_crstb_fmla2.gif)
...
11. Select **Finish** to create the crosstab and preview it. The crosstab is shown somewhat as follows. You can see that in the aggregate cell, based on the formula expression, "N/A" is displayed if the price value equals to or is less than 5‰ of the grand total price $16,337.85, while the actual price is displayed if the price is more than 5‰ of the grand total price.
    ...
    ![Crosstab Result with Custom Aggregate Funtion](https://devnet.logianalytics.com/hc/article_attachments/4404909278103/cmpnt_crstb_fmla.gif)
...
* **Viewing properties of a****crosstab formula**  
   To view the properties of a crosstab formula, right-click the crosstab formula and select **Properties**. The [properties](https://devnet.logianalytics.com/hc/en-us/articles/1500010069121-Formula-Properties) are then displayed in the Properties dialog.
