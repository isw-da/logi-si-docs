...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009674121-Page-Report-Studio-Tag-Library
updated_at: 2021-07-24T20:53:52Z
---

# Page Report Studio Tag Library

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404920354071/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009674081-Advanced-Exporting-with-JSPs)   [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404920354327/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009644602-JDashboard)
...
Before you can use the Page Report Studio tag library in Logi JReport Server, you should first copy the file Jinfonet\_DHTML\_taglib.tld in `<intall_root>\public_html\dhtmljsp` to the folder where your JSP pages are located.
...
2. Add Jinfonet\_DHTML\_taglib.tld in `<intall_root>\public_html\dhtmljsp` to the war file in which your JSP pages reside, or alternatively, you can use web.xml to specify a path. For example,
...
| user - string | The user name for logging in Logi JReport Server. |
| password - string | The user password for logging in Logi JReport Server. |
