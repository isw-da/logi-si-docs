...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009749762-Record-Level-and-Column-Level-Security
updated_at: 2021-07-24T00:47:38Z
---

# Record Level and Column Level Security

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404880134167/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009749742-Cached-Report-Bursting)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404880134423/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009749722-Business-View-Security)
...
After setting up the security policy for a report in Designer, you can then publish it to Server as normal. Then, when you log onto the server as different users, you will find that Server applies the security settings to the report. That is, different users will only see the data they are supposed to see.

For more information, see Applying Record Level and Column Level Security in the *Logi Report Designer Guide*.

![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4404885305111/noteicon.jpg)Server may not recognize the users and roles that the report designer defined. If your security policies contain such users/roles, create these users and roles respectively in Server, and then in Designer, synchronize the security information with Server using the **Merge** option.
