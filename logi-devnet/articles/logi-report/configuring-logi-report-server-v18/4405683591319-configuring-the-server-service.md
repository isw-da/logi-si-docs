...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405683591319-Configuring-the-Server-Service
updated_at: 2022-01-27T07:58:32Z
---

# Configuring the Server Service

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420453372695/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405683585431-Initializing-the-Database-System-as-a-Non-admin-Database-User)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420453372951/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405690484631-Configuring-Connections)
...
1. On the system toolbar of the Server Console, navigate to **Administration** > **Configuration** > **Service**. Server displays the Service page.
   ...
   ![Service page](https://devnet.logianalytics.com/hc/article_attachments/4420461724183/config_service.gif)
...
6. Server selects **Enable Secure Socket Layer Connection** by default. It means that you can use HTTPS schema to visit the Logi Report Server UI in the standalone mode. You can configure the other SSL settings. For more information, see [Configuring SSL in Standalone Logi Report Server](#SSL).
7. The
...
Server enables SSL support by default. However, you still need to configure other settings in order to use HTTPS schema to visit Logi Report Server UI. You can achieve this either on the Server Console as an administrator or using the **server.properties** file in the `<install_root>\bin` directory.
