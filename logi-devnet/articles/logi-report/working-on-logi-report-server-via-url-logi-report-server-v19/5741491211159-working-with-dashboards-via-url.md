...
For example, run the URL `http://localhost:8888/dashboard/app/entry/run.jsp`, and JDashboard will be opened with a new blank dashboard in it. You can then begin to [build your dashboards](https://devnet.logianalytics.com/hc/en-us/articles/5741409582359-Creating-and-Saving-Dashboards).

## Visiting a Dashboard as the Server Home Page via URL

After you set a dashboard [as the Server Console home page](https://devnet.logianalytics.com/hc/en-us/articles/5741401720599-General-Operations-in-JDashboard#HomePage), you can use a URL to access the home page.
...
* jrd\_resext={  
  ...
  >  "type":40, // Indicate it
  > is a dashboard.  
  >  "param\_page":true, // Optional. Value: true/false. Specify whether to pop up the parameter dialog box if the dashboard uses parameters.   
  > "dsh\_params":[  
...
* jrd\_dashboard\_mode  
  ...
  + view - Open JDashboard in the view mode. [Execute permission](https://devnet.logianalytics.com/hc/en-us/articles/5741463668119-Managing-Permissions) is required.
  + edit - Open JDashboard in the edit mode. [Edit permission](https://devnet.logianalytics.com/hc/en-us/articles/5741463668119-Managing-Permissions) is required.If you do not have the corresponding permission on the dashboard, the dashboard will fail to run. When this property is not provided in the URL, the [default mode](https://devnet.logianalytics.com/hc/en-us/articles/5741409420567-Configuring-Server-Profile#JDashboardMode) of JDashboard specified in the server profile will be applied.
* jrd\_responsive  
  // Optional. Set this property to **false** to turn off [Responsive View](https://devnet.logianalytics.com/hc/en-us/articles/5741401720599-General-Operations-in-JDashboard#Responsive) in the view mode of JDashboard on computers.
...
* catalog\_security=[  
   // Optional. The [security file](https://devnet.logianalytics.com/hc/en-us/articles/5741483705367-Dynamic-Security) you want to apply to a catalog when running dashboards.
  > {
  >
...
* `http://localhost:8888/dashboard/app/entry/run.jsp?jrd_resext={"active":1,"reslst":[{"name":"/USERFOLDERPATH/admin/Dashboard 2.dsh"},{"name":"/USERFOLDERPATH/admin/Dashboard 1.dsh"}]}&jrd_dashboard_mode=view`
  ...
  The difference between this example and the second one is that the former runs JDashboard in the view mode while the later runs JDashboard in the mode set in the server preference.
...
> > >  "jrd\_datasources":[{datasource1},{datasource2},...] // See [Opening Web Reports in Web Report Studio Via JSON](https://devnet.logianalytics.com/hc/en-us/articles/5741456438167-Running-Reports-via-URL#JSON)for more information about using the property for web report.
> > >
> > > }
> >
> > ],
