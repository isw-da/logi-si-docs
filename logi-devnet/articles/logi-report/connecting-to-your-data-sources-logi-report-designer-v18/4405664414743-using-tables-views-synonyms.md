...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405664414743-Using-Tables-Views-Synonyms
updated_at: 2022-01-27T20:34:39Z
---

# Using Tables/Views/Synonyms

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420394625303/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405664413207-Using-DBMS-Objects-via-JDBC-Connections)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420394625687/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405661423383-Using-Stored-Procedures)
...
1. In the Catalog Manager resource tree, do one of the following:
   ...
   * Select the **Tables**/****Views****/****Synonyms**** node of the JDBC connection, or any existing table/view/synonym or folder in the connection and select **Add Tables**/**Views**/**Synonyms** on the Catalog Manager toolbar.
   ...
   Designer displays the [Add Tables/Views/Synonyms dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405661455639-Add-Tables-Views-Synonyms-Dialog-Box).

   ![Add Tables/Views/Synonyms dialog box](https://devnet.logianalytics.com/hc/article_attachments/4420402540439/addtbvwsynm.gif)
...
9. To add certain tables by name or by patterns in their name, select **Table Name Pattern**/**View Name Pattern**/**Synonym Name Pattern**. Designer then displays the wildcard "%" in the text box.
...
2. In the Move Table/Move View/Move Synonym dialog box, select the folder to which you want to place the table/view/synonym, then select **OK**.
   ...
   ![Move Table dialog box](https://devnet.logianalytics.com/hc/article_attachments/4420410859031/cnctn_jdbc_obj_mvtbl.gif)
...
2. In the Add Columns dialog box, select the required columns from the **Columns** box and select **Add**.
   ...
   ![Add Columns dialog box](https://devnet.logianalytics.com/hc/article_attachments/4420394873239/cnctn_jdbc_obj_addclm.gif)
...
2. Designer displays the data of this column in a list in a dialog box, which also includes other information including the field type, precision, scale, and number of records.
   ...
   ![Browse data of a column](https://devnet.logianalytics.com/hc/article_attachments/4420394873495/cnctn_jdbc_obj_brsdt.gif)
