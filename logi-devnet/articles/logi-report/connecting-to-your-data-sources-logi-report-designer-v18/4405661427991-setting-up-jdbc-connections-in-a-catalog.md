...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405661427991-Setting-Up-JDBC-Connections-in-a-Catalog
updated_at: 2022-01-27T20:34:40Z
---

# Setting Up JDBC Connections in a Catalog

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420394625303/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405664412311-Connecting-via-JDBC-Connections)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420394625687/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405664415895-Creating-JDBC-Connections-via-Plug-ins)

# Setting Up JDBC Connections in a Catalog

Logi Report supports most of the [relational databases](https://devnet.logianalytics.com/hc/en-us/articles/4405661784855-Supported-Report-Databases) which support JDBC drivers. Via specific JDBC drivers, you can create connections which connect catalogs to different relational databases. This topic describes how you can set up JDBC drivers for the Logi Report products and create connections in a catalog via the JDBC drivers.
...
1. In Designer, [create a catalog](https://devnet.logianalytics.com/hc/en-us/articles/4405661330711-Creating-Opening-and-Saving-Catalogs) or [open a catalog](https://devnet.logianalytics.com/hc/en-us/articles/4405661330711-Creating-Opening-and-Saving-Catalogs#Open).
...
3. In the [Get JDBC Connection Information dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405661634839-Get-JDBC-Connection-Information-Dialog-Box), provide the necessary information to connect with the database.

   ![Get JDBC Connection Information dialog box](https://devnet.logianalytics.com/hc/article_attachments/4420410692759/jdbccnnctn.gif)

   You can set up a JDBC connection using one of the following methods:
...
6. Select **OK** to set up the connection. Designer then displays a message box, showing the status of connecting to the database.
   ...
   Upon finishing setting up the connection, Designer displays the Add Tables/Views/Synonyms dialog box, prompting you to [add tables from the database](https://devnet.logianalytics.com/hc/en-us/articles/4405664414743-Using-Tables-Views-Synonyms#Add) to the catalog. If you want to add tables later, select **Done**.

You can also use the [connection plug-ins](https://devnet.logianalytics.com/hc/en-us/articles/4405664415895-Creating-JDBC-Connections-via-Plug-ins) Designer provides to connect to the Oracle, MySQL, SQL Server, InterSystems IRIS, and PostgreSQL databases in an easy way.

![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4420394642839/noteicon.jpg) If you want to use the DB2 app connection, you need to install the client and configure the net address first.
...
5. Type the user name **dbadmin** and password **test1234** respectively.
   ...
   ![Get JDBC Connection Information dialog box](https://devnet.logianalytics.com/hc/article_attachments/4420402546967/cnctn_jdbc_set_rds.gif)
...
5. Type the user name **dbadmin** and password **test1234** respectively.
   ...
   ![Get JDBC Connection Information dialog box](https://devnet.logianalytics.com/hc/article_attachments/4420402547223/cnctn_jdbc_set_redshift.gif)
6. Select **OK** to set up the connection.
...
6. Add **weblogic.jar** to **setenv.bat**.
   ...
   To connect via the WebLogic Connection Pool in Designer, you first need to add weblogic.jar in `<weblogic_install_root>\wlserver6.1\lib` to the ADDCLASSPATH variable of setenv.bat. In this example, supposing that you have installed Designer in `C:\LogiReport\Designer`, and WebLogic in `C:\bea`, modify setenv.bat in `C:\LogiReport\Designer\bin` to add `C:\bea\wlserver6.1\lib\weblogic.jar` to the ADDCLASSPATH variable as follows:
...
![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4420394642839/noteicon.jpg) Designer does not support the data types longbarbinary and BigDecimal when you use a WebLogic Connection Pool.
