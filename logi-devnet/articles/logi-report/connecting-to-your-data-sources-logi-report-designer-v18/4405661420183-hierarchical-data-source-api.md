...
This interface provides data to Logi Report for generating reports. The JRHierarchicalDataset class is developed by users of Logi Report, and can provide data from a flat file, non-relational database, or application data.
...
This interface provides metadata for JRHierarchicalDataset. The JRHierarchicalDatasetMetaData class is developed by users of Logi Report, and it works together with a JRHierarchicalDataset.
