...
![XSD syntax diagram](https://devnet.logianalytics.com/hc/article_attachments/4420542184471/cnctn_xml_imprt_xsd1.gif)
...
* **Element Declaration::=**
  ...
  ![Element Declaration diagram](https://devnet.logianalytics.com/hc/article_attachments/4420550956823/cnctn_xml_imprt_xsd2.gif)
...
* **SimpleType::=**
  ...
  ![SimpleType diagram](https://devnet.logianalytics.com/hc/article_attachments/4420542184727/cnctn_xml_imprt_xsd3.gif)
...
* **Anonymous SimpleType Definition::=**
  ...
  ![Anonymous SimpleType Definition diagram](https://devnet.logianalytics.com/hc/article_attachments/4420556225559/cnctn_xml_imprt_xsd4.gif)
...
* **SimpleType Definition::=**
  ...
  ![SimpleType Definition diagram](https://devnet.logianalytics.com/hc/article_attachments/4420556225815/cnctn_xml_imprt_xsd5.gif)
...
* **ComplexType::=**
  ...
  ![ComplexType diagram](https://devnet.logianalytics.com/hc/article_attachments/4420550958615/cnctn_xml_imprt_xsd6.gif)
...
* **Anonymous ComplexType Definition::=**
  ...
  ![Anonymous ComplexType Definition diagram](https://devnet.logianalytics.com/hc/article_attachments/4420542185367/cnctn_xml_imprt_xsd7.gif)
...
* **ComplexType Definition::=**
  ...
  ![ComplexType Definition diagram](https://devnet.logianalytics.com/hc/article_attachments/4420556226327/cnctn_xml_imprt_xsd8.gif)
...
* **All::=**
  ...
  ![All diagram](https://devnet.logianalytics.com/hc/article_attachments/4420550959383/cnctn_xml_imprt_xsd9.gif)
...
* **Choice::=**
  ...
  ![Choice diagram](https://devnet.logianalytics.com/hc/article_attachments/4420542185879/cnctn_xml_imprt_xsd10.gif)
...
* **Sequence::=**
  ...
  ![Sequence diagram](https://devnet.logianalytics.com/hc/article_attachments/4420542185879/cnctn_xml_imprt_xsd10.gif)
...
In order to provide precision schemas to transform, in the process of transforming an XML schema to relational tables, you can modify the properties or supplement some necessary information for the imported XML schemas according to your own requirements, so that they can be more useful to you. For more information about the properties, see [XML Schema Properties](https://devnet.logianalytics.com/hc/en-us/articles/4405664644503-XML-Schema-Properties). The following describes more about the Format Pattern property.
...
* Designer transforms a simple element in the XML schema according to the two rules:
  ...
  ![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4420542072599/noteicon.jpg) The value of the Is Multiple property of a simple element is defined by the value of its maxOccurs property in the XSD. If you modify it and make it not match with the maxOccurs property in the transformation process, Designer transforms the element according to the Is Multiple property, regardless of the maxOccurs property. The following are the two conditions:
...
* Designer transforms a complex element in the XML schema to a relational table. Contents of complex elements may contain three kinds of subnodes: text, simple element, and subcomplex element.
...
In the example, Employee is a simple element and its Is Multiple property is "true" according to the value of maxOccurs in the XSD which is 10, so Designer transforms it to the Employee table and contents of the simple element to records of a column with the same name as the Employee table.
...
![Table transformed from the parent element of the simple element in XML instance](https://devnet.logianalytics.com/hc/article_attachments/4420556226583/cnctn_xml_trnsfrm_rule2.gif)
...
![Table transformed from the parent element/](https://devnet.logianalytics.com/hc/article_attachments/4420556226839/cnctn_xml_trnsfrm_rule3.gif)
...
![Table transformed from sub-elements](https://devnet.logianalytics.com/hc/article_attachments/4420556227095/cnctn_xml_trnsfrm_rule4.gif)
...
![Table transformed from a complex element](https://devnet.logianalytics.com/hc/article_attachments/4420542186135/cnctn_xml_trnsfrm_rule1.gif)
