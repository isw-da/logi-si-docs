...
1. In the Catalog Manager, select the data source to create queries, then select **Show Properties** to expand the Properties sheet.
...
* If Designer needs other tables to bridge the tables you select to add to a query, Designer prompts you whether to add the other tables at the same time. For example,
  ...
  ![Diagram of pre-join lacking of a bridge tables](https://devnet.logianalytics.com/hc/article_attachments/4420410610071/qury_prjn1.gif)
...
* If there is more than one path available in the pre-joins, for example,
  ...
  ![Diagram of pre-join with more than one path](https://devnet.logianalytics.com/hc/article_attachments/4420394663831/qury_prjn2.gif)
