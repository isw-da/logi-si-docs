...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010062642-Locking-Queries
updated_at: 2021-07-23T19:16:47Z
---

# Locking Queries

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404856790679/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010062702-Working-with-Union-Queries)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404856790935/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010062622-Applying-the-Filter-of-a-Query-to-Multiple-Queries)
...
1. In the Catalog Manager, right-click the query you want to claim and select **Create User** from the shortcut menu. Designer displays the [Create Query's Username and Password dialog box](https://devnet.logianalytics.com/hc/en-us/articles/1500010095921-Create-Query-s-Username-and-Password-Dialog-Box).

   ![Create Query's Username and Password dialog box](https://devnet.logianalytics.com/hc/article_attachments/4404848426391/crtqrynmpw.gif)
2. Type in the user name and password.
3. Select **OK** to confirm the information.

After creating a user for a query, you can also modify the user information or remove the user as required.
...
3. In the [Create Query's Username and Password dialog box](https://devnet.logianalytics.com/hc/en-us/articles/1500010095921-Create-Query-s-Username-and-Password-Dialog-Box), type in the new user name and password and select **OK**.

* To remove a user, right-click the query and select **Delete User** on the shortcut menu. In the Remove User dialog box, provide the user and password information and select **OK**. The query is then free to be shared.
...
2. In the Set Query's Share Property dialog box, provide the user information and select or clear the **Share** option as required.

   ![Set Query's Share Property dialog box](https://devnet.logianalytics.com/hc/article_attachments/4404848426647/qury_lock_share.gif)
