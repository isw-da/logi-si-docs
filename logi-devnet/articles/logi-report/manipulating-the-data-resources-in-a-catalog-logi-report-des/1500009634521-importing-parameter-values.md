...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009634521-Importing-Parameter-Values
updated_at: 2021-07-24T16:03:50Z
---

# Importing Parameter Values

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404911578903/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009634541-Specifying-Parameter-Values) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404911579543/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009611122-Formulas)

# Importing Parameter Values

When you run a report with parameters, Logi Report will prompt you the Enter Parameter Values dialog to [specify the parameter values](https://devnet.logianalytics.com/hc/en-us/articles/1500009634541-Specifying-Parameter-Values). The default values shown in the dialog are fixed at development time. However showing a default, fixed value often is not useful to users.
...
3. Append the class path to the ADDCLASSPATH variable of the file setenv.bat/setenv.sh in `<install_root>\bin` for both Logi Report Designer and Logi Report Server.
...
3. Compile ParamTest.java to generate ParamTest.class, and store the class file in `C:\LogiReport\Designer\help`.  
     
   `javac -classpath C:\LogiReport\Designer\lib\JREngine.jar; ParamTest.java`
4. Append `C:\LogiReport\Designer\help` to the ADDCLASSPATH variable of setenv.bat in `C:\LogiReport\Designer\bin`.
5. Restart Logi Report Designer and open Report1.
6. In the Report Inspector, find the report property **Import Parameter Values** and specify the class name with the full package name. In this example, type **help.ParamTest**, and then set the property Parameter List Auto to **false**.
   ...
   **Tip:** The report node is not shown in the resource tree of the Report Inspector by default. To have it shown, select the report tab node in the tree (in this example, the report 1 node), and then select the **Up** button ![Up button](https://devnet.logianalytics.com/hc/article_attachments/4404911587607/btn_up.gif) on the Report Inspector toolbar.
...
10. [Publish the saved report](https://devnet.logianalytics.com/hc/en-us/articles/1500009636101-Publishing-and-Downloading-Resources#Remotely) Report1 to Logi Report Server.
11. Append `C:\LogiReport\Designer\help` to the ADDCLASSPATH variable of setenv.bat in `<server_install_root>\bin`.
12. Start Logi Report Server with the modified batch file.
13. Load your web browser to access the Logi Report Server console. You will then have the same parameter values as you did in Logi Report Designer.
...
3. Start Logi Report Designer.
4. Create a report with a [dynamic group/sort](https://devnet.logianalytics.com/hc/en-us/articles/1500009611482-Parameter-Application-Cases#DynamicData) using the parameter ImportPara.
