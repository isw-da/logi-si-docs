...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010061022-Formula-Levels
updated_at: 2021-07-23T19:16:13Z
---

# Formula Levels

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404856790679/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010060962-Working-with-Formulas)[Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404856790935/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010061042-Formula-Syntax)
...
![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4404856814359/noteicon.jpg) Logi Report Engine makes several passes over the data to determine when it executes formulas. Even though an individual formula appears to be a certain level, if it references anything in the higher level, it also becomes the higher level formula.

## Constant Level Formulas

A constant level formula is a formula that does not refer to any DBFields, summaries, global variables, [page level special fields](https://devnet.logianalytics.com/hc/en-us/articles/1500010060982-Creating-Formulas-in-a-Catalog#PageLevel) (the value of the special field is ready at the time when Logi Report Engine generates the report result), or other non-constant formulas. For example, `return CurrentDate()` is a constant level formula.
...
![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4404856814359/noteicon.jpg) You can use report global and global variables only in page reports.
...
Logi Report calculates the page level formulas in the exact sequence of the panels as Logi Report Engine lays out them. Thus, if a page level formula includes any of the page level special fields, Logi Report calculates it in the detail or group header and footer exactly in the order they are laid out. In the above example, if you want to do a running total on each detail, the formula expression is as follows:
