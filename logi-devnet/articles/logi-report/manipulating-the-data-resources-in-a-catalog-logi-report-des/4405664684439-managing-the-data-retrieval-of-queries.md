...
* Select the Refetch Data button ![Refetch Data button](https://devnet.logianalytics.com/hc/article_attachments/4420542071447/btn_refetchdt.gif) on the toolbar of the View tab to run the report again if you find that the specified properties do not take effect.
...
5. In the Catalog Manager or the Data panel, right-click the query the report uses and select **Data Manager** from the shortcut menu. Designer displays the [Data Manager dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405661496855-Data-Manager-Dialog-Box).

   ![Data Manager dialog box](https://devnet.logianalytics.com/hc/article_attachments/4420550839063/dtmngr.gif)
...
7. Use the query Payroll to [create another page report](https://devnet.logianalytics.com/hc/en-us/articles/4405661926423-Creating-Reports#Page) report1.cls.
...
2. [Publish a page report](https://devnet.logianalytics.com/hc/en-us/articles/4405661923607-Publishing-and-Downloading-Resources#Remotely) that has its query properties Maximum Rows and/or Maximum Duration set together with its catalog to Server.
