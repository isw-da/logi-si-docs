...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009636081-Creating-Union-Queries
updated_at: 2021-07-24T16:03:24Z
---

# Creating Union Queries

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404911578903/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009636061-Using-Pre-joins-in-Queries) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404911579543/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009636021-Using-a-Query-to-Filter-Multiple-Queries)
...
4. A new Query Editor is displayed. [Create the query](https://devnet.logianalytics.com/hc/en-us/articles/1500009635981-Creating-Queries-in-a-Catalog) as required.
...
2. In the Query Editor, select **Menu** > **Query** > **Union** > **Select**. The Union dialog appears.
   ...
   ![Union dialog](https://devnet.logianalytics.com/hc/article_attachments/4404911631895/qury_union.gif)
3. To add a union to the query, select a union in the Queries box and select ![Add button](https://devnet.logianalytics.com/hc/article_attachments/4404904175639/btn_addarrow.gif). To remove a union from the query, select it in the Union box, and then select ![Remove button](https://devnet.logianalytics.com/hc/article_attachments/4404911602327/btn_rmvarrow.gif).
4. In the Union box, select the Attribute column to specify the type of the union.
   * ![No Duplicate Records button](https://devnet.logianalytics.com/hc/article_attachments/4404911632407/qury_union1.gif): No duplicate records will be returned.
   * ![All Records button](https://devnet.logianalytics.com/hc/article_attachments/4404904194327/qury_union2.gif): All records will be returned.
