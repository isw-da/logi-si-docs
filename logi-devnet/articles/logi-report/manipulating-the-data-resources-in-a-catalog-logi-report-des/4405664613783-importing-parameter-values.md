...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405664613783-Importing-Parameter-Values
updated_at: 2022-01-27T20:34:50Z
---

# Importing Parameter Values

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420556069783/back.png)Yi Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405661802903-Specifying-Parameter-Values)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420550802199/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405664600343-Working-with-Formulas)

# Importing Parameter Values

When you run a report with parameters, Logi Report prompts you to specify the parameter values. The values shown in the UIs for specifying the parameter values are fixed at development time; however, showing a default, fixed value at runtime is often not useful to users. Therefore, Logi Report provides you the interface jet.util.ImportParamValues for importing different default values from outside class files, so that you can specify the default values flexibly. This topic describes how you can implement the interface to import parameter values.
...
1. Define a Java class file. Refer to the sample program **ParamTest.java** and **TestParamList.java** in `<install_root>\help\samples\APIParameter` for additional information. To import parameter values, implement the interface jet.util.ImportParamValues in your Java file. The class definition may be:
...
2. [Create a page report with a Group Above table in it](https://devnet.logianalytics.com/hc/en-us/articles/4405661926423-Creating-Reports#Page) based on the query **CascadeParameter** in Data Source 1, which displays **Order Date** and **Order ID** as the detail fields, and is grouped by **Shipper Territory**.
...
7. In the Report Inspector, find the report property **Import Parameter Values** and specify the class name with the full package name. In this example, type **help.ParamTest**, and then set the property **Parameter List Auto** to **false**.
   ...
   ![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4420542072599/noteicon.jpg) You cannot see the report node in the resource tree of the Report Inspector by default. To show it, select the report tab node in the tree (in this example, the **report 1** node), and then select **Up**![Up button](https://devnet.logianalytics.com/hc/article_attachments/4420550817175/btn_forwd.gif) on the Report Inspector toolbar.
...
12. [Publish the report](https://devnet.logianalytics.com/hc/en-us/articles/4405661923607-Publishing-and-Downloading-Resources#Remotely) to Server.
...
3. Start Designer.
4. Create a report with a [dynamic group/sort](https://devnet.logianalytics.com/hc/en-us/articles/4405661801239-Parameter-Application-Cases#DynamicData) using the parameter **ImportPara**.
