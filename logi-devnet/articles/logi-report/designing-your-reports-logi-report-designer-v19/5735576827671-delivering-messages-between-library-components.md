...
url: https://devnet.logianalytics.com/hc/en-us/articles/5735576827671-Delivering-Messages-Between-Library-Components
updated_at: 2022-11-02T08:23:00Z
---

# Delivering Messages Between Library Components

[![Back](https://devnet.logianalytics.com/hc/article_attachments/9898402961815/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/5735534296599-Using-Dynamic-Resources-and-Local-Parameters-in-a-Report)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/9898402971543/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/5735534125591-Creating-Bursting-Reports)
...
* [Example: Delivering a Message Between Library Components](#Example)
...
A message consists of the message ID, message name, and message value set. A message ID is a natural number. Logi Report reserves the IDs from 1 to 1000, which are used for built-in messages, so you can only use IDs beyond 1000 to identify user-defined messages. A message name is the name of a message. A message value set is a set of key-value pairs. Each key-value pair has one key and one value. A key or a value can be static or dynamic. A key is of the String data type, and each value has its own data type, which can be Number, Integer, String, Date, Time, DateTime, Boolean, or Currency.
...
* **Parameter**  
  ...
  ![Note icon](https://devnet.logianalytics.com/hc/article_attachments/9898403122327/noteicon.jpg) For compatibility with earlier versions, Designer converts the Parameter message defined in a previous version to the Customized type and the Parameters message to the Automatic type.
* **On-screen Filter**  
...
* If you select Customize, you can define the message by yourself in the [Send Message dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5735552784023-Send-Message-Dialog-Box).

  ![Send Message dialog box](https://devnet.logianalytics.com/hc/article_attachments/9898423073943/sndmsg.gif)

  1. Select a [trigger event](https://devnet.logianalytics.com/hc/en-us/articles/9898540480023-Defining-Web-Behaviors-of-Objects-in-a-Report#Event) in the **Events** box, then select on the name of the event to select it.
  2. From the **Message** drop-down list, select the [message](#Type) you want to send out when the specified event occurs on the object at runtime.
  3. Define the message.
     ...
     + For a user-defined message,
       ...
       2. Select **Add**![Add button](https://devnet.logianalytics.com/hc/article_attachments/9898403108631/btn_add.gif) to add a message key-value line.
       ...
       6. Add more key-value lines and specify the key, data type, and value in each line. To delete a message key-value line, select it and select **Remove**![Trash Can button](https://devnet.logianalytics.com/hc/article_attachments/9898403114647/btn_trashcan.gif). You can also use **Move Up**![Move Up button](https://devnet.logianalytics.com/hc/article_attachments/9898406165911/btn_mvup.gif) and **Move Down**![Move Down button](https://devnet.logianalytics.com/hc/article_attachments/9898423100695/btn_mvdwn.gif) to adjust the order of the message key-value lines.

       ![Note icon](https://devnet.logianalytics.com/hc/article_attachments/9898403122327/noteicon.jpg) You can also create a blank user-defined message by only specifying the ID and name of the message.
...
In addition to the previous method, you can also use the [Send Message web action](https://devnet.logianalytics.com/hc/en-us/articles/9898540480023-Defining-Web-Behaviors-of-Objects-in-a-Report#SendMessage) to send out messages.
...
1. Right-click the data component and select **Receive Message** from the shortcut menu. Designer displays the [Receive Message dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5735567115287-Receive-Message-Dialog-Box).

   ![Receive Message dialog box](https://devnet.logianalytics.com/hc/article_attachments/9898423112087/rcvmsg.gif)
2. Select **Add**![Add button](https://devnet.logianalytics.com/hc/article_attachments/9898403108631/btn_add.gif) to add a message line.
...
4. If you select a built-in message, you cannot change the action the message responds, but you can edit how to perform the action as you want. If you select a user-defined message, you can specify the action the data component responds when it receives the message and define how to perform the action.
5. Repeat the preceding steps to add more messages to receive and define the actions to respond the messages.
   To delete a message, select it and select **Remove**![Trash Can button](https://devnet.logianalytics.com/hc/article_attachments/9898403114647/btn_trashcan.gif). You can also use **Move Up**![Move Up button](https://devnet.logianalytics.com/hc/article_attachments/9898406165911/btn_mvup.gif) and **Move Down**![Move Down button](https://devnet.logianalytics.com/hc/article_attachments/9898423100695/btn_mvdwn.gif) to adjust the display order of the messages in the message box.
6. Select **OK** to finish setting the messages the data component is going to receive.

![Note icon](https://devnet.logianalytics.com/hc/article_attachments/9898403122327/noteicon.jpg) In the drop-down lists for editing the conditions to respond a message, you may find that some items have the icon ![Message Key icon](https://devnet.logianalytics.com/hc/article_attachments/9898423137431/btn_msgkey.gif) ahead of them and they are listed under the Message Key node. If you choose an item of this type, it means that at runtime Logi Report Engine does not use the item directly in a condition, instead, it maps the item to a key in the message and finds the value that users specify to the key from the message first and then uses that value to compose the condition.
...
2. If you want to edit the filter condition, select in the **Actions** column and select the **ellipsis**![Ellipsis button](https://devnet.logianalytics.com/hc/article_attachments/9898423153431/btn_ellipsis1.gif). Designer displays the [Filter dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5735509055895-Filter-Dialog-Box).

   ![Filter dialog box](https://devnet.logianalytics.com/hc/article_attachments/9898423171863/fltr2.gif)
3. Specify the filter condition by selecting the field based on which to filter the data component from the **Filter On** drop-down list, the operator to compose the condition from the **Operator** drop-down list, and the value of how to filter the field from the **Value** drop-down list (to specify the value by yourself, select **<Input...>** and type the value in the text box).
   ...
   ![Note icon](https://devnet.logianalytics.com/hc/article_attachments/9898403122327/noteicon.jpg) When you type the value, if multiple values are required, you should separate them with ","; if a value contains the character "," or "\", type the character as "\," or "\\".
...
2. If you want to edit the sort condition, select in the **Actions** column and select the **ellipsis**![Ellipsis button](https://devnet.logianalytics.com/hc/article_attachments/9898423153431/btn_ellipsis1.gif). Designer displays the [Sort dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5735515567127-Sort-Dialog-Box).

   ![Receive Message dialog box](https://devnet.logianalytics.com/hc/article_attachments/9898423192983/sort.gif)
...
5. Adjust the order of the sort conditions using **Move Up**![Move Up button](https://devnet.logianalytics.com/hc/article_attachments/9898406165911/btn_mvup.gif) and **Move Down**![Move Down button](https://devnet.logianalytics.com/hc/article_attachments/9898423100695/btn_mvdwn.gif). The order determines the sort priority of the conditions at runtime.
...
2. Choose a message type from the **Message Info** column: Automatic or Customized.
   * When you select **Automatic**, Designer automatically applies all the parameter values specified in the sent message. If you want to edit the parameters,
     1. Select in the **Actions** column and select the **ellipsis**![Ellipsis button](https://devnet.logianalytics.com/hc/article_attachments/9898423153431/btn_ellipsis1.gif). Designer displays the [Parameter dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5735524288151-Parameter-Dialog-Box#BParam).
     ...
     3. Select **Add**![Add button](https://devnet.logianalytics.com/hc/article_attachments/9898403108631/btn_add.gif) to add more parameter lines to specify other parameter values. If you specify a parameter value more than once, the last setting takes effect. To delete a parameter, select it and select **Remove**![Trash Can button](https://devnet.logianalytics.com/hc/article_attachments/9898403114647/btn_trashcan.gif). You can also use **Move Up**![Move Up button](https://devnet.logianalytics.com/hc/article_attachments/9898406165911/btn_mvup.gif) and **Move Down**![Move Down button](https://devnet.logianalytics.com/hc/article_attachments/9898423100695/btn_mvdwn.gif) to adjust the order of the parameter lines.
   ...
   * When you select **Customized**, Designer automatically applies the parameter value defined in the sent message. If you want to edit the parameter,
     1. Select in the **Actions** column and select the **ellipsis**![Ellipsis button](https://devnet.logianalytics.com/hc/article_attachments/9898423153431/btn_ellipsis1.gif) to open the Parameter dialog box.

        ![Parameter dialog box](https://devnet.logianalytics.com/hc/article_attachments/9898423217303/prm1.gif)
...
2. If you want to edit the filter condition, select in the **Actions** column and select the **ellipsis**![Ellipsis button](https://devnet.logianalytics.com/hc/article_attachments/9898423153431/btn_ellipsis1.gif). Designer displays the [On-screen Filter dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5735543893271-On-screen-Filter-Dialog-Box).

   ![On-screen Filter dialog box](https://devnet.logianalytics.com/hc/article_attachments/9898473559191/onscrnfltr.gif)
3. Specify the filter condition by selecting the field based on which to filter the data component from the **Filter On** drop-down list, and the value of how to filter the field from the **Value** drop-down list (to specify the value by yourself, select **<Input...>** and type the value in the text box).
   ...
   ![Note icon](https://devnet.logianalytics.com/hc/article_attachments/9898403122327/noteicon.jpg) When you type the value, if multiple values are required, you should separate them with ","; if a value contains the character "," or "\", type the character as "\," or "\\".
4. Select **Add**![Add button](https://devnet.logianalytics.com/hc/article_attachments/9898403108631/btn_add.gif) to add more condition lines and specify the filter conditions. To delete a filter condition, select it and select **Remove**![Trash Can button](https://devnet.logianalytics.com/hc/article_attachments/9898403114647/btn_trashcan.gif).
...
1. In the Receive Message dialog box, specify the ID and name of the user-defined message in the **Message ID** and **Message Name** columns respectively, then select in the **Actions** column and select the **ellipsis**![Ellipsis button](https://devnet.logianalytics.com/hc/article_attachments/9898423153431/btn_ellipsis1.gif).
2. In the [Web Action List dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5735531755159-Web-Action-List-Dialog-Box), select **\*Filter** in the **Action Name** column and select **OK**.
...
1. In the Receive Message dialog box, specify the ID and name of the user-defined message in the **Message ID** and **Message Name** columns respectively, then select in the **Actions** column and select the **ellipsis**![Ellipsis button](https://devnet.logianalytics.com/hc/article_attachments/9898423153431/btn_ellipsis1.gif).
2. In the [Web Action List dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5735531755159-Web-Action-List-Dialog-Box), select **\*On-screen Filter** in the **Action Name** column and select **OK**.
...
1. In the Receive Message dialog box, specify the ID and name of the user-defined message in the **Message ID** and **Message Name** columns respectively, then select in the **Actions** column and select the **ellipsis**![Ellipsis button](https://devnet.logianalytics.com/hc/article_attachments/9898423153431/btn_ellipsis1.gif).
2. In the [Web Action List dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5735531755159-Web-Action-List-Dialog-Box), select **\*Remove Filter** in the **Action Name** column and select **OK**. Designer displays the [Remove Filter dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5735515281559-Remove-Filter-Dialog-Box).

   ![Remove Filter dialog box](https://devnet.logianalytics.com/hc/article_attachments/9898473578647/rmvfltr.gif)
...
4. By default, JDashboard removes all the on-screen filters from the data component when it receives the message at runtime if you select Remove \*On-screen Filters. If you only want to remove the filter conditions that are related to certain data fields, clear **All Fields**, then select **Add**![Add button](https://devnet.logianalytics.com/hc/article_attachments/9898403108631/btn_add.gif) to add a field line, select in the line and select a field from the drop-down list or select **<Input...>** and type the field name in the text box. Repeat this to add all the required fields. To delete a field, select it and select **Remove**![Trash Can button](https://devnet.logianalytics.com/hc/article_attachments/9898403114647/btn_trashcan.gif).
5. Select **OK** to accept the settings.
...
1. In the Receive Message dialog box, specify the ID and name of the user-defined message in the **Message ID** and **Message Name** columns respectively, then select in the **Actions** column and select the **ellipsis**![Ellipsis button](https://devnet.logianalytics.com/hc/article_attachments/9898423153431/btn_ellipsis1.gif).
2. In the Web Action List dialog box, select **\*Parameter** in the **Action Name** column and select **OK**. Designer displays the [Parameter dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5735524288151-Parameter-Dialog-Box#UParam).
...
4. Specify how to apply the action: run another library component or refresh the current library component.
...
7. Select **Add**![Add button](https://devnet.logianalytics.com/hc/article_attachments/9898403108631/btn_add.gif) to add more parameter lines to specify other parameter values. To delete a parameter, select it and select **Remove**![Trash Can button](https://devnet.logianalytics.com/hc/article_attachments/9898403114647/btn_trashcan.gif). You can also use **Move Up**![Move Up button](https://devnet.logianalytics.com/hc/article_attachments/9898406165911/btn_mvup.gif) and **Move Down**![Move Down button](https://devnet.logianalytics.com/hc/article_attachments/9898423100695/btn_mvdwn.gif) to adjust the order of the parameter lines.
...
1. In the Receive Message dialog box, specify the ID and name of the user-defined message in the **Message ID** and **Message Name** columns respectively, then select in the **Actions** column and select the **ellipsis**![Ellipsis button](https://devnet.logianalytics.com/hc/article_attachments/9898423153431/btn_ellipsis1.gif).
2. In the Web Action List dialog box, select **\*Property** in the **Action Name** column and select **OK**. Designer displays the [Change Property dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5735565102615-Change-Property-Dialog-Box).

   ![Change Property dialog box](https://devnet.logianalytics.com/hc/article_attachments/9898406354711/chgpty.gif)
...
1. In the Receive Message dialog box, specify the ID and name of the user-defined message in the **Message ID** and **Message Name** columns respectively, then select in the **Actions** column and select the **ellipsis**![Ellipsis button](https://devnet.logianalytics.com/hc/article_attachments/9898423153431/btn_ellipsis1.gif).
2. In the Web Action List dialog box, select **\*Go Down** in the **Action Name** column and select **OK**. Designer displays the [Go Down dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5735529999511-Go-Down-Dialog-Box).

   ![Go Down dialog box](https://devnet.logianalytics.com/hc/article_attachments/9898406367895/godwn.gif)
...
1. In the Receive Message dialog box, specify the ID and name of the user-defined message in the **Message ID** and **Message Name** columns respectively, then select in the **Actions** column and select the **ellipsis**![Ellipsis button](https://devnet.logianalytics.com/hc/article_attachments/9898423153431/btn_ellipsis1.gif).
2. In the Web Action List dialog box, select **\*Go Up** in the **Action Name** column and select **OK**. Designer displays the [Go Up dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5735514552215-Go-Up-Dialog-Box).

   ![Go Up dialog box](https://devnet.logianalytics.com/hc/article_attachments/9898473633687/goup.gif)
...
1. In the Receive Message dialog box, specify the ID and name of the user-defined message in the **Message ID** and **Message Name** columns respectively, then select in the **Actions** column and select the **ellipsis**![Ellipsis button](https://devnet.logianalytics.com/hc/article_attachments/9898423153431/btn_ellipsis1.gif).
2. In the Web Action List dialog box, select **\*Go To** in the **Action Name** column and select **OK**. Designer displays the [Go To dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5735523494423-Go-To-Dialog-Box).
...
2. Use the business view **SaleStat** in Data Source 1 of the catalog to [create two library components](https://devnet.logianalytics.com/hc/en-us/articles/5735569787671-Creating-Reports#LC) and save them as "Component 1.lc" and "Component 2.lc".
...
6. Select **Add**![Add button](https://devnet.logianalytics.com/hc/article_attachments/9898403108631/btn_add.gif) to add a message line.
...
8. Select **Current Value** from the drop-down list in the **Value** column. Designer displays **String** automatically in the **Data Type** column.
   ...
   ![Send Message dialog box](https://devnet.logianalytics.com/hc/article_attachments/9898406409495/rpt_lc_msg_eg_send.gif)
...
5. Select in the **Actions** column and select the **ellipsis**![Ellipsis button](https://devnet.logianalytics.com/hc/article_attachments/9898423153431/btn_ellipsis1.gif).

   ![Receive Message dialog box](https://devnet.logianalytics.com/hc/article_attachments/9898473689111/rpt_lc_msg_eg_recv1.gif)
...
7. Select **Assigned Region** from the **Filter On** drop-down list, keep the default operator, then select **<Input>** under the **Message Key** node in the **Value** drop-down list and type **Assigned Region**. Select **OK** to apply the filter condition in the message.
   ...
   ![Filter dialog box](https://devnet.logianalytics.com/hc/article_attachments/9898456802711/rpt_lc_msg_eg_recv2.gif)
8. In the Receive Message dialog box, select **OK** to finish defining the message the chart receives.

   ![Receive Message dialog box](https://devnet.logianalytics.com/hc/article_attachments/9898456814103/rpt_lc_msg_eg_recv3.gif)
...
3. Drag the two library components to the dashboard.
   ...
   ![Components in Dashboard](https://devnet.logianalytics.com/hc/article_attachments/9898456835223/rpt_lc_msg_eg_msg1.gif)
4. Select **Asia-Pacific** in the chart legend to send out the message. JDashboard filters both the chart and the crosstab to show data in the Asia-Pacific region only.
   ...
   ![Data in the Asia-Pacific Region for Chart and Crosstab](https://devnet.logianalytics.com/hc/article_attachments/9898473774871/rpt_lc_msg_eg_msg2.gif)
5. Select **Clear Filters**![](https://devnet.logianalytics.com/hc/article_attachments/9898456866071/rpt_lc_msg_eg_clrfltr.gif) on the toolbar to clear the filter in both components.
6. Select **Europe, Middle East, Africa** in the chart legend. The chart and crosstab now shows data for this region.

   ![Data in Europe, Middle East, and Africa for Chart and Crosstab](https://devnet.logianalytics.com/hc/article_attachments/9898473822743/rpt_lc_msg_eg_msg3.gif)
