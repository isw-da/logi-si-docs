...
url: https://devnet.logianalytics.com/hc/en-us/articles/5735534254999-Managing-Page-Reports
updated_at: 2022-11-02T08:22:59Z
---
...
![Manage Page Reports](https://devnet.logianalytics.com/hc/article_attachments/9898456893207/rpt_mng.gif)

### Adding a Folder

1. Select a folder and select **New Folder** on the toolbar, or right-click a folder and select **New Folder** from the shortcut menu. Designer then adds a new folder as a subnode, and the default name for the folder is Folder1, Folder2.... You can rename the folder.
...
2. The Move To box lists all the available folders. Select the folder to which you want to move the folder/report.
   ...
   ![Move Report](https://devnet.logianalytics.com/hc/article_attachments/9898456919319/rpt_mng_move.gif)
...
You can use the search box to search for the properties you want to edit (to display the search box, select the **Search** icon ![Search icon](https://devnet.logianalytics.com/hc/article_attachments/9898421903255/btn_srch.gif) at the upper right corner of the Properties sheet). To start searching, type the text you want to search for in the search box and Designer lists the properties containing the matched text. Designer closes the search box when you select another object.
...
1. Select a folder and right-click it, then select **Search** on the shortcut menu. Designer displays the [Search Reports dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5735567555223-Search-Reports-Dialog-Box).

   ![Search Reports](https://devnet.logianalytics.com/hc/article_attachments/9898456938007/srchrpt.gif)
2. In the **Find what** text box, type the report or folder name, or report keywords you specify for the **Keywords** property of the report in the Properties sheet, then select the corresponding search criteria from the **By** drop-down list, which can be by name, by keywords, or by name or keywords.
   ...
   ![Note icon](https://devnet.logianalytics.com/hc/article_attachments/9898403122327/noteicon.jpg) If you just type part of the report or folder name, or report keywords, use \* to replace the other part of the name or keywords. For example, if you want to search for the report EmployeeInformation, you should type **\*Info\*** instead of **info** in the text box.
...
2. On the shortcut menu, select **Export**. Designer displays the [Get JDBC Connection Information dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5735530237847-Get-JDBC-Connection-Information-Dialog-Box).
3. Fill in the required text boxes for connecting to the database, and then select **OK**.
4. Give a name for the table and select **OK** in the Input dialog box. Designer adds the report information to the table in the database. You need to make sure there are no duplicate name in the database; otherwise, Designer replaces the same name table directly.

You can then [set up a JDBC connection](https://devnet.logianalytics.com/hc/en-us/articles/5735521536663-Setting-Up-JDBC-Connections-in-a-Catalog) in a catalog to connect with the database and [add the table](https://devnet.logianalytics.com/hc/en-us/articles/5735521508887-Using-Tables-Views-Synonyms#Add) to the catalog via the JDBC connection.

### Deleting Folders/Reports

1. Select the folders/reports in the Reports tree, and then do one of the following:
...
3. Select **Yes** in the box. When you select folders, Designer removes the folders and all their content.
...
You can import report tabs to a page report from another page report in the same catalog, and specify [dataset](https://devnet.logianalytics.com/hc/en-us/articles/5735555287063-Manipulating-Report-Datasets) for the data components in the to be imported report tabs.

1. Navigate to **File** > **Import** > **Page Report**.
2. In the Open Report dialog box, specify the page report that contains the report tabs you want to import, then select **Open**. Designer displays the [Select Report Tab dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5735531292311-Select-Report-Tab-Dialog-Box).

   ![Select Report Tab](https://devnet.logianalytics.com/hc/article_attachments/9898456951703/slctrpttab.gif)
...
5. Select **OK**. Designer displays the [Customize Dataset dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5735528845847-Customize-Dataset-Dialog-Box).

   ![Customize Dataset](https://devnet.logianalytics.com/hc/article_attachments/9898473919511/cstmzdtst.gif)
6. Designer lists all data components in the selected report tabs, which have self-bound datasets. Specify which dataset you want a data component to use by selecting its **Dataset Name** cell and choosing from the drop-down list.
...
2. Right-click any report tab on the report tab bar and select **Customize Status** from the shortcut menu. Designer displays the [Customize Page Report Tab Status dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5735522340119-Customize-Page-Report-Tab-Status-Dialog-Box).

   ![Customize Page Report Tab Status dialog box](https://devnet.logianalytics.com/hc/article_attachments/9898457003287/cstmzpgrpttbstts.gif)
