...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009611022-Exporting-to-PostScript
updated_at: 2021-07-24T16:03:58Z
---

# Exporting to PostScript

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404911578903/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009634181-Exporting-to-XML) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404911579543/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009610962-Exporting-to-Fax)
...
2. Select **File** > **Export**  > ****To** PostScript**. The [Export to PostScript](https://devnet.logianalytics.com/hc/en-us/articles/1500009631121-Export-to-PostScript-Dialog) dialog appears.

   ![Export to PostScript dialog](https://devnet.logianalytics.com/hc/article_attachments/4404904225431/expt2ps.gif)
...
5. Select **No Margin** if you want to remove the margins in the exported PostScript result, which are set at report design time.
6. Select **Run Linked Report** if you want to include the reports that is linked with the report (not including the detail reports) in the exported PostScript result. If you are only interested in the primary report, leave this option unselected. Generating linked reports at the same time, especially when the linked reports contain a large amount of data, will cause performance issue.
