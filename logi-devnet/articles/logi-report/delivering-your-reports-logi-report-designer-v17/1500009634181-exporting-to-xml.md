...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009634181-Exporting-to-XML
updated_at: 2021-07-24T16:03:58Z
---

# Exporting to XML

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404911578903/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009634141-Exporting-to-RTF) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404911579543/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009611022-Exporting-to-PostScript)
...
2. Select **File** > **Export**  > **To XML**. The [Export to XML](https://devnet.logianalytics.com/hc/en-us/articles/1500009608202-Export-to-XML-Dialog) dialog appears.

   ![Export to XML dialog](https://devnet.logianalytics.com/hc/article_attachments/4404911668759/expt2xml.gif)
3. Select the **Browse** button to specify the destination directory and file name of the exported XML file. You can also type the location and file name in the Export to text box manually (make sure that the folder you specify does exist, otherwise an error message will be produced).
...
6. Select the **Only Data** checkbox to only export data of the web report or report tab.
7. Select **Run Linked Report** if you want to include the reports that is linked with the report (not including the detail reports) in the XML result. If you are only interested in the primary report, leave this option unselected. Generating linked reports at the same time, especially when the linked reports contain a large amount of data, will cause performance issue.
...
* If you do not want to see all the property values in a generated XML file, you can comment out any unwanted properties in this way:
  ...
  4. Save the property file and refresh the one in resource\_en\_US.jar.
     ...
     In addition, when you clear Only Data, and add an @ sign in front of the value in JRXMLTag.properties, the property listed in the Element node will then move to the Attribute node.
