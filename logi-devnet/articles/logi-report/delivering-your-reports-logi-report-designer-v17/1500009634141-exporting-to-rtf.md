...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009634141-Exporting-to-RTF
updated_at: 2021-07-24T16:03:58Z
---

# Exporting to RTF

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404911578903/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009611082-Exporting-to-Text) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404911579543/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009634181-Exporting-to-XML)
...
2. Select **File** > **Export**  > **To RTF**. The [Export to RTF](https://devnet.logianalytics.com/hc/en-us/articles/1500009631141-Export-to-RTF-Dialog) dialog appears.

   ![Export to RTF dialog](https://devnet.logianalytics.com/hc/article_attachments/4404911669655/expt2rtf.gif)
...
5. Select the **No Margin** checkbox to remove the margins in the RTF result, which are set at report design time.
6. Select **Best Editing** to apply the flow layout when exporting.
7. Select **Run Linked Report** if you want to include the reports that is linked with the report (not including the detail reports) in the RTF result. If you are only interested in the primary report, leave this option unselected. Generating linked reports at the same time, especially when the linked reports contain a large amount of data, will cause performance issue.
8. Select **OK** to start exporting.

**Notes:**

* The Arc drawing object cannot be exported to a RTF file.
* If Best Editing is selected, the result can be edited easily, but the layout may be different from that you designed, because some flow layout properties will not be supported by Logi Report RTF exporter, such as clear, relative, and so on.
