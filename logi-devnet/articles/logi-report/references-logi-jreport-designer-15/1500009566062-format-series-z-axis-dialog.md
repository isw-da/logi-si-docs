...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009566062-Format-Series-Z-Axis-Dialog
updated_at: 2021-07-24T05:55:11Z
---

# Format Series(Z) Axis Dialog

[![](https://devnet.logianalytics.com/hc/article_attachments/4404889273495/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009587421-Format-Scatter-Dialog)  [Next Topic![](https://devnet.logianalytics.com/hc/article_attachments/4404889273751/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009566082-Format-Series-Z-Gridline-Dialog)

# Format Series (Z) Axis Dialog

The Format Series (Z) Axis dialog appears when you double-click the series (Z) axis of a chart, or right-click a chart and then select Format Axes > Format Series (Z) Axis from the shortcut menu. It helps you to [format the series (Z) axis of a chart](https://devnet.logianalytics.com/hc/en-us/articles/1500009562982-Formatting-the-Axes#Series), and consists of the following tabs:
...
Specifies properties for the labels on the axis.
...
Specifies properties of the tick marks on the axis. [See the tab](javascript:%20void(null)).
...
Specifies the font format of text in the major tick mark labels on the axis. [See the tab](javascript:%20void(null)).
