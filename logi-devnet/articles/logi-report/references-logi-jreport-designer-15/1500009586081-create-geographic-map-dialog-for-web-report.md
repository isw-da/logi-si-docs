---
title: "Create Geographic Map Dialog (for Web Report)"
id: 1500009586081
section: "References - Logi JReport Designer 15"
category: "Logi Report"
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009586081-Create-Geographic-Map-Dialog-for-Web-Report
updated_at: 2021-07-24T05:55:31Z
---

# Create Geographic Map Dialog (for Web Report)

[![](https://devnet.logianalytics.com/hc/article_attachments/4404889273495/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009564922-Create-Geographic-Map-Dialog-for-Page-Report-)  [Next Topic![](https://devnet.logianalytics.com/hc/article_attachments/4404889273751/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009564942-Create-Query-s-Username-and-Password-Dialog)

# Create Geographic Map Dialog (for Web Report)

The Create Geographic Map dialog for web report appears when you select Insert > Map > Geographic Map, or drag the Geographic Map ![Geographic Map button](https://devnet.logianalytics.com/hc/article_attachments/4404889376407/btn_instgmp.gif) buttonfrom the Components panel into a web report. It helps you to [insert a geographic map](https://devnet.logianalytics.com/hc/en-us/articles/1500009584101-Inserting-a-Geographic-Map) into a web report, and consists of the following screens:
...
![Create Geographic Map wizard for Web Report - Data screen](https://devnet.logianalytics.com/hc/article_attachments/4404893937175/crtgmp_dt_wb.gif)
...
![Create Geographic Map wizard for Web Report - Display screen](https://devnet.logianalytics.com/hc/article_attachments/4404893937431/crtgmp_dsply_wb.gif)
...
* **Label By**  
   Specifies the field to control the labels shown above the areas for the selected group level. When more than one field is added, you can adjust the order of the fields by dragging and dropping.
  + ![Label button](https://devnet.logianalytics.com/hc/article_attachments/4404893879447/btn_lbl.gif)  
     Specifies the font format of the label text.
    - ![Font Face button](https://devnet.logianalytics.com/hc/article_attachments/4404893794583/btn_fntface.gif)  
       Specifies the font of the label text.
...
![Create Geographic Map wizard for Web Report - Filter screen](https://devnet.logianalytics.com/hc/article_attachments/4404889376663/crtgmp_fltr_wb.gif)
