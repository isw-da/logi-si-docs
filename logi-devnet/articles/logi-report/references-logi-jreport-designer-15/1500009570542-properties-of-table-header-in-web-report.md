---
title: "Properties of Table Header in Web Report"
id: 1500009570542
section: "References - Logi JReport Designer 15"
category: "Logi Report"
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009570542-Properties-of-Table-Header-in-Web-Report
updated_at: 2021-07-24T05:53:56Z
---

# Properties of Table Header in Web Report

[![](https://devnet.logianalytics.com/hc/article_attachments/4404889273495/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009592321-Properties-of-Table-in-Web-Report)  [Next Topic![](https://devnet.logianalytics.com/hc/article_attachments/4404889273751/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009570502-Properties-of-Table-Group-in-Web-Report)

# Properties of Table Header in Web Report

The properties of a table header object in a web report are as follows:
...
| Color | |
| Background | Specifies the background color and fill effect of the object. Choose a color from the drop-down list or select Custom to customize a color. You can also enter a hexadecimal RGB value (for example, 0xff0000) to specify a color. Data type: String |
| CSS | |
...
| Fill Whole Page | Specifies whether to make the row extended to the bottom of the page, so that the next row starts on a new page. Data type: Boolean |
...
| [On New Page](https://devnet.logianalytics.com/hc/en-us/articles/1500009591161-Properties-of-Group-Header-Panel-in-Page-Report#OnNewPage) | Specifies whether the row starts on a new page. This property is applied only when the report has page layout enabled. The default is false which means the row starts on a new page only if the previous page is filled. Data type: Boolean |
...
| Repeat Header for Excel | Specifies whether to make the object appear in every page of the report results when exporting the report to Excel. Data type: Boolean |
| Repeat Header for TXT | Specifies whether to make the object appear in every page of the report results when exporting the report to a.txt file. Data type: Boolean |
| Repeat Header for XML | Specifies whether to make the object appear in every page of the report results when exporting the report to XML. Data type: Boolean |
| Repeat on Pages | Specifies whether to make the object appear in every page of the report results. Data type: Boolean |
...
**Note:** Only these properties available to the table header object in the Inspector panel of Web Report Studio can be rendered in Web Report Studio.
