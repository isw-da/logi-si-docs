---
title: "Properties of UDO in Page Report"
id: 1500009570002
section: "References - Logi JReport Designer 15"
category: "Logi Report"
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009570002-Properties-of-UDO-in-Page-Report
updated_at: 2021-07-24T05:54:04Z
---

# Properties of UDO in Page Report

[![](https://devnet.logianalytics.com/hc/article_attachments/4404889273495/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009591941-Properties-of-TOC-in-Page-Report)  [Next Topic![](https://devnet.logianalytics.com/hc/article_attachments/4404889273751/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009570022-Properties-for-Objects-in-Web-Report)

# Properties of UDO in Page Report

As the name suggests, a UDO is an object defined by users. It has special properties defined by users. The properties listed in Logi JReport Report Inspector correspond with the ones defined inyour UDO programs. Here are some default properties:
...
| Export to CSV | Specifies whether to include the object when exporting the report to CSV. If it is set to true, only the text value will be exported. Data type: Boolean |
| Export to Excel | Specifies whether to include the object when exporting the report to Excel. If it is set to true, only the text value will be exported. Data type: Boolean |
...
| Export to Text | Specifies whether to include the object when exporting the report to Text. If it is set to true, only the text value will be exported. Data type: Boolean |
| Export to XML | Specifies whether to include the object when exporting the report to XML. If it is set to true, only the text value will be exported. Data type: Boolean |
...
| Suppress When No Records | Specifies whether to display the object in the report results when no record is returned to its parent data container. Data type: Boolean |
| Excel | |
...
* The above are the basic properties of a UDO and more will be added with those defined in your program.
* Logi JReport UDO does not support RTF and PDF format output. That is, when exporting to RTF and PDF, a report with a UDO may not be rendered correctly. However, there is no such problem for HTML and PS.
...
| Display Value | Specifies the displayed text of the hyperlink. This property has lower priority than Display Image. Data type: String |
...
| Executer Class Name | If the specified URL is linked to a .rst file - the Logi JReport Result export result file, you should select jet.udos.RPTExecuter. For other links, use jet.udos.IEExecuter. Data type: String |
...
* URL: `C:\docword.txt`  
  Display Value: abc  
  Display Image: `C:\Logi JReport\Designer\Demo\SampleReports\Coffee.jpg`
