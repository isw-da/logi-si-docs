...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009566122-Format-Stock-Dialog
updated_at: 2021-07-24T05:55:10Z
---

# Format Stock Dialog

[![](https://devnet.logianalytics.com/hc/article_attachments/4404889273495/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009566082-Format-Series-Z-Gridline-Dialog)  [Next Topic![](https://devnet.logianalytics.com/hc/article_attachments/4404889273751/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009566102-Format-Surface-Dialog)

# Format Stock Dialog

The Format Stock dialog appears when you double-click a stock of a chart, or right-click it and select Format Stock from the shortcut menu. It helps you to [format stocks of a chart](https://devnet.logianalytics.com/hc/en-us/articles/1500009583641-Formatting-the-Stock-Chart), and consists of the following tabs:
...
Specifies general format of the stock chart. [See the tab](javascript:%20void(null)).

![Format Stock dialog - General](https://devnet.logianalytics.com/hc/article_attachments/4404889340567/fmtstck_gnrl.gif)
...
* **Color**  
   Specifies the color schema for the stock lines. To edit the color, select the color image and select a color from the [color palette](https://devnet.logianalytics.com/hc/en-us/articles/1500009593081-Menu-Tabs#Palette) or input the hexadecimal value (for example, 0xff0000) of a color directly in the text box.
* **Thickness**  
   Specifies the thickness of the stock lines, in pixels.

**Stock Bar**

Specifies properties for stock bars of an Open-High-Low-Close stock chart, which requires four series of values in this order.
...
Specifies the properties for border of the stock bars, which take effect only when the [Border](https://devnet.logianalytics.com/hc/en-us/articles/1500009591241-Properties-of-Chart-Paper-in-Page-Report#Border) property on chart paper is set to true in the Report Inspector. [See the tab](javascript:%20void(null)).

![Format Stock dialog - Border](https://devnet.logianalytics.com/hc/article_attachments/4404893884183/fmtstck_brdr.gif)
...
Specifies properties for data labels displayed on the stock chart. [See the tab](javascript:%20void(null)).

![Format Stock dialog - Data Label](https://devnet.logianalytics.com/hc/article_attachments/4404889340951/fmtstck_data.gif)
