...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009566142-Format-Text-Dialog
updated_at: 2021-07-24T05:55:10Z
---

# Format Text Dialog

[![](https://devnet.logianalytics.com/hc/article_attachments/4404889273495/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009566102-Format-Surface-Dialog)  [Next Topic![](https://devnet.logianalytics.com/hc/article_attachments/4404889273751/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009566162-Format-Value-Y-Axis-Dialog)

# Format Text Dialog

The Format Text dialog appears when you right-click some selected strings and then select Font or Paragraph (if the string is in a table cell, Format Text) from the shortcut menu. You can set the properties of the text in a paragraph and font of the text in the following two tabs:
...
Specifies properties for the text in the paragraph. [See the tab](javascript:%20void(null)).

![Format Text dialog - Paragraph](https://devnet.logianalytics.com/hc/article_attachments/4404893883927/frmttext_prgrphtab.gif)
...
Specifies the font format of text in the paragraph. [See the tab](javascript:%20void(null)).

![Format Text dialog - Font](https://devnet.logianalytics.com/hc/article_attachments/4404889340311/frmttext_fonttab.gif)
