...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009564482-Add-Tables-Dialog
updated_at: 2021-07-24T05:55:40Z
---

# Add Tables Dialog

[![](https://devnet.logianalytics.com/hc/article_attachments/4404889273495/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009585581-Add-Stored-Procedures-Dialog)  [Next Topic![](https://devnet.logianalytics.com/hc/article_attachments/4404889273751/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009585621-Add-Tables-Views-Queries-Dialog)

# Add Tables Dialog

The Add Tables dialog appears when you right-click the Tables node in a connection and select Add Tables on the shortcut menu in the Catalog Manager. It helps you to add tables into a Logi JReport catalog via the connection you set up, and varies according to connection types.

If it is an XML or JSON connection, options in the dialog are as follows. [See the dialog](javascript:%20void(null)).

![Add Tables dialog - XML/JSON](https://devnet.logianalytics.com/hc/article_attachments/4404893957911/addtbl_xml.gif)
...
Lists the tables contained in the schema after you select the Load Tables button.
...
If it is a web service connection, options in the dialog are as follows. [See the dialog](javascript:%20void(null)).

![Add Tables dialog - web service connection](https://devnet.logianalytics.com/hc/article_attachments/4404893958167/addtbl_wbsvc.gif)
...
If it is a MongoDB connection, options in the dialog are as follows. [See the dialog](javascript:%20void(null)).

![Add Tables dialog - MongoDB connection](https://devnet.logianalytics.com/hc/article_attachments/4404893958423/addtbl_mngodb.gif)
...
> * [Managing Tables in an XML Connection](https://devnet.logianalytics.com/hc/en-us/articles/1500009585461-Managing-Tables-in-an-XML-Connection)
> * [Adding Tables to a Web Service Connection](https://devnet.logianalytics.com/hc/en-us/articles/1500009585361-Adding-Tables-to-a-Web-Service-Connection)
