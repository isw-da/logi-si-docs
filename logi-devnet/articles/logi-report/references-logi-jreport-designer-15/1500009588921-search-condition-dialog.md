---
title: "Search Condition Dialog"
id: 1500009588921
section: "References - Logi JReport Designer 15"
category: "Logi Report"
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009588921-Search-Condition-Dialog
updated_at: 2021-07-24T05:54:48Z
---

# Search Condition Dialog

[![](https://devnet.logianalytics.com/hc/article_attachments/4404889273495/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009588501-Scrollable-Chart-Dialog)  [Next Topic![](https://devnet.logianalytics.com/hc/article_attachments/4404889273751/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009567642-Search-Dialog)

# Search Condition Dialog

The Search Condition dialog appears when you select Menu > Query > Filter in the [Query Editor](https://devnet.logianalytics.com/hc/en-us/articles/1500009567142-Query-Editor-Dialog). It helps you to [specify more criteria for the fields to be retrieved from the database](https://devnet.logianalytics.com/hc/en-us/articles/1500009570722-Filtering-the-Fields-of-a-Query). [See the dialog](javascript:%20void(null)).
...
Specifies the field to be filtered. You can either type in the field manually or select **![](https://devnet.logianalytics.com/hc/article_attachments/4404889276567/btn_chsr.gif)** to specify the field in the [Expressions](https://devnet.logianalytics.com/hc/en-us/articles/1500009565482-Expressions-Dialog) dialog.
...
* **is [not] null**   
   It is used in WHERE clause predicates to match null values occurring in a specified data column. For operator ‘is null' or ‘is not null', the value text box is hidden.
* **[not] like**  
