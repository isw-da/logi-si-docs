---
title: "Properties of DBField in Page Report"
id: 1500009591441
section: "References - Logi JReport Designer 15"
category: "Logi Report"
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009591441-Properties-of-DBField-in-Page-Report
updated_at: 2021-07-24T05:54:12Z
---

# Properties of DBField in Page Report

[![](https://devnet.logianalytics.com/hc/article_attachments/4404889273495/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009591461-Properties-of-Dataset-in-Page-Report)  [Next Topic![](https://devnet.logianalytics.com/hc/article_attachments/4404889273751/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009569562-Properties-of-Filter-Control-in-Page-Report)

# Properties of DBField in Page Report

The properties of a DBField object in a page report are:
...
| Query | Shows the query/UDS name. This property is read only. |
...
| [Format](#Format) | Specifies the display format of the text in the report result. It varies with data type and can be manually defined. Data type: String  **Note:** For the BigDecimal type, to avoid precision loss, you should enter a prefix JRD when setting the format property value. |
...
| Export to Applet | Specifies whether to include the object when exporting the report to Applet. This property is available only when the object is displayed as a web control, barcode or rank. Data type: Boolean |
| Export to CSV | Specifies whether to include the object when exporting the report to CSV. Not available when the object is displayed as a rank, image or image button. Data type: Boolean |
| Export to Excel | Specifies whether to include the object when exporting the report to Excel. Data type: Boolean |
| Export to HTML | Specifies whether to include the object when exporting the report to HTML. This property is available only when the object is displayed as a a web control, barcode or rank. Data type: Boolean |
| Export to PDF | Specifies whether to include the object when exporting the report to PDF. This property is available only when the object is displayed as a web control, barcode or rank. Data type: Boolean |
| Export to PostScript | Specifies whether to include the object when exporting the report to HTML. This property is available only when the object is displayed as a a web control, barcode or rank. Data type: Boolean |
| Export to Report Result | Specifies whether to show the object in the design area and in the report results. All formulas and calculations will still be performed. Data type: Boolean |
| Export to RTF | Specifies whether to include the object when exporting the report to RTF. This property is available only when the object is displayed as a a web control, barcode or rank. Data type: Boolean |
| Export to Text | Specifies whether to include the object when exporting the report to Text. This property is available only when the object is displayed as a barcode or web control except for image button. Data type: Boolean |
| Export to XML | Specifies whether to include the object when exporting the report to XML. This property is available only when the object is displayed as a barcode or web control except for image button. Data type: Boolean |
