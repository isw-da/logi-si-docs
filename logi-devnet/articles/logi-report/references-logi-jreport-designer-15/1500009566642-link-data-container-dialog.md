...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009566642-Link-Data-Container-Dialog
updated_at: 2021-07-24T05:55:04Z
---

# Link Data Container Dialog

[![](https://devnet.logianalytics.com/hc/article_attachments/4404889273495/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009587741-Line-Pattern-List-Dialog)  [Next Topic![](https://devnet.logianalytics.com/hc/article_attachments/4404889273751/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009566682-Mailing-Label-Wizard-Dialog)

# Link Data Container Dialog

The Link Data Container dialog appears when you right-click a child data component and select Data Container Link from the shortcut menu. It helps you to [set up link conditions between the child data component and its parent](https://devnet.logianalytics.com/hc/en-us/articles/1500009583301-Setting-Up-a-Data-Container-Link).

The following are details about options in the dialog:

**Condition tab**

Specifies the link conditions between the parent and child data components. [See the tab](javascript:%20void(null)).

![Link Data Container - Condition](https://devnet.logianalytics.com/hc/article_attachments/4404889331095/lnkdtcntnr_cndtn.gif)
...
* **Field**Lists all the fields that are used in the link conditions.
  + **Fields(Parent)**  
...
Specifies values for all parameters in the child data component. [See the tab](javascript:%20void(null)).

![](https://devnet.logianalytics.com/hc/article_attachments/4404889331351/lnkdtcntnr_prmtr.gif)
...
Specifies values of the child data component fields which will be returned as the parent data component parameter values. [See the tab](javascript:%20void(null)).

![Link Data Container - Returen Value](https://devnet.logianalytics.com/hc/article_attachments/4404889331607/lnkdtcntnr_value.gif)
