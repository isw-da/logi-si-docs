---
title: "Properties of Parameter Field in Page Report"
id: 1500009591721
section: "References - Logi JReport Designer 15"
category: "Logi Report"
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009591721-Properties-of-Parameter-Field-in-Page-Report
updated_at: 2021-07-24T05:54:08Z
---

# Properties of Parameter Field in Page Report

[![](https://devnet.logianalytics.com/hc/article_attachments/4404889273495/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009569782-Properties-of-Parameter-Control-in-Page-Report)  [Next Topic![](https://devnet.logianalytics.com/hc/article_attachments/4404889273751/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009569802-Properties-of-Parameter-Form-Control-in-Page-Report)

# Properties of Parameter Field in Page Report

The properties of a parameter field object in a page report are:

| Property Name | Description |
| --- | --- |
| General | |
| Data Type | Shows the data type of the parameter. This property is read only. |
| Default Value | Shows the default value of the parameter. This property is read only. |
| Field Type | Shows what kind of field it is. This property is read only. |
| Instance Name | Shows the instance name of the object. This property is read only. |
| Parameter Name | Shows the name of the parameter. This property is read only. |
| Geometry | |
...
| CSS | |
| [ID](https://devnet.logianalytics.com/hc/en-us/articles/1500009569642-Properties-of-Label-in-Page-Report#CSS) | Specifies the identifier of the object, which must be unique in the report. The ID property can be a style sheet selector. A String type value. |
...
| Detail Report | Specifies the detail report that the object is linked to. Select  in the value cell to set the detail report. For details, refer to [Linking to a Detail Report](https://devnet.logianalytics.com/hc/en-us/articles/1500009563442-Binding-a-Link-to-a-Label#Detail). Data type: Boolean |
...
| Parameter | Substitutes the current parameter with another one by selecting from the drop-down list. To make the property editable, uncheck Forbid changing parameter in the Options dialog (**File** > **Options** > **Panel** > **Forbid changing parameter**).  Data type: String |
