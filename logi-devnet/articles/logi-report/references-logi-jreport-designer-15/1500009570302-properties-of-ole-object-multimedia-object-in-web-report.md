---
title: "Properties of OLE Object (Multimedia Object) in Web Report"
id: 1500009570302
section: "References - Logi JReport Designer 15"
category: "Logi Report"
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009570302-Properties-of-OLE-Object-Multimedia-Object-in-Web-Report
updated_at: 2021-07-24T05:53:59Z
---

# Properties of OLE Object (Multimedia Object) in Web Report

[![](https://devnet.logianalytics.com/hc/article_attachments/4404889273495/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009592221-Properties-of-Navigation-Item-in-Web-Report)  [Next Topic![](https://devnet.logianalytics.com/hc/article_attachments/4404889273751/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009570322-Properties-of-Page-Panel-in-Web-Report)

# Properties of OLE Object (Multimedia Object) in Web Report

The properties of an OLE object, that is a multimedia object in a web report are:
...
| Alternate Text | Specifies the text will be displayed instead if the object cannot be displayed. Data type: String |
...
| Declare | Specifies whether to make the current object definition a declaration only. The object must be instantiated by a subsequent object definition referring to this declaration. Data type: Boolean |
| Horizontal Space | Specifies the horizontal margin for the object. Data type: Float |
| Name | Specifies the name of the object. Data type: String |
| Stand By | Specifies the message to be displayed while the object is being loaded. Data type: String |
| Tab Index | Specifies the index that defines the tab order for the object. Data type: Integer |
| Title | Specifies the tip information of the object, which will be displayed when you hover the mouse pointer over the object after the report is exported to HTML or Page Report Result. Data type: String |
| Use Map | Specifies the URL, often with a bookmark extension (#name), to use as a client-side image map. Data type: String |
| Value Type | Specifies the MIME (Multipurpose Internet Mail Extensions) type of the object. Data type: String |
| Vertical Space | Specifies the vertical margin for the object. Data type: Float |
