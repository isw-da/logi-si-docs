---
title: "Properties of Chart Legend in Web Report"
id: 1500009570082
section: "References - Logi JReport Designer 15"
category: "Logi Report"
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009570082-Properties-of-Chart-Legend-in-Web-Report
updated_at: 2021-07-24T05:54:03Z
---

# Properties of Chart Legend in Web Report

[![](https://devnet.logianalytics.com/hc/article_attachments/4404889273495/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009591961-Properties-of-Heat-Map-Rectangle-Title-in-Web-Report)  [Next Topic![](https://devnet.logianalytics.com/hc/article_attachments/4404889273751/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009570062-Properties-of-Chart-Label-in-Web-Report)

# Properties of Chart Legend in Web Report

The properties of a chart legend object in a web report are:
...
| Background | |
| Border Color | Specifies the color of the legend border. Choose a color from the drop-down list or select Custom to customize a color. You can also enter a hexadecimal RGB value (for example, 0xff0000) to specify a color. Data type: String |
...
| Border Variable Dash | Specifies whether to resize the dash automatically.  * **true** - If selected, the dash size will be adjusted automatically, and the option Auto Adjust Dash in the [Format Legend](https://devnet.logianalytics.com/hc/en-us/articles/1500009565902-Format-Legend-Dialog-for-Web-Report-#Dash) dialog will take effect. * **false** - If selected, the dash size will be of fixed size, and the option Fixed Dash Size in the [Format Legend](https://devnet.logianalytics.com/hc/en-us/articles/1500009565902-Format-Legend-Dialog-for-Web-Report-#Dash) dialog will take effect.   Data type: Boolean |
| Color | Specifies the color of the legend background, applied when the property Fill Type is set to color. Choose a color from the drop-down list or select Custom to customize a color. You can also enter a hexadecimal RGB value (for example, 0xff0000) to specify a color. Data type: String |
...
| Icon | |
| Border Color | Specifies the color of the icon borders. Choose a color from the drop-down list or select Custom to customize a color. You can also enter a hexadecimal RGB value (for example, 0xff0000) to specify a color. Data type: String |
