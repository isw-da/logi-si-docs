...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009565882-Format-Label-Dialog
updated_at: 2021-07-24T05:55:14Z
---

# Format Label Dialog

[![](https://devnet.logianalytics.com/hc/article_attachments/4404889273495/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009587241-Format-Indicator-Dialog-for-Report-)  [Next Topic![](https://devnet.logianalytics.com/hc/article_attachments/4404889273751/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009587261-Format-Legend-Dialog-for-Library-Component-)

# Format Label Dialog

The Format Label dialog appears when you right-click a label of a chart and then select Format Label from the shortcut menu. It helps you to [format the titles of a chart](https://devnet.logianalytics.com/hc/en-us/articles/1500009583521-Formatting-the-Labels), and consists of the following tabs:
...
Specifies the general format of the label. [See the tab](javascript:%20void(null)).

![Format Label dialog - General](https://devnet.logianalytics.com/hc/article_attachments/4404893897495/fmtlabel_gnrl.gif)
...
* **Fill**  
   Specifies the color to fill the selected icon. To edit the color, select the color image and select a color from the [color palette](https://devnet.logianalytics.com/hc/en-us/articles/1500009593081-Menu-Tabs#Palette) or input the hexadecimal value (for example, 0xff0000) of a color directly in the text box.
* **Transparency**  
...
* **Icon** Specifies the alignment format for icons in the label.

## Fill

Specifies the color schema to fill the title of the label. [See the tab](javascript:%20void(null)).

![Format Label dialog - Fill](https://devnet.logianalytics.com/hc/article_attachments/4404889348631/fmtlabel_fill.gif)
...
Specifies properties of the label border. [See the tab](javascript:%20void(null)).

![Format Label dialog - Border](https://devnet.logianalytics.com/hc/article_attachments/4404893897751/fmtlabel_brdr.gif)
...
Specifies the font format of the label text. [See the tab](javascript:%20void(null)).

![Format Label dialog - Font](https://devnet.logianalytics.com/hc/article_attachments/4404889348887/fmtlabel_font.gif)
...
This tab allows you to set the alignment format of the label text and the icon. [See the tab](javascript:%20void(null)).

![Format Label dialog - Orientation](https://devnet.logianalytics.com/hc/article_attachments/4404893898007/fmtlabel_orntatn.gif)
