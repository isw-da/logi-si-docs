...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009568302-Math-Operators
updated_at: 2021-07-24T05:54:37Z
---

# Math Operators

[![](https://devnet.logianalytics.com/hc/article_attachments/4404889273495/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009589581-Operators)  [Next Topic![](https://devnet.logianalytics.com/hc/article_attachments/4404889273751/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009589601-Comparison-Operators)

# Math Operators

Below is a list of the Math operators used in Logi JReport Designer:
...
When a Date value is added to an Integer value, the return value will be a Date value because the Integer value will have changed to a Date value.
...
* `String URL="http://localhost:8888/jinfonet/runReport.jsp?";   
   ...
   return URL + Reports + Catalog + ReportSet + resultType + para + para1;`
...
When a text value is added to a Date value, the return value will be a text value because the Date value can be changed to a text value, while the text value cannot be changed to a Date value.
...
When a Date value is subtracted from a Date value, the return value will be an Integer. The result is the number of days between the two dates.
...
When a Integer value is subtracted from an Date value, the return value will be a Date value because the Integer value will have changed into a Date value.
...
When a DateTime value is subtracted from a DateTime value, the return value will be an Integer. The result is the number of seconds between the two DateTimes.
...
When an Integer value is subtracted from a Datetime value, the return value will be a DateTime value because the Integer value will have changed into a DateTime value.
...
When an Integer value is subtracted from an Time value, the return value will be a Time value because the Integer value will have changed into a Time value.
...
When a Time value is subtracted from a Time value, the return value will be an Integer. The result is the number of seconds between the two times.
