---
title: "Table Wizard Dialog (for Page Report)"
id: 1500009589121
section: "References - Logi JReport Designer 15"
category: "Logi Report"
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009589121-Table-Wizard-Dialog-for-Page-Report
updated_at: 2021-07-24T05:54:45Z
---

# Table Wizard Dialog (for Page Report)

[![](https://devnet.logianalytics.com/hc/article_attachments/4404889273495/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009589081-Table-Wizard-Dialog-for-Library-Component-)  [Next Topic![](https://devnet.logianalytics.com/hc/article_attachments/4404889273751/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009589101-Table-Wizard-Dialog-for-Web-Report-)

# Table Wizard Dialog (for Page Report)

The Table Wizard dialog for page report differs according to the data resource used to create the table: [query resource](#Query)  or [business view](#BV).

## When using a Query Resource

This wizard helps you to [create](https://devnet.logianalytics.com/hc/en-us/articles/1500009592821-Creating-a-Page-Report) or [modify](https://devnet.logianalytics.com/hc/en-us/articles/1500009584421-Modifying-a-Table) a table based on a query resource in a page report. It appears when you do either of the following:

* In the [Select Component for Page Report Tab](https://devnet.logianalytics.com/hc/en-us/articles/1500009588661-Select-Component-for-Page-Report-Tab-Dialog) dialog or [Select Component for Page Report](https://devnet.logianalytics.com/hc/en-us/articles/1500009567422-Select-Component-for-Page-Report-Dialog) dialog, select a table component and then select OK.
* Right-click a table created on a query and select Table Wizard on the shortcut menu.
...
Specifies the dataset for the table. [See the screen](javascript:%20void(null)).

![](https://devnet.logianalytics.com/hc/article_attachments/4404893846295/tblwzd_dt.gif)
...
* **Existing Dataset**  
   If checked, select a dataset from the ones existing in the open report to create the table. Select the Edit button to edit the dataset in the [Dataset Editor](https://devnet.logianalytics.com/hc/en-us/articles/1500009586301-Dataset-Editor-Dialog) if required.
* **Current Dataset**  
...
![](https://devnet.logianalytics.com/hc/article_attachments/4404893846551/tblwzd_dsply.gif)
...
![](https://devnet.logianalytics.com/hc/article_attachments/4404889315223/tblwzd_grp.gif)
...
![](https://devnet.logianalytics.com/hc/article_attachments/4404893846807/tblwzd_sum.gif)
...
![](https://devnet.logianalytics.com/hc/article_attachments/4404889315479/tblwzd_fltr.gif)
...
![](https://devnet.logianalytics.com/hc/article_attachments/4404889315735/tblwzd_sty.gif)
...
Opens the [Page Setup](https://devnet.logianalytics.com/hc/en-us/articles/1500009588121-Page-Setup-Dialog) dialog to specify the page settings. Available only when creating a table.

## When using a Business View

The wizard helps you to [create](https://devnet.logianalytics.com/hc/en-us/articles/1500009592821-Creating-a-Page-Report) or [modify](https://devnet.logianalytics.com/hc/en-us/articles/1500009584421-Modifying-a-Table) a table based on a business view in a page report. It appears when you do either of the following:

* In the [Select Component for Page Report](https://devnet.logianalytics.com/hc/en-us/articles/1500009567422-Select-Component-for-Page-Report-Dialog) dialog, select Create Using Business View at bottom left, next select a table component, and then select OK.
* When creating a new report tab in a page report which is based business views, in the [Select Component for Page Report Tab](https://devnet.logianalytics.com/hc/en-us/articles/1500009588661-Select-Component-for-Page-Report-Tab-Dialog) dialog, select a table component and select OK.
* Right-click a table created based on a business view and select Table Wizard on the shortcut menu.
...
Specifies a business view for the table. [See the screen](javascript:%20void(null)).

![Table Wizard for business view - Data screen](https://devnet.logianalytics.com/hc/article_attachments/4404889315991/tblwzd_dt-bv.gif)
...
![Table Wizard for business view - Display screen](https://devnet.logianalytics.com/hc/article_attachments/4404893847063/tblwzd_dsply-bv.gif)
...
![Table Wizard for business view - Group screen](https://devnet.logianalytics.com/hc/article_attachments/4404893847319/tblwzd_grp-bv.gif)
...
Specifies the aggregations to display in the table. This screen is available only when you create a table. [See the screen](javascript:%20void(null)).

![Table Wizard for business view - Summary screen](https://devnet.logianalytics.com/hc/article_attachments/4404893847575/tblwzd_sum-bv.gif)
...
![Table Wizard for business view - Filter screen](https://devnet.logianalytics.com/hc/article_attachments/4404893847831/tblwzd_fltr-bv.gif)
...
![Table Wizard for business view - Style screen](https://devnet.logianalytics.com/hc/article_attachments/4404889316503/tblwzd_sty-bv.gif)
