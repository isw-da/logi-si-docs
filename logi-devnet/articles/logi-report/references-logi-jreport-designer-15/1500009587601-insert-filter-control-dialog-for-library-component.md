---
title: "Insert Filter Control Dialog (for Library Component)"
id: 1500009587601
section: "References - Logi JReport Designer 15"
category: "Logi Report"
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009587601-Insert-Filter-Control-Dialog-for-Library-Component
updated_at: 2021-07-24T05:55:06Z
---

# Insert Filter Control Dialog (for Library Component)

[![](https://devnet.logianalytics.com/hc/article_attachments/4404889273495/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009587581-Insert-Fields-Dialog)  [Next Topic![](https://devnet.logianalytics.com/hc/article_attachments/4404889273751/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009566462-Insert-Filter-Control-Dialog-for-Report-)

# Insert Filter Control Dialog (for Library Component)

The Insert Filter Control dialog for library component appears when you select Insert > Web Controls > Filter Control, or drag the Filter Control button ![Filter Control button](https://devnet.logianalytics.com/hc/article_attachments/4404889334551/btn_instfltrcntrl.gif) from the Components panel into the library component. It helps you to [insert a filter control](https://devnet.logianalytics.com/hc/en-us/articles/1500009584601-Using-Filter-Control-to-Filter-Data) into a library component for filtering component data. [See the dialog](javascript:%20void(null)).
...
* **For Text List and Single Value Slider**
  ...
  ![Customize initial values for text list and single value slider](https://devnet.logianalytics.com/hc/article_attachments/4404889335319/instfltrctrl_txt.gif)
  ...
  + ![Calendar](https://devnet.logianalytics.com/hc/article_attachments/4404889335063/btn_slctdt.gif)  
...
* **For Range Slider**
  ...
  ![Customize Initial Values for Range Slider](https://devnet.logianalytics.com/hc/article_attachments/4404893874199/instfltrctrl_rng.gif)

  + **From**  
     Select the start value of the slider from the drop-down list or type the value in the text box. For the Date/Time type, you can also select the ![Calendar](https://devnet.logianalytics.com/hc/article_attachments/4404889335063/btn_slctdt.gif) button to specify a value.
  + **To**  
     Select the end value of the slider from the drop-down list or type the value in the text box. For the Date/Time type, you can also select the ![Calendar](https://devnet.logianalytics.com/hc/article_attachments/4404889335063/btn_slctdt.gif) button to specify a value.
  + **Special Function**  
...
Inserts the filter control into the library component and closes the dialog.
