...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009566102-Format-Surface-Dialog
updated_at: 2021-07-24T05:55:11Z
---

# Format Surface Dialog

[![](https://devnet.logianalytics.com/hc/article_attachments/4404889273495/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009566122-Format-Stock-Dialog)  [Next Topic![](https://devnet.logianalytics.com/hc/article_attachments/4404889273751/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009566142-Format-Text-Dialog)

# Format Surface Dialog

The Format Surface dialog appears when you double-click a surface of a chart, or right-click it and then select Format Surface from the shortcut menu. It helps you to [format surfaces in a chart](https://devnet.logianalytics.com/hc/en-us/articles/1500009563202-Formatting-the-Surface), and consists of the following tabs:
...
Specifies the color or fill effect and the transparency for the surfaces. [See the tab](javascript:%20void(null)).

![Format Surface dialog - Fill](https://devnet.logianalytics.com/hc/article_attachments/4404893884695/fmtsrfc_fill.gif)

**Color**

Specifies the color schema for the selected surfaces in the same data series. To edit the color, select the color image and select a color from the [color palette](https://devnet.logianalytics.com/hc/en-us/articles/1500009593081-Menu-Tabs#Palette) or input the hexadecimal value (for example, 0xff0000) of a color directly in the text box.
...
Opens the [Color List](https://devnet.logianalytics.com/hc/en-us/articles/1500009564822-Color-List-Dialog) dialog to modify color pattern for surfaces in the same data series respectively.
...
Specifies properties for border of the surfaces, which take effect only when the [Border](https://devnet.logianalytics.com/hc/en-us/articles/1500009591241-Properties-of-Chart-Paper-in-Page-Report#Border) property on chart paper is set to true in the Report Inspector. [See the tab](javascript:%20void(null))

![Format Surface dialog - Border](https://devnet.logianalytics.com/hc/article_attachments/4404889341207/fmtsrfc_brdr.gif)
...
Specifies properties for data labels displayed on the surfaces. [See the tab](javascript:%20void(null)).

![Format Surface dialog - Data Label](https://devnet.logianalytics.com/hc/article_attachments/4404889341463/fmtsrfc_data.gif)
