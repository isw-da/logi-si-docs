...
![Priority diagram](https://devnet.logianalytics.com/hc/article_attachments/9898536045847/scrty_bv_intro.gif)
...
![Note icon](https://devnet.logianalytics.com/hc/article_attachments/9898403122327/noteicon.jpg) If you define all members in a group object regardless of whether it is set to a principal directly or to the parents indirectly, Logi Report Engine retrieves no data from the group object to the principal.
