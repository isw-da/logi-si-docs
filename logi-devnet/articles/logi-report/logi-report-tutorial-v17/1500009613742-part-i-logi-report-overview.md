...
![Logi Report Product Architecture](https://devnet.logianalytics.com/hc/article_attachments/4404904155031/ov_view.gif)
...
* **Business Analyst**If you are a business analyst, you should understand how Logi Report Page Report Studio and Web Report Studio allow you to create a special category of reports called ad hoc reports. Unlike the predefined reports in Logi Report Designer, you build these reports in the runtime environment based on a data model built and published by a report developer.
  ...
  Focus on tracks in [Part IV: End User Experience](https://devnet.logianalytics.com/hc/en-us/articles/1500009605002-Part-IV-End-User-Experience).
* **Developer and Report Developer**
  ...
  Focus on [Part II: Logi Report Basics for Developers](https://devnet.logianalytics.com/hc/en-us/articles/1500009604922-Part-II-Logi-Report-Basics-for-Developers).
* **Systems Analyst or Application Server Administrator**
  ...
  See [Publishing, Running and Administering Resources](https://devnet.logianalytics.com/hc/en-us/articles/1500009604502-Track-5-Publishing-Running-and-Administering-Resources) in Part III.
* **End User**
...
![Report Template](https://devnet.logianalytics.com/hc/article_attachments/4404904155287/ov_what.gif)
...
![Report Lifecycle](https://devnet.logianalytics.com/hc/article_attachments/4404911573911/ov_life.gif)
...
After a report is generated, end users can access it in a variety of ways. A report can be viewed through the Logi Report Server console, through a Java application, or routed to a delivery target such as an e-mail address or printer. The business analyst can also build ad hoc reports as needed.
