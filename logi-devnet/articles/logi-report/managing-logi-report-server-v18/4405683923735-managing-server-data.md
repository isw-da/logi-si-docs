...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405683923735-Managing-Server-Data
updated_at: 2022-01-27T07:59:37Z
---

# Managing Server Data

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420453372695/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405683937303-Managing-Report-Running-Tasks)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420453372951/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405683922583-Managing-Cached-Report-Data)
...
[Configuring the Server Database](https://devnet.logianalytics.com/hc/en-us/articles/4405690486423-Configuring-the-Server-Database).
...
* **Backing up the server data via the Server Console**
  ...
  2. Select the **Backup** tab.
     ...
     ![Backup tab](https://devnet.logianalytics.com/hc/article_attachments/4420453525655/mng_data_back.gif)
...
* **Backing up the server data by command line**
  ...
  You can use a tool to back up the server data. It is [DBMaintain.bat/DBMaintain.sh](https://devnet.logianalytics.com/hc/en-us/articles/4405690640535-Running-Logi-Report-Server-as-a-Standalone-Server#DBMaintain) in <`install_root>\bin`. It has two parameters:
...
2. Server displays the Realm DB/Profiling DB page. Select **Archive**.
   ...
   ![Archive tab](https://devnet.logianalytics.com/hc/article_attachments/4420453525911/mng_data_archive.gif)
...
2. Select **Summary**.
   ...
   ![Summary tab](https://devnet.logianalytics.com/hc/article_attachments/4420461596823/mng_data_view.gif)
3. Select a realm from the **Select Realm** drop-down list at the upper-right corner.
...
2. Select the **Realm DB Check** tab.
   ...
   ![Realm DB Check tab](https://devnet.logianalytics.com/hc/article_attachments/4420447192471/mng_data_clear.gif)
3. Select a realm from the **Select Realm** drop-down list at the upper-right corner.
