...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405683939607-Browsing-Versions
updated_at: 2022-01-27T07:59:40Z
---

# Browsing Versions

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420453372695/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405683940759-Creating-Versions)[Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420453372951/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405683941911-Checking-Version-Properties)
...
* To view the version information of a single resource, browse to the folder where the resource is, then:
  + Put the mouse pointer over the resource row and select the **Version** button ![Version button](https://devnet.logianalytics.com/hc/article_attachments/4420447130135/btn_srv_vrsn.gif) on the floating toolbar.
...
| NLS Editor | Administrators can [edit NLS](https://devnet.logianalytics.com/hc/en-us/articles/4405683948567-NLS-at-Report-Level#Local) for a specified catalog version by selecting the corresponding link. |
...
| --- | --- |
| Version Date | The date and time when Server generated the version. You can sort the versions by version date. |
| NLS Editor | Administrators can [edit NLS](https://devnet.logianalytics.com/hc/en-us/articles/4405683948567-NLS-at-Report-Level#Local) for a specified report version by selecting the corresponding link. |
| Version Number | The serial ID that identifies a version in the version table. |
| Creator | The ID of the user who created the version. Available to web reports that you used create [shared reports](https://devnet.logianalytics.com/hc/en-us/articles/4405683936279-Sharing-Web-Reports) only. |
...
| --- | --- |
| Version Date | The date and time when Server generated the version. You can sort the versions by version date. |
| NLS Editor | Administrators can [edit NLS](https://devnet.logianalytics.com/hc/en-us/articles/4405683948567-NLS-at-Report-Level#Local) for a specific library component version by selecting the corresponding link. |
| Version Number | The serial ID that identifies a version in the version table. |
