...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405683806743-Category-Options-Dialog-Box-Properties
updated_at: 2022-01-27T07:59:13Z
---

# Category Options Dialog Box Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420453372695/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405683792279-Button-Properties)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420453372951/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405690571415-Chart-Properties)

# Category Options Dialog Box Properties

This topic describes how you can use the Category Options dialog box to [set the sort order of the category values and define the number of the category values to show](https://devnet.logianalytics.com/hc/en-us/articles/4405684040855-Inserting-Components-in-Web-Report#SlctN) in a chart.

Server displays the dialog box when you select the Top N button ![Top N button](https://devnet.logianalytics.com/hc/article_attachments/4420447081367/btn_wbrpt_topn.gif) above the category box in the [Chart Wizard](https://devnet.logianalytics.com/hc/en-us/articles/4405683794583-Chart-Wizard-Properties), [Insert Chart dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405690593815-Insert-Chart-Dialog-Box-Properties), [Convert to Chart dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405683797655-Convert-to-Chart-Dialog-Box-Properties), or [To Chart dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405683892631-To-Chart-Dialog-Box-Properties), or in the Bind Data screen of chart in the [Web Report Wizard](https://devnet.logianalytics.com/hc/en-us/articles/4405690615447-Web-Report-Wizard-Properties#Chart).

![Category Options dialog](https://devnet.logianalytics.com/hc/article_attachments/4420447081623/ctgryoptn.gif)

**Category Order**

Specify in which order you want to display data on the category axis of a chart.
...
* **Select**  
  ...
  + **Top N**   
     Select, and then specify a number N in the field to the right to display the first N category values.
  + **Bottom** **N**  
     Select, and then specify a number N in the field to the right to display the last N category values.
* **Based On**  
