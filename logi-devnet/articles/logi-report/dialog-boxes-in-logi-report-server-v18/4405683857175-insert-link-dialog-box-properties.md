...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405683857175-Insert-Link-Dialog-Box-Properties
updated_at: 2022-01-27T07:59:23Z
---

# Insert Link Dialog Box Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420453372695/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405683856151-Insert-Image-Dialog-Box-Properties)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420453372951/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405683858199-Insert-Multimedia-Dialog-Box-Properties)
...
* ![Add button](https://devnet.logianalytics.com/hc/article_attachments/4420447073687/btn_add1.gif)**Add button**  
   Select to add a new condition using the [Edit Conditions dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405683809047-Edit-Conditions-Dialog-Box-Properties).
...
![Insert Link dialog - Report](https://devnet.logianalytics.com/hc/article_attachments/4420453420695/insrtlnk_rpt.gif)

**Report**

Specify the target linked report. Select **Browse** to select the desired report in the [Select a Report dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405683880855-Select-a-Report-Dialog-Box-Properties).
...
* **<Server Setting>**  
   Select to load the linked report according to setting of [Target of Detail Table Report and Links](https://devnet.logianalytics.com/hc/en-us/articles/4405684049047-Customizing-Web-Report-Studio-Profile#Target) in the Web Report Studio profile.
* **Same Frame**  
...
* **Components**  
  ...
  + ![Add button](https://devnet.logianalytics.com/hc/article_attachments/4420447073687/btn_add1.gif)**Add Component button**  
     Select to add a component in the linked report to interlink with the primary report.
  + ![Delete button](https://devnet.logianalytics.com/hc/article_attachments/4420453394455/btn_delete.gif)**Remove Component button**  
...
* **Field Conditions**  
  ...
  + ![Add button](https://devnet.logianalytics.com/hc/article_attachments/4420447073687/btn_add1.gif)**Add Condition button**  
     Select to add a new condition line.
  + ![Delete button](https://devnet.logianalytics.com/hc/article_attachments/4420453394455/btn_delete.gif)**Remove Condition button**  
     Select to remove the selected condition lines.
  + **Fields (Primary)**  
     Fields in the business view used by the selected component in the primary report.
  + **OP**  
     Specify the operator to compose the condition. It can be "=", "<>", "<", ">", "<=", ">=", or "IN".
  + **Fields (Linked)**  
     Fields in the business views of the linked report which are of the same data type as the selected fields in the primary report.
...
* **Primary Report Property/Object**  
   Filter objects in the primary report whose values you want to pass to filter objects in the linked report. Select the ellipsis button ![Select Value](https://devnet.logianalytics.com/hc/article_attachments/4420461473943/btn_chsr.gif) to select a filter object in the primary report in the [Select Value dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405690606103-Select-Value-Dialog-Box-Properties).
* **Linked Report Property/Object**  
   Filter objects in the linked report which will adopt the values passed from filter objects in the primary report. Select the ellipsis button ![Select Value](https://devnet.logianalytics.com/hc/article_attachments/4420461473943/btn_chsr.gif) to select a filter object in the linked report in the [Select Value dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405690606103-Select-Value-Dialog-Box-Properties). Make sure that the values of the filter object in the primary report can apply to the filter object in the linked report in the same line.
...
![Insert Link dialog - URL](https://devnet.logianalytics.com/hc/article_attachments/4420453422359/insrtlnk_url.gif)
...
* **Add Dynamic Field**  
   Select to open the [Select Field dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405690604311-Select-Field-Dialog-Box-Properties#Link) to insert a field into the URL.
...
* **<Server Setting>**  
   Select to load the URL according to setting of [Target of Detail Table Report and Links](https://devnet.logianalytics.com/hc/en-us/articles/4405684049047-Customizing-Web-Report-Studio-Profile#Target) in the Web Report Studio profile.
* **Same Frame**  
...
![Insert Link dialog - Mail](https://devnet.logianalytics.com/hc/article_attachments/4420453422615/insrtlnk_mal.gif)

**Hyperlink**

Specify the [email address](https://devnet.logianalytics.com/hc/en-us/articles/4405684041879-Adding-Links-in-Web-Report#MailSyntax) to link the object to. Then after you trigger the link, Server displays an email with the information you specified in the Hyperlink box. You can then further customize the email and send it.

* **Add Dynamic Field**  
   Select to open the [Select Field dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405690604311-Select-Field-Dialog-Box-Properties#Link) to insert a field into the email address.
...
![Insert Link dialog - Content](https://devnet.logianalytics.com/hc/article_attachments/4420447076759/insrtlnk_cntnt.gif)
...
Specify the content type for the Blob type data. You can select the formula button ![Formula button](https://devnet.logianalytics.com/hc/article_attachments/4420447036695/btn_wbrpt_fmla.gif) to bind it with a string type business view element, or with a dynamic formula in the current report.

**File Name**

Specify the file name for the Blob type data. You can select the formula button ![Formula button](https://devnet.logianalytics.com/hc/article_attachments/4420447036695/btn_wbrpt_fmla.gif) to bind it with a string type business view element, or with a dynamic formula in the current report.
