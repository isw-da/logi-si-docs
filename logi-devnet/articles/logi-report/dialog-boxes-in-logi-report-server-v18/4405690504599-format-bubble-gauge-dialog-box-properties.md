...
![Format Bubble Gauge dialog box - Staff Graph](https://devnet.logianalytics.com/hc/article_attachments/4420461709591/fmtbublgauge_stfgraph.gif)
...
![Format Bubble Gauge dialog box - Frame](https://devnet.logianalytics.com/hc/article_attachments/4420447322263/fmtbublgauge_frm.gif)
...
* **Show Gauge Group Name**   
  ...
  + **Position**  
     Select the position of the names relative to the bubbles. If you select **customized**, the X and Y settings on the General tab of the [Format Gauge Label dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405683640599-Format-Gauge-Label-Dialog-Box-Properties#General) will take effect.

## Range Color Tab Properties

Specify different colors to fill the bubbles in the bubble gauge in different ranges.

![Format Bubble Gauge dialog box - Range Color](https://devnet.logianalytics.com/hc/article_attachments/4420461709847/fmtbublgauge_rgclr.gif)
...
![Format Bubble Gauge dialog box - Hint](https://devnet.logianalytics.com/hc/article_attachments/4420453644951/fmtbublgauge_hint.gif)
