...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405683636119-Format-Bar-Gauge-Dialog-Box-Properties
updated_at: 2022-01-27T08:00:07Z
---

# Format Bar Gauge Dialog Box Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420453372695/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405683635095-Format-Bar-Dialog-Box-Properties)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420453372951/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405690504599-Format-Bubble-Gauge-Dialog-Box-Properties)
...
![Format Bar Gauge dialog box - Staff Graph](https://devnet.logianalytics.com/hc/article_attachments/4420461710103/fmtbargauge_stfgraph.gif)
...
![Format Bar Gauge dialog box - Axis - Axis tab](https://devnet.logianalytics.com/hc/article_attachments/4420461710359/fmtbargauge_axis_axis.gif)
...
![Format Bar Gauge dialog box - Axis - Tick Mark](https://devnet.logianalytics.com/hc/article_attachments/4420447322519/fmtbargauge_axis_tkmk.gif)
...
![Format Bar Gauge dialog box - Axis - Label](https://devnet.logianalytics.com/hc/article_attachments/4420461710615/fmtbargauge_axis_lbl.gif)
...
![Format Bar Gauge dialog box - Axis - Format](https://devnet.logianalytics.com/hc/article_attachments/4420461711127/fmtbargauge_axis_fmt.gif)

## Pointer Tab Properties

Specify the properties of the pointers in the bar gauge.

![Format Bar Gauge dialog box - Pointer](https://devnet.logianalytics.com/hc/article_attachments/4420453645335/fmtbargauge_pnt.gif)
...
* **Pointer Color**  
  ...
  + **Color List**   
     Select to open the [Color List dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405683801367-Color-List-Dialog-Box-Properties) to specify the color pattern for pointers in the same data series, respectively.
  + **Transparency**  
...
* **Pointer Color**  
  ...
  + **Color List**   
     Select to open the [Color List dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405690501271-Color-List-Dialog-Box-Properties) to specify the color pattern for color bars in the same data series, respectively.
* **Pointer Value**  
...
![Format Bar Gauge dialog box - Target](https://devnet.logianalytics.com/hc/article_attachments/4420453645591/fmtbargauge_tgt.gif)
...
* **Show Target Value**   
  ...
  + **Position**  
     Select the position of the target value relative to the bar. If you select **customized**, the X and Y settings on the General tab of the [Format Target Label dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405690507031-Format-Target-Label-Dialog-Box-Properties#General) will take effect.

## Frame Tab Properties

Specify the properties for the frame of the bar gauge chart.

![Format Bar Gauge dialog box - Frame](https://devnet.logianalytics.com/hc/article_attachments/4420447322903/fmtbargauge_frm.gif)
...
* **Show Gauge Group Name**   
  ...
  + **Position**  
     Select the position of the names relative to the bars. If you select **customized**, the X and Y settings on the General tab of the [Format Gauge Label dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405683640599-Format-Gauge-Label-Dialog-Box-Properties#General) will take effect.

## Range Color Tab Properties

Specify different colors to fill the bars in the bar gauge in different ranges.

![Format Bar Gauge dialog box - Range Color](https://devnet.logianalytics.com/hc/article_attachments/4420453645847/fmtbargauge_rgclr.gif)
...
![Format Bar Gauge dialog box - Hint](https://devnet.logianalytics.com/hc/article_attachments/4420461711383/fmtbargauge_hint.gif)
