...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405683695511-User-Defined-Function-Editor-Properties
updated_at: 2022-01-27T07:58:52Z
---

# User Defined Function Editor Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420453372695/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405683691031-Turn-to-Page-Dialog-Box-Properties)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420453372951/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405683696535-Zoom-Dialog-Box-Properties)

# User Defined Function Editor Properties

You can use the User Defined Function Editor to [write a user defined function](https://devnet.logianalytics.com/hc/en-us/articles/4405690650263-Using-Dynamic-Resources-in-Page-Report#UDF) which you can call in dynamic formulas or other user defined functions. This topic describes the properties in the dialog box.
...
Server displays a list of the Logi Report built-in functions and user defined functions that you can use in functions. Double-click a function to insert it into the editing box at the insertion point completely with its required syntax items (such as parentheses and commas).
...
Select this button, and then specify a color in the [Select Color dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405683679639-Select-Color-Dialog-Box-Properties). Server inserts the HEX code of the color in the editing box.
