...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009717741-Converting-Resources-of-Earlier-Versions-into-Current-Version
...
* **Converting via UI**
  ...
  1. In the Logi JReport Server console, point to **Administration** on the system toolbar, and then select **Other** > **Converting** from the drop-down menu to display the Converting page.

     ![Converting Resources](https://devnet.logianalytics.com/hc/article_attachments/4412112562583/mng_rsc_cnvt.gif)
...
* **Converting using tool**
  ...
  You can also use [rptconv.bat/rptconv.sh](https://devnet.logianalytics.com/hc/en-us/articles/1500009691282-Running-as-a-Standalone-Server#rptconv.bat) located in the `<install_root>\bin` directory to convert a resource and a type of resources or all resources earlier than V8 in a directory to current version.
