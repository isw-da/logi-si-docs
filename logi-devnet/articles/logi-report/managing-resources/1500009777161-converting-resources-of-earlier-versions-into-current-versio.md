...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009777161-Converting-Resources-of-Earlier-Versions-into-Current-Version
...
* **Converting resources via UI**
  ...
  1. In the Server Console, point to **Administration** on the system toolbar, and then select **Other** > **Converting** from the drop-down menu. Server displays the Converting page.

     ![Converting Resources](https://devnet.logianalytics.com/hc/article_attachments/4404885415191/mng_rsc_cnvt.gif)
  2. Specify the folders that contain the resources you want to convert.
...
* **Converting resources using tool**
  ...
  You can also use [rptconv.bat/rptconv.sh](https://devnet.logianalytics.com/hc/en-us/articles/1500009748582-Running-Logi-Report-Server-as-a-Standalone-Server#rptconv.bat) in the `<install_root>\bin` directory to convert a resource, a type of resources, or all resources earlier than V8 in a directory to current version.
