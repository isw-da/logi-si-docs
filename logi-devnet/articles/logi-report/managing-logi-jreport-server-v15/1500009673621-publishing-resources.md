...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009673621-Publishing-Resources
updated_at: 2021-07-24T20:54:02Z
---

# Publishing Resources

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404920354071/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009648782-Managing-Resources)   [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404920354327/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009673661-Searching-for-Resources)

# Publishing Resources

Before you can perform any tasks on Logi JReport Server, you first need to have your resources published and organized. The resources are reports, library components, catalogs, and folders.
...
You can directly publish your reports, library components, or catalogs from Logi JReport Designer to Logi JReport Server. For detailed information, see the topic "Publishing Resources Remotely" in the *Logi JReport Designer User's Guide*.
...
1. Do either of the following:
   * For administrators, on the Logi JReport Administration page, select **Resources** on the system toolbar and select **Resources** from the drop-down menu. In the Resources page, browse to the folder where you want to publish the resources, then select the **Publish to Local Server** link.
   * For end users, on the Logi JReport Console > Resources page, browse to the folder in which to publish the resources, then on the task bar of the Resources page, select **Publish** > **To Local Server**.

   The [Publish to Local Server](https://devnet.logianalytics.com/hc/en-us/articles/1500009671101-Publish-to-Local-Server) dialog appears.
...
3. Specify properties for the to-be-published resources as required.
   * **If the Page Report or Web Report resource type is selected:**
     ...
     + **Incomplete**  
        The report is not completely designed and cannot be run, advanced run or scheduled Logi JReport Server.5. Specify values of the [custom fields](https://devnet.logianalytics.com/hc/en-us/articles/1500009648802-Working-with-Custom-Fields) for the report if there are custom fields.
   ...
   * **If the Folder with Contents resource type is selected:**
     1. Select the **Browse** button next to the From Folder text field to specify the folder where the resources you want to publish are saved.
...
5. To apply an [archive policy](https://devnet.logianalytics.com/hc/en-us/articles/1500009673721-Applying-an-Archive-Policy) to the resources that you are publishing,
...
6. If the resources are to be published to the Public Reports or Public Components folder, select the **Set Permissions** link to specify user [permissions](https://devnet.logianalytics.com/hc/en-us/articles/1500009674981-Managing-Permissions) to them according to your requirement.
...
1. Do either of the following:
   * For administrators, on the Logi JReport Administration page, select **Resources** on the system toolbar and select **Resources** from the drop-down menu. In the Resources page, browse to the folder where you want to publish the resources, then select **Publish to Remote Server**.
   * For end users, on the Logi JReport Console > Resources page, browse to the folder in which to publish the resources, then on the task bar of the Resources page, select **Publish** > **To Remote Server**.

   The [Publish to Remote Server](https://devnet.logianalytics.com/hc/en-us/articles/1500009646742-Publish-to-Remote-Server) dialog appears.
...
3. Specify where the resources will be published.
   ...
   * If you want to create a new folder in the current open folder to locate the resources,
     ...
     4. Specify values of the [custom fields](https://devnet.logianalytics.com/hc/en-us/articles/1500009648802-Working-with-Custom-Fields) for the folder if there are custom fields.
     5. In the Resource Real Path text field, type a local disk path as the real path of the folder. If you want to enable getting resources from the real path, check **Enable Resources from Real Paths**. The local disk resources will be mapped into the resource node of the folder in the server resource tree and the server will be able to always get resources and updates from the real path. For details, see [Getting and Using Resources from a Real Path](https://devnet.logianalytics.com/hc/en-us/articles/1500009648902-Getting-and-Using-Resources-from-a-Real-Path).
4. If the resources you specify to publish contain reports created in earlier versions, check **Automatically Convert Old Report Schemas**, the reports will then be automatically converted into current version Logi JReport reports when publishing finishes.
5. To apply an [archive policy](https://devnet.logianalytics.com/hc/en-us/articles/1500009673721-Applying-an-Archive-Policy) to the resources that you are publishing,
   * For resources published to the My Reports or Public Reports folder, check the **Apply Archive Policy** option, then specify the archive policy as required: Archive as New Version or Replace Old Version.
   * For resources published to the My Components or Public Components folder, specify the maximum number of versions that will be listed in the version table of the resources.
...
* The resource type of Remote Publish can ONLY be a compressed file. You should compress the reports, library components, and catalog files in advance, and if special fonts are used in the reports or library components, add the corresponding font files into the compressed file as well. There are two approaches to building a compressed file.
  ...
  + You can use jar.exe that the JSDK provides to build a compressed jar file directly. Use the command as follows:
    ...
    `C:\myReports>C:\jdk1.7.0_17\bin\jar -cvfM c:\temp\aa.jar.`
...
* The Enable Resources from Real Paths option in the publish dialog can only be checked when the same option on the Logi JReport Administration > Configuration > Advanced page has also been checked.
* The Publish to Local Server option is always available to administrators on the Logi JReport Console page. For end users, the option is displayed only when they have the privilege of publishing resources and have logged onto Logi JReport Server from a local browser.
* After resources have been delivered to Logi JReport Server, you may find that the publish time shown on the server UI is different from the client time. That is because the publish time takes the server time instead of the client time.
