...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009648862-Linking-Resources-and-Catalogs
updated_at: 2021-07-24T20:54:02Z
---

# Linking Resources and Catalogs

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404920354071/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009673641-Changing-Resource-Properties)   [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404920354327/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009648822-Managing-Dynamic-Display-Names-of-Business-View-Elements)
...
* To set linked catalog at server level (this can only be done by administrators):
  1. Go to the Logi JReport Administration page, select **Configuration** on the system toolbar and select **Advanced** from the drop-down menu.
  2. On the Configuration - Advanced page, check **Enable Linked Catalog**, then select the **Select Another Catalog** link to specify the catalog which will be used as the linked catalog at server level.
  3. Select **Save** to save the change.
  4. Restart Logi JReport Server to make the settings take effect.
* To set linked catalog at folder/resource level, go to the [Properties](https://devnet.logianalytics.com/hc/en-us/articles/1500009673641-Changing-Resource-Properties) dialog of the folder/resource, check **Enable Linked Catalog**, then specify the linked catalog as required. End users can specify a linked catalog for multiple resources at a time.
...
* When [saving a page report](https://devnet.logianalytics.com/hc/en-us/articles/1500009673981-Saving-the-Report) in Page Report Studio, you can also save the original catalog as a linked catalog for the page report. It is the same case when [saving a web report](https://devnet.logianalytics.com/hc/en-us/articles/1500009650362-Saving-the-Report) in Web Report Studio.
* The [saved analysis templates](https://devnet.logianalytics.com/hc/en-us/articles/1500009667801-Saving-Analysis-Templates) are linked to their original catalogs. You cannot customize the analysis templates to be linked with a different catalog.
