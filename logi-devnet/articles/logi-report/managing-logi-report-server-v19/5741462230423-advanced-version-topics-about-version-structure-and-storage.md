...
Developers can also [use API to manage the resource versions](https://devnet.logianalytics.com/hc/en-us/articles/5741386771735-Working-with-Resource-Versions).
...
3. After Server connects to the database, ij enables the execution of Derby SQL statements interactively or via scripts.
   ...
   ![Critical icon](https://devnet.logianalytics.com/hc/article_attachments/9905614395415/criticalicon.gif)You must terminate all statements with a semicolon.
...
![Critical icon](https://devnet.logianalytics.com/hc/article_attachments/9905614395415/criticalicon.gif)Do not delete, update, or insert data into the database. You should make all modifications to the database from Logi Report Server instead of in the DBMS tools. Otherwise, Logi Report Server might stop responding if it finds invalid data.
...
For a [Logi Report Server Cluster](https://devnet.logianalytics.com/hc/en-us/articles/5741415572759-Logi-Report-Server-Cluster-Logi-Report-Server-v19), you can also use the **resource.share.hist.dir** property in the **server.properties** file to change the storage folder.
