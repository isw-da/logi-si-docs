...
For detailed examples of the going actions, refer to [Going Through the Report Data](https://devnet.logianalytics.com/hc/en-us/articles/1500009724802-Going-Through-the-Report-Data).
...
![Filter Condition Created by Going Action](https://devnet.logianalytics.com/hc/article_attachments/4404942605335/dshbrd_mnplt_go.gif)
...
![Data Format Submenu](https://devnet.logianalytics.com/hc/article_attachments/4404936954519/dshbrd_mnplt_format1.gif)
...
* **Filtering data in a table**  
  ...
  + **Using shortcut menu**   
    ...
    ![Filter Submenu](https://devnet.logianalytics.com/hc/article_attachments/4404942605591/dshbrd_mnplt_filter.gif)
    ...
    - **Select Values**   
      Brings up the [Select Values](https://devnet.logianalytics.com/hc/en-us/articles/1500009720302-Select-Values) dialog box to select the values to filter the field with.
  + **Using the filter button on table column headers**  
     You can use the filter button on any table column header to filter values in the column if the feature is enabled in the [server profile](https://devnet.logianalytics.com/hc/en-us/articles/1500009744941-Configuring-Server-Profile#ColumnHeader). By default, the feature is disabled so you need to configure the profile before you can use it.
    ...
    3. Put the mouse pointer on any column header and you can find the filter button ![Filter button](https://devnet.logianalytics.com/hc/article_attachments/4404942467223/btn_lblfltr.gif). Select the button and a filter list which contains the same items as the [Filter submenu](#Menu) appears.
...
* **Sorting data in a group table**  
  ...
  + **Using shortcut menu**  
    ...
    ![Sort Submenu](https://devnet.logianalytics.com/hc/article_attachments/4404942605847/dshbrd_mnplt_sort.gif)
  ...
  + **Using the sort button on table column headers**  
    ...
    2. Run a dashboard containing a table.
    3. Put the mouse pointer on any column header and you can find the sort button ![Sort button](https://devnet.logianalytics.com/hc/article_attachments/4404942455191/btn_lblsort.gif).
...
* **Swapping chart groups**  
  ...
  ![Chart Shortcut Menu](https://devnet.logianalytics.com/hc/article_attachments/4404942606103/dshbrd_mnplt_chart.gif)
...
* **Configuring real time chart settings**  
  ...
  1. Right-click the chart and select **Real-time Settings** from the shortcut menu. Report Server displays the [Real-time Settings](https://devnet.logianalytics.com/hc/en-us/articles/1500009720262-Real-time-Settings) dialog box.

     ![Real-time Settings dialog](https://devnet.logianalytics.com/hc/article_attachments/4404936892695/rltmset.gif)
  ...
  4. Select the **Incremental Fetch** button to add the fields you want to use as the unique key of the real time chart in the [Unique Key](https://devnet.logianalytics.com/hc/en-us/articles/1500009747141-Unique-Key) dialog box.
...
* **Switching crosstab fields**  
  ...
  ![Crosstab Shortcut Menu](https://devnet.logianalytics.com/hc/article_attachments/4404942606359/dshbrd_mnplt_crstb.gif)
