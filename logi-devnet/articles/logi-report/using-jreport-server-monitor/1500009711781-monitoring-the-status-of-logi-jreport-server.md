---
title: "Monitoring the Status of Logi JReport Server"
id: 1500009711781
section: "Using JReport Server Monitor"
category: "Logi Report"
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009711781-Monitoring-the-Status-of-Logi-JReport-Server
updated_at: 2021-11-03T06:58:42Z
---

# Monitoring the Status of Logi JReport Server

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4412139637143/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009686022-Configuring-Logi-JReport-Server-Monitor)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4412139637399/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009711761-Monitoring-the-Performance-of-Logi-JReport-Server)

# Monitoring the Status of Logi JReport Server

Logi JReport Server Monitor allows you to inspect the status of Logi JReport Server. You can list the servers and their status from a cluster. You can also list the reports by drilling down into the servers. For example, running reports, waiting reports, finished reports, and failed reports. Tracking further down, you can even view the status of these reports. Note that Logi JReport Server Monitor is not able to monitor the information of a report that is running in Page Report Studio.
...
| Status | The status of the server. Can be either Active or Inactive.  * **Active** - The server has been started and is ready for service. * **Inactive** - The server is inactive and cannot be available for service. |
...
* **Task ID**The exact date and time when the report was opened.
...
* **Average Number of Times per Day**The average number of times the opened report has run per day.
* **Last Submit Time**  
...
| --- | --- |
| Action | Stops the report from running and makes it a failed report. |
| Task ID | The internal ID for this report. If you select the ID, the [Task Information dialog](#Taskinfo) will pop up showing you the detailed task information. |
| Report | The full path name of the report. |
| User ID | The ID of the user who opened the report. |
...
the server database in a standalone environment in the *Logi JReport Server User's Guide*.

**To export the monitoring data of the reports' status:**

1. Select the **Export Data** link on the reports status panel. The Export Data dialog is displayed.

   ![Export Data dialog](https://devnet.logianalytics.com/hc/article_attachments/4412139637655/exptdata.gif)
...
**Note:** The exported monitoring data in the CSV file is encoded with UTF-8. If you open an exported CSV file that contains Chinese strings by a double-click, the Chinese strings display as random code in the file. To solve this problem, open the file in the following way:
...
Expand any server node in the left panel of the Logi JReport Server Monitor home page, and then select **Users**, you can see the status of the online users on the server. You can also select and remove specific users.
...
Expand any server node in the left panel of the Logi JReport Server Monitor home page, and then select **Databases**, you can see the status of the server's database connection pool. You can also select and remove specific connections.
