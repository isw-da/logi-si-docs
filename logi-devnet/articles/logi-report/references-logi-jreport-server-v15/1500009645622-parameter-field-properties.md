...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009645622-Parameter-Field-Properties
updated_at: 2021-07-24T20:55:04Z
---

# Parameter Field Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404920354071/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009669901-Parameter-Control-Properties)   [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404920354327/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009645602-Parameter-Form-Control-Properties)

# Parameter Field Properties

The Parameter Field Properties dialog helps you to edit the properties of a parameter field. It contains the following tabs:
...
This tab shows some general information of the parameter field. [See the tab](javascript:%20void(null)).

![](https://devnet.logianalytics.com/hc/article_attachments/4404920616087/prmtrprpty_gnrl.gif)
...
Specifies to show the translated name of the display name of the parameter field in the Name text box if you have enabled the NLS feature and translated it.
...
To change the color, select the color indicator to access the [Select Color](https://devnet.logianalytics.com/hc/en-us/articles/1500009645662-Select-Color) dialog and then specify a new color, or input a color string in the text box.

[![](https://devnet.logianalytics.com/hc/article_attachments/4404920354583/totop.png)Back to top](#top "Click to go to the top")

## Font

This tab shows the font-related information of the parameter field. [See the tab](javascript:%20void(null)).

![](https://devnet.logianalytics.com/hc/article_attachments/4404920616343/prmtrprpty_font.gif)
...
This tab shows information about borders of the parameter field. [See the tab](javascript:%20void(null)).

![](https://devnet.logianalytics.com/hc/article_attachments/4404920616599/prmtrprpty_border.gif)
...
![](https://devnet.logianalytics.com/hc/article_attachments/4404920617111/prmtrprpty_other.gif)
...
Specifies to display the parameter field as list. [See the tab](javascript:%20void(null)).

![](https://devnet.logianalytics.com/hc/article_attachments/4404926764695/prmtrprpty_rndrlst.gif)
...
Specifies to display the parameter field as drop-down list. [See the tab](javascript:%20void(null)).

![](https://devnet.logianalytics.com/hc/article_attachments/4404920617495/prmtrprpty_rndrdrpdwn.gif)
...
**Reference:** For the rest display types, see [Data Field Properties](https://devnet.logianalytics.com/hc/en-us/articles/1500009645022-Data-Field-Properties#Render).
