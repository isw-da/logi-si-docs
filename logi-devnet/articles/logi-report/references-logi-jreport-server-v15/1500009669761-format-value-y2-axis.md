...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009669761-Format-Value-Y2-Axis
updated_at: 2021-07-24T20:55:10Z
---

# Format Value (Y2) Axis

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404920354071/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009645162-Format-Value-Y-Axis)   [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404920354327/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009669661-Formula-Editor)

# Format Value (Y2) Axis

The Format Value (Y2) Axis dialog appears when you right-click a chart and select Format Axis (unavailable to pie or indicator chart) > Format Value (Y2) Axis from the shortcut menu. It helps you to format the value (Y2) axis of the chart and contains the following tabs:
...
![](https://devnet.logianalytics.com/hc/article_attachments/4404920624791/fmtvalueaxis2_axis.gif)
...
Specifies the properties of the major tick marks on the axis. [See the tab](javascript:%20void(null)).

![](https://devnet.logianalytics.com/hc/article_attachments/4404920625047/fmtvalueaxis2_mark_major.gif)
...
Specifies the properties of the minor tick marks on the axis. [See the tab](javascript:%20void(null)).

![](https://devnet.logianalytics.com/hc/article_attachments/4404926769047/fmtvalueaxis2_mark_minor.gif)
...
![](https://devnet.logianalytics.com/hc/article_attachments/4404920625303/fmtvalueaxis2_font.gif)
...
![](https://devnet.logianalytics.com/hc/article_attachments/4404920625559/fmtvalueaxis2_orntatn.gif)
...
Specifies data format of the major tick mark labels on the axis. [See the tab](javascript:%20void(null)).

![](https://devnet.logianalytics.com/hc/article_attachments/4404920625815/fmtvalueaxis2_fmt.gif)
