...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009645122-Filter-Control-Properties
updated_at: 2021-07-24T20:55:10Z
---

# Filter Control Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404920354071/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009645182-Fetch-Data)   [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404920354327/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009645102-Filter)

# Filter Control Properties

The Filter Control Properties dialog helps you to edit the properties of a filter control. It contains the following tabs:
...
This tab shows some general information of the filter control. [See the tab](javascript:%20void(null)).

![](https://devnet.logianalytics.com/hc/article_attachments/4404926774295/fltrctrlprpty_gnrl.gif)
...
Specifies to show the translated name of the display name of the filter control in the Name text box if you have enabled the NLS feature and translated it.
...
Displays the fields that the filter control is based on. You can select the button ![](https://devnet.logianalytics.com/hc/article_attachments/4404920370839/btn_chsr2.gif) to open the [Edit Filter Control](https://devnet.logianalytics.com/hc/en-us/articles/1500009669581-Edit-Filter-Control) dialog.
...
This tab shows the font-related information of the text in the filter control. [See the tab](javascript:%20void(null)).

![](https://devnet.logianalytics.com/hc/article_attachments/4404920634647/fltrctrlprpty_font.gif)
...
This tab shows information about borders of the filter control. [See the tab](javascript:%20void(null)).

![](https://devnet.logianalytics.com/hc/article_attachments/4404920635031/fltrctrlprpty_border.gif)
...
This tab shows information about the title of the filter control. It is available when the Show Title option is selected in the General tab of the same dialog. [See the tab](javascript:%20void(null)).

![](https://devnet.logianalytics.com/hc/article_attachments/4404920635415/fltrctrlprpty_title.gif)
