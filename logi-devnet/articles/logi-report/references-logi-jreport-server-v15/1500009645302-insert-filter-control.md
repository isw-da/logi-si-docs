...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009645302-Insert-Filter-Control
updated_at: 2021-07-24T20:55:07Z
---

# Insert Filter Control

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404920354071/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009645282-Insert-Detail-Column)   [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404920354327/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009645322-Insert-Group-Column)

# Insert Filter Control

The Insert Filter Control dialog helps you to [insert a filter control](https://devnet.logianalytics.com/hc/en-us/articles/1500009674041-Applying-Web-Controls#Filter) into a report for filtering data components in the report (excluding its subreport). [See the dialog](javascript:%20void(null)).
...
* **Fetch Data**  
   Opens the [Fetch Data](https://devnet.logianalytics.com/hc/en-us/articles/1500009645182-Fetch-Data) dialog to select values from the database and adds the selected values to the text box below.
* **Text box**  
...
Specifies whether the filter control can be affected by other filter controls which are applied to the same data components and contain the same data type of fields from the same business view or query as the filter control. In the case when one filter control is based on a business view and another a query, if the business view contains the query definition, the two filter controls are also interlinked.
