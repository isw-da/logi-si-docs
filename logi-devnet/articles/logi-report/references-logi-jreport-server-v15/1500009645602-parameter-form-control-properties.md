...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009645602-Parameter-Form-Control-Properties
updated_at: 2021-07-24T20:55:04Z
---

# Parameter Form Control Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404920354071/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009645622-Parameter-Field-Properties)   [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404920354327/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009645522-PDF-Encrypt-Option)

# Parameter Form Control Properties

The Parameter Form Control Properties dialog helps you to edit the properties of a parameter form control. It contains the following tabs:
...
This tab shows some general information of the parameter form control. [See the tab](javascript:%20void(null)).

![](https://devnet.logianalytics.com/hc/article_attachments/4404920617751/prmfrmctrlprpty_gnrl.gif)
...
Specifies to show the translated name of the display name of the parameter form control in the Name text box if you have enabled the NLS feature and translated it.

If checked, this option takes effect only when the display name of the parameter form control is not modified.

**Position**

Displays the position mode of the parameter form control. If the parameter form control is directly contained in the report body, a tabular cell, or a text box, its position mode can be modified.

* **Absolute**: The parameter form control's position will be decided by its X and Y property values.
* **Static**: The parameter form control will be positioned at the default location in its container. If selected, the X, Y and other position-related properties will be hidden or disabled.
...
This tab shows information about borders of the parameter form control. [See the tab](javascript:%20void(null)).

![](https://devnet.logianalytics.com/hc/article_attachments/4404920618007/prmfrmctrlprpty_border.gif)
...
This tab shows information about the title of the parameter form control. It is available when the Show Title option is selected in the General tab of the same dialog. [See the tab](javascript:%20void(null)).

![](https://devnet.logianalytics.com/hc/article_attachments/4404920618263/prmfrmctrlprpty_title.gif)
