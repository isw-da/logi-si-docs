...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009671601-Convert-to-Crosstab
updated_at: 2021-07-24T20:54:37Z
---

# Convert to Crosstab

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404920354071/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009671581-Convert-to-Chart)   [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404920354327/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009671621-Convert-to-Table)

# Convert to Crosstab

The Convert to Crosstab dialog appears when you focus on a table or a chart and then select ![](https://devnet.logianalytics.com/hc/article_attachments/4404920367639/btn_wbrpt_2crstb.gif) on the visualization toolbar but the data fields in the table or chart are not enough for a crosstab. It helps you to convert a table or chart to a crosstab. [See the dialog](javascript:%20void(null)).
...
Adds the selected aggregation object ![](https://devnet.logianalytics.com/hc/article_attachments/4404926627351/btn_bvaggrgtn.gif) or detail object ![](https://devnet.logianalytics.com/hc/article_attachments/4404920356631/btn_bvdtl.gif) to be the summary field of the crosstab.
...
* **Label**  
   Specifies the display names for the selected group objects. You can select in the cells to edit them if required.
* **Sort**  
...
* **Label**  
   Specifies the display names for the selected objects. You can select in the cells to edit them if required.
* **Aggregation**  
