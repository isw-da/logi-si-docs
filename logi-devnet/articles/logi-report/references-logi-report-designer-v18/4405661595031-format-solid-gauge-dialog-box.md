...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405661595031-Format-Solid-Gauge-Dialog-Box
updated_at: 2022-01-27T20:38:13Z
---

# Format Solid Gauge Dialog Box

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420394625303/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405661592471-Format-Series-Z-Gridline-Dialog-Box)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420394625687/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405661597719-Format-Stock-Dialog-Box)

# Format Solid Gauge Dialog Box

You can use the Format Solid Gauge dialog box to [format a solid gauge chart](https://devnet.logianalytics.com/hc/en-us/articles/4405664379031-Formatting-the-Gauge-in-a-Gauge-Chart#Solid). This topic describes the options in the dialog box.
...
![Format Solid Gauge dialog box - Circular Graph](https://devnet.logianalytics.com/hc/article_attachments/4420394767511/fmtsldgauge_crculr.gif)
...
* **Angle**  
  Select the degree for the angle of the arcs. If you select "Customized", Designer displays the [Customize Gauge Angle dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405664448919-Customize-Gauge-Angle-Dialog-Box) for you to customize the angle.
* **Thickness**  
...
* **Color**  
  Specify the color of the arcs. To edit the color, select the color indicator and select a color from the [color palette](https://devnet.logianalytics.com/hc/en-us/articles/4405661953175-Menu-Tabs#Palette) or type the hexadecimal value of a color (for example, 0xff0000) in the text box.
* **Color List**  
  Select to open the [Color List](https://devnet.logianalytics.com/hc/en-us/articles/4405661476887-Color-List-Dialog-Box) dialog to modify the color pattern for arcs in the same data series respectively.
* **Transparency**  
...
![Format Solid Gauge dialog box - Axis - Axis](https://devnet.logianalytics.com/hc/article_attachments/4420410725143/fmtsldgauge_axis_axis1.gif)
...
* **Minimum Value**  
  Specify the minimum value to display on the axis. You can select ![Formula button](https://devnet.logianalytics.com/hc/article_attachments/4420410598551/btn_fmla.gif) to [use a formula to control the value](https://devnet.logianalytics.com/hc/en-us/articles/4405664601367-Using-Formulas-to-Control-Object-Properties).
* **Maximum Value**  
  Specify the maximum value to display on the axis. You can select ![Formula button](https://devnet.logianalytics.com/hc/article_attachments/4420410598551/btn_fmla.gif) to use a formula to control the value.
...
![Format Solid Gauge dialog box - Axis - Tick Mark](https://devnet.logianalytics.com/hc/article_attachments/4420402440215/fmtsldgauge_axis_tkmk.gif)
...
* **Correlate with Axis**  
  ...
  + **Transparency**  
    Specify the color transparency of the minor tick mark line. Designer disables this option when you select Use Range Color in the Axis subtab.
  + **Thickness**  
...
![Format Solid Gauge dialog box - Axis - Label](https://devnet.logianalytics.com/hc/article_attachments/4420410726039/fmtsldgauge_axis_lbl.gif)
...
![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4420394642839/noteicon.jpg) Designer disables the Font Color and Transparency options if you select [Use Range Color](#UseRangeColor) in the Axis subtab.
...
![Format Solid Gauge dialog box - Axis - Format](https://devnet.logianalytics.com/hc/article_attachments/4420410726295/fmtsldgauge_axis_fmt.gif)
...
![Format Solid Gauge dialog box - Pointer](https://devnet.logianalytics.com/hc/article_attachments/4420410726551/fmtsldgauge_pnt.gif)
...
![Format Solid Gauge dialog box - Target](https://devnet.logianalytics.com/hc/article_attachments/4420402441111/fmtsldgauge_tgt.gif)
...
* **Target Value**  
  Specify the target value. You can select ![Formula button](https://devnet.logianalytics.com/hc/article_attachments/4420410598551/btn_fmla.gif) to use a formula to control the value.
...
![Format Solid Gauge dialog box - Frame](https://devnet.logianalytics.com/hc/article_attachments/4420410727191/fmtsldgauge_frm.gif)
...
![Format Solid Gauge dialog box - Range Color](https://devnet.logianalytics.com/hc/article_attachments/4420394771863/fmtsldgauge_rgclr.gif)
...
![Format Solid Gauge dialog box - Hint](https://devnet.logianalytics.com/hc/article_attachments/4420402442135/fmtsldgauge_hint.gif)
...
![Format Solid Gauge dialog box - Behaviors](https://devnet.logianalytics.com/hc/article_attachments/4420394772887/fmtsldgauge_bhvr.gif)
