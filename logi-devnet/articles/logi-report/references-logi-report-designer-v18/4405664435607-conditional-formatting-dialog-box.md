...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405664435607-Conditional-Formatting-Dialog-Box
updated_at: 2022-01-27T20:35:40Z
---

# Conditional Formatting Dialog Box

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420394625303/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405661470231-Comparison-Function-Dialog-Box)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420394625687/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405661471511-Connect-to-Logi-Report-Server-Dialog-Box)

# Conditional Formatting Dialog Box

You can use the Conditional Formatting dialog box to add conditional formatting [to values of the selected field](https://devnet.logianalytics.com/hc/en-us/articles/4405664395799-Working-with-DBFields#Format) or [to geographic map markers](https://devnet.logianalytics.com/hc/en-us/articles/4405661389335-Modifying-Geographic-Maps#Format). This topic describes the options in the dialog box.

Designer displays the Conditional Formatting dialog box when you select a field or geographic map in a report and then select Conditional Formatting ![Conditional Formatting button](https://devnet.logianalytics.com/hc/article_attachments/4420394635159/btn_cndtnlfmt.gif) on the Home/Format menu tab, or right-click the field or geographic map and select Conditional Formatting from the shortcut menu. Designer provides you with different options in the dialog box for adding conditional formatting [for the values of a field](#Field) or [for geographic map markers](#GMap).
...
![Conditional Formatting dialog box for a field](https://devnet.logianalytics.com/hc/article_attachments/4420402525847/cndtnlfmt.gif)
...
* ![Add button](https://devnet.logianalytics.com/hc/article_attachments/4420394650391/btn_add.gif)**Add button**  
  Select to open the [Edit Conditions dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405664456727-Edit-Conditions-Dialog-Box) to add a new condition.
...
* **Foreground Color**  
  Specify the foreground color for the values. To edit the color, select the color indicator and select a color from the [color palette](https://devnet.logianalytics.com/hc/en-us/articles/4405661953175-Menu-Tabs#Palette) or type the hexadecimal value of a color (for example, 0xff0000) in the text box.
* **Background Color**  
...
![Conditional Formatting dialog box for geographic map](https://devnet.logianalytics.com/hc/article_attachments/4420402526359/cndtnlfmt_gmp.gif)
