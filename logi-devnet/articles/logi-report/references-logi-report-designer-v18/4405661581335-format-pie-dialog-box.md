...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405661581335-Format-Pie-Dialog-Box
updated_at: 2022-01-27T20:35:58Z
---

# Format Pie Dialog Box

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420394625303/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405661584023-Format-Pattern-Dialog-Box)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420394625687/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405664497047-Format-Platform-Dialog-Box)

# Format Pie Dialog Box

You can use the Format Pie dialog box to [format the pies of a pie chart](https://devnet.logianalytics.com/hc/en-us/articles/4405664383127-Formatting-the-Pies-Donuts-and-KPI-Value-Labels-in-a-Pie-Donut-Chart). This topic describes the options in the dialog box.
...
![Format Pie - General](https://devnet.logianalytics.com/hc/article_attachments/4420410740759/fmtpie_gnrlv18.2.gif)
...
Designer enables this box when you do not set the chart property [Swap Groups](https://devnet.logianalytics.com/hc/en-us/articles/4405664650263-Chart-Properties#SwapGroups) to "true".

* **Show KPI Value**  
  Select to show the KPI value for each pie.
* **KPI Value**  
  Specify the KPI value to display on each pie. Type the value in the text box or select ![Formula button](https://devnet.logianalytics.com/hc/article_attachments/4420410598551/btn_fmla.gif) and select a formula or summary from the drop-down list to use its value as the KPI value.
  + **Auto**  
...
![Format Pie - Fill](https://devnet.logianalytics.com/hc/article_attachments/4420410741271/fmtpie_fill.gif)
...
* **Color List**  
  Select to open the [Color List dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405661476887-Color-List-Dialog-Box) to modify the color pattern for pie sections in the same data series respectively.
...
* **Advanced**
  + ![Edit button](https://devnet.logianalytics.com/hc/article_attachments/4420394656407/btn_edit.gif)**Edit button**  
    Select to open the [Edit Conditions dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405664456727-Edit-Conditions-Dialog-Box#Chart) to edit the condition and its color pattern.
  + **Condition**  
...
![Format Pie - Border](https://devnet.logianalytics.com/hc/article_attachments/4420394777751/fmtpie_border.gif)
...
![Format Pie - Data Label](https://devnet.logianalytics.com/hc/article_attachments/4420402452247/fmtpie_data.gif)
...
![Format Pie - Hint](https://devnet.logianalytics.com/hc/article_attachments/4420402452759/fmtpie_hint.gif)
...
![Format Pie - Behaviors](https://devnet.logianalytics.com/hc/article_attachments/4420394778391/fmtpie_bhvr.gif)
