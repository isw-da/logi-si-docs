...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405661601047-Format-Value-Y2-Axis-Dialog-Box
updated_at: 2022-01-27T20:36:10Z
---

# Format Value (Y2) Axis Dialog Box

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420556069783/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405661602455-Format-Value-Y-Gridline-Dialog-Box)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420550802199/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405664509719-Format-Value-Y2-Gridline-Dialog-Box)

# Format Value (Y2) Axis Dialog Box

You can use the Format Value (Y2) Axis dialog box to [format the value (Y2) axis of a combo chart](https://devnet.logianalytics.com/hc/en-us/articles/4405664375831-Formatting-the-Axes#Value). This topic describes the options in the dialog box.

Designer displays the Format Value (Y2) Axis dialog box when you right-click a combo chart and navigate to Format Axes > Format Value (Y2) Axis on the shortcut menu, or double-click the Y2 axis of a combo chart.
...
![Format Value (Y2) Axis - Axis](https://devnet.logianalytics.com/hc/article_attachments/4420556157463/fmtvalueaxis2_axis.gif)
...
Use this subtab to specify properties of the major tick marks on the value (Y2) axis.

![Format Value (Y2) Axis - Major Tick Mark](https://devnet.logianalytics.com/hc/article_attachments/4420542122391/fmtvalueaxis2_mark_major.gif)
...
Use this subtab to specify properties of the minor tick marks on the value (Y2) axis.

![Format Value (Y2) Axis - Minor Tick Mark](https://devnet.logianalytics.com/hc/article_attachments/4420550893463/fmtvalueaxis2_mark_minor.gif)
...
![Format Value (Y2) Axis - Font](https://devnet.logianalytics.com/hc/article_attachments/4420542122647/fmtvalueaxis2_font.gif)
...
![Format Value (Y2) Axis - Orientation](https://devnet.logianalytics.com/hc/article_attachments/4420550893847/fmtvalueaxis2_orntatn.gif)
...
![Format Value (Y2) Axis - Format](https://devnet.logianalytics.com/hc/article_attachments/4420550894103/fmtvalueaxis2_fmt.gif)
