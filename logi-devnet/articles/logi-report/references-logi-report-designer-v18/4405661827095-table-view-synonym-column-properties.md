...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405661827095-Table-View-Synonym-Column-Properties
updated_at: 2022-01-27T20:35:30Z
---

# Table/View/Synonym Column Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420394625303/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405661825943-Table-View-Synonym-Properties)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420394625687/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405661828503-User-Defined-Data-Source-UDS-Properties)
...
| Column Name | Specifies the name of the column in the raw database. Data type: String  Note icon Designer does not provide this property when the table column is in a MongoDB/JSON/Elasticsearch connection. |
| Column Type | Designer displays this property when the table column is in a MongoDB/JSON/Elasticsearch connection. It shows the type of the column. This property is read only. |
...
| Nullable | Shows the nullability for the values of the column. This property is read only. |
