...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405664433559-Chart-Iterator-Dialog-Box
updated_at: 2022-01-27T20:36:03Z
---

# Chart Iterator Dialog Box

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420556069783/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405664431511-Change-Property-Dialog-Box)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420550802199/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405661468695-Chart-Wizard-Dialog-Box)

# Chart Iterator Dialog Box

You can use the Chart Iterator dialog box to edit the [properties of an iterator](https://devnet.logianalytics.com/hc/en-us/articles/4405661370647-Editing-Range-Groups-on-Category-Values) in a chart. This topic describes the options in the dialog box.

Designer displays the Chart Iterator dialog box when you right-click the blank area and select Chart Iterator from the shortcut menu in the editing box of the [Data Label Editor dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405664453655-Data-Label-Editor-Dialog-Box).
...
![Chart Interator dialog box - Text Format](https://devnet.logianalytics.com/hc/article_attachments/4420542177943/chtitratr_txt.gif)
...
* **At**  
  Specify the distances between lines. This option takes effect for the "at least", "exactly", or "multiple" Line Spacing only.
...
![Chart Iterator dialog box - Font](https://devnet.logianalytics.com/hc/article_attachments/4420556220183/chtitratr_fnt.gif)

**Font list**

This box lists all the available font faces for the text. Select the font face you want to apply.
...
Select the font color of the text. You can select Custom from the drop-down list to customize a color in the [Pick a Color dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405664544407-Pick-a-Color-Dialog-Box#Color).
...
* **Underline Color**  
  Select the color for the horizontal line under the text. You can select Custom from the drop-down list to customize a color in the [Pick a Color dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405664544407-Pick-a-Color-Dialog-Box#Color).
* **Underline Style**  
...
![Chart Iterator dialog box - Iteration](https://devnet.logianalytics.com/hc/article_attachments/4420542178199/chtitratr_itratn.gif)

**Iterated By**

This box lists the fields that you select to use as the marks of the iterator. You can change the display order of the fields.
