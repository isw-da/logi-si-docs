...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405661574935-Format-Indicator-Dialog-Box
updated_at: 2022-01-27T20:35:33Z
---

# Format Indicator Dialog Box

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420394625303/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405664491543-Format-Gauge-Label-Dialog-Box)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420394625687/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405661576215-Format-KPI-Label-Dialog-Box)

# Format Indicator Dialog Box

You can use the Format Indicator dialog box to [format the indicators in an indicator chart](https://devnet.logianalytics.com/hc/en-us/articles/4405661356695-Formatting-the-Indicators-in-an-Indicator-Chart). This topic describes the options in the dialog box.
...
![Format Indicator - General](https://devnet.logianalytics.com/hc/article_attachments/4420394785687/fmtindctr_gnrl.gif)
...
![Format Indicator - Frame](https://devnet.logianalytics.com/hc/article_attachments/4420410752663/fmtindctr_frm.gif)
...
![Format Indicator - Range Color for Boolean Values](https://devnet.logianalytics.com/hc/article_attachments/4420394787095/fmtindctr_range_boln.gif)
...
This column shows the colors that you specify for the two values in the indicator chart. Select the cell to customize the color in the [color palette](https://devnet.logianalytics.com/hc/en-us/articles/4405661953175-Menu-Tabs#Palette).

**Image**

This column shows the images that you specify to represent the two values of the indicator chart. Select the ellipsis ![Ellipsis button](https://devnet.logianalytics.com/hc/article_attachments/4420402297111/btn_ellipsis2.gif) in each cell to select the image for a range.
...
![Format Indicator - Range Color for String/Numeric Values](https://devnet.logianalytics.com/hc/article_attachments/4420402459415/fmtindctr_range_num.gif)
...
This column shows the colors that you specify for the ranges. Select the color cell to customize the color in the [color palette](https://devnet.logianalytics.com/hc/en-us/articles/4405661953175-Menu-Tabs#Palette).

**Image**

This column shows the images that you specify to represent the values in the ranges. Select the ellipsis ![Ellipsis button](https://devnet.logianalytics.com/hc/article_attachments/4420402297111/btn_ellipsis2.gif) in each cell to select the image for a range.
...
* **Image**  
  Specify the image to represent the values. Select the ellipsis ![Ellipsis button](https://devnet.logianalytics.com/hc/article_attachments/4420402297111/btn_ellipsis2.gif) to select the image.

## Hint Tab

Use this tab to specify properties for the hint of the indicators.

![Format Indicator - Hint](https://devnet.logianalytics.com/hc/article_attachments/4420394787479/fmtindctr_hint.gif)
...
![Format Indicator - Behaviors](https://devnet.logianalytics.com/hc/article_attachments/4420394787863/fmtindctr_bhvr.gif)
