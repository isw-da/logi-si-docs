...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405661667735-Options-Dialog-Box
updated_at: 2022-05-25T03:22:47Z
---

# Options Dialog Box

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420556069783/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405661666327-Open-Report-Dialog-Box)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420550802199/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405664538519-Page-Panel-Dialog-Box)
...
![Options dialog box - General category](https://devnet.logianalytics.com/hc/article_attachments/4420550871959/optn_gnrl.gif)
...
Select to show objects that are hidden in your report. When you select this option, Designer selects Hidden Objects on the View menu tab by default, and vice versa.
...
Select to apply high precision view in Designer by default. When you select this option, Designer selects High Precision View on the View menu tab by default, and vice versa.
...
Specify the ratio using which to scale the Designer UI. The larger the ratio is, the larger the graphics and text you see on the Designer UI. If you are using JDK 11 or higher, you should specify an appropriate ratio based on your device requirements, in order to display the graphics and text on the Designer UI in the size you expect.
...
Use this category to specify properties of the report editor, that is the [Design tab](https://devnet.logianalytics.com/hc/en-us/articles/4405661948695-Design-View-Area) in the main window.

![Options dialog box - Editor category](https://devnet.logianalytics.com/hc/article_attachments/4420542107799/optn_edtr.gif)

**Show status bar**

Select to show the status bar at the bottom of the Designer main window when you preview a report. When you select this option, Designer selects Status Bar on the View menu tab by default, and vice versa.

**Show ruler**

Select to show the horizontal and vertical rulers in the design area. When you select this option, Designer selects Rules on the View menu tab by default, and vice versa.

**Show guidelines**

Select to show the guidelines in the main window of the reports. When you select this option, Designer selects Gridlines on the View menu tab by default, and vice versa.
...
Select to show the margins in the design area. When you select this option, Designer selects Margin on the View menu tab by default, and vice versa.

* **Margin Line Color**  
  Select the color of the margin line. Select a color from the drop-down list or select Custom to customize a color in the [Pick a Color dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405664544407-Pick-a-Color-Dialog-Box#Color).
...
* **Color**  
  Select the color of the grids. Select a color from the drop-down list or select Custom to customize a color in the [Pick a Color dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405664544407-Pick-a-Color-Dialog-Box#Color).

**Display Attributes**

You can specify the display attributes for Designer in this box, which you can also set in the [Display Attributes dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405664450967-Display-Attributes-Dialog-Box).
...
![Options dialog box - Panel category](https://devnet.logianalytics.com/hc/article_attachments/4420556138647/optn_pnl.gif)>

**Show Components**

Select to show the Components panel in the Designer main window. When you select this option, Designer selects Components on the View menu tab by default, and vice versa.

**Show Data**

Select to show the Data panel in the Designer main window. When you select this option, Designer selects Data on the View menu tab by default, and vice versa.

**Show Catalog Manager**

Select to show the Catalog Manager in Designer. When you select this option, Designer selects Catalog Manager on the View menu tab by default, and vice versa.

**Show Inspector**

Select to show the Inspector panel in the Designer main window. When you select this option, Designer selects Inspector on the View menu tab by default, and vice versa.
...
![Options dialog box - Format category](https://devnet.logianalytics.com/hc/article_attachments/4420542108183/optn_frmt.gif)
...
You can specify the font properties of the text in the columns in this box.
...
* **Vertical Alignment**  
  Select vertical alignment of the text in the columns.
* **Foreground**  
  Select the foreground color of the text in the columns. Select a color from the drop-down list or select Custom to customize a color in the [Pick a Color dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405664544407-Pick-a-Color-Dialog-Box#Color).
* **Auto Fit**  
  Select to adjust the width and height of the columns according to their contents.
* **Word wrap**  
...
* **Border Color**  
  Select the color of the borders. Select a color from the drop-down list or select Custom to customize a color in the [Pick a Color dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405664544407-Pick-a-Color-Dialog-Box#Color).
* **Top Line**  
...
Select the background color of the columns. Select a color from the drop-down list or select Custom to customize a color in the [Pick a Color dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405664544407-Pick-a-Color-Dialog-Box#Color).
...
![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4420542072599/noteicon.jpg) Designer applies the padding values when you add data columns to a catalog. You can adjust the values for each column in the Catalog Manager, or after adding the columns to reports in the Report Inspector.

## Dataset Category

Use this category to specify the options for using datasets in reports.

![Options dialog box - Dataset category](https://devnet.logianalytics.com/hc/article_attachments/4420550872855/optn_dtst.gif)
...
![Options dialog box - Component category](https://devnet.logianalytics.com/hc/article_attachments/4420556138903/optn_cmpnt.gif)
...
See the [Position](https://devnet.logianalytics.com/hc/en-us/articles/4405661931671-Editing-Reports#Position) property for more information.
...
Use this category to specify the options for [previewing reports](https://devnet.logianalytics.com/hc/en-us/articles/4405664696343-Previewing-Reports) in Designer.

![Options dialog box - Preview category](https://devnet.logianalytics.com/hc/article_attachments/4420550873111/optn_prvw.gif)
...
![Options dialog box - Catalog category](https://devnet.logianalytics.com/hc/article_attachments/4420556139287/optn_ctlg.gif)
...
Select to open the [Advanced Export Settings dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405664427671-Advanced-Export-Settings-Dialog-Box) to customize the layout precision for each export format.

### HTML Tab

You can specify the preferences for [exporting the report to HTML](https://devnet.logianalytics.com/hc/en-us/articles/4405664596375--Exporting-to-HTML) in this tab.

![Options dialog box - Export to category - HTML tab](https://devnet.logianalytics.com/hc/article_attachments/4420550873495/optn_expt_html.gif)
...
You can specify the email server and the preferences for [exporting the report to email](https://devnet.logianalytics.com/hc/en-us/articles/4405664597271-Exporting-to-Mail) in this tab.

![Options dialog box - Export to category - E-mail tab](https://devnet.logianalytics.com/hc/article_attachments/4420550854295/optn_expt_mal.gif)
...
You can specify the fax settings for [exporting the report to fax](https://devnet.logianalytics.com/hc/en-us/articles/4405661755031-Exporting-to-Fax) in this tab. You can export the report either via a fax machine or a fax server.

![Options dialog box - Export to category - Fax tab](https://devnet.logianalytics.com/hc/article_attachments/4420550873751/optn_expt_fax.gif)
...
Use this category to specify the options for [printing reports](https://devnet.logianalytics.com/hc/en-us/articles/4405664599447-Printing-Reports).

![Options dialog box - Print category](https://devnet.logianalytics.com/hc/article_attachments/4420556119063/optn_print.gif)
...
Use this category to specify the default properties of the Query Editor which you use for [creating queries](https://devnet.logianalytics.com/hc/en-us/articles/4405661917975-Creating-Queries-in-a-Catalog).

![Options dialog box - Query Editor category](https://devnet.logianalytics.com/hc/article_attachments/4420556140183/optn_qryedtr.gif)
...
![Options dialog box - Security category](https://devnet.logianalytics.com/hc/article_attachments/4420550874391/optn_scrty.gif)
...
![Options dialog box - Cache category](https://devnet.logianalytics.com/hc/article_attachments/4420556140951/optn_cache.gif)
...
![Options dialog box - Server category](https://devnet.logianalytics.com/hc/article_attachments/4420542109591/optn_srv.gif)
