...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405661577239-Format-Label-Dialog-Box
updated_at: 2022-01-27T20:36:20Z
---

# Format Label Dialog Box

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420394625303/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405661576215-Format-KPI-Label-Dialog-Box)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420394625687/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405661578263-Format-Legend-Dialog-Box)

# Format Label Dialog Box

You can use the Format Label dialog box to [format the labels of a chart](https://devnet.logianalytics.com/hc/en-us/articles/4405664380951-Formatting-the-Labels). This topic describes the options in the dialog box.
...
Use this tab to specify the general properties of the label.

![Format Label - General](https://devnet.logianalytics.com/hc/article_attachments/4420410750487/fmtlabel_gnrl.gif)
...
* **Fill**  
  Specify the color to fill the icon. To edit the color, select the color indicator and select a color from the [color palette](https://devnet.logianalytics.com/hc/en-us/articles/4405661953175-Menu-Tabs#Palette) or type the hexadecimal value of a color (for example, 0xff0000) in the text box.
* **Transparency**  
  Specify the transparency of the color to fill the icon.
* **Width**  
...
Use this tab to specify the color pattern to fill the label.

![Format Label - Fill](https://devnet.logianalytics.com/hc/article_attachments/4420394784279/fmtlabel_fill.gif)

**Color**

Specify the color to fill the label. To edit the color, select the color indicator and select a color from the [color palette](https://devnet.logianalytics.com/hc/en-us/articles/4405661953175-Menu-Tabs#Palette) or type the hexadecimal value of a color (for example, 0xff0000) in the text box.

**Transparency**

Specify the transparency of the color to fill the label.
...
![Format Label - Border](https://devnet.logianalytics.com/hc/article_attachments/4420410750871/fmtlabel_brdr.gif)
...
![Format Label - Font](https://devnet.logianalytics.com/hc/article_attachments/4420402458135/fmtlabel_font.gif)
...
![Format Label - Orientation](https://devnet.logianalytics.com/hc/article_attachments/4420402458391/fmtlabel_orntatn.gif)
