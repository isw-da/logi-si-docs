...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405661696919-Security-Dialog-Box
updated_at: 2022-01-27T20:35:37Z
---

# Security Dialog Box

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420394625303/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405664580887-Search-Reports-Dialog-Box)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420394625687/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405661698071-Security-Configuration-Setting-Dialog-Box)

# Security Dialog Box

You can use the Security dialog box to specify the security settings for a [data source security entry](https://devnet.logianalytics.com/hc/en-us/articles/4405661342359-Working-with-RLS-and-CLS-at-Data-Source-Scope#Create). This topic describes the options in the dialog box.
...
* ![Add button](https://devnet.logianalytics.com/hc/article_attachments/4420394650391/btn_add.gif)**Add button**  
  ...
  + **Add User**  
    Select to open the [Add User dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405664426647-Add-User-Dialog-Box) to add a new user.
  + **Add Group**  
    Select to open the [Add Group dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405661449495-Add-Group-Dialog-Box) to add a new group.
  + **Add Role**  
    Select to open the [Add Role dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405661452695-Add-Role-Dialog-Box) to add a new role.
  + **Import from Logi Report Server**  
    Select to open the [Import from Logi Report Server dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405661621911-Import-from-Logi-Report-Server-Dialog-Box) to import users, roles, and groups from Server.
  + **Import from File**  
    Select to import users, roles, and groups from an XML file.
* ![Export button](https://devnet.logianalytics.com/hc/article_attachments/4420402405783/btn_expt2fl.gif)**Export button**  
...
* **Expression**  
  Specify the field on which to create the condition. You can type the name of the field in the text box or select the ellipsis ![Ellipsis button](https://devnet.logianalytics.com/hc/article_attachments/4420402297111/btn_ellipsis2.gif) to select the field you need.
* **Operator**  
...
* **Value**  
  Specify the value of how to build the condition. You can type the value in the text box manually or select the ellipsis ![Ellipsis button](https://devnet.logianalytics.com/hc/article_attachments/4420402297111/btn_ellipsis2.gif) to specify the value.
* **More**  
