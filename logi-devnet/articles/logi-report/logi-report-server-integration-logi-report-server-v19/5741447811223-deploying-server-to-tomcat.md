...
url: https://devnet.logianalytics.com/hc/en-us/articles/5741447811223-Deploying-Server-to-Tomcat
updated_at: 2022-10-31T17:17:57Z
---

# Deploying Server to Tomcat

[![Back](https://devnet.logianalytics.com/hc/article_attachments/9905574448535/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/5741467821079-Deploying-Server-to-WebLogic-14-1-1)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/9905574466839/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/5741437564439-Deploying-Server-to-JBoss-EAP)

# Deploying Server to Tomcat 9.0.68

This topic describes how you can deploy Logi Report Server to Tomcat 9.0.68.

![Note icon](https://devnet.logianalytics.com/hc/article_attachments/9905612785687/noteicon.jpg)Logi Report Server does not support Tomcat 10.
...
* The Logi Report Server WAR file **jreport.war** is in the `/opt/LogiReport/Server/bin/distribute` directory. To create the WAR file, see [Building a WAR/EAR File to Include a Self-contained Logi Report Server](https://devnet.logianalytics.com/hc/en-us/articles/5741473837719-Building-a-WAR-EAR-File-to-Include-a-Self-contained-Logi-Report-Server).
  ...
  ![Note icon](https://devnet.logianalytics.com/hc/article_attachments/9905612785687/noteicon.jpg) When you set **unpackWARs="false"** in **server.xml** in the **conf** folder of Tomcat, you need to do the following:
  ...
  2. Add the **-Djbossas7=true** parameter when launching makewar.bat/.sh to build the WAR.
     ...
     ```
  3. Move **log4j-api-2.17.2.jar** and **log4j-core-2.17.2.jar** from jreport.war > WEB-INF > lib to the **lib** folder of Tomcat. See the note concerning [Log4J Vulnerability](#Log4J).
