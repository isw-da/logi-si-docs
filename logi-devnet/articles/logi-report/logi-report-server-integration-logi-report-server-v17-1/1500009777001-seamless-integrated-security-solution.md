...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009777001-Seamless-Integrated-Security-Solution
updated_at: 2021-07-24T00:48:02Z
---

# Seamless Integrated Security Solution

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404880134167/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009776941-Integrating-Remote-Logi-Report-Server-with-WebLogic-14-1-1-by-a-WAR-File)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404880134423/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009743402-Logi-Report-Server-Cluster)
...
![Same JVM](https://devnet.logianalytics.com/hc/article_attachments/4404880308247/integ_sltn_same.gif)
...
In the illustration above, you can see that the HTTP client can send a request directly to the application JSP/Servlets or Logi Report JSPs/Servlets. Before the Logi Report JSP and Servlet make a response, an Auth Check is performed to authenticate the session and then authorize the action. Normally, the built-in authenticator and authorization instance of Logi Report Server (Instance) is called to perform these checking actions. However, if the application wants to control the process, the web application developer can set up the configuration to use the customized authenticator and authorization instance instead.
...
![Different JVM](https://devnet.logianalytics.com/hc/article_attachments/4404880308631/integ_sltn_dif.gif)
