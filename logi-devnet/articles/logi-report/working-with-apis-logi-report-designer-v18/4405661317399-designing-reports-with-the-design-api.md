...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405661317399-Designing-Reports-with-the-Design-API
...
![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4420542072599/noteicon.jpg) When you create reports, you should create the reports based on an existing catalog file; otherwise, you get an error.
...
![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4420542072599/noteicon.jpg) You can use the *getControlFields(String handle, String name)* method to get fields that can control property values at runtime.
