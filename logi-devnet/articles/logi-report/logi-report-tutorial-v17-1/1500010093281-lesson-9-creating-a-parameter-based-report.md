...
3. In the Data panel, select the **<New Parameter...>** item in the Parameters node.
   ...
   ![New Parameter](https://devnet.logianalytics.com/hc/article_attachments/4404848766231/rpt_lsn9_prm.gif)
4. In the New Parameter dialog box, type **pStartDate** in the Name field, keep the default Value Setting, select **DateTime** from the Value Type drop-down list, select ![Add button](https://devnet.logianalytics.com/hc/article_attachments/4404857138199/btn_add.gif) to add a value row in the Value List box and type **May 1, 2016, 8:00:00 AM** as the prompting value, and then type **Please input start date:** as the prompting text. Select **OK** to create the parameter.

   ![Define the Parameter](https://devnet.logianalytics.com/hc/article_attachments/4404848766487/rpt_lsn9_crtprm.gif)
...
1. On the Data panel toolbar, select the **Dataset Filter** button ![Dataset Filter button](https://devnet.logianalytics.com/hc/article_attachments/4404848766743/btn_fltr.gif).
2. In the Dataset Filter dialog box, select the **Add Condition** button to add a filter line, select **ORDER DATE** from the field drop-down list, set **>=** as the operator, then select the **ellipsis** button ![Ellipsis button](https://devnet.logianalytics.com/hc/article_attachments/4404848766999/btn_chsr.gif).
3. In the Expressions dialog box, double-click the **pStartDate** parameter to use it as value of the filter condition.
   ...
   ![Filter Dataset](https://devnet.logianalytics.com/hc/article_attachments/4404857138455/rpt_lsn9_prmfltr.gif)
...
5. Specify condition of the newly added filter as follows:
   ...
   ![Dataset Filter Conditions](https://devnet.logianalytics.com/hc/article_attachments/4404848767255/rpt_lsn9_fltr.gif)
...
1. Save the report and select the **View** tab to preview the report.
   ...
   ![Enter Parameter Values](https://devnet.logianalytics.com/hc/article_attachments/4404857138711/rpt_lsn9_value.gif)
...
3. Select the **Default** button to generate the report output based on the default values for the parameters. Designer displays the report as follows, showing information for orders from May 1, 2016 8:00:00 AM to June 1, 2016 8:00:00 AM only:
   ...
   ![Preview Report](https://devnet.logianalytics.com/hc/article_attachments/4404857138967/rpt_lsn9_rpt.gif)
