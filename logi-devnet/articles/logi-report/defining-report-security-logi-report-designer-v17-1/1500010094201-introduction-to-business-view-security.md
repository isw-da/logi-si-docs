...
![Priority diagram](https://devnet.logianalytics.com/hc/article_attachments/4404848701079/scrty_bv_intro.gif)
...
![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4404856814359/noteicon.jpg) If you define all members in a group object regardless of whether it is set to a principal directly or to the parents indirectly, Logi Report Engine retrieves no data from the group object to the principal.
...
And in below table, we list the business view security setting in the left cells, and the final results a user gets are listed in the right cells.
