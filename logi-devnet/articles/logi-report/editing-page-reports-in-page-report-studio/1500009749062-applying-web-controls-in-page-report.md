...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009749062-Applying-Web-Controls-in-Page-Report
updated_at: 2021-07-24T00:47:51Z
---

# Applying Web Controls in Page Report

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404880134167/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009748902-Adding-Objects-in-Page-Report)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404880134423/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009749022-Manipulating-Data-Components-in-Page-Report)
...
1. Do either of the following:
   ...
   * Drag **Parameter Control** from the Toolbox panel to the destination in the report.
   ...
   Server displays the [Insert Parameter Control](https://devnet.logianalytics.com/hc/en-us/articles/1500009772661-Insert-Parameter-Control-Dialog-Box-Properties) dialog box.

   ![Insert Parameter Control dialog](https://devnet.logianalytics.com/hc/article_attachments/4404885383319/insrtprmctrl.gif)
2. Select the parameter you would like to add to the parameter control, then select **OK**.
3. A parameter control will be added into the report. Specify the value for the parameter. [You may specify the value in one of these ways.](https://devnet.logianalytics.com/hc/en-us/articles/1500009772161-Enter-Parameter-Values-Dialog-Box-Properties)
4. Once the value in the parameter control changes, the report will re-run with the new parameter value.

![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4404885305111/noteicon.jpg)If the specified parameter is no longer used in the report, the parameter control becomes invalid.
...
1. Do either of the following:
   ...
   * Drag **Parameter Form Control** from the Toolbox panel to the destination in the report.
   ...
   Server displays the [Insert Parameter Form Control](https://devnet.logianalytics.com/hc/en-us/articles/1500009772681-Insert-Parameter-Form-Control-Dialog-Box-Properties) dialog box.

   ![Insert Parameter Form Control dialog](https://devnet.logianalytics.com/hc/article_attachments/4404880248855/insrtprmfrmctrl.gif)
...
5. In the parameter form control, specify values of the listed parameters. [You may specify the values in these ways.](https://devnet.logianalytics.com/hc/en-us/articles/1500009772161-Enter-Parameter-Values-Dialog-Box-Properties)
...
1. Do either of the following:
   ...
   * Select **Menu** > **Insert** > **Filter Control**, then point to the destination where you want to add the filter control and select the mouse button.
   ...
   Server displays the [Insert Filter Control](https://devnet.logianalytics.com/hc/en-us/articles/1500009772641-Insert-Filter-Control-Dialog-Box-Properties) dialog box.
...
2. The Select Fields drop-down list lists all the group and detail objects in the business views used by the current report. Select the objects of the same data type based on which to create the filter control, and then select outside of the drop-down list to close it. The name of the first selected object will be displayed as the name of the filter control.
   ...
   ![Insert Filter Control dialog - Select Fields](https://devnet.logianalytics.com/hc/article_attachments/4404880250135/pgrpt_edit_wbctrl_slctfld.gif)
3. All values of the selected objects are used in the filter control by default. If you want to customize the value list, select **Customize Initial Values** and then select **Fetch Data** to select the desired values in the [Fetch Data](https://devnet.logianalytics.com/hc/en-us/articles/1500009744582-Fetch-Data-Dialog-Box-Properties) dialog box. You can also type the values manually in the text box below.

   Type a value in one row, and then press Enter to start a new row. General text editing operations including Copy, Paste, Cut, Backspace, Delete, and so on are supported. You need to make sure of the accuracy of the formats and values.

   ![Insert Filter Control dialog - Customize Initial Values](https://devnet.logianalytics.com/hc/article_attachments/4404880250391/pgrpt_edit_wbctrl_cstmz.gif)
...
![Filter Control Options](https://devnet.logianalytics.com/hc/article_attachments/4404880251031/pgrpt_edit_wbctrl_fltrctrl.gif)

* **Properties**  
   Opens the [Filter Control Properties](https://devnet.logianalytics.com/hc/en-us/articles/1500009744322-Filter-Control-Properties) dialog box for modifying the properties of the filter control. The dialog box provides an entry to editing the filter control. To do this, in the General tab, select ![Select Fields](https://devnet.logianalytics.com/hc/article_attachments/4404880145687/btn_chsr2.gif) beside the Filter On text box. Then in the [Edit Filter Control](https://devnet.logianalytics.com/hc/en-us/articles/1500009744262-Edit-Filter-Control-Dialog-Box-Properties) dialog box, change the settings of the filter control.
* **Search**  
  Displays the search bar which enables you to search values in the filter control. You can also select the button ![Search button](https://devnet.logianalytics.com/hc/article_attachments/4404880135831/btn_srch.gif) on the title bar of the filter control to launch the search bar.
...
* **Clear**  
   Cancels the selection of values in the filter control. You can also use the button ![Clear button](https://devnet.logianalytics.com/hc/article_attachments/4404880145431/btn_clear.gif) on the title bar to cancel the selection. This operation can be undone/redone.
* **Sort**  
