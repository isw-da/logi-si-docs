...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009750242-Customizing-Web-Report-Studio-Profile
updated_at: 2021-07-24T00:47:28Z
---

# Customizing Web Report Studio Profile

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404880134167/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009750102-Exporting-Printing-the-Web-Report-Result)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404880134423/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009750262-Customizing-the-Web-Report-Studio-UI)

# Customizing Web Report Studio Profile

This topic describes how you can configure the preferences and features of Web Report Studio by the profile in the Server Console.
...
2. In the **Features** tab, select the feature profile from the **Default Profile** drop-down list. The feature profile determines the features that are available in Web Report Studio.

   ![Features subtab](https://devnet.logianalytics.com/hc/article_attachments/4404885306647/profile_featr.gif)
   ...
   * To create a profile, select **New Profile**. Server displays the [Web Report Studio Profile](https://devnet.logianalytics.com/hc/en-us/articles/1500009746502-Web-Report-Studio-Profile-Properties) dialog box. Then create the profile.
...
| Show Toolbar | Server shows the toolbar which contains the menu options and toolbar icons for working with Web Report Studio. For more information, see [Web Report Studio Window Elements](https://devnet.logianalytics.com/hc/en-us/articles/1500009778841-Web-Report-Studio-Window-Elements). |
...
| Show Filter Panel | Server shows the Filter panel in which you can set the criteria to filter data fields. |
| Right-click Menu | Server shows a shortcut menu when you select the right mouse button, which can help you with most of the component operations in Web Report Studio. |
| View Web Reports in Responsive Mode | Marks content and feature updates for Logi Report v17.1. New feature new content.Clear this option to disable [Responsive View](https://devnet.logianalytics.com/hc/en-us/articles/1500009778761-General-Operations-in-Web-Report#Responsive) in the View Mode of Web Report Studio on computers. |
| Marks content and feature updates for Logi Report v17.1. New feature new content.Align Center Report Content | Select this option and clear the above option **View Web Reports in Responsive Mode** if you want to display the report content centrally in the View Mode of Web Report Studio. By default, reports appear the top left corner in the View Mode of Web Report Studio, which may leave space on the right for a small report. |
