...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009722942-Sending-Commands-to-Logi-Report-Server-from-Java
updated_at: 2021-07-25T07:19:01Z
---

# Sending Commands to Logi Report Server from Java

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404936712471/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009749901-Running-Within-an-Application-Server)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404942444695/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009749881-Accessing-Logi-Report-Server-via-a-Web-Browser)

# Sending Commands to Logi Report Server from Java

After Logi Report Server has been [started as a standalone server](https://devnet.logianalytics.com/hc/en-us/articles/1500009749961-Running-as-a-Standalone-Server), you can send commands to the server to either shut it down or pop up the user interactive interface for administration. All of these can be done through the class jet.server.CommandSender. The full command is as follows:
...
* **-Dreporthome**  
   This is where Logi Report Server is installed. It is the destination location you specified when you installed it. It is required only if you do not execute the command from the local host on which Logi Report Server is running.
* **-Dpoperror=true**  
...
* **admin**  
   A command sent to the server asking to pop up the user interactive interface for administering Logi Report Server.
* **shutdown**  
...
**Note:** Some of the common options will be used in the later topics. In addition, Logi Report has automatically generated the batch file CmdSender.bat for you so that you do not have to write a complicated command line.
