...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010055942-Start-Creating-New-Reports
updated_at: 2021-07-23T19:14:14Z
---

# Start Creating New Reports

[![](https://devnet.logianalytics.com/hc/article_attachments/4404848811031/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010093021-Open-Sample-Report-Templates)  [Next Topic![](https://devnet.logianalytics.com/hc/article_attachments/4404848811287/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010093001-Online-Help)
...
1. Select **Logi Report Designer** in the Logi Report folder on the Start menu to start Designer.
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4404848814487/newrpt_start.gif)
...
3. In the Select Component for Page Report dialog box, decide whether to create the page report using business views (by default page reports are query-based).
   ...
   ![New Page Report dialog box](https://devnet.logianalytics.com/hc/article_attachments/4404848814743/newrpt_page.gif)
...
3. In the **Data** screen, select a business view.
   ...
   ![Create Chart wizard - Data](https://devnet.logianalytics.com/hc/article_attachments/4404848815255/newrpt_wbrpt_bv.gif)
...
5. Select **Next** twice to access the **Display** screen, then define the data in the chart.
   ...
   ![Create Chart wizard - Display](https://devnet.logianalytics.com/hc/article_attachments/4404857186583/newrpt_wbrpt_data.gif)
6. Select **Finish** to create the chart.

   ![Chart](https://devnet.logianalytics.com/hc/article_attachments/4404848815639/newrpt_wbrpt_rst.gif)
7. Select the **View** tab to preview the web report.

   ![Preview Chart](https://devnet.logianalytics.com/hc/article_attachments/4404857186839/newrpt_wbrpt_view.gif)
...
2. In the Select Component for Library Component dialog box, type a title for the library component and select the component you want to create in the library component.
   ...
   ![New Library Component dialog box](https://devnet.logianalytics.com/hc/article_attachments/4404857187479/newrpt_lc.gif)
3. Select **OK**.
