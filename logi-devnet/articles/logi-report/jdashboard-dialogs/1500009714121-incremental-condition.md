...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009714121-Incremental-Condition
updated_at: 2021-11-03T06:57:53Z
---

# Incremental Condition

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4412131374359/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009688282-Hyperlink)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4412139481879/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009714141-Insert-Filter-Control)

# Incremental Condition

The Incremental Condition dialog helps you to specify conditions to filter the incremental data. This dialog appears when you select Incremental Condition in the [Auto Refresh](https://devnet.logianalytics.com/hc/en-us/articles/1500009713981-Auto-Refresh) dialog.
...
Specifies the field to be filtered. Select ![More button](https://devnet.logianalytics.com/hc/article_attachments/4412139573399/btn_dshbrd_more1.gif) next to the text box to select the field.
...
Specifies the value of how to filter the field. You can either enter the value manually in the text box or select a resource field from the drop-down list, or select the button ![Toggle button](https://devnet.logianalytics.com/hc/article_attachments/4412112611991/btn_dshbrd_toggle.gif) and then select value from the drop-down list as the value. When you type in the value manually, if multiple values are required, they should be separated with ",", and if "," or "\" is contained in the values, write it as "\," or "\\".
