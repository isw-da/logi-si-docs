...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010068821-NLS-at-Application-Level
updated_at: 2021-07-24T10:38:10Z
---

# NLS at Application Level

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404901108631/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010033362-Applying-National-Language-Support) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404901037591/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010068841-NLS-at-Report-Level)

# NLS at Application Level

All the Logi JReport Designer UI text and message related files are packaged in the file resource\_en\_US.jar (if Logi JReport Designer is Chinese version, the file name is resource\_zh\_CN.jar) in `<install_root>\lib`. To make Logi JReport Designer display in your required language, you just need to translate the needed files in this package.

The following takes French as an example to explain how to make Logi JReport Designer display in another language.
...
11. Open the file **config.xml**`in <install_root>\bin`, and set the value of the property to **\_fr\_FR**. Make sure that Logi JReport Designer is closed when you modify this file.

    The language name must follow the format below: abbreviation of the language with lowercase\_abbreviation of the country using the language with uppercase.jar. If the name format is not correct, Logi JReport Designer will start with the default language.
12. Right-click the file Logi JReport.bat in `<install_root>\bin` and select **Edit** from the shortcut menu to open the file, then change the name of the language package resource\_en\_US.jar to **resource\_fr\_FR.jar**.
13. Save the file. Then when you run Logi JReport Designer, the UI text will be displayed in the specified language.
