...
1. On the Catalog Manager toolbar, select the **Data Mapping Editor**  button. The [Data Mapping Editor](https://devnet.logianalytics.com/hc/en-us/articles/1500010065361-Data-Mapping-Editor-Dialog) appears.

   ![Data Mapping Editor](https://devnet.logianalytics.com/hc/article_attachments/4404901156119/dtmpedtr.gif)
2. Select the **New** button and the [Create Data Mapping File](https://devnet.logianalytics.com/hc/en-us/articles/1500010030122-Create-Data-Mapping-File-Dialog) dialog appears.

   ![Create Data Mapping File dialog](https://devnet.logianalytics.com/hc/article_attachments/4404909142295/crtdtmpfile.gif)
...
6. In the Data Mapping Editor, select the **Import Key** button to import the resources with the data values you want to map from the Import Key dialog.
   ...
   ![Import Key dialog](https://devnet.logianalytics.com/hc/article_attachments/4404909142551/nls_rpt_map.gif)
