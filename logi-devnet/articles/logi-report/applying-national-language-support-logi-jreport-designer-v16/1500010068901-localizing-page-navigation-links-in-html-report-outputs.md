...
10. Select **File** > **Export** > **HTML** to export the report to HTML, make sure No Hyperlink and No Page Number are not checked. In the exported HTML result, you will find that the page navigation links are displayed in the language you specified.
