...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405690635159-Building-a-WAR-EAR-File-to-Include-a-Self-contained-Logi-Report-Server
updated_at: 2022-01-27T07:59:35Z
---

# Building a WAR/EAR File to Include a Self-contained Logi Report Server

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420453372695/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405683907223--Server-Integration-Server-v18)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420453372951/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405690633367-Specifying-Reporthome-for-Logi-Report-Server-in-a-Java-EE-Environment)
...
Before generating the WAR/EAR file, you can [customize the reporthome](https://devnet.logianalytics.com/hc/en-us/articles/4405690633367-Specifying-Reporthome-for-Logi-Report-Server-in-a-Java-EE-Environment) and data source for Logi Report Server, or use the default settings. For more information, see [Configuring the Server Database in an Integrated Environment](https://devnet.logianalytics.com/hc/en-us/articles/4405683584407-Configuring-the-Server-Database-in-an-Integrated-Environment).

![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4420447034135/noteicon.jpg)Logi Report Server uses a parameter **autoDetectServletPath** in the self-contained WAR/EAR, to dynamically detect and modify servlet path based on context path of the self-contained WAR/EAR when you deploy the WAR/EAR to a J2EE application server. Server enables this property by default, and the actual servlet path will be concatenating "context path" with "default servlet path" set in server.properties. If you do not want this way, you can disable the feature using either of the following ways:
