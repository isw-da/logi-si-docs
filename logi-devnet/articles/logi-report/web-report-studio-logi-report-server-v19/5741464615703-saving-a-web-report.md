...
url: https://devnet.logianalytics.com/hc/en-us/articles/5741464615703-Saving-a-Web-Report
updated_at: 2022-10-31T17:18:35Z
---

# Saving a Web Report

[![Back](https://devnet.logianalytics.com/hc/article_attachments/9905574448535/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/7985371637143-Bookmarking-a-Web-Report)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/9905574466839/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/5741470801175-Exporting-Printing-a-Web-Report)

# Saving a Web Report

This topic describes how you can save changes that you made to a web report and save a copy of it.

To save the changes you made to the current report, select the **Save** button ![Save button](https://devnet.logianalytics.com/hc/article_attachments/9905577991703/btn_save.gif) on the toolbar or **Menu** > **File** > **Save**.

* If you created the report just now and has not saved it yet, Server displays the [Save As dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5741436888471-Save-As-Dialog-Box-Properties).

  ![Save As dialog](https://devnet.logianalytics.com/hc/article_attachments/9905629638935/svas_rpt.gif)

  1. In the **Save In** section, browse to the folder in the server resource tree where you want to save the web report. You can use the arrow button ![Up Level button](https://devnet.logianalytics.com/hc/article_attachments/9905617355671/btn_wbrpt_up.gif) to return to the parent folder.
...
* If the report is an [editable shared report](https://devnet.logianalytics.com/hc/en-us/articles/5741461964439-Sharing-Web-Reports), Server displays the Confirm dialog box, prompting you to choose whether to save a finished or unfinished version for the report.

  ![Confirm Dialog](https://devnet.logianalytics.com/hc/article_attachments/9905629684887/wbrpt_edt_save.gif)
...
To save a copy of a report, select **Menu** > **File** > **Save As** or the **Save As** button ![Save As button](https://devnet.logianalytics.com/hc/article_attachments/9905615943319/btn_saveas.gif) on the toolbar. Server displays the Save As dialog box. Then do as above. If you are saving to an existing web report, Server displays the Confirm dialog box asking whether you want to replace it or [save a new version into it](https://devnet.logianalytics.com/hc/en-us/articles/5741462158487-Creating-Versions#Save).
