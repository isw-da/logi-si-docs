...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009748762-Browsing-Versions
updated_at: 2021-07-24T00:47:54Z
---

# Browsing Versions

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404880134167/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009748782-Creating-Versions)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404880134423/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009777381-Checking-Version-Properties)
...
* To view the version information of a single resource, browse to the folder where the resource is, then:
  + Put the mouse pointer over the resource row and select the **Version** button ![Version button](https://devnet.logianalytics.com/hc/article_attachments/4404885367191/btn_srv_vrsn.gif) on the floating toolbar.
...
* To view the version information of multiple resources at a time, browse to the folder where the resources are, select the required resources (to view the version information of all the resources, select the top check box), then select **Tools** > **Version** on the task bar, or right-click in any selected resource row and select **Version** from the shortcut menu. Server displays the version table for multiple resources.

## Version Tables

Server collects relevant information about the versions that a resource hosts, such as the version date and version number, in a table called the version table. You can also use [URL commands](https://devnet.logianalytics.com/hc/en-us/articles/1500009750382-Working-with-Server-via-URL#Version) to directly access the version table of a specific resource.

![Version Table](https://devnet.logianalytics.com/hc/article_attachments/4404885408151/mng_vrsn_browse.gif)
...
| NLS Editor | Administrators can [edit NLS](https://devnet.logianalytics.com/hc/en-us/articles/1500009777481-NLS-at-Report-Level#Local) for a specified catalog version by selecting the corresponding link. |
...
| --- | --- |
| Version Date | The date and time when Server generated the version. You can sort the versions by version date. |
| NLS Editor | Administrators can [edit NLS](https://devnet.logianalytics.com/hc/en-us/articles/1500009777481-NLS-at-Report-Level#Local) for a specified report version by selecting the corresponding link. |
| Version Number | The serial ID that identifies a version in the version table. |
| Creator | The ID of the user who created the version. Available to web reports that you used create [shared reports](https://devnet.logianalytics.com/hc/en-us/articles/1500009777281-Sharing-Web-Reports) only. |
...
| --- | --- |
| Version Date | The date and time when Server generated the version. You can sort the versions by version date. |
| NLS Editor | Administrators can [edit NLS](https://devnet.logianalytics.com/hc/en-us/articles/1500009777481-NLS-at-Report-Level#Local) for a specific library component version by selecting the corresponding link. |
| Version Number | The serial ID that identifies a version in the version table. |
...
* When accessing the version tables in the Server Console, you can customize the columns shown in the tables as follows: locate the table, select **Preferences** on the task bar of the Resources page, select the corresponding items in the Preferences dialog box, then select **OK** to apply the settings.
