...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009777361-Deleting-Versions
...
When you remove the versions in the Server Console, Server also deletes the archive versions stored on disk in the history folder.
...
[Open the version table](https://devnet.logianalytics.com/hc/en-us/articles/1500009748762-Browsing-Versions) of the resource, then:
...
* To delete a version of the resource:
  ...
  + Put the mouse pointer over the version row and select the **Delete** button ![Delete button](https://devnet.logianalytics.com/hc/article_attachments/4404885308823/btn_dltobj.gif) on the floating toolbar.
