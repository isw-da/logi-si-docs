...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009669021-Configuring-Cache
updated_at: 2021-07-24T20:55:22Z
---

# Configuring Cache

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404920354071/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009644402-Configuring-Advanced-Server-Settings)   [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404920354327/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009644582-Configuring-Server-Profile)

# Configuring Cache

On the Logi JReport Administration > Cache page, administrators can configure the following cache settings of Logi JReport Server:
...
1. On the Logi JReport Administration page, select **Cache** on the system toolbar and then select **Report Cache** from the drop-down menu to open the Cache - Report Cache page.

   ![Configure Report Cache](https://devnet.logianalytics.com/hc/article_attachments/4404926783383/config_cache_rpt.gif)
...
8. Specify the buffer size for the sort action on page reports as required. Any change to the buffer size takes effect immediately. This setting is not available to [organization admin](https://devnet.logianalytics.com/hc/en-us/articles/1500009675081-Multi-tenancy-Supported-via-Organizations).
   * **System Managed Size**  
...
The security cache system temporarily stores security objects such as users, roles, groups and ACLs. For detailed information, see [Security Cache System](https://devnet.logianalytics.com/hc/en-us/articles/1500009650042-Security-Cache-System).
...
1. On the Logi JReport Administration page, select **Cache** on the system toolbar and then select **Image Cache** from the drop-down menu to open the Cache - Image Cache page.

   ![Configure Image Cache](https://devnet.logianalytics.com/hc/article_attachments/4404926783639/config_cache_img.gif)
