---
title: "Format Target Label Dialog"
id: 1500009608622
section: "References - Logi Report Designer v17"
category: "Logi Report"
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009608622-Format-Target-Label-Dialog
updated_at: 2021-07-24T16:04:32Z
---

# Format Target Label Dialog

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404911578903/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009631641-Format-Surface-Dialog) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404911579543/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009631681-Format-Text-Dialog)

# Format Target Label Dialog

The Format Target Label dialog helps you to [format the target labels](https://devnet.logianalytics.com/hc/en-us/articles/1500009628601-Formatting-the-Gauge-in-a-Gauge-Chart#Label) on a gauge chart. It appears when you double-click a target label on a gauge chart, or right-click it and then select Format Target Label from the shortcut menu.
...
![Format Target Label - General](https://devnet.logianalytics.com/hc/article_attachments/4404904287767/fmttgtlbl_gnrl.gif)
...
* **Color**  
  Specifies the color of the border. To edit the color, select the color indicator and select a color from the [color palette](https://devnet.logianalytics.com/hc/en-us/articles/1500009613582-Menu-Tabs#Palette) or input the hexadecimal value (for example, 0xff0000) of a color in the text box.</li>
* **Line Style**  
...
![Format Target Label - Font](https://devnet.logianalytics.com/hc/article_attachments/4404904288023/fmttgtlbl_font.gif)
...
![Format Target Label - Format](https://devnet.logianalytics.com/hc/article_attachments/4404904288535/fmttgtlbl_fmt.gif)
...
Enabled when the target value is bound with a field that is of the Number data type. It specifies whether to automatically scale the target labels when the label values fall into the two ranges:
