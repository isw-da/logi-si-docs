...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009607322-Bursting-Dialog
updated_at: 2021-07-24T16:04:59Z
---

# Bursting Dialog

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404911578903/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009607302-Bind-Data-Dialog) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404911579543/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009607342-Business-View-Editor-Dialog)

# Bursting Dialog

The Bursting dialog helps you to edit a normal page report to become a [bursting report](https://devnet.logianalytics.com/hc/en-us/articles/1500009636121-Creating-Bursting-Reports). It appears when you select Report > Bursting.
...
* **Logi Report Server Version**  
   Specifies the data field that defines resource directories in the Logi Report Server resource system.
* **Logi Report Server User**  
   Specifies the data field that defines user addresses in the Logi Report Server security system.
  + **User E-mail**  
     If the option is selected, the report result will be sent to e-mail addresses.
  + **User Private Folder**  
     If the option is selected, the report result will be sent to the users' My Reports folders in the server resource tree and you are allowed to give a sub path.
    - **Sub Path**  
       If the option is selected, you can specify a sub path in the My Reports folder and the report result will be sent to the sub path.
* **Logi Report Server Group**  
   Specifies the data field that defines group addresses in the Logi Report Server security system.
  + **User E-mail**  
     If the option is selected, the report result will be sent to e-mail addresses.
  + **User Private Folder**  
     If the option is selected, the report result will be sent to the group members' My Reports folders in the server resource tree and you are allowed to give a sub path.
    - **Sub Path**  
       If the option is selected, you can specify a sub path in the My Reports folder and the report result will be sent to the sub path.
* **Logi Report Server Role**  
   Specifies the data field that defines role addresses in the Logi Report Server security system.
  + **User E-mail**  
     If the option is selected, the report result will be sent to e-mail addresses.
  + **User Private Folder**  
     If the option is selected, the report result will be sent to the role members' My Reports folders in the server resource tree and you are allowed to give a sub path.
    - **Sub Path**  
       If the option is selected, you can specify a sub path in the My Reports folder and the report result will be sent to the sub path.

**E-mail Settings**

Enabled when E-mail or Logi Report Server User/Group/Role > User E-mail is selected in the Recipient section. Select it to access the [E-mail Settings](https://devnet.logianalytics.com/hc/en-us/articles/1500009630981-E-mail-Settings-Dialog) dialog to specify more e-mail information.
