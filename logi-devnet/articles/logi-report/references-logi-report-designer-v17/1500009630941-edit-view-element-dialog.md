...
![Edit View Element dialog - General tab](https://devnet.logianalytics.com/hc/article_attachments/4404904344215/edtvwelmnt_gen.gif)
...
Specifies the mapping name of the field to which the view element is mapped. Select ![](https://devnet.logianalytics.com/hc/article_attachments/4404904178967/btn_chsr.gif) to select the field.
...
Available only when the view element is an aggregation. It specifies the [function](https://devnet.logianalytics.com/hc/en-us/articles/1500009611182-Summaries#Function) for the aggregation object. When DistinctSum is selected, the following option is available and should be set:
...
![Edit View Element dialog - Security tab](https://devnet.logianalytics.com/hc/article_attachments/4404904344471/edtvwelmnt_scrty.gif)
