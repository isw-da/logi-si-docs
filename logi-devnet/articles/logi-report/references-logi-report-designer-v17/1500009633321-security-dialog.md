...
* ![Add button](https://devnet.logianalytics.com/hc/article_attachments/4404904181783/btn_add.gif)  
  ...
  + **Import from Logi Report Server**  
     Opens the [Import from Logi Report Server](https://devnet.logianalytics.com/hc/en-us/articles/1500009632001-Import-from-Logi-Report-Server-Dialog) dialog to import users, roles, and groups from Logi Report Server.
  + **Import from File**  
...
* **Expression**  
   Specifies the field on which the condition is based. You can type in the field directly or select the button ![](https://devnet.logianalytics.com/hc/article_attachments/4404904178967/btn_chsr.gif) next to the text box to select the desired field.
* **Operator**  
...
* **Value**  
   Specifies the value of how to build the condition. You can type in the value manually or select the button ![](https://devnet.logianalytics.com/hc/article_attachments/4404904178967/btn_chsr.gif) next to the value text box to specify the value.
* **More**  
