...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009631581-Format-Radar-Dialog
updated_at: 2021-07-24T16:04:34Z
---

# Format Radar Dialog

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404911578903/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009631541-Format-Pointer-Label-Dialog) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404911579543/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009608542-Format-Rectangle-Dialog)

# Format Radar Dialog

The Format Radar dialog helps you to [format the radar in a radar chart](https://devnet.logianalytics.com/hc/en-us/articles/1500009605942-Formatting-the-Radar-in-a-Radar-Chart). It appears when you right-click any line which connects two value nodes in a radar chart and select Format Radar from the shortcut menu, or double-click any line connecting two value nodes in a radar chart.
...
![Format Radar - General](https://devnet.logianalytics.com/hc/article_attachments/4404916791831/fmtradr_gnrl.gif)
...
![Format Radar - Fill](https://devnet.logianalytics.com/hc/article_attachments/4404904298391/fmtradr_fill.gif)
...
Specifies whether to edit the color pattern for the radar areas themselves. When the option is unselected, the color settings defined here will be synchronized to the [Pattern List property](https://devnet.logianalytics.com/hc/en-us/articles/1500009612122-Chart-Properties#Pattern) on the chart object in the Report Inspector, which can also be applied by data markers of other subtypes if the chart is a combo chart.

**Color List**

Opens the [Color List](https://devnet.logianalytics.com/hc/en-us/articles/1500009630161-Color-List-Dialog) dialog to modify the color pattern for radar areas in the same data series respectively.
...
![Format Radar - Border](https://devnet.logianalytics.com/hc/article_attachments/4404916792087/fmtradr_brdr.gif)

**Show Border**

Specifies whether to show the border of the radar. When it is selected, the other border properties in the tab will be enabled.
...
![Format Radar - Data Label](https://devnet.logianalytics.com/hc/article_attachments/4404916792343/fmtradr_data.gif)
...
* **Show Static Data Label**  
   Specifies whether or not to show the static data labels on the radar. Only when it is selected can the following static data label related properties take effect.
* **Position**  
