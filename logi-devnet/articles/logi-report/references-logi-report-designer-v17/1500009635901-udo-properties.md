...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009635901-UDO-Properties
updated_at: 2021-07-24T16:03:26Z
---

# UDO Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404911578903/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009613002-TOC-Properties) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404911579543/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009613062-Web-Report-Properties)
...
**Note**:Logi Report UDO does not support RTF and PDF format output. That is, when exporting to RTF and PDF, a report with a UDO may not be rendered correctly. However, there is no such problem for HTML and PostScript.
...
| Original | Specifies from where the image is fetched when viewing or running the report on Logi Report Server. The property has following two options:   * **true** - If selected, the image will not be delivered when publishing the report to Logi Report Server. Logi Report Server will find the image from the local directory specified by the property Display Image when you view the report. * **false** - If selected, the image will be delivered when publishing the report to Logi Report Server. Logi Report Server will obtain the image from the server side when you view or run the report.   Data type: Boolean |
| Accessibility | |
