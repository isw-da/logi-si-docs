...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009631281-Format-Bar-Gauge-Dialog
updated_at: 2021-07-24T16:04:38Z
---

# Format Bar Gauge Dialog

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404911578903/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009608342-Format-Bar-Dialog) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404911579543/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009631301-Format-Bubble-Dialog)

# Format Bar Gauge Dialog

The Format Bar Gauge dialog helps you to [format a bar gauge](https://devnet.logianalytics.com/hc/en-us/articles/1500009628601-Formatting-the-Gauge-in-a-Gauge-Chart#Bar). It appears when you double-click a bar gauge of a chart, or right-click it and select Format Bar Gauge from the shortcut menu.
...
![Foramt Bar Gauge dialog - Staff Graph](https://devnet.logianalytics.com/hc/article_attachments/4404904331543/fmtbargauge_stfgraph.gif)
...
![Foramt Bar Gauge dialog - Axis - Axis](https://devnet.logianalytics.com/hc/article_attachments/4404904331799/fmtbargauge_axis_axis.gif)
...
* **Pointer Color**  
  ...
  + **Color List**   
     Opens the [Color List](https://devnet.logianalytics.com/hc/en-us/articles/1500009630161-Color-List-Dialog) dialog to specify the color pattern for pointers in the same data series respectively.
  + **Transparency**  
...
* **Pointer Color**  
  ...
  + **Color List**   
    Opens the [Color List](https://devnet.logianalytics.com/hc/en-us/articles/1500009630161-Color-List-Dialog) dialog to specify the color pattern for color bars in the same data series respectively.
  + **Self Settings**Specifies whether to edit the color pattern for the color bars themselves. When the option is unselected, the color settings defined here will be synchronized to the [Pattern List property](https://devnet.logianalytics.com/hc/en-us/articles/1500009612122-Chart-Properties#Pattern) on the chart object in the Report Inspector, which can also be applied by data markers of other subtypes if the chart is a combo chart.
  + **Thickness**  
...
![Format Bar Gauge dialog - Range Color](https://devnet.logianalytics.com/hc/article_attachments/4404904333719/fmtbargauge_rgclr.gif)
