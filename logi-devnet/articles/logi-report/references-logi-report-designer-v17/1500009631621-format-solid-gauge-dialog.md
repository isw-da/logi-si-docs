...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009631621-Format-Solid-Gauge-Dialog
updated_at: 2021-07-24T16:04:33Z
---

# Format Solid Gauge Dialog

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404911578903/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009608602-Format-Series-Z-Gridline-Dialog) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404911579543/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009631661-Format-Stock-Dialog)

# Format Solid Gauge Dialog

The Format Solid Gauge dialog helps you to [format the solid gauge](https://devnet.logianalytics.com/hc/en-us/articles/1500009628601-Formatting-the-Gauge-in-a-Gauge-Chart#Solid). It appears when you right-click any arc in a solid gauge and select Format Solid Gauge from the shortcut menu, or double-click any arc in a solid gauge.
...
* **Angle**  
   Specifies the degree for angles of the arcs. Select the angle of the gauge from the drop-down list or select Customized to open the [Customize Gauge Angle](https://devnet.logianalytics.com/hc/en-us/articles/1500009607622-Customize-Gauge-Angle-Dialog) dialog to specify the start angle and stop angle.
* **Thickness**  
...
* **Color**  
   Specifies the color of the arcs.
* **Color List**  
   Opens the [Color List](https://devnet.logianalytics.com/hc/en-us/articles/1500009630161-Color-List-Dialog) dialog to modify the color patter for arcs in the same data series respectively.
* **Transparency**  
   Specifies the transparency for color of the arcs.
* **Self Settings**Specifies whether to edit the color pattern for the arcs themselves. When the option is unselected, the color settings defined here will be synchronized to the [Pattern List property](https://devnet.logianalytics.com/hc/en-us/articles/1500009612122-Chart-Properties#Pattern) on the chart object in the Report Inspector, which can also be applied by data markers of other subtypes if the chart is a combo chart.
* **Background**  
...
* **Minimum**  
   Specifies the minimum value on the axis. You can also [use a formula to control the value](https://devnet.logianalytics.com/hc/en-us/articles/1500009634221-Using-Formulas-to-Control-Object-Properties).
* **Maximum**  
  Specifies the maximum value on the axis. You can also [use a formula to control the value](https://devnet.logianalytics.com/hc/en-us/articles/1500009634221-Using-Formulas-to-Control-Object-Properties).
