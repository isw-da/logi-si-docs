...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009632221-Insert-Link-Dialog
updated_at: 2021-07-24T16:04:27Z
---

# Insert Link Dialog

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404911578903/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009632181-Insert-Group-Column-Dialog) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404911579543/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009608842-Insert-Parameter-Control-Dialog)

# Insert Link Dialog

The Insert Link dialog helps you to [link an object to a specified target](https://devnet.logianalytics.com/hc/en-us/articles/1500009613322-Adding-Links-in-Reports). It appears when you select a specific object in the design area of a report, right-click it and select Link on the shortcut menu, or select ![Choose button](https://devnet.logianalytics.com/hc/article_attachments/4404904183063/btn_chsr1.gif) in the value cell of the Link property or Detail Report property in the Report Inspector.
...
Specifies the target report. Select the Browse button to select the desired report in the [Select a Report](https://devnet.logianalytics.com/hc/en-us/articles/1500009610142-Select-a-Report-Dialog) dialog.
...
![Insert Link dialog - Master/Detail Report](https://devnet.logianalytics.com/hc/article_attachments/4404904188567/instlnk_dtl.gif)

**Report**

Specifies the report in which the detail report tab is. Select the Browse button to select the desired report in the [Select a Report](https://devnet.logianalytics.com/hc/en-us/articles/1500009610142-Select-a-Report-Dialog) dialog.
...
Specifies the content type for the Blob type data. You can select the button ![Formula button](https://devnet.logianalytics.com/hc/article_attachments/4404904189591/btn_fmla.gif) to bind it with a field column or a record level pass one formula in the selected data resource, or with a dynamic formula in the current report (available to web report and library component only).

**File Name**

Specifies the file name for the linked Blob type data. You can select the button ![Formula button](https://devnet.logianalytics.com/hc/article_attachments/4404904189591/btn_fmla.gif) to bind it with a field column or a record level pass one formula in the selected data resource.
