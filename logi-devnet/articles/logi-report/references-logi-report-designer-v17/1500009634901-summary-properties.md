...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009634901-Summary-Properties
updated_at: 2021-07-24T16:03:44Z
---

# Summary Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404911578903/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009634821-Stored-Procedure-Column-Properties) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404911579543/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009634921-Table-View-Synonym-Properties)
...
| Display Width | Specifies the display width of the summary. Type a numeric value to change the width. Data type: Float  **Notes:**   * If the Display Width value of a summary is not set in the Catalog Manager, the summary will be inserted in a report with the default width defined by Logi Report. * Assume that you have set the Display Width of a summary, and used the summary while creating a new component with the report wizard, its width may be adjusted according to the paper size. |
| Expression | Displays the statement of the summary. This property is read only. |
| Function | Specifies the [function](https://devnet.logianalytics.com/hc/en-us/articles/1500009611182-Summaries#Function) of the summary. Data type: String |
...
| Special Function | If the group-by field is of Numeric, String, Date or Time type, you can further define to calculate the summary by specifying a [special function](https://devnet.logianalytics.com/hc/en-us/articles/1500009606502-Grouping-the-Data-in-Tables#Function). Data type: String |
| [SQL Type](https://devnet.logianalytics.com/hc/en-us/articles/1500009611622-Formula-Properties#SQL) | Specifies the SQL type of the summary defined in Java. Choose an option from the drop-down list. Data type: Integer |
...
| [Format](https://devnet.logianalytics.com/hc/en-us/articles/1500009635341-DBField-Properties#Format) | Specifies the display format of the summary's value. The format varies with the summary's data type and can be defined manually. Data type: String |
