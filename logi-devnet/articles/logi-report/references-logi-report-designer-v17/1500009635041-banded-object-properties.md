...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009635041-Banded-Object-Properties
updated_at: 2021-07-24T16:03:42Z
---

# Banded Object Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404911578903/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009635021-Arc-Shape-Properties) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404911579543/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009611942-Banded-Footer-Properties)

# Banded Object Properties

This topic lists the properties of a Banded Object. The availabilities of the properties vary for the [supported report types](https://devnet.logianalytics.com/hc/en-us/articles/1500009611922-Report-Object-Properties#ReportType): Page Report and Web Report.
...
| Geometry | | |
| This image notes any new content for version 17 of the product. For more information please see the Release Notes or What's New topics.Auto Fit | Page Report, Web Report | Specifies whether to automatically adjust the width of a vertical banded object or the height of a horizontal banded object according to the contents. Data type: Boolean |
...
| [Position](https://devnet.logianalytics.com/hc/en-us/articles/1500009613302-Editing-Reports#Position) | Page Report, Web Report | Specifies the position of the object. Choose an option from the drop-down list. Data type: Enumeration |
...
* When exporting the report to Text via dialog, do select the Delimited Format option.

**Note:** Preview as Text cannot support the specified values for the default setting of Delimited Format is unselected and it is unconfigurable.

### TOC

Some objects in a report can be set up to show in a table of contents. Then when previewing the report in Logi Report format, exporting it to PDF or HTML format, or running it in Page Report Studio for a page report, you can use the TOC tree to locate the objects.
...
Logi Report also allows you to specify [properties of the TOC tree](https://devnet.logianalytics.com/hc/en-us/articles/1500009613002-TOC-Properties), including its CSS style, colors and fonts as you want.
