...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009607162-Add-Tables-Dialog
updated_at: 2021-07-24T16:05:02Z
---

# Add Tables Dialog

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404911578903/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009607142-Add-Stored-Procedures-Dialog) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404911579543/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009607182-Add-Tables-Views-Queries-Dialog)

# Add Tables Dialog

The Add Tables dialog helps you to add tables into a Logi Report catalog via the connection you set up. It appears when you right-click the Tables node in a connection and select Add Tables on the shortcut menu in the Catalog Manager.

The dialog varies according to different connection types: [XML/JSON/Elasticsearch](#XML), [Web Service](#Web), or [MongoDB](#MongoDB).

---

If it is an [XML](https://devnet.logianalytics.com/hc/en-us/articles/1500009629721-Working-with-XML-Connections-in-a-Catalog#Add), [JSON](https://devnet.logianalytics.com/hc/en-us/articles/1500009606902-JSON-Connections#Add), or [Elasticsearch](https://devnet.logianalytics.com/hc/en-us/articles/1500009629721-Working-with-XML-Connections-in-a-Catalog#Add) connection, the dialog shows as follows:

![Add Tables dialog - XML/JSON](https://devnet.logianalytics.com/hc/article_attachments/4404916819991/addtbl_xml.gif)
...
Adds the selected tables to the Logi Report catalog.
...
If it is a [web service](https://devnet.logianalytics.com/hc/en-us/articles/1500009629701-SOAP-Web-Service-Connections#Table) connection, the dialog shows as follows:

![Add Tables dialog - web service connection](https://devnet.logianalytics.com/hc/article_attachments/4404904398231/addtbl_wbsvc.gif)
...
If it is a [MongoDB](https://devnet.logianalytics.com/hc/en-us/articles/1500009629621-Working-with-MongoDB-Connections-in-a-Catalog#AddTable) connection, the dialog shows as follows:

![Add Tables dialog - MongoDB connection](https://devnet.logianalytics.com/hc/article_attachments/4404904398743/addtbl_mngodb.gif)
