...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009609482-Options-Dialog
updated_at: 2023-06-09T00:16:22Z
---

# Options Dialog

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404911578903/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009632821-Open-Report-Dialog) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404911579543/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009609542-Page-Panel-Dialog)

# Options Dialog

The Options dialog helps you to configure Logi Report Designer to your preferences and requirements. It appears when you select File > Options, or select Options on the Catalog Manager toolbar.
...
Specifies the general options of Logi Report Designer.

![Options dialog - General category](https://devnet.logianalytics.com/hc/article_attachments/4404911689879/optn_gnrl.gif)

**Show welcome page**

Specifies whether or not to show the welcome page when you start Logi Report Designer.

**Show version warning message when opening reports**

Specifies whether or not to show the version warning message when a report of an earlier version is opened using a higher version. The message warns you that you are about to open a report which belongs to an earlier version, and if you save the report using the current version, you may not be able to open it with the earlier version of Logi Report Designer again.
...
Specifies whether or not to limit the number of the reports that can be opened in Logi Report Designer. If the option is selected, you can set the the maximum number of the reports that can be opened in Logi Report Designer.

**Set recently used report names to display**

Specifies whether or not to display names of the recently used reports in the welcome page. If the option is selected, you can set the number of report names that are recently used to display.
...
Specifies whether or not to show the warning message when the applied CSS style contains properties that Logi Report does not support.
...
Specifies the ratio using which to scale the Logi Report Designer UI. The larger the ratio is, the larger the graphics and text shown on the Logi Report Designer UI will be. If you are using JDK 11 or higher, it is recommended that you specify an appropriate ratio based on your device requirements to make the graphics and text on the Logi Report Designer UI shown in the size you expect.

The ratio can also be customized by adding the -Dsun.java2d.uiScale parameter in the file JReport.bat that is stored in `<install_root>\bin`. Valid values for the parameter are: 1, 1.25, 1.5, 1.75, 2, 2.25 and 2.5. If you specify the scale ratio via the parameter, the one specified in the Options dialog will be ignored. See an example of setting the parameter below:
...
Specifies the properties of the report editor, that is the [Design tab](https://devnet.logianalytics.com/hc/en-us/articles/1500009613502-Design-View-Area) in the Logi Report Designer main window.

![Options dialog - Editor category](https://devnet.logianalytics.com/hc/article_attachments/4404904248087/optn_edtr.gif)

**Show status bar**

Specifies whether to show the status bar in Logi Report Designer.

**Show ruler**

Specifies whether or not to show the horizontal and vertical rulers in the main window of Logi Report Designer.
...
* **Margin Line Color**  
   Specifies the color of the margin line that is to be displayed in reports. Select a color from the drop-down list or select Custom from the list to customize a color in the [Pick a Color](https://devnet.logianalytics.com/hc/en-us/articles/1500009609622-Pick-a-Color-Dialog#Color) dialog.
...
Specifies the display attributes, which can also be set in the [Display Attributes](https://devnet.logianalytics.com/hc/en-us/articles/1500009607642-Display-Attributes-Dialog) dialog.
...
Specifies whether to show the basic panels of Logi Report Designer by default, and some properties for the Inspector panel.

![Options dialog - Panel category](https://devnet.logianalytics.com/hc/article_attachments/4404911690135/optn_pnl.gif)>
...
![Options dialog - Format category](https://devnet.logianalytics.com/hc/article_attachments/4404904248343/optn_frmt.gif)
...
* **Foreground**  
   Specifies the color of the font foreground. Select a color from the drop-down list or select Custom from the list to customize a color in the [Pick a Color](https://devnet.logianalytics.com/hc/en-us/articles/1500009609622-Pick-a-Color-Dialog#Color) dialog.
* **Autofit**  
   Specifies whether to adjust the width according to the contents.
* **Word wrap**  
   If the option is selected, the contents will be wrapped.
* **Italic**  
   If the option is selected, italic fontface will be used.
* **Underline**  
   If the option is selected, the contents will be underlined.
* **Strikethrough**  
   Specifies whether or not to draw a line through the column contents.
* **Bold**  
   If the option is selected, fold fontface will be used.
...
If there is no value in a column, Logi Report will display NULL as default. You can also set what will be displayed when there is no value in the column by inserting the mouse in the Report Inspector and inputting a value.
...
![Options dialog - Dataset category](https://devnet.logianalytics.com/hc/article_attachments/4404911690391/optn_dtst.gif)
...
![Options dialog - Component category](https://devnet.logianalytics.com/hc/article_attachments/4404911690647/optn_cmpnt.gif)
...
See the [Position](https://devnet.logianalytics.com/hc/en-us/articles/1500009613302-Editing-Reports#Position) property for more information.
...
Specifies whether to customize the indent of groups created via the report wizard. By default, the indent of the groups is 0 inch or centimeter. You can also type in a value between 0 and 4 to customize the indent.
...
By default, any field added to the catalog in Logi Report can be used to group and sort. However, you can specify here whether or not a field can be used to group or sort. The qualification information will be stored in the database connection.
...
Specifies the options for [previewing reports](https://devnet.logianalytics.com/hc/en-us/articles/1500009613422-Previewing-Reports) in Logi Report Designer.

![Options dialog - Preview category](https://devnet.logianalytics.com/hc/article_attachments/4404904248599/optn_prvw.gif)
...
Specifies whether to preview reports that you design in Logi Report Designer using a temporary file.

**Start Logi Report Server when previewing report**

Specifies whether to start Logi Report Server at the same time when you preview a report.

**Start Logi Report Server when starting Designer**

Specifies whether to start Logi Report Server when Designer is started.

**Port**

Specifies the port as the TCP port to which Logi Report Server listens.

**Run Linked Report**

Specifies whether or not to generate the linked reports (not including the detail reports) when viewing the primary reports in Logi Report Designer or previewing the primary reports in all formats except for Web Report Result and Page Report Result. Generating linked reports at the same time, especially when the linked reports contain a large amount of data, will cause performance issue.

## Catalog

Specifies some properties for working with catalogs in Logi Report Designer.

![Options dialog - Catalog category](https://devnet.logianalytics.com/hc/article_attachments/4404911690903/optn_ctlg.gif)
...
* **Identify all differences**  
   If selected, Logi Report Designer will check for all the differences between the two catalogs. All the resources referenced by the report will be displayed in the Merge dialog with all the conflicting resources marked.
* **Identify critical differences**  
   If selected, Logi Report Designer will check for differences which can cause the engine to fail in running a report. All the resources referenced by the report will be displayed in the Merge dialog with the critical conflicting resources marked. When this option is selected, different values may be returned when you run the saved report later.
* **Ignore differences**  
...
Opens the [Advanced Export Settings](https://devnet.logianalytics.com/hc/en-us/articles/1500009629901-Advanced-Export-Settings-Dialog) dialog to customize the layout precision for each export format.

### HTML

Specifies the preferences for [exporting the report result to HTML](https://devnet.logianalytics.com/hc/en-us/articles/1500009610982--Exporting-to-HTML).

![Options dialog - Export to category - HTML tab](https://devnet.logianalytics.com/hc/article_attachments/4404911691159/optn_expt_html.gif)
...
* **Multiple files**  
   If selected, Logi Report Designer will convert the report into multiple files and designates a serial number for each HTML page. For example, if a 3-page report is named Sales, Logi Report Designer will create three files called Sales\_1.html, Sales\_2.html, and Sales\_3.html.
* **Single file**  
...
If the option is selected, the accessibility attributes defined for the report elements via the Report Inspector will be exported to the HTML format report result which is Section 508 compliant. See [Accessibility](https://devnet.logianalytics.com/hc/en-us/articles/1500009628201-Accessibility) for more information.
...
Specifies the e-mail server and the preferences for [exporting the report result to E-mail](https://devnet.logianalytics.com/hc/en-us/articles/1500009634121-Exporting-to-Mail).
...
This option must be selected if an SMTP Server requires authentication.
...
Specifies fax settings for [exporting the report result to fax](https://devnet.logianalytics.com/hc/en-us/articles/1500009610962-Exporting-to-Fax). You can specify to export the report result either via a fax machine or a fax server.

![Options dialog - Export to category - Fax tab](https://devnet.logianalytics.com/hc/article_attachments/4404911691671/optn_expt_fax.gif)
...
Specifies the properties for [printing reports](https://devnet.logianalytics.com/hc/en-us/articles/1500009611102-Printing-Report-Result).
...
Specifies whether or not to separate large pages during printing. When you print a report with a report page size which is larger than the print paper size, the report will be printed in multiple pages serially. That is, Logi Report will automatically separate a large page of a report.

## Query Editor

Specifies the default properties of the Query Editor used for [creating queries](https://devnet.logianalytics.com/hc/en-us/articles/1500009635981-Creating-Queries-in-a-Catalog).

![Options dialog - Query Editor category](https://devnet.logianalytics.com/hc/article_attachments/4404904249111/optn_qryedtr.gif)
...
* **Automatically add quotation marks on input values**  
   Enables Logi Report Designer to add quote marks automatically after a String type value is inputted into the second Expression text box in the AND format when you specify certain criteria for the fields to be retrieved from the database.

## Security

You can set one or more user accounts to use Logi Report Designer.

![Options dialog - Security category](https://devnet.logianalytics.com/hc/article_attachments/4404911691927/optn_scrty.gif)

**Start Security Manager**

Specifies whether to enable this feature or not. For the first time you select this checkbox, you are prompted to create a user account in the Report Register dialog:
...
Specifies the image cache in Logi Report Designer.

![Options dialog - Cache category](https://devnet.logianalytics.com/hc/article_attachments/4404911692439/optn_cache.gif)
...
* **All used images**  
   If the option is selected, all the images that are used in reports will be cached.
* **Maximum Image Cache Size**  
   If the option is selected, you can specify the maximum size for caching images as required. The default value is 5 MB.

## Server

Specifies the options for connecting with a started Logi Report Server in order to publish or get resources from the server.

![Options dialog - Server category](https://devnet.logianalytics.com/hc/article_attachments/4404904249495/optn_srv.gif)
...
When both the connection and user information is remembered by Logi Report Designer and the specified server is started, when you want to connect to the server to publish or get resources, Logi Report Designer will set up the connection and log you in automatically, otherwise you will be prompted with the [Connect to Logi Report Server](https://devnet.logianalytics.com/hc/en-us/articles/1500009607442-Connect-to-Logi-Report-Server-Dialog) dialog to specify the connection and user information.
