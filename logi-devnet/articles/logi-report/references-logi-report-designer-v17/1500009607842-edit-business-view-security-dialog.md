...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009607842-Edit-Business-View-Security-Dialog
updated_at: 2021-07-24T16:04:48Z
---

# Edit Business View Security Dialog

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404911578903/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009607822-Edit-Aggregation-Dialog) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404911579543/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009630621-Edit-Color-Dialog)

# Edit Business View Security Dialog

The Edit Business View Security dialog helps you to [define security](https://devnet.logianalytics.com/hc/en-us/articles/1500009605382-Business-View-Security#Configure) for business views in a catalog. It appears when you do one of the following:

* Select Menu > Tools > Security Configuration in the [Business View Editor](https://devnet.logianalytics.com/hc/en-us/articles/1500009607342-Business-View-Editor-Dialog).
...
![Edit Business View Security dialog](https://devnet.logianalytics.com/hc/article_attachments/4404904352919/edtbvscrty.gif)
...
* ![Add button](https://devnet.logianalytics.com/hc/article_attachments/4404904181783/btn_add.gif)  
  ...
  + **Add User**  
     Creates a new user in the [Add User](https://devnet.logianalytics.com/hc/en-us/articles/1500009629881-Add-User-Dialog) dialog.
  + **Add Group**  
     Creates a new group in the [Add Group](https://devnet.logianalytics.com/hc/en-us/articles/1500009629841-Add-Group-Dialog) dialog.
  + **Add Role**  
     Creates a new role in the [Add Role](https://devnet.logianalytics.com/hc/en-us/articles/1500009629861-Add-Role-Dialog) dialog.
  + **Import from Logi Report Server**  
     Imports principals from a started Logi Report Server. If Logi Report Designer cannot connect to the server and log you in automatically, you will be prompted with the [Connect to Logi Report Server](https://devnet.logianalytics.com/hc/en-us/articles/1500009607442-Connect-to-Logi-Report-Server-Dialog) dialog to specify the properties for connecting with the server first.
  + **Import from File**  
     Imports principals from an xml file.
* ![Export button](https://devnet.logianalytics.com/hc/article_attachments/4404904245015/btn_expt2fl.gif)  
...
* **![Search button](https://devnet.logianalytics.com/hc/article_attachments/4404916806807/btn_srchusr.gif)**  
...
* ![Drop-down Menu button](https://devnet.logianalytics.com/hc/article_attachments/4404904353815/btn_drpdwn.gif)  
...
* **![Search button](https://devnet.logianalytics.com/hc/article_attachments/4404904354199/btn_srchrsc.gif)**  
...
* **Use Default**  
   Specify whether to use the default security settings of the selected fields. Clear the option to specify the data security and resource security for the selected fields.
* **Set as Default**  
   The option is enabled when Use Default is unselected and only one principal and one field is selected. It saves the current data security and resource security settings as the selected field's default security settings.
...
* **Allowed Set**  
  ...
  + ![Edit button](https://devnet.logianalytics.com/hc/article_attachments/4404911588375/btn_edit.gif)  
     Edits the allowed members in the [Edit Values](https://devnet.logianalytics.com/hc/en-us/articles/1500009630921-Edit-Values-Dialog) dialog.
  + ![Delete button](https://devnet.logianalytics.com/hc/article_attachments/4404904182167/btn_rmv.gif)  
...
* **Denied Set**  
  ...
  + ![Edit button](https://devnet.logianalytics.com/hc/article_attachments/4404911588375/btn_edit.gif)  
     Edits the denied members in the [Edit Values](https://devnet.logianalytics.com/hc/en-us/articles/1500009630921-Edit-Values-Dialog) dialog.
  + ![Delete button](https://devnet.logianalytics.com/hc/article_attachments/4404904182167/btn_rmv.gif)  
     Deletes the specified members or condition.
