...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405690649367-Automatic-Drilling-Page-Report-Data
updated_at: 2022-01-27T07:59:42Z
---

# Automatic Drilling Page Report Data

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420453372695/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405683952919-Drilling-Through-Page-Report-Data)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420453372951/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405683954071-Going-Through-Page-Report-Data)
...
Drilling is only available when a data component bases on a business view or has been converted to use a business view. Otherwise you will see [Going](https://devnet.logianalytics.com/hc/en-us/articles/4405683954071-Going-Through-Page-Report-Data) instead of Drilling actions.

You need a [Logi Report Live license for Server](https://devnet.logianalytics.com/hc/en-us/articles/4405683899543-Logi-Report-Licenses#ServerLive) to perform drilling on data components in Page Report Studio. For more product information, including new purchases and upgrades, contact [US Sales](mailto:salesteam@logianalytics.com?subject=I%20am%20interested%20in%20purchasing%20this%20product,%20please%20contact%20me. "US Sales email address.") or [UK Sales](mailto:emea_sales@logianalytics.com?subject=I%20am%20interested%20in%20purchasing%20this%20product.%20Please%20contact%20me. "Email address for UK sales team.").
...
1. Right-click any value of Region, Asia-Pacific for example, and choose **Drill To** from the shortcut menu. The list of groups available for Drill To will appear on the submenu.
   ...
   ![Drill To](https://devnet.logianalytics.com/hc/article_attachments/4420453498519/pgrpt_edit_drl_auto1.gif)
2. Select **Product Type**  on the submenu, then in the regenerated report, we can see that Sales Year remains the group for rows and Product Type becomes the group for columns.
   ...
   ![Drill to Product Type](https://devnet.logianalytics.com/hc/article_attachments/4420447161111/pgrpt_edit_drl_auto2.gif)
...
3. Select **Product Type**  too. Server regenerates the report.
   ...
   ![Drill to by Value - Product Type](https://devnet.logianalytics.com/hc/article_attachments/4420447161623/pgrpt_edit_drl_auto3.gif)
   ...
   ![Drill Filter Panel](https://devnet.logianalytics.com/hc/article_attachments/4420447161879/pgrpt_edit_drl_auto7.gif)
...
1. Go back to the original report in the preceding example, right-click the value **North America**, then select **Drill Down** on the shortcut menu. We can see that **Country** is the submenu item.
   ...
   ![Drill Down](https://devnet.logianalytics.com/hc/article_attachments/4420461568151/pgrpt_edit_drl_auto4.gif)
2. Select **Country** to see the report. It displays the data about countries in the North America region.

   ![Drill Down to Country](https://devnet.logianalytics.com/hc/article_attachments/4420447162135/pgrpt_edit_drl_auto5.gif)
3. The one-level-lower group for Country defined in the hierarchy is State. Now select **Canada** directly and Server also drills it down to **State**.
   ...
   ![Drill Down to State](https://devnet.logianalytics.com/hc/article_attachments/4420453498775/pgrpt_edit_drl_auto6.gif)
   ...
   ![Drill Filter Panel](https://devnet.logianalytics.com/hc/article_attachments/4420461568407/pgrpt_edit_drl_auto8.gif)
...
1. Based on the report after drill-down, right-click any value of State, BC for example, then select **Drill Up** on the shortcut menu. We can see that Country is the submenu item.
   ...
   ![Drill Up](https://devnet.logianalytics.com/hc/article_attachments/4420461568663/pgrpt_edit_drl_auto9.gif)
2. Select **Country** to see the report. The group goes to the higher level. Country is now the group for columns.

   ![Drill Up to Country](https://devnet.logianalytics.com/hc/article_attachments/4420461568919/pgrpt_edit_drl_auto10.gif)
3. The one-level-higher group for Country defined in the hierarchy is Region. Now right-click any value of Country, Canada for example, then select **Drill Up** > **Region** on the shortcut menu. Server drills it up to Region.
   ...
   ![Drill Up to Region](https://devnet.logianalytics.com/hc/article_attachments/4420447162647/pgrpt_edit_drl_auto11.gif)
