...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009747841-Set-Alias
updated_at: 2021-07-25T07:19:35Z
---

# Set Alias

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404936712471/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009720962-Select-Target)[Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404942444695/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009747661-Set-Permissions)

# Set Alias

The Set Alias dialog box is used to set an [alias](https://devnet.logianalytics.com/hc/en-us/articles/1500009724522-Managing-Aliases) resource tree for the specified role, group, or user. It appears when an admin user selects the Set Role Alias, Set Group Alias or Set User Alias link in the Administration > Security > Alias page in the server console.
...
![Set Alias dialog - Select](https://devnet.logianalytics.com/hc/article_attachments/4404942478231/setalias_select.gif)
...
![Set Alias dialog - Define](https://devnet.logianalytics.com/hc/article_attachments/4404936763927/setalias_tree.gif)
...
* **Real Resource Name**  
   Specifies a resource in a public folder with full path. You can select a resource in the resource tree or type one manally.
* **OK**  
   Applies the setting.
* **Cancel**  
