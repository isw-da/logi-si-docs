...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009721922-Format-Target-Label
updated_at: 2021-07-25T07:19:19Z
---

# Format Target Label

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404936712471/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009721902-Format-Solid-Gauge)[Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404942444695/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009748681-Format-Value-Y-Axis)

# Format Target Label

The Format Target Label dialog box is used to format the target labels in a gauge chart. It appears when you right-click on a gauge chart (excluding bubble gauge) and then select Format Target Label from the shortcut menu.
...
![Format Target Label - General](https://devnet.logianalytics.com/hc/article_attachments/4404936839447/fmttgtlbl_gnrl.gif)
...
* **X**  
   Specifies the horizontal coordinate of the top left corner of the labels, relative to their parent container. It takes effect when the Show Target Value option is selected and Position is set to customized in the Target tab of the gauge's corresponding Format XXX Gauge dialog box.
* **Y**  
   Specifies the vertical coordinate of the top left corner of the labels, relative to their parent container. It takes effect when the Show Target Value option is selected and Position is set to customized in the Target tab of the gauge's corresponding Format XXX Gauge dialog box.
* **Alignment**  
...
![Format Target Label - Font](https://devnet.logianalytics.com/hc/article_attachments/4404936839703/fmttgtlbl_font.gif)
...
![Format Target Label - Format](https://devnet.logianalytics.com/hc/article_attachments/4404936839959/fmttgtlbl_fmt.gif)
