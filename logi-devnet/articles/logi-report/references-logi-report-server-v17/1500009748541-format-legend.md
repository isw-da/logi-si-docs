...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009748541-Format-Legend
updated_at: 2021-07-25T07:19:21Z
---

# Format Legend

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404936712471/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009748521-Format-KPI-Label)[Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404942444695/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009748561-Format-Line)

# Format Legend

The Format Legend dialog box is used to format the legend of a chart. It appears when you right-click a chart and select Format Legend (unavailable to org chart and gauge bubble chart) from the shortcut menu.

There are the following tabs in this dialog box: [General](#General), [Placement](#Placement), [Border](#Border), [Font](#Font) and [Label](#Label).
...
![Format Legend dialog - General](https://devnet.logianalytics.com/hc/article_attachments/4404942539671/fmtlgnd_gnrl.gif)
...
![Format Legend dialog - Placement](https://devnet.logianalytics.com/hc/article_attachments/4404936845335/fmtlgnd_place.gif)
...
![Format Legend dialog - Border](https://devnet.logianalytics.com/hc/article_attachments/4404942540183/fmtlgnd_border.gif)
...
![Format Legend dialog - Font](https://devnet.logianalytics.com/hc/article_attachments/4404936845719/fmtlgnd_font.gif)
...
![Format Legend dialog - Label](https://devnet.logianalytics.com/hc/article_attachments/4404936845975/fmtlgnd_lbl.gif)
...
* **Label Text**  
   Specifies the text of the legend entry labels. Type the desired label text manually or select ![Formula button](https://devnet.logianalytics.com/hc/article_attachments/4404936732951/btn_wbrpt_fmla.gif) to select a field from the drop-down list to use its values as the label text.
