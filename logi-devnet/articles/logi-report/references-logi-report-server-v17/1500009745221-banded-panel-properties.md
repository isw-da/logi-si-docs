...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009745221-Banded-Panel-Properties
updated_at: 2021-07-25T07:20:10Z
---

# Banded Panel Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404936712471/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009719102-Banded-Object-Properties)[Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404942444695/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009745241-Banded-Wizard)

# Banded Panel Properties

The Banded Panel Properties dialog box is used to edit the properties of a banded panel.
...
![Banded Panel Properties dialog - General tab](https://devnet.logianalytics.com/hc/article_attachments/4404936952087/bdpnlprpty_gnrl.gif)
...
![Banded Panel Properties dialog - Border tab](https://devnet.logianalytics.com/hc/article_attachments/4404936952343/bdpnlprpty_border.gif)
...
![Banded Panel Properties dialog - Others tab](https://devnet.logianalytics.com/hc/article_attachments/4404936952599/bdpnlprpty_other.gif)
...
When the current page cannot hold the whole panel, the panel will cross into the next page if the property is set to true, or else the whole panel will be displayed in the next page.

**Suppress When No Records**

Specifies whether to display the panel in the report result when no record is returned to its parent data component.

**Export to XLS**

If true, the panel will be exported when you save the report result as an XLS file (make sure to check Data Format in the Export dialog box).
