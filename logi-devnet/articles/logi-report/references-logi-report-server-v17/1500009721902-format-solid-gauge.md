...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009721902-Format-Solid-Gauge
updated_at: 2021-07-25T07:19:19Z
---

# Format Solid Gauge

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404936712471/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009748661-Format-Series-Z-Gridline)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404942444695/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009721922-Format-Target-Label)

# Format Solid Gauge

The Format Solid Gauge dialog box is used to format the solid gauges in a solid gauge chart. It appears when you right-click on a solid gauge chart and select Format Graph from the shortcut menu.
...
![Format Solid Gauge dialog - Circular Graph](https://devnet.logianalytics.com/hc/article_attachments/4404936840215/fmtsldgauge_crculr.gif)
...
* **Angle**  
   Specifies the degree for angles of the arcs. Select the angle of the gauge from the drop-down list or select Customized to open the [Customize Gauge Angle](https://devnet.logianalytics.com/hc/en-us/articles/1500009748221-Customize-Gauge-Angle) dialog box to specify the start angle and end angle.
* **Thickness**  
...
* **Color**  
   Specifies the color of the arcs.
* **Color List**  
   Opens the [Color List](https://devnet.logianalytics.com/hc/en-us/articles/1500009748181-Color-List) dialog box to specify the color of the arcs.
* **Transparency**  
...
![Format Solid Gauge dialog - Axis - Axis tab](https://devnet.logianalytics.com/hc/article_attachments/4404936840471/fmtsldgauge_axis_axis.gif)
...
![Format Solid Gauge dialog - Axis - Tick Mark](https://devnet.logianalytics.com/hc/article_attachments/4404936840727/fmtsldgauge_axis_tkmk.gif)
...
![Format Solid Gauge dialog - Axis - Label](https://devnet.logianalytics.com/hc/article_attachments/4404936840983/fmtsldgauge_axis_lbl.gif)
...
![Format Solid Gauge dialog - Axis - Format](https://devnet.logianalytics.com/hc/article_attachments/4404936841239/fmtsldgauge_axis_fmt.gif)
...
![Format Solid Gauge dialog - Pointer](https://devnet.logianalytics.com/hc/article_attachments/4404936841495/fmtsldgauge_pnt.gif)
...
* **Arrow**  
  ...
  + **Value Pointer**  
     Specifies the style of the value pointers. Select a style from the drop-down list or select Customized to specify another image as the value pointers in the [Insert Image](https://devnet.logianalytics.com/hc/en-us/articles/1500009722002-Insert-Image) dialog box.
  + **Width**   
...
* **Style List**  
   Opens the [Style List](https://devnet.logianalytics.com/hc/en-us/articles/1500009722362-Style-List) dialog box to specify the style for pointers in the same data series respectively.
...
* **Color List**   
   Opens the [Color List](https://devnet.logianalytics.com/hc/en-us/articles/1500009748181-Color-List) dialog box for you to specify the pointer color.
* **Transparency**  
...
![Format Solid Gauge dialog - Target](https://devnet.logianalytics.com/hc/article_attachments/4404942533527/fmtsldgauge_tgt.gif)
...
* **Target Pointer**  
   Specifies the style of the target pointer. Select a style from the drop-down list or select Customized to specify another image as the target pointer in the [Insert Image](https://devnet.logianalytics.com/hc/en-us/articles/1500009722002-Insert-Image) dialog box.
* **Width**  
...
![Format Solid Gauge dialog - Frame](https://devnet.logianalytics.com/hc/article_attachments/4404936841751/fmtsldgauge_frm.gif)
...
![Format Solid Gauge dialog - Range Color](https://devnet.logianalytics.com/hc/article_attachments/4404942533783/fmtsldgauge_rgclr.gif)
...
![Format Solid Gauge dialog - Hint](https://devnet.logianalytics.com/hc/article_attachments/4404936842007/fmtsldgauge_hint.gif)
