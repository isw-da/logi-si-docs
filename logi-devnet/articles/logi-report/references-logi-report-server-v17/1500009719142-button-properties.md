...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009719142-Button-Properties
updated_at: 2021-07-25T07:20:10Z
---

# Button Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404936712471/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009719122-Bottom-N)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404942444695/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009719162-Chart-Definition)

# Button Properties

The Button Properties dialog box is used to modify the properties of a button in a navigation control. It varies according to the button type:
...
![Button Properties dialog - Button](https://devnet.logianalytics.com/hc/article_attachments/4404942603927/btnprpty_btn.gif)
...
![Button Properties dialog - Image Button](https://devnet.logianalytics.com/hc/article_attachments/4404942604183/btnprpty_img.gif)
...
* **Local File**  
   Specifies to use an image from the local file system. The types and size of the images that can be used are defined by the administrator in the Administration > Configuration > Upload page in the Logi Report Server console.
  + **File Name**  
