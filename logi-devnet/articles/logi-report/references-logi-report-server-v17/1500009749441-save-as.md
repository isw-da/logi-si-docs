...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009749441-Save-As
updated_at: 2021-07-25T07:19:10Z
---

# Save As

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404936712471/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009749281-Report-Body-Properties)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404942444695/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009749381-Select-a-Report)

# Save As

The Save As dialog box is used to save the current [web report](#Report) or the [web report template](#Template), or save a data component in the current web report [as a library component](#LC). It varies when used for different purposes.

---

To use the Save As dialog box to [save the current web report](https://devnet.logianalytics.com/hc/en-us/articles/1500009751541-Saving-the-Report), select Menu > File > Save As or the Save As button ![Save As button](https://devnet.logianalytics.com/hc/article_attachments/4404936715031/btn_saveas.gif) on the toolbar, or select Save in the [Web Report Wizard](https://devnet.logianalytics.com/hc/en-us/articles/1500009722522-Web-Report-Wizard). In this case Report Server displays the dialog box as follows:

![Save As dialog - Web Report](https://devnet.logianalytics.com/hc/article_attachments/4404936723351/svas_rpt.gif)

**Save In**

Specifies the directory in the server resource tree where you want to save the report. Use the button ![Up Level button](https://devnet.logianalytics.com/hc/article_attachments/4404936723607/btn_wbrpt_up.gif) to go to the parent folder. The root folder cannot be used to store resources.
...
Saves the web report template with the specified settings and closes this dialog box.

**Cancel**

Does not save the web report template and closes the dialog box.
...
To use the dialog box to [save a data component in a web report as a library component](https://devnet.logianalytics.com/hc/en-us/articles/1500009724842-Manipulating-Data-Components#SaveAsLC), right-click a table, crosstab, chart, KPI or geographic map and select Save as Library Component. In this case Report Server displays the dialog box as follows:

![Save As dialog - Library Component](https://devnet.logianalytics.com/hc/article_attachments/4404942459287/svas_lc.gif)

**Save In**

Specifies the directory in the server resource tree where you want to save the library component. Use the button ![Up Level button](https://devnet.logianalytics.com/hc/article_attachments/4404936723607/btn_wbrpt_up.gif) to go to the parent folder. The root folder cannot be used to store resources.
