...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009722402-Table-Header-Properties
updated_at: 2021-07-25T07:19:09Z
---

# Table Header Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404936712471/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009749481-Table-Footer-Properties)[Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404942444695/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009722422-Table-Properties)

# Table Header Properties

The Table Header Properties dialog box is used to specify the properties of the table header. It appears when you select anywhere in a table header row, then select ![Select Row button](https://devnet.logianalytics.com/hc/article_attachments/4404936724503/btn_wbrpt_slctrow.gif) that appears on the table header to select the row, right-click on the row and select Properties from the shortcut menu.
...
![Table Header Properties dialog - General tab](https://devnet.logianalytics.com/hc/article_attachments/4404936820375/tablehdrprpty_gnrl.gif)
...
![Table Header Properties dialog - Border tab](https://devnet.logianalytics.com/hc/article_attachments/4404936820631/tablehdrprpty_border.gif)
