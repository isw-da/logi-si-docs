...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009719822-Parameter-Field-Properties
updated_at: 2021-07-25T07:19:57Z
---

# Parameter Field Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404936712471/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009746161-Parameter-Control-Properties)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404942444695/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009746181-Parameter-Form-Control-Properties)

# Parameter Field Properties

The Parameter Field Properties dialog box is used to edit the properties of a parameter field.
...
![Parameter Field Properties dialog - General tab](https://devnet.logianalytics.com/hc/article_attachments/4404936914327/prmtrprpty_gnrl.gif)
...
To change the color, select the color indicator to access the [Select Color](https://devnet.logianalytics.com/hc/en-us/articles/1500009746261-Select-Color) dialog box and then specify a new color, or type a color string in the text box.

## Font

This tab shows the font-related information of the parameter field.

![Parameter Field Properties dialog - Font tab](https://devnet.logianalytics.com/hc/article_attachments/4404936915351/prmtrprpty_font.gif)
...
![Parameter Field Properties dialog - Border tab](https://devnet.logianalytics.com/hc/article_attachments/4404942582935/prmtrprpty_border.gif)
...
![Parameter Field Properties dialog - Others tab](https://devnet.logianalytics.com/hc/article_attachments/4404942583191/prmtrprpty_other.gif)

**TOC Anchor**

Specifies whether or not to add the node that represents the parameter field to the TOC tree in the TOC Browser.
...
If true, the parameter field will be exported when you save the report result as an XLS file (make sure to check Data Format in the Export dialog box).
...
![Parameter Field Properties dialog - List Display Type](https://devnet.logianalytics.com/hc/article_attachments/4404936915607/prmtrprpty_rndrlst.gif)
...
![Parameter Field Properties dialog - Drop-down List Display Type](https://devnet.logianalytics.com/hc/article_attachments/4404936915863/prmtrprpty_rndrdrpdwn.gif)
...
**Reference:** For the rest display types, see [Data Field Properties](https://devnet.logianalytics.com/hc/en-us/articles/1500009745381-Data-Field-Properties#Render).
