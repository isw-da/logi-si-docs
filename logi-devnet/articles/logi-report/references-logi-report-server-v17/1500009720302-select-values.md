...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009720302-Select-Values
updated_at: 2021-07-25T07:19:47Z
---

# Select Values

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404936712471/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009720282-Select-Parameter)[Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404942444695/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009747101-Send-Sync)

# Select Values

The Select Values dialog box is used to specify one or more values to apply a filter criterion. It appears when you right-click on any value of a table detail field and select Filter > Select Values from the shortcut menu.

![Select Values dialog](https://devnet.logianalytics.com/hc/article_attachments/4404942569495/slctvlu.gif)
...
* **Text box**  
   Type the text you want to search for in the text box and the values containing the matched text will be listed.
* **X**  
...
* ![Search Options](https://devnet.logianalytics.com/hc/article_attachments/4404942460951/btn_srchtlbr_adv.gif)  
  ...
  + **Advanced**  
    ...
    - **For fields of String type**
      ...
      ![Advanced Options - String Type](https://devnet.logianalytics.com/hc/article_attachments/4404942524055/btn_srchtlbr_string.gif)
    ...
    - **For fields of Numeric type**  
      ...
      ![Advanced Options - Numeric Type](https://devnet.logianalytics.com/hc/article_attachments/4404942524311/btn_srchtlbr_num.gif)
    ...
    - **For fields of Date/Time type**
      ...
      ![Advanced Options - Date/Time Type](https://devnet.logianalytics.com/hc/article_attachments/4404942524567/btn_srchtlbr_date.gif)

      Five [operators](#Operator) are supported for composing the search condition. Select an operator from the operator drop-down list and select the **Calendar** icon ![](https://devnet.logianalytics.com/hc/article_attachments/4404936722455/btn_clndr.gif) to select a value from the calendar to compose the condition, then select the **OK** button to start searching. The Cancel button is used to close the search bar.
...
![Clear button](https://devnet.logianalytics.com/hc/article_attachments/4404942451223/btn_clear.gif)**Clear**
