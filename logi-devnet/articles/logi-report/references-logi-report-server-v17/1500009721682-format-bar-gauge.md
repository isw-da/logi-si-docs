...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009721682-Format-Bar-Gauge
updated_at: 2021-07-25T07:19:23Z
---

# Format Bar Gauge

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404936712471/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009721662-Format-Bar)[Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404942444695/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009721702-Format-Bench)

# Format Bar Gauge

The Format Bar Gauge dialog box is used to format the bar gauges in a bar gauge chart. It appears when you right-click on a bar gauge chart and select Format Graph from the shortcut menu.

There are the following tabs in this dialog box: [Staff Graph](#Staff), [Axis](#Axis), [Pointer](#Pointer), [Target](#Target), [Frame](#Frame), [Range Color](#Range) and [Hint](#Hint).
...
![Format Bar Gauge dialog - Staff Graph](https://devnet.logianalytics.com/hc/article_attachments/4404942548503/fmtbargauge_stfgraph.gif)
...
![Format Bar Gauge dialog - Axis - Axis tab](https://devnet.logianalytics.com/hc/article_attachments/4404936855191/fmtbargauge_axis_axis.gif)
...
![Format Bar Gauge dialog - Axis - Tick Mark](https://devnet.logianalytics.com/hc/article_attachments/4404942548759/fmtbargauge_axis_tkmk.gif)
...
![Format Bar Gauge dialog - Axis - Label](https://devnet.logianalytics.com/hc/article_attachments/4404936855447/fmtbargauge_axis_lbl.gif)
...
![Format Bar Gauge dialog - Axis - Format](https://devnet.logianalytics.com/hc/article_attachments/4404936855703/fmtbargauge_axis_fmt.gif)
...
![Format Bar Gauge dialog - Pointer](https://devnet.logianalytics.com/hc/article_attachments/4404936855959/fmtbargauge_pnt.gif)
...
* **Pointer Color**  
  ...
  + **Color List**   
     Opens the [Color List](https://devnet.logianalytics.com/hc/en-us/articles/1500009748181-Color-List) dialog box to specify the color pattern for pointers in the same data series respectively.
  + **Transparency**  
...
* **Pointer Color**  
  ...
  + **Color List**   
     Opens the [Color List](https://devnet.logianalytics.com/hc/en-us/articles/1500009748181-Color-List) dialog box to specify the color pattern for color bars in the same data series respectively.
* **Pointer Value**  
...
![Format Bar Gauge dialog - Target](https://devnet.logianalytics.com/hc/article_attachments/4404936856215/fmtbargauge_tgt.gif)
...
![Format Bar Gauge dialog - Frame](https://devnet.logianalytics.com/hc/article_attachments/4404936856471/fmtbargauge_frm.gif)
...
![Format Bar Gauge dialog - Range Color](https://devnet.logianalytics.com/hc/article_attachments/4404942549015/fmtbargauge_rgclr.gif)
...
![Format Bar Gauge dialog - Hint](https://devnet.logianalytics.com/hc/article_attachments/4404936856855/fmtbargauge_hint.gif)
