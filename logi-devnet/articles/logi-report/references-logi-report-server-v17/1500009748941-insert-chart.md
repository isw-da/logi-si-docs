...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009748941-Insert-Chart
updated_at: 2021-07-25T07:19:17Z
---

# Insert Chart

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404936712471/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009748901-Insert-Banded-Object)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404942444695/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009748961-Insert-Column)

# Insert Chart

The Insert Chart dialog box is used to define a chart and insert it to the destination, and varies with different chart types: [common chart types](#Common), [organization chart](#Org), [heat map](#Map), and [KPI chart](#KPI).
...
* Right-click the icon ![KPI button](https://devnet.logianalytics.com/hc/article_attachments/4404942451735/btn_pgrpt_drag.gif) of a KPI or the blank area in a KPI that contains no KPI chart, then select Insert KPI Chart from the shortcut menu.

**OK**

Inserts a chart in the destination and closes the dialog box.
...
![Insert Chart dialog- common](https://devnet.logianalytics.com/hc/article_attachments/4404942464279/insrtcht.gif)
...
![Insert Chart dialog- KPI Chart](https://devnet.logianalytics.com/hc/article_attachments/4404936834711/insrtcht_kpi.gif)
...
Lists the group object ![Group Object](https://devnet.logianalytics.com/hc/article_attachments/4404936726423/btn_bvgrp.gif) you want to use as the motion field. A motion field can only be of Integer, Date or Time data type. Available to single bar and bench chart types only.
