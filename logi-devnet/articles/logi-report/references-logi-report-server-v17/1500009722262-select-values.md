...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009722262-Select-Values
updated_at: 2021-07-25T07:19:11Z
---

# Select Values

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404936712471/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009722282-Select-Value)[Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404942444695/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009749301-Series-Options)

# Select Values

The Select Values dialog box is used to specify one or more values to apply a filter criterion. It appears when you right-click on any value of a detail field in a table or banded object and select Filter > Select Values from the shortcut menu.

![Select Values dialog](https://devnet.logianalytics.com/hc/article_attachments/4404942523799/slctvalue.gif)
...
* ![Search Options](https://devnet.logianalytics.com/hc/article_attachments/4404942460951/btn_srchtlbr_adv.gif)  
  ...
  + **Advanced**  
    ...
    - **For fields of the String type**
      ...
      ![Advanced - String Fields](https://devnet.logianalytics.com/hc/article_attachments/4404942524055/btn_srchtlbr_string.gif)
    ...
    - **For fields of Numeric type**  
      ...
      ![Advanced - Numeric Fields](https://devnet.logianalytics.com/hc/article_attachments/4404942524311/btn_srchtlbr_num.gif)
    ...
    - **For fields of Date/Time type**
      ...
      ![Advanced - Date/Time Fields](https://devnet.logianalytics.com/hc/article_attachments/4404942524567/btn_srchtlbr_date.gif)

      Five [operators](#Operator) are supported for composing the search condition. Select one from the operator drop-down list and select the **Calendar** icon ![](https://devnet.logianalytics.com/hc/article_attachments/4404936722455/btn_clndr.gif) to select a value from the calendar to compose the condition, then select the **OK** button to start searching. The Cancel button is used to close the search bar.
* ![Previous button](https://devnet.logianalytics.com/hc/article_attachments/4404936734487/btn_srchtlbr_prv.gif)  
   When Highlight All is selected, you can use this button to go to the previous matched text.
* ![Next button](https://devnet.logianalytics.com/hc/article_attachments/4404936734743/btn_srchtlbr_nxt.gif)  
   When Highlight All is selected, you can use this button to go to the next matched text.

![Clear button](https://devnet.logianalytics.com/hc/article_attachments/4404942451223/btn_clear.gif)
