...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009721802-Format-Gauge-Label
updated_at: 2021-07-25T07:19:22Z
---

# Format Gauge Label

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404936712471/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009748481-Format-Donut)[Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404942444695/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009748501-Format-Indicator)

# Format Gauge Label

The Format Gauge Label dialog box is used to format the group labels in a gauge chart. It appears when you right-click on a gauge chart (excluding bubble gauge) and then select Format Gauge Label from the shortcut menu.
...
![Format Gauge Label - General](https://devnet.logianalytics.com/hc/article_attachments/4404942540951/fmtgaugelbl_gnrl.gif)
...
* **X**  
   Specifies the horizontal coordinate of the top left corner of the labels, relative to their parent container. It takes effect when the Show Gauge Group Name option is selected and Position is set to customized in the Frame tab of the gauge's corresponding Format XXX Gauge dialog box.
* **Y**  
   Specifies the vertical coordinate of the top left corner of the labels, relative to their parent container. It takes effect when the Show Gauge Group Name option is selected and Position is set to customized in the Frame tab of the gauge's corresponding Format XXX Gauge dialog box.
* **Alignment**  
...
![Format Gauge Label - Font](https://devnet.logianalytics.com/hc/article_attachments/4404936846999/fmtgaugelbl_font.gif)
...
![Format Gauge Label - Format](https://devnet.logianalytics.com/hc/article_attachments/4404942541207/fmtgaugelbl_fmt.gif)
