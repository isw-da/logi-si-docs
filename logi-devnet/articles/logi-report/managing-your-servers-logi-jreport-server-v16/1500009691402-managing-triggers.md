...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009691402-Managing-Triggers
updated_at: 2021-11-03T06:56:51Z
---

# Managing Triggers

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4412131374359/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009691322-Managing-In-memory-Cubes)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4412139481879/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009718061-National-Language-Support)
...
Administrators manage triggers in the Triggers page of the Logi JReport Server console (to access the page, point to **Administration** on the system toolbar, and then select **Other** > **Triggers** from the drop-down menu).

![Trigger page](https://devnet.logianalytics.com/hc/article_attachments/4412131435287/mng_trgr.gif)

Administrators can manage the triggers as follows:

* **Creating a trigger**
  1. Select **New Trigger** on the task bar. The [New Trigger](https://devnet.logianalytics.com/hc/en-us/articles/1500009688882-New-Trigger) dialog appears.

     ![New Trigger dialog](https://devnet.logianalytics.com/hc/article_attachments/4412131435543/nwtrigr.gif)
  2. In the Trigger Name text box, input a unique name for the trigger. Select**Conflict Check** to check whether the name has been used.
  3. In the Description text box, enter a brief description to introduce the trigge
