...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405690677015-Scheduling-Bursting-Reports
updated_at: 2022-01-27T07:59:46Z
---

# Scheduling Bursting Reports

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420453372695/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405684006039-Examples-of-Scheduling-Reports)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420453372951/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405684009879-Applying-Dynamic-Names-for-Published-Result-Files)

# Scheduling Bursting Reports

This topic describes the advantages of bursting reports and how you can schedule bursting reports to generate bursting result and non-bursting result.
...
Bursting reports can be distributed to email or FTP addresses, to disk, to the Logi Report versioning system, or to the security system members such as users, groups, and roles.
...
* **Sub bursting task**: It is responsible for generating the report outputs according to split data and sending the outputs to the addresses of the bursting recipients.
...
![Select Bursting Schema](https://devnet.logianalytics.com/hc/article_attachments/4420453478807/wkrpt_sch_burst1.gif)
...
![Bursting Result Tab](https://devnet.logianalytics.com/hc/article_attachments/4420447138199/wkrpt_sch_burst2.gif)
...
When scheduling a bursting report, you do not need to specify the destination in the Publish tab since the bursting schema has included the recipient addresses. However, you can give a file name to the subset of report instead of using the default name.
...
When a bursting key is of one of the following data types, Server converts it into String to make a valid result file name:

* Integer, Float, Character: Same as Java, Server transfers these data types to String directly.
* Date and Time: Server transfers all date and time formats to a date format: yyyy-MM-dd hh:mm:ss.
...
To avoid the same name in the same path, Server appends an index to the result name, for example: report1\_USA\_Maryland1.pdf, report1\_USA\_Maryland2.pdf.

![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4420447034135/noteicon.jpg)

* All bursting sub results apply the security information of the bursting task submitter.
* When a busting report has applied with security policies or filters, Logi Report may not be able to obtain the bursting key from the specified bursting schema, in this case, it will not send the busting result.
...
![Non-bursting Result Tab](https://devnet.logianalytics.com/hc/article_attachments/4420461546263/wkrpt_sch_burst3.gif)
