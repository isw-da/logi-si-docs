...
1. In the [Start Page](https://devnet.logianalytics.com/hc/en-us/articles/5741379895063-Lesson-1-Starting-Server) of the Server Console, select **My Profile** in the **Manage** category.
...
4. Navigate to **New** > **Web Report** on the task bar.
   ...
   ![New Web Report](https://devnet.logianalytics.com/hc/article_attachments/9905858435735/adhc_lsn2_crt_new.gif)
5. In the **Page** screen of the Web Report Wizard dialog box, the **Blank** template is selected by default. Type **Sales Performance** in the **Label** text box, then select **Next**. You can also select from the other two templates if you want, with which you can customize the company logo and company name.
   ...
   ![Select Report Template](https://devnet.logianalytics.com/hc/article_attachments/9905836698135/adhc_lsn2_crt_tmplt.gif)
6. In the **Layout** screen, select the **T-Style** layout. In the first row, select the **Select here to select component** link in the left cell and select **Crosstab** from the drop-down menu. Select **Table** for the right cell and **Banded Object** for the bottom row.
   ...
   ![Define Report Components](https://devnet.logianalytics.com/hc/article_attachments/9905836735127/adhc_lsn2_crt_layout.gif)
7. Select **Next** to go to the **Bind Data** screen to define data for the three components one by one.
8. First define the crosstab: from the **Data Source** drop-down list, select **WorldWideSalesBV** in Data Source 1. Select **Region** in the **Resources** box and select **Add**![Add button](https://devnet.logianalytics.com/hc/article_attachments/9905856709783/btn_add2.gif) to add it to the **Columns** box, then add **Sales Month** to the **Rows** box and **Total Sales** to the **Summaries** box.

   ![Define Crosstab Fields](https://devnet.logianalytics.com/hc/article_attachments/9905858542359/adhc_lsn2_crt_crstb.gif)
9. Select **Next** to define the table: keep the business view in the Data Source text box unchanged to use the same data source as the crosstab, in the **Details** tab, add **Product Name**, **Order Date**, and **Total** as the detail fields of the table one by one, then select the **Group** tab and add **Country** as the group-by field.
   ...
   ![Define Table Fields](https://devnet.logianalytics.com/hc/article_attachments/9905858563479/adhc_lsn2_crt_tbl.gif)
10. Select **Next** to define the banded object: keep the business view in the Data Source text box unchanged to use the same data source as the crosstab, in the **Details** tab, add these fields: **Order ID**, **Product Name**, **Quantity**, **Unit Price**, and **Total**, then select the **Group** tab and add **Country** as the group-by field.
    ...
    ![Define Table Fields](https://devnet.logianalytics.com/hc/article_attachments/9905858590999/adhc_lsn2_crt_bdobj.gif)
...
12. Select **Run**. The report runs in Web Report Studio.
    ...
    ![Run Report in Web Report Studio](https://devnet.logianalytics.com/hc/article_attachments/9905836855447/adhc_lsn2_crt_rpt.gif)
13. Select **Save**![Save button](https://devnet.logianalytics.com/hc/article_attachments/9905835138583/btn_save.gif) on the toolbar.
...
1. Right-click the row header and navigate to **Switch Row** > **Sales Quarter** on the shortcut menu.
   ...
   ![Switch Row](https://devnet.logianalytics.com/hc/article_attachments/9905858659351/adhc_lsn2_crstb_switch.gif)

   The row header now displays quarters.

   ![Switch Row Resulr](https://devnet.logianalytics.com/hc/article_attachments/9905858695703/adhc_lsn2_crstb_switchrst.gif)
...
1. Right-click **2015-Q1** in the row header, navigate to **Go to by Value** > **Category** on the shortcut menu. The crosstab refreshes to show the total sales of each product category in the first quarter of 2015 in different regions.
   ...
   ![Go to by Value](https://devnet.logianalytics.com/hc/article_attachments/9905836945943/adhc_lsn2_crstb_go.gif)
...
1. Right-click on the row header and navigate to **Go Up** > **Product Type** on the shortcut menu.
   ...
   ![Go Up](https://devnet.logianalytics.com/hc/article_attachments/9905836967831/adhc_lsn2_crstb_goup.gif)

   The crosstab changes to：

   ![Go Up Result](https://devnet.logianalytics.com/hc/article_attachments/9905858783511/adhc_lsn2_crstb_gouprst.gif)
...
1. Right-click **Regular** and navigate to **Go Down** > **Category** on the shortcut menu.
   ...
   ![Go Down Result](https://devnet.logianalytics.com/hc/article_attachments/9905858806935/adhc_lsn2_crstb_godwrst.gif)
...
1. Right-click the blank cell in the intersection of the crosstab row and column headers, then select **To Chart** from the shortcut menu.
   ...
   ![Convert Crosstab to Chart](https://devnet.logianalytics.com/hc/article_attachments/9905858826775/adhc_lsn2_crstb_2cht.gif)
2. The To Chart dialog box lists the data fields used in the crosstab and we can define the chart based on these fields only. Keep the default chart type **Clustered Bar 2-D**, add **Total Sales** to the **Bar Length** box, **Category** to the **X-Axis** box, and **Region** to the **Clustering** box.
   ...
   ![Define the Chart](https://devnet.logianalytics.com/hc/article_attachments/9905837058583/adhc_lsn2_crstb_2chtdlg.gif)
...
4. Drag the bottom border of the chart to enlarge its height. The chart now shows the total sales of the Regular categories in the first quarter of 2015 in different regions.
   ...
   ![Converted Chart](https://devnet.logianalytics.com/hc/article_attachments/9905858869399/adhc_lsn2_crstb_2chtrst.gif)
5. Select **Save**![Save button](https://devnet.logianalytics.com/hc/article_attachments/9905835138583/btn_save.gif) on the toolbar to save the report.
...
1. Select **Swap Chart Groups**![Swap Chart Groups button](https://devnet.logianalytics.com/hc/article_attachments/9905858893591/btn_swap.gif) on the toolbar. The chart refreshes to display as follows:

   ![Swap Chart Groups](https://devnet.logianalytics.com/hc/article_attachments/9905858918807/adhc_lsn2_cht_swap.gif)

Then, we change the chart type to analyze data in line chart.

1. Select **Chart Type**![Chart Type button](https://devnet.logianalytics.com/hc/article_attachments/9905858938263/btn_chttype.gif) on the toolbar, then navigate to **Line** > **Line 2-D** on the drop-down menu.

   ![Chart Type List](https://devnet.logianalytics.com/hc/article_attachments/9905837195415/adhc_lsn2_cht_type.gif)
   ...
   ![Chart Value Tip](https://devnet.logianalytics.com/hc/article_attachments/9905858998295/adhc_lsn2_cht_tip.gif)
...
1. Right-click the highest node and select **Go to Detail** from the shortcut menu.
   ...
   ![Go to Detail](https://devnet.logianalytics.com/hc/article_attachments/9905859032215/adhc_lsn2_cht_go2dtl.gif)

   The detail table shows the Bold category's total sales in Europe, Middle East, Africa.

   ![Detail Table](https://devnet.logianalytics.com/hc/article_attachments/9905859049111/adhc_lsn2_cht_go2dtlrst1.gif)
...
1. Select **Back**![Back button](https://devnet.logianalytics.com/hc/article_attachments/9905859078551/btn_back.gif) on the toolbar to return to the main report.
...
3. The Edit Detail Table dialog box lists all the group and detail fields in the business view the chart uses. Add these fields to the right box to display in the detail table one by one: **Customer Name**, **Discount**, **Quantity**, **Unit Price**, and **Total**. Select **OK** to finish editing the detail table.
   ...
   ![Edit Detail Table Fields](https://devnet.logianalytics.com/hc/article_attachments/9905859112599/adhc_lsn2_cht_edtdtltbl.gif)
4. Right-click the highest node again and select **Go to Detail** from the shortcut menu. The detail table now displays data of the fields we selected.
   ...
   ![Customized Detail Table](https://devnet.logianalytics.com/hc/article_attachments/9905837353879/adhc_lsn2_cht_go2dtlrst2.gif)
5. Select **Back**![Back button](https://devnet.logianalytics.com/hc/article_attachments/9905859078551/btn_back.gif) on the toolbar to return to the main report.
6. Select **Save**![Save button](https://devnet.logianalytics.com/hc/article_attachments/9905835138583/btn_save.gif) on the toolbar to save the report.
...
2. From the **Resources** panel on the left, drag **Quantity** to the right border of the **Order Date** column and release the mouse button when Web Report Studio displays an orange line.
   ...
   ![Add Quantity Column](https://devnet.logianalytics.com/hc/article_attachments/9905859157143/adhc_lsn2_tbl_addclmn.gif)

   The table now displays as follows:

   ![New Table](https://devnet.logianalytics.com/hc/article_attachments/9905859185431/adhc_lsn2_tbl_addrst.gif)
...
1. Point to the **Order Date** column header. Web Report Studio displays the sort icon.
   ...
   ![Sort Order Date](https://devnet.logianalytics.com/hc/article_attachments/9905837432215/adhc_lsn2_tbl_srt.gif)
2. Select the down arrow to sort the dates in descending order.

   ![Sort Result](https://devnet.logianalytics.com/hc/article_attachments/9905837481239/adhc_lsn2_tbl_srtrst.gif)
...
2. In the Aggregate On dialog box, set the function to **Sum** and select **OK**.
   ...
   ![Summarize Order Total for Groups](https://devnet.logianalytics.com/hc/article_attachments/9905837530519/adhc_lsn2_tbl_sumrst.gif)
...
2. In the Conditional Formatting dialog box, select **Add**![Add button](https://devnet.logianalytics.com/hc/article_attachments/9905837577751/btn_add1.gif) above the **Condition** box.
...
4. Select the color image ahead of the **Background Color** text box and select the yellow color **#FFCC00** from the color palette. Select **OK** to apply the conditional formatting.
   ...
   ![Edit Conditional Format](https://devnet.logianalytics.com/hc/article_attachments/9905859370903/adhc_lsn2_tbl_cdtnlfmt.gif)

   The table refreshes to display as follows:

   ![Conditional Format Result](https://devnet.logianalytics.com/hc/article_attachments/9905837644695/adhc_lsn2_tbl_cdtnlfmtrst.gif)
5. From the **Resources** panel on the left, drag **Sales Year** above the **Australia** group and release the mouse button when Web Report Studio displays an orange line.
   ...
   ![Add Sales Year Group](https://devnet.logianalytics.com/hc/article_attachments/9905859467543/adhc_lsn2_tbl_addgrp.gif)

   The table refreshes as follows:

   ![Add Sales Year Group Result](https://devnet.logianalytics.com/hc/article_attachments/9905859499671/adhc_lsn2_tbl_addgrprst.gif)
6. Select **Save**![Save button](https://devnet.logianalytics.com/hc/article_attachments/9905835138583/btn_save.gif) on the toolbar to save the report.
...
1. Select in the banded object, then select **Edit Template**![Edit Template button](https://devnet.logianalytics.com/hc/article_attachments/9905837761943/btn_edttmplt.gif) on the visualization toolbar to access the template editor.

   ![Template editor](https://devnet.logianalytics.com/hc/article_attachments/9905837795991/adhc_lsn2_bndobj_tmpltedtr.gif)
2. Drag the detail object **Cost** from the **Resources** panel to the detail panel on the right of the **Total** column in the banded object.
   ...
   ![Add Detail Object](https://devnet.logianalytics.com/hc/article_attachments/9905837823383/adhc_lsn2_bndobj_adddtl.gif)

   Web Report Studio displays the result as follows:

   ![Add Detail Object Result](https://devnet.logianalytics.com/hc/article_attachments/9905837854999/adhc_lsn2_bndobj_adddtlrst.gif)
3. Drag **Region** from the Resources panel to the GH panel in the template editor and release the mouse button until Web Report Studio displays an orange line above GH.
   ...
   ![Add group field](https://devnet.logianalytics.com/hc/article_attachments/9905837876631/adhc_lsn2_bndobj_drgfld.gif)

   Web Report Studio adds the Region group above the Country group.

   ![Added group field result](https://devnet.logianalytics.com/hc/article_attachments/9905837895959/adhc_lsn2_bndobj_drgfldrst.gif)
...
1. Drag **Convert or drag to add Bar**![Bar Chart icon](https://devnet.logianalytics.com/hc/article_attachments/9905859706903/btn_barcht.gif) from the visualization toolbar to the GH panel of the Region group.

   ![Insert Chart](https://devnet.logianalytics.com/hc/article_attachments/9905837955351/adhc_lsn2_bndobj_instbarcht.gif)
2. In the Insert Chart dialog box, add **Total Sales** to the **Bar Length** box and **Category** to the **X-Axis** box.

   ![Define Chart Fields](https://devnet.logianalytics.com/hc/article_attachments/9905837995287/adhc_lsn2_bndobj_chtdlg.gif)
...
4. Resize the chart smaller: select in the chart to select it, then drag the bottom right corner of the chart to resize. You can also drag the chart to change its position.
   ...
   ![Resize Chart](https://devnet.logianalytics.com/hc/article_attachments/9905838022679/adhc_lsn2_bndobj_rszcht.gif)
5. Select the GH panel that contains the chart to select the panel, then drag the bottom border of the panel to be closer to the chart.
   ...
   ![Resize GH Panel](https://devnet.logianalytics.com/hc/article_attachments/9905859813527/adhc_lsn2_bndobj_rszpnl.gif)
6. Select **Return**![Return Button](https://devnet.logianalytics.com/hc/article_attachments/9905838061335/btn_rtn.gif) on the visualization toolbar to exit the template editor.

   The banded object looks as follows:

   ![Banded Object Result](https://devnet.logianalytics.com/hc/article_attachments/9905859868951/adhc_lsn2_bndobj_rst.gif)
...
1. Right-click **Asia-Pacific** and navigate to **Switch Group** > **Sales Year** on the shortcut menu.
   ...
   ![Switch Group](https://devnet.logianalytics.com/hc/article_attachments/9905859897367/adhc_lsn2_bndobj_swtchgrp.gif)

   The banded object now shows as follows:

   ![Switch Group Result](https://devnet.logianalytics.com/hc/article_attachments/9905838137495/adhc_lsn2_bndobj_swtchgrprst.gif)

## Task 6: Apply a Filter

In Web Report Studio, you can apply a filter to each data component in a report individually, or use the Filter panel and filter controls to filter multiple data components at a time. For the usage of filter controls, you can learn from [Creating Web Reports](https://devnet.logianalytics.com/hc/en-us/articles/5741406846103-Track-3-Creating-Web-Reports) in the Advanced Part. Here we focus on using the Filter panel to filter report data.

1. Select **Add**![Add button](https://devnet.logianalytics.com/hc/article_attachments/9905837577751/btn_add1.gif) on the title bar of the Filter panel on the left. Web Report Studio displays the Select Field dialog box.
2. Select **Country** and **Region**, keep the default **Apply To** setting, then select **OK**.

   ![Select Fields for Filter](https://devnet.logianalytics.com/hc/article_attachments/9905859941527/adhc_lsn2_fltr_slctfld.gif)
   ...
   ![Filter Panel](https://devnet.logianalytics.com/hc/article_attachments/9905859961623/adhc_lsn2_fltr_pnl1.gif)
3. Select **North America**  in the value list. The report comes out as follows:

   ![North America Result](https://devnet.logianalytics.com/hc/article_attachments/9905859978903/adhc_lsn2_fltr_rst1.gif)
   ...
   ![Filter Panel](https://devnet.logianalytics.com/hc/article_attachments/9905860018583/adhc_lsn2_fltr_pnl2.gif)
4. Select **Mexico**. Web Report Studio filters the report to show the following data:

   ![Mexico Result](https://devnet.logianalytics.com/hc/article_attachments/9905860057111/adhc_lsn2_fltr_rst2.gif)
