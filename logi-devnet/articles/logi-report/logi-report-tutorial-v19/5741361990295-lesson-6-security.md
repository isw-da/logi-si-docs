...
1. On the system toolbar of the Server Console, navigate to **Administration** > **Security** > **User**.
   ...
   ![Server Security](https://devnet.logianalytics.com/hc/article_attachments/9905879852695/admin_lsn6_tlbr.gif)
2. In the User page, select **New User**.

   ![New User](https://devnet.logianalytics.com/hc/article_attachments/9905879878807/admin_lsn6_user.gif)
3. Complete the New User dialog box with any user information you would like to use and select **OK** to create the user.

   ![New User dialog box](https://devnet.logianalytics.com/hc/article_attachments/9905879905175/admin_lsn6_adduser.gif)
...
2. In the Auditing dialog box, select **OK** to accept the defaults.
   ...
   ![Audit User](https://devnet.logianalytics.com/hc/article_attachments/9905879943575/admin_lsn6_audit.gif)
3. Server records the events in the log file.
...
2. Point to the resource row, then select **Properties**![Properties button](https://devnet.logianalytics.com/hc/article_attachments/9905879975191/btn_prpty.gif) on the floating toolbar.
3. In the Properties dialog box, switch to the **Permission** tab, select **Enable Setting Permissions**, then select the role/user/group in the **Selected** box and select or clear the permissions. If the role/user/group is not available in the Selected box, select the corresponding radio button below the **Available** box, add the role/user/group to the Selected box and then assign the permissions accordingly. To remove resource/folder permissions for all users, groups, and roles, clear **Enable Setting Permissions**.
   ...
   ![Assign Permission](https://devnet.logianalytics.com/hc/article_attachments/9905902117399/admin_lsn6_pmsn.gif)
