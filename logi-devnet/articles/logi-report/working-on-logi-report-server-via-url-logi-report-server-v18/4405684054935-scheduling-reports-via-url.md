...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405684054935-Scheduling-Reports-via-URL
updated_at: 2022-01-27T07:59:56Z
---

# Scheduling Reports via URL

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420453372695/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405690694295-Running-Reports-via-URL)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420453372951/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405684052759-Creating-Reports-via-URL)

# Scheduling Reports via URL

You can use the **submitSchedPage.jsp** to schedule reports via URL in a web browser, and should call the method **jrs.submit\_schedule** in the URL. This topic describes how you can schedule reports to different locations via URL.
...
![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4420447034135/noteicon.jpg)If you want to publish a report to a disk path, for example, jrs.rst\_dir=C:\, you can do the same as the preceding example. If you want to publish a report to a resource tree, for example, jrs.rst\_dir=%2fSampleReports, you can omit this property *&jrs.to\_disk\_pdf\_path\_type=1* in the preceding example and replace jrs.pdf\_dir=C:\ with jrs.rst\_dir=%2fSampleReports. Here **SampleReports** is the resource path.
