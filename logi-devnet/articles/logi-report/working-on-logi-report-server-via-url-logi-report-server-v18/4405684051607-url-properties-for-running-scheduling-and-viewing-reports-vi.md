...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405684051607-URL-Properties-for-Running-Scheduling-and-Viewing-Reports-via-URL
updated_at: 2022-01-27T07:59:54Z
---

# URL Properties for Running, Scheduling, and Viewing Reports via URL

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420453372695/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405684056983-Accessing-Visual-Analysis-via-URL)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420453372951/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405683539607-Working-with-APIs-Logi-Report-Server-v18)
...
| jrs.param$+PARAMETER\_NAME | Specify the parameter values for running a report. Use jrs.param$NAME=VALUE to set parameter values of the report, where NAME is the parameter name and VALUE is the URL-encoded parameter value. For example, `jrs.param$TERMSDAYS=30&jrs.param$PTODAY=May 21, 1998`.  When specifying values for a multi-valued parameter, you need to add `_isMultiple_jrs.param$NAME=true` before the parameter values, to declare that the parameter supports multiple values. For example: `&_isMultiple_jrs.param$PM=true&jrs.param$PM=3&jrs.param$PM=16`. |
...
| jrs.security\_file\_name | Specify a [security file](https://devnet.logianalytics.com/hc/en-us/articles/4405684015511-Dynamic-Security). The security definitions in the security file will replace that in the specified catalog. |
...
| jrs.to\_mail\_html | Specify whether to send the report in an [HTML](https://devnet.logianalytics.com/hc/en-us/articles/4405683737751-Advanced-Run-Dialog-Box-Properties#HTML) file as the email attachment. |
...
| jrs.to\_mail\_pdf | Specify whether to send the report in a [PDF](https://devnet.logianalytics.com/hc/en-us/articles/4405683737751-Advanced-Run-Dialog-Box-Properties#PDF) file as the email attachment. |
...
| jrs.to\_mail\_excel | Specify whether to send the report in an [Excel](https://devnet.logianalytics.com/hc/en-us/articles/4405683737751-Advanced-Run-Dialog-Box-Properties#Excel) file as the email attachment. |
...
| jrs.to\_mail\_txt | Specify whether to send the report in a [Text](https://devnet.logianalytics.com/hc/en-us/articles/4405683737751-Advanced-Run-Dialog-Box-Properties#Text) file as the email attachment. |
...
| jrs.to\_mail\_rtf | Specify whether to send the report in an [RTF](https://devnet.logianalytics.com/hc/en-us/articles/4405683737751-Advanced-Run-Dialog-Box-Properties#RTF) file as the email attachment. |
...
| jrs.to\_mail\_xml | Specify whether to send the report in an [XML](https://devnet.logianalytics.com/hc/en-us/articles/4405683737751-Advanced-Run-Dialog-Box-Properties#XML) file as the email attachment. |
...
| jrs.to\_mail\_ps | Specify whether to send the report in a [PostScript](https://devnet.logianalytics.com/hc/en-us/articles/4405683737751-Advanced-Run-Dialog-Box-Properties#PS) file as the email attachment. |
...
| Property | Description |
| --- | --- |
| [jrd\_filters](https://devnet.logianalytics.com/hc/en-us/articles/4405690694295-Running-Reports-via-URL#jrd_filters) | Specify the values of on-screen filters. |
...
| jrs.is\_pls\_result=true | Apply [cached report bursting](https://devnet.logianalytics.com/hc/en-us/articles/4405690679703-Cached-Report-Bursting) to view the report. |
