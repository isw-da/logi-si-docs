...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009778021-Formula-Field-Properties
updated_at: 2021-07-24T00:47:44Z
---

# Formula Field Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404880134167/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009778001-Filter-Control-Properties)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404880134423/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009778041-Image-Properties)

# Formula Field Properties

This topic describes the properties of a Formula Field object.
...
| Geometry | |
| Height | Specifies the height of the object, in inches. Type a numeric value to change the height. When the formula is in a crosstab, it is available only when the DBField is used as aggregate field. Data type: Float |
| Width | Specifies the width of the object, in inches. Type a numeric value to change the width. When the formula is in a crosstab, it is available only when the DBField is used as aggregate field. Data type: Float |
| X | Specifies the horizontal coordinate of the top left corner of the object, relative to its parent container. Type a numeric value to change the position in inches. Not available when the formula is in a crosstab. Data type: Float |
| Y | Specifies the vertical coordinate of the top left corner of the object, relative to its parent container. Type a numeric value to change the position in inches. Not available when the formula is in a crosstab. Data type: Float |
| Color | |
...
| Text Format | |
| Auto Fit | Specifies whether to adjust the width and height of the object according to the contents. For performance concern, you should not set both Auto Fit and [Word Wrap](#WordWrap) to true when the formula is in a crosstab. Data type: Boolean |
| Auto Scale in Number | Specifies whether to automatically scale the values that are of the Number data type when the values fall into the two ranges:   * When 1000 <= value < 10^15, Logi Report uses the following quantity unit symbols of the International System of Units to scale the values: K (10^3), M (10^6), G (10^9), and T (10^12). * When 0 < value < 0.001 or value >= 10^15, Logi Report uses scientific notation to scale the values.   The property is available when the object is of the Number data type.  The value **auto** means that the setting follows that of the parent data container.  Data type: Boolean |
...
| Word Wrap | Specifies whether to wrap the text to the width. For performance concern, you should not set both [Auto Fit](#AutoFit) and Word Wrap to true when the formula is in a crosstab. Data type: Boolean |
| Border | |
