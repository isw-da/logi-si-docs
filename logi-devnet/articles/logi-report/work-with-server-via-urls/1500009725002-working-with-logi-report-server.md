---
title: "Working with Logi Report Server"
id: 1500009725002
section: "Work With Server via URLs"
category: "Logi Report"
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009725002-Working-with-Logi-Report-Server
updated_at: 2021-07-25T07:18:30Z
---

# Working with Logi Report Server

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404936712471/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009751661-Using-the-Authentication-Properties-)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404942444695/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009751701-Working-with-Page-Reports)

# Working with Logi Report Server

You can use URL to work with Logi Report Server, for example, add and delete users/roles in the server security system, delete a resource node from the server resource tree, get the version table of a resource, and so on. [Appendix 1: URL Properties](https://devnet.logianalytics.com/hc/en-us/articles/1500009744581-Appendix-1-URL-Properties-for-Running-Scheduling-and-Viewing-Reports-via-URL) lists the properties you would need in the URL.
...
* [Logging in and out of Logi Report Server](#Log)

## Viewing Report Results

You can view the report results that are generated when [advanced running](https://devnet.logianalytics.com/hc/en-us/articles/1500009724222-Running-Reports#Advanced) or scheduling reports to [publish to the versioning system](https://devnet.logianalytics.com/hc/en-us/articles/1500009724282-Examples-of-Scheduling-Reports#Version) via URL by either of the following two ways.

* **Using jsp**
  + **For the Page Report Result type (RSD)**   
    Page report result files can be viewed in Page Report Studio by running runReport.jsp. The URL can call either of the following two groups of properties:
    ...
    - jrs.rst\_version together with one of the three properties: jrs.version\_id, jrs.report and jrs.result. Logi Report will search for the three properties one by one starting from the first to the third until it finds one.
...
For details about the properties that would be included in the URL, see [Properties for Viewing Report Results](https://devnet.logianalytics.com/hc/en-us/articles/1500009744581-Appendix-1-URL-Properties-for-Running-Scheduling-and-Viewing-Reports-via-URL#Result).

## Specifying the Application Language

When accessing the Logi Report Server console or Page Report Studio via URL, you can control the UI language that is applied by setting the property jrs.language. The format of the URL is as follows:
...
* URL for accessing the Logi Report Server console:
...
Admin users can run the following JSPs to add or remove users/roles to the security system on Logi Report Server. However, before they can do this, they should have [logged onto the Logi Report Server console](https://devnet.logianalytics.com/hc/en-us/articles/1500009749881-Accessing-Logi-Report-Server-via-a-Web-Browser)  in order to run the URL successfully.
...
For details about the properties that would be included in the URL, see [Properties for adding and deleting users/roles](https://devnet.logianalytics.com/hc/en-us/articles/1500009744581-Appendix-1-URL-Properties-for-Running-Scheduling-and-Viewing-Reports-via-URL#User).
...
## Logging in and out of Logi Report Server

* **jrs.login**

  Description: Logs onto the server from a login dialog box with a web browser.  
  HTTP Method: GET/POST  
