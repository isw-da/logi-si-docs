...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009589781-Command-line-Startup
updated_at: 2021-07-24T05:54:34Z
---

# Command-line Startup

[![](https://devnet.logianalytics.com/hc/article_attachments/4404889273495/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009589801-Logi-JReport-Designer-Launch-Files) [Next Topic![](https://devnet.logianalytics.com/hc/article_attachments/4404889273751/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009593001-Report-Development-Environment)
...
`java -Dreporthome=path -classpath path jet.builder.Logi JReport -vError -vDebug -help`
...
* **-Dreporthome**  
  ...
  Assume that Logi JReport Designer has been installed in `C:\Logi JReport\Designer`, this parameter is `-Dreporthome=C:\Logi JReport\Designer.`
* **-classpath** path  
   Tells the Java interpreter the class path. It is usually used for appending the Logi JReport Designer lib path to the Java class path. For example, assume that Logi JReport Designer has been installed in `C:\Logi JReport\Designer` and Java (JDK1.x.x) has been installed in `C:\java`, this parameter is then:

  `-classpath C:\java\lib\classes.zip;C:\Logi JReport\designer\lib\report.jar;`
* **-Djava.compiler**=NONE  
