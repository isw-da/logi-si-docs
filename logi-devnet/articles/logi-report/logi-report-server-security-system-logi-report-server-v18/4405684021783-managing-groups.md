...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405684021783-Managing-Groups
updated_at: 2022-01-27T07:59:48Z
---

# Managing Groups

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420453372695/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405684026007-Managing-User-Accounts)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420453372951/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405684024983-Managing-Roles)
...
To manage groups, first [select the realm](https://devnet.logianalytics.com/hc/en-us/articles/4405690680727-Managing-Realms#Select) in which the groups are, then on the system toolbar of the Server Console, navigate to **Administration** > **Security** > **Group** to display the Group page.

![Security - Group page](https://devnet.logianalytics.com/hc/article_attachments/4420461527831/scrty_rsc_srv_dtmdl_group.gif)
...
1. Select **New Group** on the task bar. Server displays the [New Group](https://devnet.logianalytics.com/hc/en-us/articles/4405690555927-New-Group-Dialog-Box-Properties) dialog box.

   ![New Group dialog](https://devnet.logianalytics.com/hc/article_attachments/4420453462807/nwgrp.gif)
...
5. Select **Publish** and **Advanced Properties** to give the group the [privilege](https://devnet.logianalytics.com/hc/en-us/articles/4405684022807-Managing-Privileges)s of publishing resources to Logi Report Server and of viewing advanced resource properties information.
6. Select **OK** to create the group. The new group is now added in the group table.

## Searching for Groups

In the Search box, type the text of the group names you want to search for and the groups containing the matched text will be listed. After typing text in the Search box, you can select the arrow ![Search Options](https://devnet.logianalytics.com/hc/article_attachments/4420453419415/btn_mvdown1.gif) that appears in the box to specify the following search options: Highlight All, Match Case, and Match Whole Word. To cancel the search operation, clear the text or select ![Delete button](https://devnet.logianalytics.com/hc/article_attachments/4420461456151/btn_dltobj.gif).

## Editing a Group

In the group table, select the name of the group. In the [Edit Group](https://devnet.logianalytics.com/hc/en-us/articles/4405683744151-Edit-Group-Dialog-Box-Properties) dialog box, add or remove the Publish and Advanced Properties privileges for the group and select **OK**.
...
![Edit Members](https://devnet.logianalytics.com/hc/article_attachments/4420447122071/scrty_rsc_srv_dtmdl_group_mbr.gif)
...
Logi Report Server adopts permission control on the [scheduling recipients each user can access](https://devnet.logianalytics.com/hc/en-us/articles/4405684026007-Managing-User-Accounts#Recipient). You can customize the scheduling recipients for a group so that when the users belonging to the group schedule report tasks to publish reports to email, they are able to select the recipients allowed for the group to use the recipients' addresses to send the email.

1. In the group table, select **recipients** of the group. Server displays the recipient list for the group.

   ![Edit recipients](https://devnet.logianalytics.com/hc/article_attachments/4420447122327/scrty_rsc_srv_dtmdl_group_rcpt.gif)
