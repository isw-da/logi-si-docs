...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405690683415-Using-LDAP-Server-s-Security-Information
updated_at: 2022-01-27T07:59:50Z
---

# Using LDAP Server's Security Information

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420453372695/back.png) Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405690682519-Configuring-the-LDAP-Server)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420453372951/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405684027287-SSL-Support-in-the-LDAP-System)
...
![Working Mode](https://devnet.logianalytics.com/hc/article_attachments/4420453451159/scrty_rsc_srv_ldap_use1.gif)
...
2. Select the **Import** tab.
   ...
   ![LDAP page](https://devnet.logianalytics.com/hc/article_attachments/4420447108887/scrty_rsc_srv_ldap_use_impt.gif)
...
1. In the Administration > Security > LDAP page, go to the **Synchronize** tab.
   ...
   ![Synchronize tab](https://devnet.logianalytics.com/hc/article_attachments/4420453453719/scrty_rsc_srv_ldap_use_sync.gif)
...
3. From the **Select time type to synchronize** drop-down list, specify the time when you want to perform the task.
   ...
   ![Specify Time](https://devnet.logianalytics.com/hc/article_attachments/4420453455639/scrty_rsc_srv_ldap_use_schdl.gif)
...
1. In the Administration > Security > LDAP page, go to the **Role Map** tab.
   ...
   ![Role Map tab](https://devnet.logianalytics.com/hc/article_attachments/4420447109143/scrty_rsc_srv_ldap_use_role.gif)
2. Select **Create New Role Map**.
3. In the **Search Filter String** text box, type the search filter criteria.

   ![Search Filter String](https://devnet.logianalytics.com/hc/article_attachments/4420453456151/scrty_rsc_srv_ldap_use_map.gif)
