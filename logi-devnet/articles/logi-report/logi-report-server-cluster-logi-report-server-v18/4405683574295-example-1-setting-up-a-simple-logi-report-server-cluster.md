...
3. [Access the Server Console](https://devnet.logianalytics.com/hc/en-us/articles/4405690636055-Accessing-Logi-Report-Server-via-a-Web-Browser) of Server2 using port 8888 as an administrator.
...
23. Select **Save** to accept all the changes.
    ...
    ![Cluster Settings](https://devnet.logianalytics.com/hc/article_attachments/4420453676567/clstr_set_case1.gif)
...
44. [Create a new user](https://devnet.logianalytics.com/hc/en-us/articles/4405684026007-Managing-User-Accounts) Tom in the Administration > Security > User page.
