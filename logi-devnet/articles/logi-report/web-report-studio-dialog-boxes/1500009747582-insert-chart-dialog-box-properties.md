...
* Right-click the icon ![KPI button](https://devnet.logianalytics.com/hc/article_attachments/4404880145943/btn_pgrpt_drag.gif) of a KPI or the blank area in a KPI that contains no KPI chart, then select **Insert KPI Chart** from the shortcut menu.
...
![Insert Chart dialog- common](https://devnet.logianalytics.com/hc/article_attachments/4404880174615/insrtcht.gif)
...
![Insert Chart dialog- KPI Chart](https://devnet.logianalytics.com/hc/article_attachments/4404880353303/insrtcht_kpi.gif)
...
Lists the group object ![Group Object](https://devnet.logianalytics.com/hc/article_attachments/4404880151447/btn_bvgrp.gif) you want to use as the motion field. A motion field can only be of Integer, Date or Time data type. Available to single bar and bench chart types only.
