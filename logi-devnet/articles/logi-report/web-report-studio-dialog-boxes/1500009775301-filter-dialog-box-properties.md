...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009775301-Filter-Dialog-Box-Properties
updated_at: 2021-07-24T00:48:29Z
---

# Filter Dialog Box Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404880134167/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009747122-Filter-Control-Properties)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404880134423/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009775321-Filter-Inspector-Dialog-Box-Properties)

# Filter Dialog Box Properties

This topic describes how you can use the Filter dialog box set criteria for [filtering records](https://devnet.logianalytics.com/hc/en-us/articles/1500009778741-Applying-Filters-in-Web-Report#Dialog).
Server displays the dialog box when you select Menu > Edit > Filter, or the Filter button ![Filter button](https://devnet.logianalytics.com/hc/article_attachments/4404880138903/btn_filter.gif) on the toolbar.

**Inspector**

Opens the [Filter Inspector](https://devnet.logianalytics.com/hc/en-us/articles/1500009775321-Filter-Inspector-Dialog-Box-Properties) dialog box.
...
Specifies the value of how to filter the field. You can type the value manually in the text box, select a value from the drop-down list, or select the button ![Enter Parameter Values button](https://devnet.logianalytics.com/hc/article_attachments/4404880189463/btn_dshbrd_prm.gif) and then select a parameter from the drop-down list as the value. When you type multiple values manually, you should separate them with ",", and if "," or "\" is contained in the values, write it as "\," or "\\".
...
![Filter dialog - Advanced mode](https://devnet.logianalytics.com/hc/article_attachments/4404885485335/fltr_adv.gif)
