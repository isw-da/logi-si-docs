...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009777301-Managing-Report-Running-Tasks
updated_at: 2021-07-24T00:47:57Z
---

# Managing Report-Running Tasks

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404880134167/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009748802--Advanced-Version-Topics-About-Version-Structure-and-Storage)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404880134423/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009748642-Managing-Server-Data)

# Managing Report-Running Tasks

This topic describes how you can view and manage report-running tasks on Logi Report Server.

You can perform the following fundamental report-running tasks on Server: quickly view a report result (Run), view a report result using selected options and parameters (Advanced Run), and schedule a report to run unattended at a specific time or periodically (Schedule).
...
* Server displays the tasks that you [scheduled](https://devnet.logianalytics.com/hc/en-us/articles/1500009749542-Scheduling-Reports) in the following tables:
...
* Server displays the tasks that you performed using [Run, Advanced Run, or Background Run](https://devnet.logianalytics.com/hc/en-us/articles/1500009778381-Running-Reports) in the Background Tasks table.
...
To access a specific table, in the Server Console select **My Tasks** on the system toolbar, then select the corresponding tab. You can also use [URL commands](https://devnet.logianalytics.com/hc/en-us/articles/1500009750382-Working-with-Server-via-URL#Schedule) to directly open a task table.

![My Tasks Page](https://devnet.logianalytics.com/hc/article_attachments/4404880226199/wkrpt_sch_vwrst1.gif)
...
| Export a schedule task to a script file on disk | For more information, see [Importing and Exporting Scheduled Tasks](https://devnet.logianalytics.com/hc/en-us/articles/1500009749602-Importing-and-Exporting-Scheduled-Tasks). |
| Import a script file saved on disk to create a schedule task | For more information, see [Importing and Exporting Scheduled Tasks](https://devnet.logianalytics.com/hc/en-us/articles/1500009749602-Importing-and-Exporting-Scheduled-Tasks). |
...
1. Do either of the following to enable the task-level timeout mechanism.
   ...
   * In the Server Console, point to **Administration** on the system toolbar, and then select **Configuration** > **Advanced** from the drop-down menu. Server displays the Advanced page. Select the **Enable Task Duration** option.
...
3. Use the **Duration** tab in the Advanced Run or Schedule dialog box to specify task duration.
   ...
   ![Duration tab](https://devnet.logianalytics.com/hc/article_attachments/4404880287511/advcdrn_drtn.gif)
...
* **For an Advanced Run task**
  ...
  + In the Duration tab, if you have not selected the option Cancel the task after the specified time, the task will be switched to run in background mode when the task duration is up, in which case, you can choose to cancel the task manually. To do this, in the Background Tasks table,
    ...
    - Put the mouse pointer over the task row and select the **Delete** button ![Delete button](https://devnet.logianalytics.com/hc/article_attachments/4404885308823/btn_dltobj.gif) on the floating toolbar.
* **For a Schedule task** 
  ...
  + In the **Duration** tab, if you have not selected the option **Cancel the task after the specified time**, Server still lists the task in the Running table of the My Tasks page when the task duration is up. Then, if you want to cancel the task manually, do one of the following in the Running table,
    ...
    - Put the mouse pointer over the task row and select the **Stop** button ![Stop button](https://devnet.logianalytics.com/hc/article_attachments/4404880287127/btn_srv_stop.gif) on the floating toolbar.
