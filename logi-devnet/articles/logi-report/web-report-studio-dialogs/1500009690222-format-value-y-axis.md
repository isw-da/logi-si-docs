...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009690222-Format-Value-Y-Axis
updated_at: 2021-11-03T06:57:18Z
---

# Format Value (Y) Axis

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4412131374359/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009716401-Format-Target-Label)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4412139481879/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009716441-Format-Value-Y-Gridline)

# Format Value (Y) Axis

The Format Value (Y) Axis dialog helps you to format the value (Y) axis of the chart and contains the following tabs: [Axis](#Axis), [Tick Mark](#Tick), [Font](#Font), [Orientation](#Orientation) and [Format](#Format). This dialog appears when you right-click a chart and select Format Axes (unavailable to pie, indicator, heat map and org charts) > Format Value (Y) Axis from the shortcut menu.
...
![Format Value (Y) Axis dialog - Axis tab](https://devnet.logianalytics.com/hc/article_attachments/4412131445783/fmtvalueaxis_axis.gif)
...
![Format Value (Y) Axis dialog - Major Tick Mark tab](https://devnet.logianalytics.com/hc/article_attachments/4412112588823/fmtvalueaxis_mark_major.gif)
...
![Format Value (Y) Axis dialog - Minor Tick Mark tab](https://devnet.logianalytics.com/hc/article_attachments/4412112589079/fmtvalueaxis_mark_minor.gif)
...
![Format Value (Y) Axis dialog - Font tab](https://devnet.logianalytics.com/hc/article_attachments/4412112589335/fmtvalueaxis_font.gif)
...
![Format Value (Y) Axis dialog - Orientation tab](https://devnet.logianalytics.com/hc/article_attachments/4412112589591/fmtvalueaxis_orntatn.gif)
...
![Format Value (Y) Axis dialog - Format tab](https://devnet.logianalytics.com/hc/article_attachments/4412139548055/fmtvalueaxis_fmt.gif)
