...
url: https://devnet.logianalytics.com/hc/en-us/articles/5735522534039-Edit-Dataset-Filter-Dialog-Box
updated_at: 2022-11-02T04:14:57Z
---

# Edit Dataset Filter Dialog Box

[![Back](https://devnet.logianalytics.com/hc/article_attachments/9898402961815/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/5735513701143-Edit-Conditions-Dialog-Box)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/9898402971543/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/5735522519831-Edit-Display-Name-Dialog-Box)

# This image notes any new content for version 19 of the product. For more information please see the Release Notes or What's New topics.Edit Dataset Filter Dialog Box

You can use the Edit Dataset Filter dialog box to [specify filter conditions for a dataset](https://devnet.logianalytics.com/hc/en-us/articles/5735555312279-Filtering-Datasets-in-a-Report) that is based on a business view. This topic describes the options in the dialog box.
...
![Edit Dataset Filter dialog box](https://devnet.logianalytics.com/hc/article_attachments/9898481788567/edtdtstfltr.gif)

Designer displays these options:

**Filter**

This drop-down list contains all [predefined filters](https://devnet.logianalytics.com/hc/en-us/articles/5735576514071-Creating-Business-Views-in-a-Catalog#Filter) of the business view on which the dataset the specified data component applies is based. Select one from the drop-down list to apply, or select **User Defined** to define a new filter.
...
Specify the business view element on which to define the condition. Select the ellipsis ![Ellipsis button](https://devnet.logianalytics.com/hc/article_attachments/9898422868887/btn_ellipsis2.gif) to specify the element.
...
Specify the value of how to filter the business view element. Select the ellipsis ![Ellipsis button](https://devnet.logianalytics.com/hc/article_attachments/9898422868887/btn_ellipsis2.gif) to specify the value.
