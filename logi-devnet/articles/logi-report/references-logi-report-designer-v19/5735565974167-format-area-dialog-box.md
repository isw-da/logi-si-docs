...
url: https://devnet.logianalytics.com/hc/en-us/articles/5735565974167-Format-Area-Dialog-Box
updated_at: 2022-11-02T04:37:30Z
---

# Format Area Dialog Box

[![Back](https://devnet.logianalytics.com/hc/article_attachments/9898402961815/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/5735509116055-Format-Activity-Gauge-Dialog-Box)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/9898402971543/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/5735529553431-Format-Bar-Dialog-Box)

# Format Area Dialog Box

You can use the Format Area dialog box to [format the areas of an area chart](https://devnet.logianalytics.com/hc/en-us/articles/5735506840727-Formatting-Area-Chart). This topic describes the options in the dialog box.
...
Designer displays different options in the General tab for a [2-D area chart](#2D) and a [3-D area chart](#3D). You can use it to specify general properties of the areas.

### For 2-D Area Chart

![Format Area dialog box - General 2-D](https://devnet.logianalytics.com/hc/article_attachments/9898481282583/fmtarea_gnrl_1.gif)
...
![Format Area dialog box - General 3-D](https://devnet.logianalytics.com/hc/article_attachments/9898481286807/fmtarea_gnrl_2.gif)
...
![Format Area dialog box - Fill](https://devnet.logianalytics.com/hc/article_attachments/9898464235927/fmtarea_fill.gif)
...
* **Color**  
  Specify the color of the selected area. To edit the color, select the color indicator and select a color from the [color palette](https://devnet.logianalytics.com/hc/en-us/articles/5735570054167-Menu-Tabs#Palette), or type the hexadecimal value of a color (for example, 0xff0000) in the text box.
* **Transparency**  
  Specify the transparency of the color.
* **Color List**  
  Select to open the [Color List dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5735522093463-Color-List-Dialog-Box) to modify the color pattern for each area.
...
![Format Area dialog box - Border](https://devnet.logianalytics.com/hc/article_attachments/9898481298839/fmtarea_border.gif)
...
![Format Area dialog box - Data Label](https://devnet.logianalytics.com/hc/article_attachments/9898481304087/fmtarea_data.gif)
...
![Format Area dialog box - Behaviors](https://devnet.logianalytics.com/hc/article_attachments/9898464264727/fmtarea_bhvr.gif)
