...
url: https://devnet.logianalytics.com/hc/en-us/articles/5735514080535-Format-Bar-Gauge-Dialog-Box
updated_at: 2022-11-02T04:17:48Z
---

# Format Bar Gauge Dialog Box

[![Back](https://devnet.logianalytics.com/hc/article_attachments/9898402961815/back.png)sPrevious Topic](https://devnet.logianalytics.com/hc/en-us/articles/5735529553431-Format-Bar-Dialog-Box)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/9898402971543/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/5735523015959-Format-Bubble-Dialog-Box)

# Format Bar Gauge Dialog Box

You can use the Format Bar Gauge dialog box to [format a bar gauge chart](https://devnet.logianalytics.com/hc/en-us/articles/5735520602391-Formatting-Gauge-Chart#Bar). This topic describes the options in the dialog box.
...
![Foramt Bar Gauge dialog box - Staff Graph](https://devnet.logianalytics.com/hc/article_attachments/9898481115799/fmtbargauge_stfgraph.gif)
...
Select to show the names of the ranges that you define in the [Range Color](#Range) tab in the bars. Designer enables the Font and Effects boxes in this tab after you select this option.
...
![Foramt Bar Gauge dialog box - Axis - Axis](https://devnet.logianalytics.com/hc/article_attachments/9898464049431/fmtbargauge_axis_axis.gif)
...
Designer disables this box when you set [Type](#Type) to "Center".
...
* **Color List**   
  Select to open the [Color List dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5735522093463-Color-List-Dialog-Box) to specify the color pattern for pointers in the same data series respectively.
* **Transparency**  
...
![Format Bar Gauge dialog box - Range Color](https://devnet.logianalytics.com/hc/article_attachments/9898481194519/fmtbargauge_rgclr.gif)
