...
* **Using the Run option to access view mode of JDashboard**  
  ...
  + Put the mouse pointer on the dashboard row and select the  **Run** button ![Run button](https://devnet.logianalytics.com/hc/article_attachments/4412139520791/btn_srv_run.gif) on the floating toolbar.
...
* **Using the Edit option to access edit mode of JDashboard**  
  ...
  + Put the mouse pointer on the dashboard row and select the  **Edit**  button ![Edit button](https://devnet.logianalytics.com/hc/article_attachments/4412131412247/btn_srv_edit.gif) on the floating toolbar.
...
After [saving the dashboards](https://devnet.logianalytics.com/hc/en-us/articles/1500009712541-Creating-and-Saving-Dashboards#Save) you create to the server resource tree, you can also use the above methods to run them.
