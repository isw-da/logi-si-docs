...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010064361-Tables-Views-Synonyms
updated_at: 2021-07-24T10:39:15Z
---

# Tables/Views/Synonyms

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404901108631/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010064321-DBMS-Objects-in-JDBC-Connections) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404901037591/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010029422-Stored-Procedures)
...
[Queries](https://devnet.logianalytics.com/hc/en-us/articles/1500010070681-Queries) and [business views](https://devnet.logianalytics.com/hc/en-us/articles/1500010070641-Business-Views) can be built on tables, views and synonyms, and a report is created using either query or business view.
...
1. In the Catalog Manager resource tree, do any of the following:
   ...
   * Select the **Tables**/****Views****/****Synonyms**** node of the JDBC connection, or any existing table/view/synonym or folder in the connection and select **Add Tables**/**Views**/**Synonyms** on the Catalog Manager toolbar.
   ...
   The [Add Tables/Views/Synonyms](https://devnet.logianalytics.com/hc/en-us/articles/1500010064741-Add-Tables-Views-Synonyms-Dialog) dialog appears.

   ![Add Tables/Views/Synonyms dialog](https://devnet.logianalytics.com/hc/article_attachments/4404901296791/addtbvwsynm.gif)
...
* When you have added some tables/views/synonyms to a catalog, you can then set up pre-joins between them. For detailed information, see [Editing Pre-joins in a Catalog](https://devnet.logianalytics.com/hc/en-us/articles/1500010028522-Editing-Pre-joins-in-a-Catalog).
* If you have selected schemas in the [Schema](https://devnet.logianalytics.com/hc/en-us/articles/1500010031562-Get-JDBC-Connection-Information-Dialog#Schema) tab of the Get JDBC Connection Information dialog when setting up the connection, when you add tables/views/synonyms, by default only the selected schemas will be listed in the Schemas box of the Add Tables/Views/Synonyms dialog, however, you can check the Show All Schemas option to show all the schemas.
...
2. In the Move Table/View/Synonym dialog, select the folder to which the table/view/synonym will be moved, then select **OK**.
   ...
   ![Move Table dialog](https://devnet.logianalytics.com/hc/article_attachments/4404901307927/cnctn_jdbc_obj_mvtbl.gif)
...
2. In the Add Columns dialog, select the required columns from the Columns box and select **Add**.
   ...
   ![Add Columns dialog](https://devnet.logianalytics.com/hc/article_attachments/4404901308183/cnctn_jdbc_obj_addclm.gif)
...
2. The data of this column is shown in a list in a dialog, which also includes other information including the field type, precision, scale and number of records.
   ...
   ![Browse data of a column](https://devnet.logianalytics.com/hc/article_attachments/4404909265431/cnctn_jdbc_obj_brsdt.gif)
