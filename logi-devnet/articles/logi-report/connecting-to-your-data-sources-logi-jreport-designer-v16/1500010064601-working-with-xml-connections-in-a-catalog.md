...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010064601-Working-with-XML-Connections-in-a-Catalog
updated_at: 2021-07-24T10:39:12Z
---

# Working with XML Connections in a Catalog

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404901108631/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010029562-How-Logi-JReport-Gets-Data-from-XML-Data-Sources) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404901037591/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010064561-SOAP-Web-Service-Connections)
...
2. In the Catalog Manager, right-click the node of a data source and choose **Add XML Connection** from the shortcut menu.
   ...
   The [XML Connection Wizard](https://devnet.logianalytics.com/hc/en-us/articles/1500010033042-XML-Connection-Wizard-Dialog) appears.

   ![XML Connection Wizard](https://devnet.logianalytics.com/hc/article_attachments/4404909149335/xmlcnnctn_import.gif)
3. In the Import XML Schema screen, specify [the way to import the XML schemas](https://devnet.logianalytics.com/hc/en-us/articles/1500010029562-How-Logi-JReport-Gets-Data-from-XML-Data-Sources#Import) from the Schema Type drop-down list: Import from XSD or Parse from XML Instance.
4. Provide the required information for importing the XML schemas.
   * If Import from XSD is selected in the Schema Type drop-down list:
     ...
     13. Check **Validate with schema before fetching** to validate whether or not values in the XML instance are valid according to the W3C standard and the selected XSD schema.
...
5. Select the **Time Zone and Locale** button to specify the time zone and the locale for the XML instance in the [Time Zone and Locale Options](https://devnet.logianalytics.com/hc/en-us/articles/1500010068261-Time-Zone-and-Locale-Options-Dialog) dialog.
...
8. In the Modify Schema Properties screen, [supplement and modify the element properties](https://devnet.logianalytics.com/hc/en-us/articles/1500010029562-How-Logi-JReport-Gets-Data-from-XML-Data-Sources#SupplementInfo) as required and then select **Next**.

   ![XML Connection Wizard - Modify Schema Properties](https://devnet.logianalytics.com/hc/article_attachments/4404901167383/xmlcnnctn_modify.gif)
9. In the Transform XML Schema screen, select an XPath to be the transforming start point. Select **Next**.

   ![XML Connection Wizard - Transform XML Schema](https://devnet.logianalytics.com/hc/article_attachments/4404909150103/xmlcnnctn_trnsfrm.gif)
10. In the Transformed Relational Schema screen, check the transformed result, and then select **Next**.

    ![XML Connection Wizard - Transformed Relational Schema](https://devnet.logianalytics.com/hc/article_attachments/4404901167895/xmlcnnctn_trnsfrmd.gif)
11. In the Add Table screen, add the required tables to the connection, and check the **Generate the default pre-join path** checkbox for generating default pre-join paths for the tables. A table contains fields mapped to attributes, simple elements, contents of complex elements, and other nodes in the XML data source.
    ...
    ![XML Connection Wizard - Add Table](https://devnet.logianalytics.com/hc/article_attachments/4404909150359/xmlcnnctn_add.gif)
