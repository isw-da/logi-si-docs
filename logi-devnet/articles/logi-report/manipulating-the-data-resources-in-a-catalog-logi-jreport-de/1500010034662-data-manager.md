...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010034662-Data-Manager
updated_at: 2021-07-24T10:37:46Z
---

# Data Manager

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404901108631/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500010034702-Dynamic-Queries) [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404901037591/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500010070641-Business-Views)

# Data Manager

The Data Manager in Logi JReport Designer allows you to control the data retrieval of your queries (and also [imported SQL files](https://devnet.logianalytics.com/hc/en-us/articles/1500010064341-Imported-SQL-Files), [stored procedures](https://devnet.logianalytics.com/hc/en-us/articles/1500010029422-Stored-Procedures) and [user defined data sources](https://devnet.logianalytics.com/hc/en-us/articles/1500010064481-User-Defined-Data-Sources)), including the number of rows to be displayed and the duration allowed for retrieval. It can also keep access information from previous runs of a query.
...
If your queries use data from a relational database, you can further customize where the two properties will be implemented, on Logi JReport side or on the database side by configuring the file JdbcDriversConfig.properties, which is available in both Logi JReport Designer and Logi JReport Server in its `<install_root>\bin` directory.
...
* Select the Refetch Data button ![Refetch Data button](https://devnet.logianalytics.com/hc/article_attachments/4404909116439/btn_refetchdt.gif) on the toolbar of the View tab to run the report again if you find that the specified properties have not taken effect.
...
1. Open the file **report.ini** in `<designer_install_root>\bin` and add the command line **`alwaysShowDMRecord=true`** as follows. Here, it is assumed that Logi JReport Designer has been installed to `C:\JReport\Designer`. The escape character backslash following "=" and before each special character such as ":" and "\" are required.
   ...
   stylePath=C\:\\JReport\\Designer\\style  
   gisinfoPath=C\:\\JReport\\Designer\\gisinfo  
...
6. Use the query Payroll to [create another page report](https://devnet.logianalytics.com/hc/en-us/articles/1500010034782-Creating-Reports#Page) report1.cls.
...
2. [Publish a page report](https://devnet.logianalytics.com/hc/en-us/articles/1500010070761-Publishing-and-Downloading-Resources#Remotely) that has its query properties Maximum Rows and/or Maximum Duration set together with its catalog to Logi JReport Server.
