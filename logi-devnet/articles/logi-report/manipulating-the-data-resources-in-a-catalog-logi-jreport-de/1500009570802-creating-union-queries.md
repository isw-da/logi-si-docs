...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009570802-Creating-Union-Queries
updated_at: 2021-07-24T05:53:51Z
---

# Creating Union Queries

[![](https://devnet.logianalytics.com/hc/article_attachments/4404889273495/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009592521-Previewing-a-Query)  [Next Topic![](https://devnet.logianalytics.com/hc/article_attachments/4404889273751/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009592541-Using-a-Query-to-Filter-Multiple-Queries)
...
4. A new Query Editor is displayed. [Create the query](https://devnet.logianalytics.com/hc/en-us/articles/1500009592461-Creating-a-Query) as required.
...
2. In the Query Editor, select **Menu** > **Query** > **Union** > **Select**. The Union dialog appears.
   ...
   ![Union dialog](https://devnet.logianalytics.com/hc/article_attachments/4404893820439/unions.gif)
3. To add a union to the query, select a union in the Queries box and select ![Add button](https://devnet.logianalytics.com/hc/article_attachments/4404893789463/btn_addarrow.gif). To remove a union from the query, select it in the Union box, and then select ![Remove button](https://devnet.logianalytics.com/hc/article_attachments/4404893789975/btn_rmvarrow.gif).
4. In the Union box, select the Attribute column to specify the type of the union.
   * ![No Duplicate Records button](https://devnet.logianalytics.com/hc/article_attachments/4404889294871/qury_union1.gif): No duplicate records will be returned.
   * ![All Records button](https://devnet.logianalytics.com/hc/article_attachments/4404893820695/qury_union2.gif): All records will be returned.
