...
* If you partly implement the Security API, Logi Report Server will automatically provide implementation of some missed but required interfaces, to build an integrated security system. See the rules below:
...
Requirements: For [Record Level Security/Column Level Security](https://devnet.logianalytics.com/hc/en-us/articles/1500009749762-Record-Level-and-Column-Level-Security) scenario, you must provide user/role information.
