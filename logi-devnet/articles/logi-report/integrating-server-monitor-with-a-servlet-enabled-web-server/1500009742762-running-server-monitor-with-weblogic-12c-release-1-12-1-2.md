---
title: "Running Server Monitor with WebLogic 12c Release 1 (12.1.2)"
id: 1500009742762
section: "Integrating Server Monitor with a Servlet-Enabled Web Server"
category: "Logi Report"
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009742762-Running-Server-Monitor-with-WebLogic-12c-Release-1-12-1-2
updated_at: 2021-07-24T00:49:42Z
---

# Running Server Monitor with WebLogic 12c Release 1 (12.1.2)

[Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009770541-Integrating-Server-Monitor-with-a-Servlet-Enabled-Web-Server)  [Next Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009770561-Running-Server-Monitor-with-Tomcat-8-0-15)

# Running Server Monitor with WebLogic 12c Release 1 (12.1.2)

This topic describes how you can run Server Monitor with WebLogic 12c Release 1 (12.1.2).

Assume that:

* You installed WebLogic 12c Release 1 (12.1.2) to `D:\bea`.
...
4. After your successful login, in the Domain Structure panel on the left, select **Deployments**.
