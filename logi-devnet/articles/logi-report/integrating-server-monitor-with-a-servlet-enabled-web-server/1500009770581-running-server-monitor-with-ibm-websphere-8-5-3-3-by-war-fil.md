---
title: "Running Server Monitor with IBM WebSphere 8.5.3.3 by WAR File"
id: 1500009770581
section: "Integrating Server Monitor with a Servlet-Enabled Web Server"
category: "Logi Report"
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009770581-Running-Server-Monitor-with-IBM-WebSphere-8-5-3-3-by-WAR-File
updated_at: 2021-07-24T00:49:42Z
---

# Running Server Monitor with IBM WebSphere 8.5.3.3 by WAR File

[Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009770561-Running-Server-Monitor-with-Tomcat-8-0-15)

# Running Server Monitor with IBM WebSphere 8.5.3.3 by WAR File

This topic describes how you can run Server Monitor with IBM WebSphere 8.5.3.3 by a WAR File.

Assume that:

* You installed WebSphere 8.5.3.3 to `C:\WebSphere`.
...
2. Open the **Administrative Console** using the Start menu, or using the URL `http://hostname:9080/ibm/console`, where the hostname is host name or IP address, and 9080 is the port number.
   ...
   ![Critical icon](https://devnet.logianalytics.com/hc/article_attachments/4404885352855/criticalicon.gif)The user ID must contain only letters and numbers. You can use any of them as your user ID.
3. After you log in, expand the **Applications** node in the left tree, and then select **New Application**.
