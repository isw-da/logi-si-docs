...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405664393751-Using-Crosstab-Formulas
updated_at: 2022-01-27T20:34:29Z
---

# Using Crosstab Formulas

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420556069783/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405661377559-Modifying-Crosstabs)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420550802199/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405661345431-Working-with-Banded-Objects)

# Using Crosstab Formulas

Crosstab formulas are a type of extended [formulas](https://devnet.logianalytics.com/hc/en-us/articles/4405664600343-Working-with-Formulas) that you can apply in crosstabs using query resources. By using crosstab formulas, you can create custom aggregate functions in a crosstab to get the desired results. This topic introduces the syntax of crosstab formulas and how you can create and manage crosstab formulas in your crosstabs.
...
* A crosstab formula can reference summary expression which follows the syntax of [custom aggregation expression](https://devnet.logianalytics.com/hc/en-us/articles/4405661913239-Business-View-Elements#Expression). The following shows some summary expression examples:
...
6. In the **Resources** box, select **<New Crosstab Formula...>** in the **Crosstab Formulas** node .
   ...
   ![Add Fields to the Crosstab](https://devnet.logianalytics.com/hc/article_attachments/4420550981399/cmpnt_crstb_fmla1.gif)
7. In the Enter Crosstab Formula Name dialog box, type **CustomAgg** and select **OK**. Designer displays the [Crosstab Formula Editor dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405661478039-Crosstab-Formula-Editor-Dialog-Box).

   ![Create a Crosstab Formula](https://devnet.logianalytics.com/hc/article_attachments/4420556246039/cmpnt_crstb_fmla2.gif)
...
11. Select **Finish** to create the crosstab and preview it.

    ![Crosstab Result with Custom Aggregate Funtion](https://devnet.logianalytics.com/hc/article_attachments/4420550981783/cmpnt_crstb_fmla.gif)
...
* **Viewing properties of a crosstab formula**  
  Right-click the crosstab formula and select **Properties**. Designer then lists its [properties](https://devnet.logianalytics.com/hc/en-us/articles/4405664627479-Formula-Properties) in the Properties dialog box.
