...
You can insert UDOs in banded panels in query-based page reports as listed in [Component Placement](https://devnet.logianalytics.com/hc/en-us/articles/4405664365463-Working-with-Components-in-Reports#Relationship).
...
4. Do one of the following:
   * From the **Components** panel, drag the **UDO** icon ![UDO icon](https://devnet.logianalytics.com/hc/article_attachments/4420402423959/icon_udo.gif) in the **Others** category to the banded panel where you want to insert the UDO.
   * Navigate to **Insert** > **UDO**.
   * Navigate to **Home** > **Insert** > **UDO**.

   Designer displays the Insert UDO dialog box.

   ![Insert UDO dialog box](https://devnet.logianalytics.com/hc/article_attachments/4420394748695/instudo.gif)
...
6. Select **OK** in the dialog box.
   * If you use menu command to insert the UDO, select in the desired banded panel to insert the UDO there.
...
7. [Define the banded object](https://devnet.logianalytics.com/hc/en-us/articles/4405661347735-Inserting-Banded-Objects-in-a-Report#Query) as follows:
...
9. In the New Summary dialog box, select **Sum** from the **Aggregate Function** drop-down list, add the field **Price** from the Products table to the **Summary On** text box and **Product ID** to the **Group By** text box, and then select **OK**.
   ...
   ![New Summary](https://devnet.logianalytics.com/hc/article_attachments/4420410869015/cmpnt_udo_inst_cht1.gif)
...
12. Resize the group header panel of the banded object and add the two summaries to the panel.
    ...
    ![Banded Object](https://devnet.logianalytics.com/hc/article_attachments/4420410869399/cmpnt_udo_inst_cht2.gif)
...
18. Select the **View** tab to preview the report.
    ...
    ![UDO in Banded Page Header Panel](https://devnet.logianalytics.com/hc/article_attachments/4420402562071/cmpnt_udo_inst_cht3.gif)
