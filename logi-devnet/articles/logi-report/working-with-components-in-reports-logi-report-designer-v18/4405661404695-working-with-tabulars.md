...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405661404695-Working-with-Tabulars
updated_at: 2022-01-27T20:34:34Z
---

# Working with Tabulars

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420394625303/back.png)Yin Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405664402327-Working-with-Special-Fields)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420394625687/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405661409815-Working-with-Web-Controls)
...
![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4420394642839/noteicon.jpg) You cannot use tabulars in page reports that use business views or in library components. A web report is initially a tabular with a single cell; you cannot insert another tabular into a web report.
...
You can insert tabulars in the page report areas listed in [Component Placement](https://devnet.logianalytics.com/hc/en-us/articles/4405664365463-Working-with-Components-in-Reports#Relationship).
...
* **Using dialog box**
  ...
  2. Navigate to **Insert** > **Tabular** or **Home** > **Insert** > **Tabular**.

     Designer displays the [Insert Tabular dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405661633687-Insert-Tabular-Dialog-Box).

     ![Insert Tabular dialog box](https://devnet.logianalytics.com/hc/article_attachments/4420402424343/insttblr.gif)
  ...
  4. Select **OK** to close the dialog box.
     ...
     If the mouse pointer is in the report body or a cell of another tabular, Designer inserts the tabular there when you select OK; otherwise, you need to select in the desired location to place the tabular there.
* **By dragging and dropping**  
  From the **Components** panel, drag the **Tabular** icon ![Tabular icon](https://devnet.logianalytics.com/hc/article_attachments/4420410694167/icon_tabular.gif) in the **Grid** category to the desired location in the report which allows the insertion of a tabular, Designer then inserts a tabular with two rows and columns by default there.

## Inserting Components into a Tabular

The components that you can insert into a tabular cell are listed in [Component Placement](https://devnet.logianalytics.com/hc/en-us/articles/4405664365463-Working-with-Components-in-Reports#Relationship). The most common component to place into a tabular cell is a data component, and it is usually best to only place one single data component into one tabular cell. When you insert a component whose default size is bigger than that of the tabular cell, the component fits into the cell by default. If you place multiple components into one cell, you should make sure their [Position](https://devnet.logianalytics.com/hc/en-us/articles/4405661931671-Editing-Reports#Position) property is "static", so that the components flow one after another and do not overlap. Then at runtime,
...
2. In the Split Cell dialog box, specify how many rows/columns you want to split the cell into.
   ...
   ![Split Cell dialog box](https://devnet.logianalytics.com/hc/article_attachments/4420402566039/cmpnt_tblr.gif)
