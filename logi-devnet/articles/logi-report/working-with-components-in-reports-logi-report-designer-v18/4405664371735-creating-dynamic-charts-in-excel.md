...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405664371735-Creating-Dynamic-Charts-in-Excel
updated_at: 2024-02-28T04:26:06Z
---

# Creating Dynamic Charts in Excel

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420556069783/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405661369623-Creating-Motion-Charts)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420550802199/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405664403351-Working-with-Tables)
...
2. [Create a query](https://devnet.logianalytics.com/hc/en-us/articles/4405661917975-Creating-Queries-in-a-Catalog) named **Products** in Data Source 1 of the catalog, which contains the Products table with all of its columns.
3. Navigate to **File** > **New** > **Page Report** to
   create a page report with a banded object in its first report tab.
4. [Define the banded object](https://devnet.logianalytics.com/hc/en-us/articles/4405661347735-Inserting-Banded-Objects-in-a-Report#Query) as follows:
...
6. [Create the summary](https://devnet.logianalytics.com/hc/en-us/articles/4405661767063-Working-with-Summaries#Create) **Sum\_Price** which uses the aggregate function **Sum**, summarizes on the field **Price** in the Products table, and applies to the **Product Type Name** group level.

   ![Create a Summary](https://devnet.logianalytics.com/hc/article_attachments/4420556265495/cmpnt_cht_dynmc1.gif)
7. Drag the summary to the footer panel of the Product Type Name group in the banded object.

   ![Drag the Summary to the Banded Object](https://devnet.logianalytics.com/hc/article_attachments/4420542224023/cmpnt_cht_dynmc2.gif)
8. Select the banded header panel (BH) and [insert a Clustered Bar 2-D chart](https://devnet.logianalytics.com/hc/en-us/articles/4405664387479-Inserting-Charts-in-a-Report#Query) in it. The chart inherits the dataset from the banded object (make sure to select **Current Dataset** in the Data screen of the Create Chart dialog box), and shows **Product Type Name** on the category axis, **Category** on the series axis, and **Sum\_Price** on the value axis.

   ![Insert a Chart](https://devnet.logianalytics.com/hc/article_attachments/4420551005335/cmpnt_cht_dynmc3.gif)
...
10. In the Chart Wizard dialog box, switch to the **Layout** screen, select **Export** in the **Options** box and then select **Banded Object** from the **Mapping Component** drop-down list. Select **Finish** to accept the change.
    ...
    ![Export Setting](https://devnet.logianalytics.com/hc/article_attachments/4420542224407/cmpnt_cht_dynmc4.gif)
11. Navigate to **File** > **Options**. In the Options dialog box, select **Check the availability of dynamic chart for Excel** in the **General** category, then select **OK**.

    Designer provides this option to help you check if a chart can be correctly mapped to a banded object when you save the report or export it to Excel.
12. Navigate to **File** > **Export** > **To Excel** to export the report to Excel (make sure to select **Report Format** in the Export to Excel dialog box).
    ...
    ![Export to Excel](https://devnet.logianalytics.com/hc/article_attachments/4420556266775/cmpnt_cht_dynmc5.gif)
13. Open the exported result file in `<install_root>\Demo\Reports\SampleReports`.

    ![Exported Result](https://devnet.logianalytics.com/hc/article_attachments/4420556267031/cmpnt_cht_dynmc6.gif)
14. Change the price of **Gold Coast Blend** and **Colombia El Tambo** to **30.00**. The value of the chart changes accordingly.

    ![Change Values in the Chart](https://devnet.logianalytics.com/hc/article_attachments/4420556267287/cmpnt_cht_dynmc7.gif)
