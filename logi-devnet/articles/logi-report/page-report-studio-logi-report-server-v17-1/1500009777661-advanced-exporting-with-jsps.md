...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009777661-Advanced-Exporting-with-JSPs
updated_at: 2021-07-24T00:47:50Z
---

# Advanced Exporting with JSPs

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404880134167/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009777701-Opening-Multiple-Page-Reports-in-One-Session)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404880134423/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009749102-Page-Report-Studio-Tag-Library)

# Advanced Exporting With JSPs

You can use a JavaScript function for exporting to different formats, display the buttons for one-step export on the toolbar, control user access to different export formats, and customize the warning messages when exporting the report result to XML. This topic describes how you can perform advanced exporting using JSPs.
...
Page Report Studio provides you with a JavaScript function which enables you to open the report result or export it in a specified format. You can find this function in the file **API.js** in `<install_root>\public_html\javascript\dhtml`, as shown below:
...
**options** - The values of the options of each format. It is a string array whose member is of the format "key=value". The options and their usage are listed as follows:

| Key | Description | Available Value | Default Value |
| --- | --- | --- | --- |
| HTML | | | |
| to\_ver | Specifies whether to save the result to version. | true, false | false |
| to\_open | Specifies whether to export and open the result file. | true, false | false |
| to\_local | Specifies whether to save the result to a local file. | true, false | false |
| browser | Specifies the web browser type. | 0 - IE or Chrome 1 - Firefox | 0 |
| imagetype | Specifies the type of the images in the result file. | 0 - Decided by Page Report Studio 1 - GIF  2 - JPG | 0 |
...
| css | Specifies whether to embed the cascading style sheet in the exported HTML files. | true, false | false |
| multi | Specifies whether to generate an HTML file for each page of the report result. | true, false | false |
| hyperlink | Specifies whether to contain hyperlinks in the HTML file. | true, false | false |
| pagenumber | Specifies whether to contain page numbers in the HTML file. | true, false | false |
| drilldown | Specifies whether to include the drilled-down file in the exported HTML file. | true, false | false |
| no\_margin | Specifies whether to remove the original margins. | true, false | false |
| absolute | Specifies whether to make the font size fixed in the web browser. | true, false | false |
| PDF | | | |
| to\_ver | Specifies whether to save the result to version. | true, false | false |
| to\_open | Specifies whether to export and open the result file. | true, false | false |
| to\_local | Specifies whether to save the result to a local file. | true, false | false |
| no\_margin | Specifies whether to remove the margin. | true, false | false |
| simulate | Specifies whether the mode is to be Simulated Printing Mode. | true, false | true |
| standard | Specifies whether to set the mode as Standard Mode. | true, false | false |
| content | Specifies whether to contain the TOC in the exported PDF file. | true, false | false |
| drilldown | Specifies whether to include the drilled-down file in the exported PDF file. | true, false | false |
| encrypt | Specifies whether to encrypt the report result. | true, false | false |
| compress | Specifies whether to compress the images in the report. | true, false | false |
...
| enable\_copy | Specifies whether to allow users to copy the file contents. | true, false | false |
| enable\_access | Specifies whether to let visually impaired users read the document with window readers. | true, false | true |
| PostScript | | | |
| to\_ver | Specifies whether to save the result to version. | true, false | false |
| to\_open | Specifies whether to export and open the result file. | true, false | false |
| to\_local | Specifies whether to save the result to a local file. | true, false | false |
| no\_margin | Specifies whether to remove the margins in the PS file. | true, false | false |
| RTF | | | |
| to\_version | Specifies whether to save the result to version. | true, false | false |
| to\_open | Specifies whether to export and open the result file. | true, false | false |
| to\_local | Specifies whether to save the result to a local file. | true, false | false |
| rtf\_flow | Specifies whether to apply a flow layout when exporting the report to RTF. | true, false | false |
| no\_margin | Specifies whether to remove the margins in the RTF file. | true, false | false |
| Text | | | |
| to\_ver | Specifies whether to save the result to version. | true, false | false |
| to\_open | Specifies whether to export and open the result file. | true, false | false |
| to\_local | Specifies whether to save the result to a local file. | true, false | false |
| repeat | Specifies whether to replace a field value of a record with that of its previous record if the field value is null. | true, false | false |
| compress | Specifies whether to compress the clearance between columns. | true, false | false |
| win\_linebreak | Specifies whether to use Windows end-of-line characters. | true, false | true |
| normal | Specifies whether to generate the report result to a standard text file. | true, false | true |
| quote\_mark | Specifies whether to mark the fields in the exported file with quotation marks. | true, false | false |
| head\_foot | Specifies whether to contain all headers and footers in the report. | true, false | true |
...
| new\_layout | Specifies whether to use the new layout mode. | true, false | true |
| shapes | Specifies whether to include the shapes in the exported file. | true, false | false |
| excel\_2000 | Specifies whether to export the result in Data Format, which means only the report data will be exported without format. | true, false | false |
| advanced | Specifies whether to apply the advanced options. | true, false | false |
| header | Specifies the page header text. | Any string |  |
| footer | Specifies the page footer text. | Any string |  |
| gridline | Specifies whether to print gridlines when printing the exported Excel file. | true, false | false |
| XML | | | |
| to\_ver | Specifies whether to save the result to version. | true, false | false |
| to\_open | Specifies whether to export and open the result file. | true, false | false |
| to\_local | Specifies whether to save the result to a local file. | true, false | false |
| only\_data | Specifies whether to only contain the database column information in the exported XML file. | true, false | false |
...
* Page Report Studio also provides the function user\_downloadReport(type, options) whose usage is similar to user\_oneStepExport.
...
Page Report Studio introduces an access control ability which can restrict different users to export report result to different formats. It achieved this by passing values to the global variable **enableTypes** in both customize\_panel.jsp and save\_result.jsp files in the `<install_root>\public_html\dhtmljsp` folder. The value of enableTypes should be Integer, and Page Report Studio gives you the following integers to represent the corresponding report result types:
...
You can also export the report result via the Export panel instead of selecting Menu > File > Export. By default, Server hides the panel. So, the following is another way to create custom warning messages:
