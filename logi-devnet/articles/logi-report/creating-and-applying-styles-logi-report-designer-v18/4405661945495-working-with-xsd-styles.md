...
id: 4405661945495
section: "Creating and Applying Styles - Logi Report Designer v18"
category: "Logi Report"
url: https://devnet.logianalytics.com/hc/en-us/articles/4405661945495-Working-with-XSD-Styles
updated_at: 2022-01-27T20:34:58Z
---

# Working with XSD Styles

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4420556069783/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/4405661941527-Creating-and-Applying-Styles)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4420550802199/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/4405661944471-Working-with-CSS-Styles)
...
![Note icon](https://devnet.logianalytics.com/hc/article_attachments/4420542072599/noteicon.jpg) XSD styles are a Logi Report specific format, so you may want to use CSS styles which are an industry standard.
...
Designer provides you with the Style Editor to manage XSD styles in a catalog (to display the editor, [open the catalog](https://devnet.logianalytics.com/hc/en-us/articles/4405661330711-Creating-Opening-and-Saving-Catalogs#Open) to which you want to add the style groups, then on the Catalog Manager toolbar, select **Style**).

![Style Editor](https://devnet.logianalytics.com/hc/article_attachments/4420556094615/styledtr.gif)
...
1. Do either of the following:
   ...
   ![New Style Group](https://devnet.logianalytics.com/hc/article_attachments/4420542073111/style_xsd_crt1.gif)
...
3. Right-click the group and select **New Style**, or select the group and select **New Style** on the toolbar. Designer displays the New Style dialog box.
   ...
   ![New Style](https://devnet.logianalytics.com/hc/article_attachments/4420556094871/style_xsd_crt2.gif)
4. Specify the name, type, and description of the new style, then select **OK**.

   The style type indicates the application scope of a style, for example, you can apply a style of the "Label" type to label objects, and a style of the "DBField" type to DBFields.
5. In the [Save Style dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405661734167-Save-Style-Dialog-Box), add the properties you want to include in the style and change the property values as required.

   ![Save Style](https://devnet.logianalytics.com/hc/article_attachments/4420542073367/svstyl.gif)

   To add a property, select it in the **All Properties** box and select **Add**![Add button](https://devnet.logianalytics.com/hc/article_attachments/4420550823447/btn_addarrow.gif); to add all the available properties to the style at a time, select **Add All**![Add All button](https://devnet.logianalytics.com/hc/article_attachments/4420550823959/btn_addall.gif). Designer displays different properties in the All Properties box for different style types.
   ...
   To remove a property that you have added, select it in the Selected Properties box and select **Remove**![Remove button](https://devnet.logianalytics.com/hc/article_attachments/4420550824215/btn_rmvarrow.gif); to remove all the added properties at a time, select **Remove All**![Remove All button](https://devnet.logianalytics.com/hc/article_attachments/4420556095639/btn_rmvall.gif).
...
1. Right-click the style group and select **Edit Group** from the shortcut menu, or select the style group and select **Edit** on the Style Editor toolbar. Designer displays the [Edit Style Group dialog box](https://devnet.logianalytics.com/hc/en-us/articles/4405664466199-Edit-Style-Group-Dialog-Box).

   ![Edit Style Group](https://devnet.logianalytics.com/hc/article_attachments/4420556096151/edtstylgrp.gif)
2. In the **All Styles** box, select the styles that you want to include in the group, and then select **Add**![Add button](https://devnet.logianalytics.com/hc/article_attachments/4420550823447/btn_addarrow.gif) to add them to the **Selected Styles** box; or you can remove some existing styles from the group by selecting them in the Selected Styles box and selecting **Remove**![Remove button](https://devnet.logianalytics.com/hc/article_attachments/4420550824215/btn_rmvarrow.gif).
...
You can use the search box to search for the properties you need (to display the search box, select the **Search** icon ![Search icon](https://devnet.logianalytics.com/hc/article_attachments/4420542068631/btn_srch.gif) at the upper right corner of the Properties sheet). To start searching, type the text you want to search for in the search box and Designer lists the properties containing the matched text. Designer closes the search box when you select another style group or style.
