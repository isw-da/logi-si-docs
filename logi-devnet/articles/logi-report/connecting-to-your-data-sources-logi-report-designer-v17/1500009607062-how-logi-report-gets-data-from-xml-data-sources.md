...
Logi Report Designer provides two ways to import XML schemas: [importing from an XSD file](#XSD) or [parsing from XML instances](#XMLInstance).
...
#### XSD Syntax Supported by Logi Report Designer

In Logi Report Designer, not all XSD syntax can be supported. The following diagram shows the XSD syntax Logi Report supports and the syntax is in accordance with the W3C standard:

**XML Schema::=**

![XSD syntax diagram](https://devnet.logianalytics.com/hc/article_attachments/4404904401303/cnctn_xml_imprt_xsd1.gif)
...
* Only the anonymous attribute definition is supported by Logi Report Designer.

The following diagrams show the detail syntax of elements in the above diagram:

* **Element Declaration::=**

  ![Element Declaration diagram](https://devnet.logianalytics.com/hc/article_attachments/4404916820887/cnctn_xml_imprt_xsd2.gif)
...
* **SimpleType::=**
  ...
  ![SimpleType diagram](https://devnet.logianalytics.com/hc/article_attachments/4404904401559/cnctn_xml_imprt_xsd3.gif)
...
* **Anonymous SimpleType Definition::=**
  ...
  ![Anonymous SimpleType Definition diagram](https://devnet.logianalytics.com/hc/article_attachments/4404916821143/cnctn_xml_imprt_xsd4.gif)
...
* **SimpleType Definition::=**
  ...
  ![SimpleType Definition diagram](https://devnet.logianalytics.com/hc/article_attachments/4404904401943/cnctn_xml_imprt_xsd5.gif)
...
* **ComplexType::=**
  ...
  ![ComplexType diagram](https://devnet.logianalytics.com/hc/article_attachments/4404904402199/cnctn_xml_imprt_xsd6.gif)
...
* **Anonymous ComplexType Definition::=**
  ...
  ![Anonymous ComplexType Definition diagram](https://devnet.logianalytics.com/hc/article_attachments/4404904402711/cnctn_xml_imprt_xsd7.gif)
...
* **ComplexType Definition::=**
  ...
  ![ComplexType Definition diagram](https://devnet.logianalytics.com/hc/article_attachments/4404904402967/cnctn_xml_imprt_xsd8.gif)
...
* **All::=**
  ...
  ![All diagram](https://devnet.logianalytics.com/hc/article_attachments/4404904403223/cnctn_xml_imprt_xsd9.gif)
...
* **Choice::=**
  ...
  ![Choice diagram](https://devnet.logianalytics.com/hc/article_attachments/4404904403479/cnctn_xml_imprt_xsd10.gif)
...
* **Sequence::=**
  ...
  ![Sequence diagram](https://devnet.logianalytics.com/hc/article_attachments/4404904403479/cnctn_xml_imprt_xsd10.gif)
...
Before the data types defined in the XSD file can function in Logi Report Designer, they should be converted into corresponding SQL data types when the XML schemas are imported, following the rules in the table below.
...
* The XML schema structure will be parsed to a lot of complex elements which begin with the XML root node. You can specify data types for the imported XML schema if you know data types accurately, otherwise it will be specified as default of Logi Report Designer.
...
Displays the name of an element (![](https://devnet.logianalytics.com/hc/article_attachments/4404904229271/btn_elmnt.gif)), attribute (![](https://devnet.logianalytics.com/hc/article_attachments/4404904229655/btn_atrbt.gif)) or a reference of element (![](https://devnet.logianalytics.com/hc/article_attachments/4404911672983/btn_elmntref.gif)) in the XML instance.

**Data Type**

Specifies the data type of an element or attribute. The data type is imported when importing the XML schema from XSD file or given by Logi Report when parsing from XML source. This property on a reference of element cannot be modified.
...
* If Customized is selected, the [Format Pattern](https://devnet.logianalytics.com/hc/en-us/articles/1500009631561-Format-Pattern-Dialog) dialog will appear for you to specify patterns to format the Date, Time or DateTime data in the XML schema. [go here](#Format) for details about the format patterns.
...
A format pattern is a string and can be used for specifying patterns to format strings, which are in XML instance. Logi Report format Pattern only supports specifying patterns to format time data type strings, such as date, time and datetime. You can customize the format pattern for date, time and datetime formats or use default ones.
...
You can specify the date, time and datetime formats in XML schema by the date, time and datetime pattern strings or customize the format pattern by the Format Pattern dialog. In the dialog, the pattern string you select from the Pattern Fragments list box will be interpreted, and the delimiter that you specify will not be interpreted. Any character is acceptable and some will be quoted.
...
The DataTime format pattern consists of some pattern strings and delimiters. Logi Report provides the following pattern strings in the DataTime format pattern: G, yyyy, yy, MMMM, MM, dd, D, WW, ww, F, E, a, HH, kk, KK, hh, mm, ss, SSS, z, Z.
...
The examples below can help you better understand the transformation rules.
...
![Table transformed from a simple element in the XML instance](https://devnet.logianalytics.com/hc/article_attachments/4404904403991/cnctn_xml_trnsfrm_rule2.gif)
...
![Table transformed from the parent element of the simple element in XML instance](https://devnet.logianalytics.com/hc/article_attachments/4404904403991/cnctn_xml_trnsfrm_rule2.gif)
...
![Table transformed from the parent element/](https://devnet.logianalytics.com/hc/article_attachments/4404916821399/cnctn_xml_trnsfrm_rule3.gif)
...
![Table transformed from sub-elements](https://devnet.logianalytics.com/hc/article_attachments/4404916821655/cnctn_xml_trnsfrm_rule4.gif)
...
![Table transformed from a complex element](https://devnet.logianalytics.com/hc/article_attachments/4404916821911/cnctn_xml_trnsfrm_rule1.gif)
