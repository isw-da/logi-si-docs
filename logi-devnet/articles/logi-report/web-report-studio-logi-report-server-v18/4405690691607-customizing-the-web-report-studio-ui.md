...
2. Open **wrptstudio.css** in an editor.
...
7. Open Web Report Studio by running a web report or creating a new one. You can see the UI elements using the style you defined in wrptstudio.css.

**Tip:** You can access the Developer Tools on Internet Explorer, Google Chrome, or Mozilla Firefox to get the code about how to apply CSS to the Web Report Studio window elements. To do this, open Web Report Studio, and then press **F12**.
