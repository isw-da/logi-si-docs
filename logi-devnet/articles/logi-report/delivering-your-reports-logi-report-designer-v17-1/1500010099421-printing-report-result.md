...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500010099421-Printing-Report-Result
...
Designer relies on JDK to create the printable version of report result. By default, Designer applies the JDK 1.4 printing method, but you can use other versions. This topic introduces how you can customize the printing options in Designer and print the result of a page or web report using different printing methods.
...
4. Select the **Apply** button to save the changes, and then select the **OK** button to close the dialog box.
...
3. Select **File** > **Print**. Designer displays the Print dialog box.

   ![Print dialog box](https://devnet.logianalytics.com/hc/article_attachments/4404848472215/frmt_print_14.gif)
...
3. Select **File** > **Print**. Designer displays the Print dialog box.
   ...
   ![Print dialog box for JDK 1.1 printing method](https://devnet.logianalytics.com/hc/article_attachments/4404848472471/frmt_print_11.gif)

   In order to overcome the limitation of JDK 1.1.x, Designer is required to be calibrated on the very first print so that the lines and text can be printed correctly. You only need to calibrate once for each printer that Designer uses. Select the **Test** button, and follow the window instructions.
...
2. Open the page or web report that you want to print.
3. Select **File** > **Print**. Designer displays the Page Setup dialog box.

   ![Page Setup dialog box](https://devnet.logianalytics.com/hc/article_attachments/4404856872087/frmt_print_12.gif)
