...
url: https://devnet.logianalytics.com/hc/en-us/articles/5741462847767-Saving-a-Page-Report
updated_at: 2022-10-31T17:18:17Z
---

# Saving a Page Report

[![Back](https://devnet.logianalytics.com/hc/article_attachments/9905574448535/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/9905923782039-Enabling-and-Accessing-Template-Editor-Logi-Report-Studio)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/9905574466839/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/5741462638999-Exporting-Printing-a-Page-Report)
...
To save your page report, select **Menu** > **File** > **Save** or the **Save** button ![Save button](https://devnet.logianalytics.com/hc/article_attachments/9905577991703/btn_save.gif) on the toolbar.

If you have saved the report before, Server displays the [Save Report Template dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5741412182935-Save-Report-Template-Dialog-Box-Properties). Specify whether to save the sort and filter criteria you have made in the report, then select **Yes**. Server saves the report as a report version to the original location. If you do not want to display the dialog box, you can use the [Pop Up Save Criteria Dialog](https://devnet.logianalytics.com/hc/en-us/articles/5741427459479-Page-Report-Studio-Profile-Properties#Criteria) property in the Page Report Studio profile to disable the dialog box from popping up when saving reports.

If you have newly created the report and has not yet saved it, Server displays the [Save As dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5741404115223-Save-As-Dialog-Box-Properties).

![Save As dialog](https://devnet.logianalytics.com/hc/article_attachments/9905660781079/svas.gif)

1. In the **Save in** section, browse to the folder in the server resource tree where you want to save the report. You can use the arrow button ![Up Level button](https://devnet.logianalytics.com/hc/article_attachments/9905672802327/btn_dshbrd_up.gif) to go to the parent folder.
...
3. From the **Type** list, select the [file type](https://devnet.logianalytics.com/hc/en-us/articles/5741404115223-Save-As-Dialog-Box-Properties#Type) of the saved report. Normally you want to use the default page report format (.cls).
4. Select **Advanced** to set the advanced settings for the report if you want.
   1. When you did not clear [Select Catalog Linking Model](https://devnet.logianalytics.com/hc/en-us/articles/5741427459479-Page-Report-Studio-Profile-Properties#CatalogMode) in the Page Report Studio profile, you can specify the relationship between the saved report and the catalog used to run it. By default, the saved
...
To save a copy of a report, select **Menu** > **File** > **Save As**, or the **Save As** button ![Save As button](https://devnet.logianalytics.com/hc/article_attachments/9905615943319/btn_saveas.gif) on the toolbar to display the Save As dialog box, and then do as above. If you are saving to an existing file, Server will display a Confirm dialog box asking whether you want to replace the file or [save a new version into the file](https://devnet.logianalytics.com/hc/en-us/articles/5741462158487-Creating-Versions#Save).
