...
url: https://devnet.logianalytics.com/hc/en-us/articles/5741420507799-Advanced-Run-Dialog-Box-Properties
updated_at: 2022-10-31T17:16:51Z
---

# Advanced Run Dialog Box Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/9905574448535/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/5741405515287-Add-to-Global-NLS-Dialog-Box-Properties)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/9905574466839/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/5741432839831-Auditing-Dialog-Box-Properties)

# Advanced Run Dialog Box Properties

Use the Advanced Run dialog box to run a report in the [Advanced mode](https://devnet.logianalytics.com/hc/en-us/articles/5741439314455-Running-Reports#Advanced). This topic describes how you can specify advanced settings for running a report.
...
![Advanced Run dialog box - General tab](https://devnet.logianalytics.com/hc/article_attachments/9905659297303/advcdrn_gen.gif)
...
* **Catalog**  
   Catalog name and path in the server resource tree. Unavailable to [shared reports](https://devnet.logianalytics.com/hc/en-us/articles/5741461964439-Sharing-Web-Reports).

  Select **Select Another Catalog** if you want to choose another catalog for the report in the [Select Another Catalog dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5741433783191-Select-Another-Catalog-Dialog-Box-Properties).
* **Report Version**  
...
![Advanced Run dialog box - Parameter tab](https://devnet.logianalytics.com/hc/article_attachments/9905736760471/advcdrn_prm.gif)
...
**![Use Saved Values button](https://devnet.logianalytics.com/hc/article_attachments/9905671743127/btn_srv_ussvvlu.gif) Use Saved Values icon**
...
![Advanced Run dialog box - Format tab](https://devnet.logianalytics.com/hc/article_attachments/9905659328407/advcdrn_fmt.gif)
...
![Advanced Run dialog box - Archive tab](https://devnet.logianalytics.com/hc/article_attachments/9905659351191/advcdrn_archv.gif)
...
* **Edit Mode**  
   Select if you want Web Report Studio to run in the Edit Mode by default. You can switch to View Mode if it is available. This item is available only when you have the [Edit permission](https://devnet.logianalytics.com/hc/en-us/articles/5741463668119-Managing-Permissions) on the report.
...
* **Interactive View**  
   Select if you want Page Report Studio to run in the Interactive View by default. You can switch to Basic View if it is available. This item is available only when you have the [Edit permission](https://devnet.logianalytics.com/hc/en-us/articles/5741463668119-Managing-Permissions) on the report.

**Profile**

Select the Page Report Studio profile you want to apply to run the report, which contains [a set of Page Report Studio settings](https://devnet.logianalytics.com/hc/en-us/articles/5741427459479-Page-Report-Studio-Profile-Properties).

**Background Mode Timeout**

Select and then specify the time after which Server will continue to run the report in the background. When it runs a page report and has not generated the result yet after the specified time, Server will automatically run the report in the background mode. Once the report is complete you can find the result in the My Tasks > [Background Tasks table](https://devnet.logianalytics.com/hc/en-us/articles/5741438263319-Managing-Report-Running-Tasks#Background).

This property takes effect when you have selected [Enable Background Task for Reports](https://devnet.logianalytics.com/hc/en-us/articles/7985371543191-Customize-Profile-Dialog-Box-Properties#BackgroundTask) in the server profile.
...
Select if you want to encrypt the PDF output. Server displays the [Encrypt dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5741420715927-Encrypt-Dialog-Box-Properties) for you to configure the encrypt settings.

**Sign**

Select if you want to add the digital sign to the PDF output. Server displays the [Sign dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5741443392151-Sign-Dialog-Box-Properties) for you to configure the sign settings.
...
Select to generate the report result as an accessible PDF file. For more information, select [Making HTML and PDF Report Results and Server Console Accessible](https://devnet.logianalytics.com/hc/en-us/articles/5741473969431-Making-HTML-and-PDF-Report-Outputs-and-Server-Console-Accessible).
...
This property is available in the [Schedule dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5741433620631-Schedule-Dialog-Box-Properties).
