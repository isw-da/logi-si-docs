...
url: https://devnet.logianalytics.com/hc/en-us/articles/5741450135575-Format-Bar-Gauge-Dialog-Box-Properties
updated_at: 2022-10-31T17:17:26Z
---

# Format Bar Gauge Dialog Box Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/9905574448535/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/5741458218135-Format-Bar-Dialog-Box-Properties)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/9905574466839/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/5741444898839-Format-Bench-Dialog-Box-Properties)
...
![Format Bar Gauge dialog - Staff Graph](https://devnet.logianalytics.com/hc/article_attachments/9905721186455/fmtbargauge_stfgraph.gif)
...
Select if you want to show the names of the ranges defined in the [Range Color](#Range) tab. Then, you can continue to specify the font properties of the text in the range names.
...
![Format Bar Gauge dialog - Axis - Axis tab](https://devnet.logianalytics.com/hc/article_attachments/9905721211799/fmtbargauge_axis_axis.gif)
...
Specify the position relationship of the axis and the bar. When Layout is horizontal in the [Staff Graph](#Staff) tab, the following are available:
...
When Layout is vertical in the [Staff Graph](#Staff) tab, the following are available:
...
![Format Bar Gauge dialog - Axis - Tick Mark](https://devnet.logianalytics.com/hc/article_attachments/9905733038359/fmtbargauge_axis_tkmk.gif)

**Type**

Specify the position relationship of the axis and the tick marks. When Layout is horizontal in the [Staff Graph](#Staff) tab, the following are available:
...
![Format Bar Gauge dialog - Axis - Label](https://devnet.logianalytics.com/hc/article_attachments/9905733066647/fmtbargauge_axis_lbl.gif)
...
![Format Bar Gauge dialog - Axis - Format](https://devnet.logianalytics.com/hc/article_attachments/9905733097751/fmtbargauge_axis_fmt.gif)
...
![Format Bar Gauge dialog - Pointer](https://devnet.logianalytics.com/hc/article_attachments/9905754877975/fmtbargauge_pnt.gif)
...
* **Pointer Color**  
  ...
  + **Use Range Color**  
     Select to use the color [defined for the ranges](#Range) as the pointer color. Then, Server disables the preceding three properties.
* **Pointer Value**  
...
* **Pointer Color**  
  ...
  + **Color List**   
     Select to open the [Color List dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5741449488023-Color-List-Dialog-Box-Properties) to specify the color pattern for color bars in the same data series respectively.
* **Pointer Value**  
  Specify properties for values of the color bars.
  + **Show Pointer Value**  
     Select if you want to show values for the color bars.
  + **Position**  
     Select the position relationship between the values and the color bars. If you select **customized**, the X and Y settings in the General tab of the [Format Pointer Label dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5741435429655-Format-Pointer-Label-Dialog-Box-Properties#General) will take effect.
* **Pointer Border**  
  Specify the pointer border properties.
  + **Show Pointer Border**  
     Select if you want to show the border of the pointers. Then, Server enables the following border properties\.
...
![Format Bar Gauge dialog - Target](https://devnet.logianalytics.com/hc/article_attachments/9905754912279/fmtbargauge_tgt.gif)
...
* **Show Target Value**   
  ...
  + **Position**  
     Select the position of the target value relative to the bar. If you select **customized**, the X and Y settings in the General tab of the [Format Target Label dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5741465630999-Format-Target-Label-Dialog-Box-Properties#General) will take effect.

## Frame Tab Properties

Specify properties for the frame of the bar gauge chart.

![Format Bar Gauge dialog - Frame](https://devnet.logianalytics.com/hc/article_attachments/9905733177751/fmtbargauge_frm.gif)
...
* **Show Gauge Group Name**   
  ...
  + **Position**  
    Select the position of the names relative to the bars. If you select **customized**, the X and Y settings in the General tab of the [Format Gauge Label dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5741450295063-Format-Gauge-Label-Dialog-Box-Properties#General) will take effect.

## Range Color Tab Properties

Specify different colors to fill the bars in bar gauge in different ranges.

![Format Bar Gauge dialog - Range Color](https://devnet.logianalytics.com/hc/article_attachments/9905754954903/fmtbargauge_rgclr.gif)
...
![Format Bar Gauge dialog - Hint](https://devnet.logianalytics.com/hc/article_attachments/9905733205911/fmtbargauge_hint.gif)
