...
url: https://devnet.logianalytics.com/hc/en-us/articles/5741450704791-Format-Value-Y2-Axis-Dialog-Box-Properties
updated_at: 2022-10-31T17:17:32Z
---

# Format Value (Y2) Axis Dialog Box Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/9905574448535/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/5741445492119-Format-Value-Y-Gridline-Dialog-Box-Properties)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/9905574466839/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/5741450749079-Format-Value-Y2-Gridline-Dialog-Box-Properties)

# Format Value (Y2) Axis Dialog Box Properties

This topic describes how you can use the Format Value (Y2) Axis dialog box to format the value (Y2) axis of a chart. Server displays the dialog box when you right-click a chart and select F**ormat Axes** (unavailable to pie, indicator, heat map, and org charts) > **Format Value (Y2) Axis** from the shortcut menu.
...
![Format Value (Y2) Axis dialog box - Axis tab](https://devnet.logianalytics.com/hc/article_attachments/9905718984599/fmtvalueaxis2_axis.gif)
...
![Format Value (Y2) Axis dialog box - Major Tick Mark tab](https://devnet.logianalytics.com/hc/article_attachments/9905730749207/fmtvalueaxis2_mark_major.gif)
...
![Format Value (Y2) Axis dialog box - Minor Tick Mark tab](https://devnet.logianalytics.com/hc/article_attachments/9905719047703/fmtvalueaxis2_mark_minor.gif)
...
![Format Value (Y2) Axis dialog box - Font tab](https://devnet.logianalytics.com/hc/article_attachments/9905719065623/fmtvalueaxis2_font.gif)
...
![Format Value (Y2) Axis dialog box - Orientation tab](https://devnet.logianalytics.com/hc/article_attachments/9905719084055/fmtvalueaxis2_orntatn.gif)
...
![Format Value (Y2) Axis dialog box - Format tab](https://devnet.logianalytics.com/hc/article_attachments/9905730826903/fmtvalueaxis2_fmt.gif)
