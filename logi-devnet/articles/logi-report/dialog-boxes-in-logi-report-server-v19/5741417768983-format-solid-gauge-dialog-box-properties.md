...
url: https://devnet.logianalytics.com/hc/en-us/articles/5741417768983-Format-Solid-Gauge-Dialog-Box-Properties
updated_at: 2022-10-31T17:16:20Z
---

# Format Solid Gauge Dialog Box Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/9905574448535/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/5741410929943-Format-Scatter-Dialog-Box-Properties)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/9905574466839/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/5741397682455-Format-Stock-Dialog-Box-Properties)
...
![Format Solid Gauge dialog box - Circular Graph](https://devnet.logianalytics.com/hc/article_attachments/9905813833879/fmtsldgauge_crculr.gif)
...
* **Angle**  
   Specify the degree for angles of the arcs. Select the angle of the gauge from the list, or select **Customized** to open the [Customize Gauge Angle dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5741396975255-Customize-Gauge-Angle-Dialog-Box-Properties) to specify the start angle and end angle.
* **Thickness**  
...
* **Color**  
   Specify the color of the arcs.
* **Color List**  
  Select to open the [Color List dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5741402215575-Color-List-Dialog-Box-Properties) to specify the color of the arcs.
* **Transparency**  
...
![Format Solid Gauge dialog box - Axis - Axis tab](https://devnet.logianalytics.com/hc/article_attachments/9905775099543/fmtsldgauge_axis_axis.gif)
...
![Format Solid Gauge dialog box - Axis - Tick Mark](https://devnet.logianalytics.com/hc/article_attachments/9905775131543/fmtsldgauge_axis_tkmk.gif)
...
![Format Solid Gauge dialog box - Axis - Label](https://devnet.logianalytics.com/hc/article_attachments/9905813926935/fmtsldgauge_axis_lbl.gif)
...
![Format Solid Gauge dialog box - Axis - Format](https://devnet.logianalytics.com/hc/article_attachments/9905813959319/fmtsldgauge_axis_fmt.gif)

## Pointer Tab Properties

Specify the properties of the pointers in the solid gauge.

![Format Solid Gauge dialog box - Pointer](https://devnet.logianalytics.com/hc/article_attachments/9905775203351/fmtsldgauge_pnt.gif)
...
* **Color List**   
   Select to open the [Color List dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5741402215575-Color-List-Dialog-Box-Properties) to specify the pointer color.
* **Transparency**  
...
![Format Solid Gauge dialog box - Target](https://devnet.logianalytics.com/hc/article_attachments/9905813996311/fmtsldgauge_tgt.gif)
...
* **Position**  
   Select the position of the target value relative to the arc. If you select **customized**, the X and Y settings on the General tab of the [Format Target Label dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5741417846807-Format-Target-Label-Dialog-Box-Properties#General) will take effect.

## Frame Tab Properties

Specify the properties for the frame of the solid gauge chart.

![Format Solid Gauge dialog box - Frame](https://devnet.logianalytics.com/hc/article_attachments/9905814022039/fmtsldgauge_frm.gif)
...
* **Show Gauge Group Name**   
  ...
  + **Position**  
     Select the position of the names relative to the arcs. If you select **customized**, the X and Y settings on the General tab of the [Format Gauge Label dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5741397400343-Format-Gauge-Label-Dialog-Box-Properties#General) will take effect.

## Range Color Tab Properties

Specify different colors to fill the arcs in the solid gauge in different ranges.

![Format Solid Gauge dialog box - Range Color](https://devnet.logianalytics.com/hc/article_attachments/9905814038423/fmtsldgauge_rgclr.gif)
...
![Format Solid Gauge dialog box - Hint](https://devnet.logianalytics.com/hc/article_attachments/9905775313431/fmtsldgauge_hint.gif)
