...
![Button Properties dialog box - Button](https://devnet.logianalytics.com/hc/article_attachments/9905817403287/btnprpty_btn.gif)
...
![Button Properties dialog box - Image Button](https://devnet.logianalytics.com/hc/article_attachments/9905817435159/btnprpty_img.gif)
...
* **Web URL**  
  ...
  ![Note icon](https://devnet.logianalytics.com/hc/article_attachments/9905612785687/noteicon.jpg) If your Server is in an intranet, to access the image via URL, you need to add the parameters `-Dhttp.proxyHost=XXX -Dhttp.proxyPort=XX` to the server's startup file **JRServer.bat** in `<install_root>\bin`.
* **Library**  
