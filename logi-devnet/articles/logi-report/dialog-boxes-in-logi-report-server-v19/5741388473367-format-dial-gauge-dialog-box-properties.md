...
url: https://devnet.logianalytics.com/hc/en-us/articles/5741388473367-Format-Dial-Gauge-Dialog-Box-Properties
updated_at: 2022-10-31T17:16:17Z
---

# Format Dial Gauge Dialog Box Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/9905574448535/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/5741388427671-Format-Category-X-Axis-Dialog-Box-Properties)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/9905574466839/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/5741402753303-Format-Donut-Dialog-Box-Properties)
...
![Format Dial Gauge dialog box - Circular Graph](https://devnet.logianalytics.com/hc/article_attachments/9905814992023/fmtdlgauge_crculr.gif)
...
* **Angle**  
   Specify the degree for angles of the dials. Select the angle of the gauge from the list, or select **Customized** to open the [Customize Gauge Angle dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5741396975255-Customize-Gauge-Angle-Dialog-Box-Properties) to specify the start angle and end angle.
* **Thickness**  
...
![Format Dial Gauge dialog box - Axis - Axis tab](https://devnet.logianalytics.com/hc/article_attachments/9905815013783/fmtdlgauge_axis_axis.gif)
...
![Format Dial Gauge dialog box - Axis - Tick Mark](https://devnet.logianalytics.com/hc/article_attachments/9905776276887/fmtdlgauge_axis_tkmk.gif)
...
![Format Dial Gauge dialog box - Axis - Label](https://devnet.logianalytics.com/hc/article_attachments/9905815071255/fmtdlgauge_axis_lbl.gif)
...
![Format Dial Gauge dialog box - Axis - Format](https://devnet.logianalytics.com/hc/article_attachments/9905815098007/fmtdlgauge_axis_fmt.gif)

## Pointer Tab Properties

Specify the properties of the pointers in the dial gauge.

![Format Dial Gauge dialog box - Pointer](https://devnet.logianalytics.com/hc/article_attachments/9905815138455/fmtdlgauge_pnt.gif)
...
![Format Dial Gauge dialog box - Target](https://devnet.logianalytics.com/hc/article_attachments/9905815172887/fmtdlgauge_tgt.gif)
...
* **Show Target Value**  
  ...
  + **Position**  
     Select the position of the target value relative to the dial. If you select **customized**, the X and Y settings on the General tab of the [Format Target Label dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5741417846807-Format-Target-Label-Dialog-Box-Properties#General) will take effect.

## Frame Tab Properties

Specify the properties for the frame of the dial gauge chart.

![Format Dial Gauge dialog box - Frame](https://devnet.logianalytics.com/hc/article_attachments/9905815195031/fmtdlgauge_frm.gif)
...
* **Show Gauge Group Name**   
  ...
  + **Position**  
     Select the position of the names relative to the dial. If you select **customized**, the X and Y settings on the General tab of the [Format Gauge Label dialog box](https://devnet.logianalytics.com/hc/en-us/articles/5741397400343-Format-Gauge-Label-Dialog-Box-Properties#General) will take effect.

## Range Color Tab Properties

Specify different colors to fill the dials in dial gauge in different ranges.

![Format Dial Gauge dialog box - Range Color](https://devnet.logianalytics.com/hc/article_attachments/9905815216791/fmtdlgauge_rgclr.gif)
...
![Format Dial Gauge dialog box - Hint](https://devnet.logianalytics.com/hc/article_attachments/9905776471575/fmtdlgauge_hint.gif)
