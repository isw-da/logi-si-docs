...
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009774541-Resource-Allocation-Dialog-Box-Properties
updated_at: 2021-07-24T00:48:39Z
---

# Resource Allocation Dialog Box Properties

[![Back](https://devnet.logianalytics.com/hc/article_attachments/4404880134167/back.png)Previous Topic](https://devnet.logianalytics.com/hc/en-us/articles/1500009774461-Report-Properties)  [Next Topic![Next](https://devnet.logianalytics.com/hc/article_attachments/4404880134423/forward.png)](https://devnet.logianalytics.com/hc/en-us/articles/1500009746302-Result-Properties)

# Resource Allocation Dialog Box Properties

This topic describes how you can use the Resource Allocation dialog box to allocate the server resources to a specific [organization](https://devnet.logianalytics.com/hc/en-us/articles/1500009749922-Multitenancy-Supported-via-Organizations).

Server displays the dialog box when an admin user selects the Resource Allocation link in the Control column of the organization table in Administration > Security > Organization page in the Server Console.
...
* **Compress Swap Files**  
   Specifies whether to compress the temporary data generated during runtime before it is swapped to disk. By compressing the swap files, the I/O efforts in certain circumstance may be remarkably reduced so that the overall performance can be improved.
