...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405664599447-Printing-Reports
...
3. Navigate to **File** > **Print**. Designer displays the Print dialog box.
   ...
   ![Print dialog box](https://devnet.logianalytics.com/hc/article_attachments/4420550852375/frmt_print_14.gif)
...
3. Navigate to **File** > **Print**. Designer displays the Print dialog box.
   ...
   ![Print dialog box for JDK 1.1 printing method](https://devnet.logianalytics.com/hc/article_attachments/4420542094231/frmt_print_11.gif)
...
3. Navigate to **File** > **Print**. Designer displays the Page Setup dialog box.
   ...
   ![Page Setup dialog box](https://devnet.logianalytics.com/hc/article_attachments/4420542094487/frmt_print_12.gif)
