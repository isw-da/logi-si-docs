...
url: https://devnet.logianalytics.com/hc/en-us/articles/4402955429655-Alert-Definition-Data-Query-Structures
...
![](https://devnet.logianalytics.com/hc/article_attachments/4404959473559/noteicon.jpg) Because alert conditions are checked periodically, filter conditions must be set properly, especially if the queried data is limited to a dynamic timeframe.
...
![](https://devnet.logianalytics.com/hc/article_attachments/4404959473559/noteicon.jpg) Top of the Top sorting is not supported; only simple sorting is supported. We recommend that no sorting be specified at all.
