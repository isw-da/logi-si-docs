...
url: https://devnet.logianalytics.com/hc/en-us/articles/4402955678231-Patch-a-Theme
...
3. Use the `/api/customization/themes/<id>` API endpoint in a PATCH request to update the theme. Use snippet of JSON code as the body (`"content" : "<string>"`) of the request, but specify the ID of the theme as a parameter for the endpoint PATCH request.
   ...
   If the theme is the active theme, refresh the Composer UI to see the theme changes. If the theme is not the active theme, [activate it](https://devnet.logianalytics.com/hc/en-us/articles/4402963057303-Activate-a-Theme) to see the theme changes in the UI.
