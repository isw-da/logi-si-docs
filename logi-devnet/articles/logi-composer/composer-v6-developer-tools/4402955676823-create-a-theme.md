...
url: https://devnet.logianalytics.com/hc/en-us/articles/4402955676823-Create-a-Theme
...
2. Use the `/api/customization/themes/`[API endpoint](https://devnet.logianalytics.com/hc/en-us/articles/4402955676183-Themes-API-Endpoint) in a POST request to create the theme. Use the text of your JSON file as the body (`"content": "<string>"`) of the request. Be sure to remove the `"system": true` and `"id": "<string>"` properties from the JSON file before you use it to create a theme. Composer automatically generates an ID for the theme and sets the value of the `"system"` property when the API request to create the theme is processed.
   ...
   After the theme is successfully created, it shows up in the list of available themes when one is generated (see [*List Themes*](https://devnet.logianalytics.com/hc/en-us/articles/4402963059863-List-Themes)) and it can be updated and patched (see [*Update a Theme*](https://devnet.logianalytics.com/hc/en-us/articles/4402955679511-Update-a-Theme) and [*Patch a Theme*](https://devnet.logianalytics.com/hc/en-us/articles/4402955678231-Patch-a-Theme)). It can also be deleted (see [*Delete a Theme*](https://devnet.logianalytics.com/hc/en-us/articles/4402963058327-Delete-a-Theme)). However, it will not be used by the Composer UI until it has been activated (see [*Activate a Theme*](https://devnet.logianalytics.com/hc/en-us/articles/4402963057303-Activate-a-Theme)).
