...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405859406231-Query-Engine-Microservice
...
The Composer query engine sits between the web application (or a client application built with the Composer JavaScript SDK) and the Composer data connectors.
...
The key capabilities of the query engine include [push-down processing for select data sources](#Push-Dow), [microqueries and Data Sharpening](#Microque), [adaptive caching](#Adaptive), [data playback and live mode](https://devnet.logianalytics.com/hc/en-us/articles/4405851125143-Data-Playback-and-Live-Mode), and [multisource analysis](https://devnet.logianalytics.com/hc/en-us/articles/4405859415703-Multisource-Analysis).
...
![](https://devnet.logianalytics.com/hc/article_attachments/4406747382295/noteicon.jpg) Cached data is shared between users only if they have the same data access permissions and security context.
