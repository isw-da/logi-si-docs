...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405851053719-Embedded-Dashboard-JavaScript-Example
...
* The `createOrGetEmbedManager` asynchronous function provides an initial access token using [Trusted Access](https://devnet.logianalytics.com/hc/en-us/articles/4405851181463-Trusted-Access).
...
* The `refreshDashboard` asynchronous function refreshes the authorization token for the embedded dashboard using [Trusted Access](https://devnet.logianalytics.com/hc/en-us/articles/4405851181463-Trusted-Access).
