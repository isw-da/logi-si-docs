...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405851052695-Embedded-Events
...
![](https://devnet.logianalytics.com/hc/article_attachments/4409054855575/noteicon.jpg) The ability for your end-users to perform some of the events listed here is controlled by the permissions granted to them with their Composer credentials. See [*Embedded Composer Component Controls*](https://devnet.logianalytics.com/hc/en-us/articles/4405851048727-Embedded-Composer-Component-Controls).
...
![](https://devnet.logianalytics.com/hc/article_attachments/4409070299415/criticalicon.gif) The event detail payload that is passed to the event listener is **experimental** and might be changed. Mutating the detail object (`e.detail.*`) will not update the UI; the object is read-only.
