...
url: https://devnet.logianalytics.com/hc/en-us/articles/4402955692567-Why-Can-t-I-Recreate-Users-that-Previously-Existed
updated_at: 2022-05-19T13:57:02Z
---
...
To completely delete a user, log in as the supervisor and delete the user there. The user will be completely removed from the system and you can then create a user with the same user name. See [*Manage User Definitions*](https://devnet.logianalytics.com/hc/en-us/articles/4402955420567-Manage-User-Definitions).
