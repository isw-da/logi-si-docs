...
url: https://devnet.logianalytics.com/hc/en-us/articles/4402963069975-Verify-the-Composer-Server-Restart
updated_at: 2021-08-07T17:32:17Z
---
...
6. If you discover that the Composer Server is still running, you will need to force stop the Server by running:
   ...
   NOTE
   : If this command does not successfully terminate Composer, you can enter the following command line:
   ...
   [Linux/Unix Command: ps/kill](https://www.lifewire.com/zgrep-linux-command-unix-command-4097076)
   topic.
