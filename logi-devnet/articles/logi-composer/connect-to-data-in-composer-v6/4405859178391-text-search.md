...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405859178391-Text-Search
...
When a Composer connector supports text searches, it can perform an efficient search on text fields. When text searches are supported, search control is enabled on dashboards using data sources that use the connector. In addition, the **Lookup Values** switch on the Tables/Indices tab of the [data source configuration](https://devnet.logianalytics.com/hc/en-us/articles/4405851027479-Manage-Data-Source-Configurations) is available.
