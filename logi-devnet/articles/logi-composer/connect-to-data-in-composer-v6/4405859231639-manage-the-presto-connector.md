---
title: "Manage the Presto Connector"
id: 4405859231639
section: "Connect to Data in Composer v6"
category: "Logi Composer"
url: https://devnet.logianalytics.com/hc/en-us/articles/4405859231639-Manage-the-Presto-Connector
updated_at: 2021-09-21T01:30:42Z
---
...
Before you can establish a connection from Composer to the Presto server, the Presto connector server must be installed, configured and enabled. See [*Manage Connectors and Connector Servers*](https://devnet.logianalytics.com/hc/en-us/articles/4405859186199-Manage-Connectors-and-Connector-Servers) for general instructions and [*Connect to Presto*](#Connecti) for details specific to the Presto connector.
...
Presto connector support for specific [Composer features](https://devnet.logianalytics.com/hc/en-us/articles/4405859170583-Connector-Feature-Support) is shown in the following table.
...
1. Install Presto version 319. Refer to Presto's documentation [Installing Presto](https://trino.io/docs/current/installation/deployment.html) for more details.
2. Configure the Presto Server. Refer to Presto's documentation [Configuring Presto](https://trino.io/docs/current/installation/deployment.html) for more details.
3. Make sure that the following files are available in the `presto-server-319/etc` folder:
...
4. Configure Presto for Cassandra databases. See [Connect to Cassandra Databases Using Presto](https://devnet.logianalytics.com/hc/en-us/articles/4405850961175-Connect-to-Cassandra-Databases-Using-Presto) and Presto's documentation covering its [Cassandra connector](https://trino.io/docs/current/connector/cassandra.html) for more details.
