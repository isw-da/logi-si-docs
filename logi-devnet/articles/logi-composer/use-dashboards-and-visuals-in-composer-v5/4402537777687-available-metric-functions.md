---
title: "Available Metric Functions"
id: 4402537777687
section: "Use Dashboards and Visuals in Composer v5"
category: "Logi Composer"
url: https://devnet.logianalytics.com/hc/en-us/articles/4402537777687-Available-Metric-Functions
updated_at: 2021-09-15T02:21:22Z
---
...
Composer provides a set of metric functions that are used to group (aggregate) data. The following metric functions can be selected when you select metrics for your visuals:

| Metric Function | What Is Returned |
| --- | --- |
| AVG | The average of the data values for the field |
| MIN | The lowest value in all the data values for the field |
| MAX | The highest value in all the data values for the field |
| SUM | The total of all the data values for the field |
| LAST VALUE | The last value in all the data values for the field, sorted by the time attribute selected for the time bar. If the latest date and time for the time attribute is exactly the same in multiple records, the last value for the field is the maximum value of the field in the records with the latest date and time. See [*LAST VALUE Examples*](#LAST). |
