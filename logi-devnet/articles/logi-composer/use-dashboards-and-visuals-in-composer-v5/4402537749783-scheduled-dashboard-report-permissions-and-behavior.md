...
url: https://devnet.logianalytics.com/hc/en-us/articles/4402537749783-Scheduled-Dashboard-Report-Permissions-and-Behavior
...
To create a scheduled dashboard report, you must be an administrator or assigned to a group with the **Can Create Scheduled Reports**[privilege](https://devnet.logianalytics.com/hc/en-us/articles/4402537668503-Group-Privilege-Reference).
...
| Removed | Account |
| Removed | System | The recipient is remove from the recipients list. |

Log messages related to scheduled dashboard reports are stored in the `zoomdata.log`[log file](https://devnet.logianalytics.com/hc/en-us/articles/4402537842071-Composer-Log-Files).
