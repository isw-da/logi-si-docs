...
url: https://devnet.logianalytics.com/hc/en-us/articles/4402537919383-Bars-Multiple-Metric-Charts
updated_at: 2021-09-15T02:22:52Z
---
...
They are supported by all Composer [data connectors](https://devnet.logianalytics.com/hc/en-us/articles/4402537840279-Composer-Data-Connector-Reference).

This topic describes:

* [*Configuring Default Multiple Metric Bar Chart Settings for a Data Source*](#Configur)
* [*Configuring Settings for a Specific Multiple Metric Bar Chart*](#Configur3)
* [*Configuring Colors for a Specific Multiple Metric Bar Chart*](#Configur2)

## Configuring Default Multiple Metric Bar Chart Settings for a Data Source
...
3. On the **Standard** subtab of the [Visuals](https://devnet.logianalytics.com/hc/en-us/articles/4402537788695-Visuals-Tab) tab, select **Bars: Multiple Metrics**.
...
## Configuring Settings for a Specific Multiple Metric Bar Chart

To change the settings for a specific multiple metric bar chart:

1. Edit the multiple metric bar chart you want to modify. See [*Editing Visuals*](https://devnet.logianalytics.com/hc/en-us/articles/4402537942295-Editing-Visuals).
...
3. Select ![](https://devnet.logianalytics.com/hc/article_attachments/4406753439511/sidebar-chtsettings.png) on the [sidebar menu](https://devnet.logianalytics.com/hc/en-us/articles/4402537948311-Using-the-Sidebar-Menu). The Bar: Multiple Metrics Settings sidebar for the visual appears.

   ![](https://devnet.logianalytics.com/hc/article_attachments/4406763924247/bar-multi-settings_192x314.png)
...
## Configuring Colors for a Specific Multiple Metric Bar Chart
