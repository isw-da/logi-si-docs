---
title: "Editing a Saved Filter"
id: 4402537801879
section: "Use Dashboards and Visuals in Composer v5"
category: "Logi Composer"
url: https://devnet.logianalytics.com/hc/en-us/articles/4402537801879-Editing-a-Saved-Filter
...
You can edit saved filters that apply to the data source used by a visual on your dashboard. Changes that you make are only applied to the dashboard or visual where you made the change and not to other dashboards or visuals that have already applied the saved filter.
...
4. Alter the filter as needed. See [*Applying Row-Level Filters*](https://devnet.logianalytics.com/hc/en-us/articles/4402537794711-Applying-Row-Level-Filters) and [*Removing a Filter from a Visual or Dashboard*](https://devnet.logianalytics.com/hc/en-us/articles/4402537798039-Removing-a-Filter-from-a-Visual-or-Dashboard).
...
6. [Save](https://devnet.logianalytics.com/hc/en-us/articles/4402537747863-Saving-a-Dashboard) the dashboard.
