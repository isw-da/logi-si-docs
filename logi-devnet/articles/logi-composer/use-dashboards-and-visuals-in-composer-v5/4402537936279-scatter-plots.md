...
url: https://devnet.logianalytics.com/hc/en-us/articles/4402537936279-Scatter-Plots
...
Scatter plots are based on three metrics and one attribute. They are supported by all Composer [data connectors](https://devnet.logianalytics.com/hc/en-us/articles/4402537840279-Composer-Data-Connector-Reference).

This topic describes:

* [*Configuring Default Scatter Plot Settings for a Data Source*](#Configur)
* [*Configuring Colors for a Specific Scatter Plot*](#Configur2)

## Configuring Default Scatter Plot Settings for a Data Source

To configure default scatter plot settings for a data source configuration:
...
3. On the **Standard** subtab of the [Visuals](https://devnet.logianalytics.com/hc/en-us/articles/4402537788695-Visuals-Tab) tab, select **Scatter Plot**.

   If you want to be able to display the data collected by this data source configuration as a scatter plot, make sure the **Scatter Plot** checkbox is selected.

   Default scatter plot settings appear on the right side of the page.
4. Configure the default settings as follows:
   ...
   | Y Axis | Select a metric for the y-axis of the visual. You can also define the default aggregation function used for the metric values: **SUM**, **AVG**, **MAX**, **MIN**, or (for some data sources) **LAST VALUE**. See [*Available Metric Functions*](https://devnet.logianalytics.com/hc/en-us/articles/4402537777687-Available-Metric-Functions). |
   | X Axis | Select a metric for the x-axis of the visual. You can also define the default aggregation function used for the metric values: **SUM**, **AVG**, **MAX**, **MIN**, or (for some data sources) **LAST VALUE**. See [*Available Metric Functions*](https://devnet.logianalytics.com/hc/en-us/articles/4402537777687-Available-Metric-Functions). |
...
To specify the color settings for a specific scatter plot using the Color sidebar:
