...
url: https://devnet.logianalytics.com/hc/en-us/articles/4402537922583-Donut-Charts
...
Donut charts are based on one metric and one attribute. They are supported by all Composer [data connectors](https://devnet.logianalytics.com/hc/en-us/articles/4402537840279-Composer-Data-Connector-Reference).

This topic describes:

* [*Configuring Default Donut Chart Settings for a Data Source*](#Configur)
* [*Configuring Settings for a Specific Donut Chart*](#Configur3)
* [*Configuring Colors for a Specific Donut Chart*](#Configur2)

## Configuring Default Donut Chart Settings for a Data Source

To configure default donut chart settings for a data source configuration:
...
3. On the **Standard** subtab of the [Visuals](https://devnet.logianalytics.com/hc/en-us/articles/4402537788695-Visuals-Tab) tab, select **Donut**.

   If you want to be able to display the data collected by this data source configuration as a donut chart, make sure the **Donut** checkbox is selected.

   Default donut chart settings appear on the right side of the page.
4. Configure the default settings as follows:
   ...
   | Size | Select the metric on which the segments of the visual will be based. You can also define the default aggregation function used for the metric values: **SUM**, **AVG**, **MAX**, **MIN**, or (for some data sources) **LAST VALUE**. See [*Available Metric Functions*](https://devnet.logianalytics.com/hc/en-us/articles/4402537777687-Available-Metric-Functions). |
5. Select ![](https://devnet.logianalytics.com/hc/article_attachments/4406763898903/save-white-btn_40x23.png).

## Configuring Settings for a Specific Donut Chart

To change the settings for a specific donut chart:

1. Edit the donut chart you want to modify. See [*Editing Visuals*](https://devnet.logianalytics.com/hc/en-us/articles/4402537942295-Editing-Visuals).
...
3. Select ![](https://devnet.logianalytics.com/hc/article_attachments/4406753439511/sidebar-chtsettings.png) on the [sidebar menu](https://devnet.logianalytics.com/hc/en-us/articles/4402537948311-Using-the-Sidebar-Menu). The Donut Chart Settings sidebar for the visual appears.

   ![](https://devnet.logianalytics.com/hc/article_attachments/4406763918743/donut-settings_192x358.png)
...
## Configuring Colors for a Specific Donut Chart

To specify the color settings for a specific donut chart using the Color sidebar:
