...
url: https://devnet.logianalytics.com/hc/en-us/articles/4402537833751-Configurable-Data-Sources
...
For more information about creating and managing data source configurations, see [*Manage Data Source Configurations*](https://devnet.logianalytics.com/hc/en-us/articles/4402552802199-Manage-Data-Source-Configurations).

In addition to standard data source configurations, Composer provides methods of analyzing data from multiple sources at the same time, including the ability to fuse data sources. See [*Multisource Analysis*](https://devnet.logianalytics.com/hc/en-us/articles/4402537836951-Multisource-Analysis).
