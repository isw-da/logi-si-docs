...
url: https://devnet.logianalytics.com/hc/en-us/articles/7136317103383-Scaling-Composer-Microservices
updated_at: 2022-07-01T19:31:29Z
---
...
![](https://devnet.logianalytics.com/hc/article_attachments/7049212310423/lightbulb.png) Horizontal scaling up of a microservice doesn't provide doubled performance gains due to sharing of PostreSQL resources and overlapping of microservices.

Start your scale planning based on an approximate number of services and expected number of users. See *[Server Size Guidelines](https://devnet.logianalytics.com/hc/en-us/articles/4405851099543)* for more information on services and user estimation.

## Add or Remove Nodes in a High Availability Environment

To scale a microservice up or down, you may need to *[Add Nodes to an Existing High Availability Installation](https://devnet.logianalytics.com/hc/en-us/articles/4405859366167)* or *[Remove Nodes from a High Availability Environment](https://devnet.logianalytics.com/hc/en-us/articles/4405859367319)*. Before you add or remove nodes, you should understand the actual load on your microservices to make the decision of scaling up or down. See [*Composer System Metrics*](https://devnet.logianalytics.com/hc/en-us/articles/7172334397207).
...
Set your estimated concurrent users for each service at +20%, based on your calculations made using *[Server Size Guidelines](https://devnet.logianalytics.com/hc/en-us/articles/4405851099543)*. To manage configuration properties of `server.jetty.max-threads`, see *[Configure and Start the Configuration Microservice](https://devnet.logianalytics.com/hc/en-us/articles/4405859471255)*.
...
![](https://devnet.logianalytics.com/hc/article_attachments/7049212310423/lightbulb.png)Composer v7.1 and earlier use the property `jetty.threadPool.maxThreads` to limit throughput for the composer web and query engine microservices.
...
For more information on scaling up your environment, see *[Add Nodes to an Existing High Availability Installation](https://devnet.logianalytics.com/hc/en-us/articles/4405859366167)*.

![](https://devnet.logianalytics.com/hc/article_attachments/7049212310423/lightbulb.png) Composer-Web does not support horizontal scaling, only vertical scaling. Increase machine resources to accommodate your needs. Configure `server.jetty.max-threads` or `jetty.threadPool.maxThreads` for Composer v7.1 and earlier after increasing machine resources.
