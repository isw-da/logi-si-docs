...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405859433111-Activities-Log-Reference-Sheet
updated_at: 2022-02-24T16:47:56Z
---
...
The following table lists the activities that are logged by default and those that are not. Activities that are not logged by default must have logging manually enabled. See [*Activity Logging*](https://devnet.logianalytics.com/hc/en-us/articles/4405851110039-Activity-Logging).
...
This activity is logged while working with security key. A security key is created when a user chooses to share a dashboard and the interactive or non interactive link is created. Logging for this activity is enabled by default and captured in the `zoomdata-activity.log` file.
