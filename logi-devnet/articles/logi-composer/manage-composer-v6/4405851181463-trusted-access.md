...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405851181463-Trusted-Access
...
![](https://devnet.logianalytics.com/hc/article_attachments/4406747382295/noteicon.jpg)Logi Analytics recommends using [Trusted Access](#) for all embed-related workflows.
...
Trusted Access tokens are encrypted when stored in Composer metadata. The encryption mode used can be set as described in [*Change the Encryption Mode*](https://devnet.logianalytics.com/hc/en-us/articles/4405859459351-Change-the-Encryption-Mode).
...
* [*Trusted Access API Endpoints*](https://devnet.logianalytics.com/hc/en-us/articles/4405851180439-Trusted-Access-API-Endpoints)
* [*Trusted Access Client Properties*](https://devnet.logianalytics.com/hc/en-us/articles/4405859468951-Trusted-Access-Client-Properties)

## Trusted Access Prerequisites

* Every end user must have Composer user account defined, unless you are using LDAP autoprovisioning with Composer. See [*Manage User Definitions*](https://devnet.logianalytics.com/hc/en-us/articles/4405859120023-Manage-User-Definitions).
* Enable Trusted Access by selecting the **Trusted Access & OAUTH** option on the Security page of the Supervisor UI. See [*Enable Trusted Access and OAuth 2.0*](https://devnet.logianalytics.com/hc/en-us/articles/4405859465111-Enable-Trusted-Access-and-OAuth-2-0).
...
![](https://devnet.logianalytics.com/hc/article_attachments/4406747382295/noteicon.jpg) You cannot generate a token for supervisors. You can only generate them for regular users and for administrators.
