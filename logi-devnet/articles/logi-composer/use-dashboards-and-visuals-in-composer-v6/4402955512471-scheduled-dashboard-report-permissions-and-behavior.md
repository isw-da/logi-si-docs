...
url: https://devnet.logianalytics.com/hc/en-us/articles/4402955512471-Scheduled-Dashboard-Report-Permissions-and-Behavior
...
To create a scheduled dashboard report, you must be an administrator or assigned to a group with the **Can Create Scheduled Reports**[privilege](https://devnet.logianalytics.com/hc/en-us/articles/4402955416087-Group-Privilege-Reference).
...
Log messages related to scheduled dashboard reports are stored in the `zoomdata.log`[log file](https://devnet.logianalytics.com/hc/en-us/articles/4402955644183-Composer-Log-Files).
