...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405859261207-Create-Dashboards
updated_at: 2021-09-21T01:27:43Z
---
...
5. [Save](https://devnet.logianalytics.com/hc/en-us/articles/4405850986647-Save-a-Dashboard) your dashboard. You are prompted to supply a name for the dashboard. After it is saved, the dashboard is a single-visual dashboard until you add additional visuals to it. To add additional visuals to the dashboard, see [Add New Visuals to a Dashboard](https://devnet.logianalytics.com/hc/en-us/articles/4405851250199-Add-New-Visuals-to-a-Dashboard) and [*Place Existing Visuals on a Dashboard*](https://devnet.logianalytics.com/hc/en-us/articles/4405851256983-Place-Existing-Visuals-on-a-Dashboard).

After a dashboard is created, you can explore its data and work directly with its various visuals. You can modify, copy, export or delete its visuals. In addition, the data on the visual can be filtered (see [*Filter Data*](https://devnet.logianalytics.com/hc/en-us/articles/4405851066519-Filter-Data)). Finally, you can share, export, or delete the dashboard (see [*Manage Dashboards*](https://devnet.logianalytics.com/hc/en-us/articles/4405850985623-Manage-Dashboards)).
