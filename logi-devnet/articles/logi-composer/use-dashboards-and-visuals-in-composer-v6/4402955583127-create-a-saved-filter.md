...
url: https://devnet.logianalytics.com/hc/en-us/articles/4402955583127-Create-a-Saved-Filter
...
![](https://devnet.logianalytics.com/hc/article_attachments/4404959473559/noteicon.jpg) Cross-visual filters that have been applied from same-source and cross-source links are not saved when filters are saved for a visual. Saved filters only include row-level filters for the visual.
...
6. Select ![](https://devnet.logianalytics.com/hc/article_attachments/4404952854295/apply1-btn_43x24.png).
...
7. [Save](https://devnet.logianalytics.com/hc/en-us/articles/4402962944151-Save-a-Dashboard) the dashboard.
...
2. On the Filters sidebar, create and apply a filter for jewelry sales. See [Apply Row-Level Filters](https://devnet.logianalytics.com/hc/en-us/articles/4402955576599-Apply-Row-Level-Filters).
   ...
   * Select ![](https://devnet.logianalytics.com/hc/article_attachments/4404959500823/apply1-btn_41x23.png) to apply the filter. You visual (or dashboard) now shows all sales data for jewelry. The first page of the Filters sidebar appears again.
3. Select ![](https://devnet.logianalytics.com/hc/article_attachments/4404952854807/save-filters_61x20.png) on the Filters sidebar. The Save Filter Set dialog appears.
...
5. Select ![](https://devnet.logianalytics.com/hc/article_attachments/4404952854295/apply1-btn_43x24.png) to save the Jewelry Sales filter.
