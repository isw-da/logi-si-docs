...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405859559063-Sort-and-Limit-Visual-Data
...
For additional information, see [*Manage Data Source Configurations*](https://devnet.logianalytics.com/hc/en-us/articles/4405851027479-Manage-Data-Source-Configurations).
...
3. Select the sort and limit option (![](https://devnet.logianalytics.com/hc/article_attachments/4406743711127/sidebar-sort.png)) on the [sidebar menu](https://devnet.logianalytics.com/hc/en-us/articles/4405859578391-Use-the-Visual-Sidebar-Menu) for the visual. The Sort & Limit sidebar opens.

   ![](https://devnet.logianalytics.com/hc/article_attachments/4406747387159/sidebar-sortlimit_192x356.png)
...
5. For numeric **Sort by** fields, you can indicate how the data should be aggregated for the visual using the **Aggregation** box. Options include: SUM, AVG, MIN, MAX, or LAST VALUE. For explanations, see [*Metric Aggregation Functions*](https://devnet.logianalytics.com/hc/en-us/articles/4405851021975-Metric-Aggregation-Functions).
...
8. Select ![](https://devnet.logianalytics.com/hc/article_attachments/4406743725975/apply-btn_58x19.png) to apply your changes to the visual.
