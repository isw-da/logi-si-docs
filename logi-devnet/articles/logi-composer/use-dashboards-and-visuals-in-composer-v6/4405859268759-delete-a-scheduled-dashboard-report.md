...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405859268759-Delete-a-Scheduled-Dashboard-Report
...
4. Locate the dashboard in the dashboard library list containing the scheduled you want to remove.
5. Select ![](https://devnet.logianalytics.com/hc/article_attachments/4406743712407/dashboard-schedule.png) in the associated **Schedule** column. The Scheduled Reports dialog appears.
   ...
   Scheduled reports for this dashboard that have already been defined appear on the left side of the dialog. A message appears on the dialog if none have been defined.
6. Locate and select the scheduled report that you want to remove on the left side of the Scheduled Reports dialog. The settings for the report appear on the right side of the dialog.
7. Select ![](https://devnet.logianalytics.com/hc/article_attachments/4406743720599/trashcan-btn.png) next to the scheduled report name on the left side of the dialog. A warning dialog appears.

   ![](https://devnet.logianalytics.com/hc/article_attachments/4406743875223/dash-sched-warn_288x98.png)
8. Select ![](https://devnet.logianalytics.com/hc/article_attachments/4406743875607/delete-blue1-btn_43x22.png) to delete the scheduled dashboard report. The name of the scheduled report is removed from the list on the left of the Scheduled Reports dialog.
