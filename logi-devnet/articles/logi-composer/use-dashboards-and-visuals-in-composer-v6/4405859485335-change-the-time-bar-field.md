...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405859485335-Change-the-Time-Bar-Field
...
6. Select ![](https://devnet.logianalytics.com/hc/article_attachments/4406743745815/apply-btn_122x22.png).
   ...
   The time bar for the visual is changed. If the visual is using a unified time bar, all the visuals using the unified time bar are also changed. See [*Work with Unified Time Bars*](https://devnet.logianalytics.com/hc/en-us/articles/4405859488535-Work-with-Unified-Time-Bars).
...
5. [Save](https://devnet.logianalytics.com/hc/en-us/articles/4405850986647-Save-a-Dashboard) the dashboard.
