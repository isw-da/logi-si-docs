...
url: https://devnet.logianalytics.com/hc/en-us/articles/4402962949527-Apply-Even-Time-Intervals-on-Most-Visuals
updated_at: 2021-08-07T17:33:21Z
---
...
1. [Edit](https://devnet.logianalytics.com/hc/en-us/articles/4402955510551-Edit-a-Dashboard) a dashboard with one of these visual styles that uses a data source containing date or time fields.
2. Select a time attribute for the visual Group (x-axis).
3. Select the Time Granularity box on the x-axis.

   ![](https://devnet.logianalytics.com/hc/article_attachments/4404952889751/even-time-intervals_192x237.png)
...
5. Slide **Include Blanks** on to request even time intervals. By default, the ability to show all values is disabled and only attributes with a value greater than NULL are displayed.
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4404952892311/even-time-intervals-linecht_192x279.png)
