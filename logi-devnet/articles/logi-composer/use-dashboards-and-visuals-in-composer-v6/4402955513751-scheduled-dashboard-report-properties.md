...
url: https://devnet.logianalytics.com/hc/en-us/articles/4402955513751-Scheduled-Dashboard-Report-Properties
...
For information about the properties in the `zoomdata.properties` file, see [*zoomdata.properties Properties*](https://devnet.logianalytics.com/hc/en-us/articles/4402955454615-zoomdata-properties-Properties).

Log messages related to dashboard report scheduling are stored in the `zoomdata.log`[log file](https://devnet.logianalytics.com/hc/en-us/articles/4402955644183-Composer-Log-Files).
