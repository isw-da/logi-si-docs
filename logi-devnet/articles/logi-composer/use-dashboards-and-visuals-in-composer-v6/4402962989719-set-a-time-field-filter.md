...
url: https://devnet.logianalytics.com/hc/en-us/articles/4402962989719-Set-a-Time-Field-Filter
...
4. On the Range tab, use the **From** and **To** boxes to specify the time range for the filter. You can set the range in static time or dynamic time, or use preset ranges provided with Composer.
   ...
   * Select **Static Time** or **Dynamic Time** in the **fx** drop-down menu.
     ...
     ![](https://devnet.logianalytics.com/hc/article_attachments/4404959533207/time-bar-range-types1_250x150.png)
     ...
     ![](https://devnet.logianalytics.com/hc/article_attachments/4404959533463/filter-time-range-static1_150x254.png)
     ...
     ![](https://devnet.logianalytics.com/hc/article_attachments/4404952855831/filter-time-range-dynamic1_139x260.png)
   * Alternatively, select ![](https://devnet.logianalytics.com/hc/article_attachments/4404959534231/presets-btn1_66x22.png) to fill the **From** and **To** boxes with predefined time ranges provided by Composer.
...
5. Alternatively, select a keyset on the **Keysets** tab to use for the filter. See [*Use Keysets*](https://devnet.logianalytics.com/hc/en-us/articles/4402955615511-Use-Keysets).
