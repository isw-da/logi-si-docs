...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405859560471-Tree-Maps
updated_at: 2021-09-21T01:30:24Z
---
...
Tree maps are based on two metrics and one attribute. They are supported by all Composer [data connectors](https://devnet.logianalytics.com/hc/en-us/articles/4405859436055-Composer-Data-Connector-Reference).

This topic describes:

* [*Configure Default Tree Map Settings for a Data Source*](#Configur)
* [*Configure Colors for a Specific Tree Map*](#Configur2)
* [*Understand Visual Color Condition Thresholds*](#ColorCondThresh)

## Configure Default Tree Map Settings for a Data Source

To configure default tree map settings for a data source configuration:
...
3. On the **Standard** subtab of the [Visuals](https://devnet.logianalytics.com/hc/en-us/articles/4405859325591-Visuals-Tab) tab, select **Tree Map**.

   If you want to be able to display the data collected by this data source configuration as a tree map, make sure the **Tree Map** checkbox is selected.

   Default tree map settings appear on the right side of the page.
4. Configure the default settings as follows:
   ...
   | Size | Select a metric that affects the rectangle sizes in the visual. You can also define the default aggregation function used for the metric values: **SUM**, **AVG**, **MAX**, **MIN**, or (for some data sources) **LAST VALUE**. See [*Metric Aggregation Functions*](https://devnet.logianalytics.com/hc/en-us/articles/4405851021975-Metric-Aggregation-Functions). |
   | Color | Select the metric that affects the rectangle colors in the visual. You can also define the default aggregation function used for the metric values: **SUM**, **AVG**, **MAX**, **MIN**, or (for some data sources) **LAST VALUE**. See [*Metric Aggregation Functions*](https://devnet.logianalytics.com/hc/en-us/articles/4405851021975-Metric-Aggregation-Functions). |
5. Select ![](https://devnet.logianalytics.com/hc/article_attachments/4406747382679/save-white-btn_40x23.png).

## Configure Colors for a Specific Tree Map

To specify the color settings for a specific tree map using the Color sidebar:
