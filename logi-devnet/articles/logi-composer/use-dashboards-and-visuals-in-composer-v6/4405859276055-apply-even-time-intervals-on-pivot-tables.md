...
url: https://devnet.logianalytics.com/hc/en-us/articles/4405859276055-Apply-Even-Time-Intervals-on-Pivot-Tables
updated_at: 2021-09-21T01:27:51Z
---
...
1. [Edit](https://devnet.logianalytics.com/hc/en-us/articles/4405850982039-Edit-a-Dashboard) a dashboard with a pivot table that uses a data source containing date or time fields.
...
4. On the sidebar, select ![](https://devnet.logianalytics.com/hc/article_attachments/4406743863575/edit.png) in **Rows** or **Columns** and select a time field for the row or column. Select **OK**.

   The time field is selected and expands so you can select its granularity and even time intervals setting.

   ![](https://devnet.logianalytics.com/hc/article_attachments/4406743864727/pivot-table-timeflds_192x80.png)
...
7. Select ![](https://devnet.logianalytics.com/hc/article_attachments/4406743865239/apply-btn_106x35.png) to apply the changes to the pivot table.
