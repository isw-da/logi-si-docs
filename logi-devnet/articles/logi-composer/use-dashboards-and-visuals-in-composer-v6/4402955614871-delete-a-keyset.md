...
url: https://devnet.logianalytics.com/hc/en-us/articles/4402955614871-Delete-a-Keyset
...
![](https://devnet.logianalytics.com/hc/article_attachments/4404959473559/noteicon.jpg) Keysets can only be deleted by the user account that created them or by any Composer user belonging to a group with the **Can Administer Dashboards** privilege. In addition, they can only be deleted if they are not used by any visual in the environment.
...
5. Select the delete icon (![](https://devnet.logianalytics.com/hc/article_attachments/4404959489559/delete-open.png)) next to the keyset name. A warning dialog appears.

   ![](https://devnet.logianalytics.com/hc/article_attachments/4404959519767/keyset-delete_288x83.png)
6. Select ![](https://devnet.logianalytics.com/hc/article_attachments/4404952843287/delete-blue1-btn_45x23.png). The keyset is deleted.
