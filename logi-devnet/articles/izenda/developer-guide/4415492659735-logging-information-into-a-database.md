...
category: "Izenda"
url: https://devnet.logianalytics.com/hc/en-us/articles/4415492659735-Logging-Information-Into-a-Database
...
* Lower on the same web.config file, there is a element (line 14).
  ...
  + Replace the removed section with the following, noting to add your
    ...
    Note: The bufferSize value is currently set to 1. You can adjust
