...
category: "Izenda"
url: https://devnet.logianalytics.com/hc/en-us/articles/12528223106839-Add-Internal-User
updated_at: 2023-02-23T15:13:02Z
---
...
* [Add Tenant](https://devnet.logianalytics.com/hc/en-us/articles/12528296396055-Tenant-APIs#_bm3)
* [Add Data Model](https://devnet.logianalytics.com/hc/en-us/articles/12528277291287-Data-Model-APIs#_bm2)
* [Add Role](https://devnet.logianalytics.com/hc/en-us/articles/12528280786967-Role-APIs#_bm3)
...
1. Create a user with an associated role.
   1. Prepare an empty [UserDetail](https://devnet.logianalytics.com/hc/en-us/articles/12528298705815-UserDetail) object.
   2. Populate user details.
   3. Populate user role.
   4. Call [POST user](https://devnet.logianalytics.com/hc/en-us/articles/12528280909847-User-APIs#_bm3) API, and receive back the saved id.
2. Generate a [password link](https://devnet.logianalytics.com/hc/en-us/articles/12528224699927-Glossary#password_link) for the user.
   1. Prepares a [UserDetail](https://devnet.logianalytics.com/hc/en-us/articles/12528298705815-UserDetail) object as API input.
   2. Call [POST user/generatePasswordLink](https://devnet.logianalytics.com/hc/en-us/articles/12528280909847-User-APIs#_bm4) API, and receive back the hash value.
3. Save the password and security questions for user.
   ...
   4. Call [POST user/passwordAndSecurityQuestion](https://devnet.logianalytics.com/hc/en-us/articles/12528280909847-User-APIs#_bm5) API.
...
* `tenantId` with the actual tenant id   
  Get the list of tenants from [GET tenant/activeTenants](https://devnet.logianalytics.com/hc/en-us/articles/12528296396055-Tenant-APIs#_bm4)
* `roles` with the selected role id   
  Get the list of roles from [GET role/all/(tenant\_id)](https://devnet.logianalytics.com/hc/en-us/articles/12528280786967-Role-APIs#_bm4)
...
## Generate a [password link](https://devnet.logianalytics.com/hc/en-us/articles/12528224699927-Glossary#top) for the user

1. Prepare the input [UserDetail](https://devnet.logianalytics.com/hc/en-us/articles/12528298705815-UserDetail) object.
...
2. Call [POST user/generatePasswordLink](https://devnet.logianalytics.com/hc/en-us/articles/12528280909847-User-APIs#_bm6) API.
3. Receive back the [OperationResult](https://devnet.logianalytics.com/hc/en-us/articles/12528297472791-OperationResult) object
...
2. Call [POST user/passwordAndSecurityQuestion](https://devnet.logianalytics.com/hc/en-us/articles/12528280909847-User-APIs#_bm7) API.
   1. Check that the **success** field equals true.
