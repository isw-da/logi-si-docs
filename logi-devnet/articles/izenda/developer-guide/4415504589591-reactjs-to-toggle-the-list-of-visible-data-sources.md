...
category: "Izenda"
url: https://devnet.logianalytics.com/hc/en-us/articles/4415504589591-ReactJS-to-Toggle-the-List-of-Visible-Data-Sources
...
* We will use the [POST connection/loadRemoteSchema](https://devnet.logianalytics.com/hc/en-us/articles/4415504629911-Connection-APIs#_bm)
  and [POST connection](https://devnet.logianalytics.com/hc/en-us/articles/4415504629911-Connection-APIs#POST) APIs.

## Prerequisites

1. This sample is a continuation of [ReactJS to manage the list of categories](https://devnet.logianalytics.com/hc/en-us/articles/4415492662679-ReactJS-to-Manage-the-List-of-Categories).
...
[![../_images/Connection_Move_Data_Source_to_Visible_List.jpg](https://devnet.logianalytics.com/hc/article_attachments/4415504315671/connection_move_data_source_to_visible_list_611x292.jpg)](https://devnet.logianalytics.com/hc/article_attachments/4415511697559/connection_move_data_source_to_visible_list.jpg)
...
The response from the API is detailed in [POST connection/loadRemoteSchema](https://devnet.logianalytics.com/hc/en-us/articles/4415504629911-Connection-APIs#_bm2).
...
1. The inverse flow begins in QuerySourceItem where we bind the id of
   the query source to the callback function in SchemaItem.
2. In SchemaItem we bind the id of the schema to the callback function
   in App.
3. In App we use the id of the schema and the id of the query source to
