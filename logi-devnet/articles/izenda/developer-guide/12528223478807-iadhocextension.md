...
category: "Izenda"
url: https://devnet.logianalytics.com/hc/en-us/articles/12528223478807-IAdHocExtension
updated_at: 2023-02-23T15:16:36Z
---
...
| Load Custom Functions | [LoadCustomFunctions](#LoadCust) | Adds .NET implementation of Custom Functions which have been whitelisted in CustomFunctionFilePath |
...
See also: [Full-code Samples for all IAdHocExtension Methods](https://devnet.logianalytics.com/hc/en-us/articles/12528223064471-IAdHocExtension-Samples)
...
This method customizes the behavior of [POST report/loadFilterFieldDataAsTree](https://devnet.logianalytics.com/hc/en-us/articles/12528280091031-Report-Designer-Filters-APIs#POST) and [POST dashboard/loadFilterFieldDataAsTree](https://devnet.logianalytics.com/hc/en-us/articles/12528225753495-Dashboard-Designer-APIs#POST2) APIs.
...
This method customizes the behavior of [POST report/loadFilterFieldDataAsTree](https://devnet.logianalytics.com/hc/en-us/articles/12528280091031-Report-Designer-Filters-APIs#POST) and [POST dashboard/loadFilterFieldDataAsTree](https://devnet.logianalytics.com/hc/en-us/articles/12528225753495-Dashboard-Designer-APIs#POST) APIs.
...
![../_images/QueryTree_Sample.png](https://devnet.logianalytics.com/hc/article_attachments/12528147536663/querytree_sample.png)
...
* From v2.6.19, [DataFormat](https://devnet.logianalytics.com/hc/en-us/articles/12528296906519-DataFormat) object has 1 new field: JsFormatString
...
* New in v2.6.20, if JsFormatString does not contain braces {} that means the value of jsFormatString is the name of the funtion will be obtained in the FE to apply in the chart.   
  User must ensure to register the format function by using [Front-end integration API: addJsFormat(formatName, formatFunction)](https://devnet.logianalytics.com/hc/en-us/articles/12528207176215-Front-end-Integration-APIs#addJsFormat(formatName,_formatFunction)).
...
This method customizes the behavior of [GET systemSetting/themes](https://devnet.logianalytics.com/hc/en-us/articles/12528280822039-System-Configuration-APIs#get-systemsetting-themes) API.
...
| **ConnectorInfo** object |  | The [RESTConnectorInfo](https://devnet.logianalytics.com/hc/en-us/articles/12528298384023-RESTConnectorInfo) object |
| **EndpointInfo** object |  | The [RESTEndpointInfo](https://devnet.logianalytics.com/hc/en-us/articles/12528283037079-RESTEndpointInfo) object |
| **UserContext** object |  | The [UserContext.Current](https://devnet.logianalytics.com/hc/en-us/articles/12528298698263-UserContext) object contains data of the current logged in user |
| **ReportDefinition** object | Y | The [ReportDefinition](https://devnet.logianalytics.com/hc/en-us/articles/12528297929111-ReportDefinition) object |
...
This method loads the .NET implementation of Custom Functions which have been whitelisted using the CustomFunctionFilePath setting in the IzendaSystemSetting table. More information on CustomFunctionFilePath can be found here. This method and .NET implementation is required when using Custom Functions in a report based on two different databases and leveraging Izenda’s Fusion engine.

```
public virtual List<CustomFunction> LoadCustomFunctions()
{
return new List<CustomFunction>
{
new CustomFunction
{
...
The [UserContext.Current](https://devnet.logianalytics.com/hc/en-us/articles/12528298698263-UserContext) object contains data of the current logged in user, which can be leveraged in filters:
