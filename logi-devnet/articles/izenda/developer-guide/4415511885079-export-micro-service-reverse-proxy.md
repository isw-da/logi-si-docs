...
category: "Izenda"
url: https://devnet.logianalytics.com/hc/en-us/articles/4415511885079-Export-Micro-Service-Reverse-Proxy
...
Export micro service can also run on the same server as Izenda back-end application. For installation on same server, follow the steps mentioned here [Export Micro Service](https://devnet.logianalytics.com/hc/en-us/articles/4415504567191-Export-Micro-Service)
...
2. On successful completion of these commands, Export Service will start listening on specified port number.
   ...
   > [![../_images/service_started_linux.png](https://devnet.logianalytics.com/hc/article_attachments/4415511679767/service_started_linux_653x110.png)](https://devnet.logianalytics.com/hc/article_attachments/4415504295703/service_started_linux.png)
...
1. Login as root user and run following commands.
   ...
   4. Verify Apache installation by running localhost.
      ...
      [![../_images/Ubuntu_Stadnalone_Apache.png](https://devnet.logianalytics.com/hc/article_attachments/4415492409879/ubuntu_stadnalone_apache_653x523.png)](https://devnet.logianalytics.com/hc/article_attachments/4415511680791/ubuntu_stadnalone_apache.png)
...
2. On successful completion of these commands, Export Service will start listening on specified port number.
   ...
   > [![../_images/service_started_windows.png](https://devnet.logianalytics.com/hc/article_attachments/4415511680023/service_started_windows_653x102.png)](https://devnet.logianalytics.com/hc/article_attachments/4415492409367/service_started_windows.png)
...
7. Click Install.
   ...
   > ![../_images/web-installer.png](https://devnet.logianalytics.com/hc/article_attachments/4415511681175/web-installer_653x315.png)
...
9. Select a server node in the tree view on the left hand side and then click on the “Application Request Routing” feature.
   ...
   > [![../_images/arr.png](https://devnet.logianalytics.com/hc/article_attachments/4415511681431/arr_653x324.png)](https://devnet.logianalytics.com/hc/article_attachments/4415492410263/arr.png)
10. Check the “Enable Proxy” check box. Leave the default values for all the other settings on this page:
11. Select Apply.

    > [![../_images/enable-proxy.png](https://devnet.logianalytics.com/hc/article_attachments/4415511684631/enable-proxy_653x365.png)](https://devnet.logianalytics.com/hc/article_attachments/4415492410519/enable-proxy.png)
...
13. Click the ellipsis (…) button to select the location of the extracted Izenda export service containing the app.js file.
    ...
    > [![../_images/site.png](https://devnet.logianalytics.com/hc/article_attachments/4415504298263/site_653x582.png)](https://devnet.logianalytics.com/hc/article_attachments/4415504297111/site.png)
14. Select your website under sites in left side section. Now select “URL Rewrite” option.

    > [![../_images/url-rewrite.png](https://devnet.logianalytics.com/hc/article_attachments/4415511685527/url-rewrite_653x372.png)](https://devnet.logianalytics.com/hc/article_attachments/4415492410903/url-rewrite.png)
...
16. Now select Reverse Proxy under inbound and outbound section.
    ...
    > [![../_images/add-reverse-proxy.png](https://devnet.logianalytics.com/hc/article_attachments/4415504299287/add-reverse-proxy_653x439.png)](https://devnet.logianalytics.com/hc/article_attachments/4415492411159/add-reverse-proxy.png)
17. Add the server name or IP address with port under inbound rules input box. This is the URL of the export service running locally on the server.
    ...
    > [![../_images/add-url.png](https://devnet.logianalytics.com/hc/article_attachments/4415504299799/add-url_653x599.png)](https://devnet.logianalytics.com/hc/article_attachments/4415511685783/add-url.png)
...
3. Deployment Steps
   ...
   > > ```
   >
   > [![../_images/micro-services-export-micro-services.png](https://devnet.logianalytics.com/hc/article_attachments/4415511680535/micro-services-export-micro-services_1024x608.png)](https://devnet.logianalytics.com/hc/article_attachments/4415511680279/micro-services-export-micro-services.png)
