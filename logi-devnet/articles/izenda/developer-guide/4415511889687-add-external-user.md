...
category: "Izenda"
url: https://devnet.logianalytics.com/hc/en-us/articles/4415511889687-Add-External-User
...
* [Add Tenant](https://devnet.logianalytics.com/hc/en-us/articles/4415504677783-Tenant-APIs#_bm)
* [Add Data Model](https://devnet.logianalytics.com/hc/en-us/articles/4415504641943-Data-Model-APIs#_bm)
* [Add Role](https://devnet.logianalytics.com/hc/en-us/articles/4415492757911-Role-APIs#_bm)
...
* `tenantId` with the actual tenant id   
  Get the list of tenants from [GET tenant/activeTenants](https://devnet.logianalytics.com/hc/en-us/articles/4415504677783-Tenant-APIs#_bm2)
* `roles` with the selected role id   
  Get the list of roles from [GET role/all/(tenant\_id)](https://devnet.logianalytics.com/hc/en-us/articles/4415492757911-Role-APIs#_bm2)
...
Call either the [POST user/integration/saveUser](https://devnet.logianalytics.com/hc/en-us/articles/4415492760599-User-APIs#_bm) or [POST external/user](https://devnet.logianalytics.com/hc/en-us/articles/4415492760599-User-APIs#_bm2) endpoint using the UserDetail object.
