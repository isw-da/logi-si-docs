...
category: "Izenda"
url: https://devnet.logianalytics.com/hc/en-us/articles/4415492696343-Glossary
updated_at: 2021-12-10T03:08:04Z
---
...
Fusion
:   The Izenda database query engine, which leverages asynchronous querying in tandem with in memory query tree and map reduce technologies. This enables fast cross database querying and multi-step calculations. See [Izenda Fusion](https://devnet.logianalytics.com/hc/en-us/articles/4415511933719-Query-Performance#izenda-fusion).

gauge
:   A built-in type of report part that displays data using a speedometer.

global report
:   A system report saved in the special section “Global Categories”, accessible and runnable to tenants having [database mapping](#term-database-mapping) to the system connection. See [Global Report Setup Guide](https://devnet.logianalytics.com/hc/en-us/articles/4415512097943-Global-Report-Setup-Guide).

grid
:   A built-in type of report part that displays data in a tabular format

IAdHocExtension
:   A programming interface (abstract type) that defines the extension APIs that allows customization code to hook in the report life cycle. See [IAdHocExtension](https://devnet.logianalytics.com/hc/en-us/articles/4415504593303-IAdHocExtension).
...
system variable
:   A named place-holder that will be replaced by actual values while being used. See [Izenda System Variables](https://devnet.logianalytics.com/hc/en-us/articles/4415511976599-Izenda-System-Variables).

template
:   A pre-built report that serves as a medium to create quick ad-hoc reports. See [Using Templates](https://devnet.logianalytics.com/hc/en-us/articles/4415512112279-Using-Templates).
