...
category: "Izenda"
url: https://devnet.logianalytics.com/hc/en-us/articles/12528208081175-Upgrade-Guide
updated_at: 2023-02-23T14:34:24Z
---
...
If you are upgrading your environment to two or more versions newer than your current version, it is recommended that you utilize the [Schema Migration Assistant](https://tools.izenda.com/) to compile and download all necessary scripts for your upgrade. This tool allows you to specify your Current Version, Target Version, and Database Type. If the “Download as sql script” is checked, your compiled script will automatically be downloaded. If this option is unchecked, your compiled script will be displayed in your browser.

> ![../_images/schema_migration_assistant.png](https://devnet.logianalytics.com/hc/article_attachments/12528147857175/schema_migration_assistant.png)
...
1. Log in to the server with Izenda System Database using an administrator account.
2. Right-click the Izenda database then Tasks > Back Up…

   ![../_images/IzendaTest_Backup.png](https://devnet.logianalytics.com/hc/article_attachments/12528163848215/izendatest_backup_359x343.png)
3. In the pop-up, choose Backup type Full and Backup component Database.
...
5. Choose to back up to Disk and click Add.
   ...
   ![../_images/IzendaTest_Backup_Pop-up.png](https://devnet.logianalytics.com/hc/article_attachments/12528163854231/izendatest_backup_pop-up_518x469.png)
6. Select File name and click … button to select a path and file name.

   ![../_images/IzendaTest_Backup_Filename.png](https://devnet.logianalytics.com/hc/article_attachments/12528163868951/izendatest_backup_filename_299x92.png)
7. Click OK 3 times to run the backup.

   ![../_images/IzendaTest_Backup_Success.png](https://devnet.logianalytics.com/hc/article_attachments/12528147899159/izendatest_backup_success_455x94.png)
...
6. After all the scripts, re-run the query `selectVersionfromIzendaDBVersion` to verify the version.
