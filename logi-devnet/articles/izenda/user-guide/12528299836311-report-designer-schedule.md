...
section: "User Guide"
category: "Izenda"
url: https://devnet.logianalytics.com/hc/en-us/articles/12528299836311-Report-Designer-Schedule
updated_at: 2023-02-23T14:47:47Z
---
...
2. Summaries of existing schedules are listed together with delivery options.
3. Each schedule can be edited, copied or deleted using the icons in Action field.
4. New schedule can be added using the Add Schedule button above the list.

[![../_images/Report_Schedule_List.png](https://devnet.logianalytics.com/hc/article_attachments/12528220289175/report_schedule_list_950x177.png)](https://devnet.logianalytics.com/hc/article_attachments/12528204416663/report_schedule_list.png)
...
![../_images/Report_Schedule_Search.png](https://devnet.logianalytics.com/hc/article_attachments/12528204457239/report_schedule_search_348x161.png)
...
2. In Schedule tab:
   ...
   4. Enter the start time (some common values can be quickly selected from the pre-defined list).
   5. Select a common recurrence period from the list, or select Custom Recurrence to define a different one.

   [![../_images/Report_Add_Schedule_pop-up_Schedule.png](https://devnet.logianalytics.com/hc/article_attachments/12528220314647/report_add_schedule_pop-up_schedule_600x389.png)](https://devnet.logianalytics.com/hc/article_attachments/12528220299159/report_add_schedule_pop-up_schedule.png)
3. In Delivery tab, select:

   * “Email” Delivery Type: send the report to the email address of selected users.
     1. Select Delivery Method: email a **Link**, email an **Attachment**, or email with **Embedded HTML** body.
   ...
   * “File Location” Delivery Type: save the report as a file.
   ...
   [![../_images/Report_Add_Schedule_pop-up_Delivery.png](https://devnet.logianalytics.com/hc/article_attachments/12528204489623/report_add_schedule_pop-up_delivery_600x389.png)](https://devnet.logianalytics.com/hc/article_attachments/12528220324887/report_add_schedule_pop-up_delivery.png)
4. Optionally re-select values for report filters.

   [![../_images/Report_Add_Schedule_pop-up_Filter_Value_Selection.png](https://devnet.logianalytics.com/hc/article_attachments/12528220343575/report_add_schedule_pop-up_filter_value_selection_600x390.png)](https://devnet.logianalytics.com/hc/article_attachments/12528204495511/report_add_schedule_pop-up_filter_value_selection.png)
