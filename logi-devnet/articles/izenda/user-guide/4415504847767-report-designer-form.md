...
section: "User Guide"
category: "Izenda"
url: https://devnet.logianalytics.com/hc/en-us/articles/4415504847767-Report-Designer-Form
...
Form is a built-in type of report part that allows WYSIWYG editing in
HTML. User can:
...
[![../_images/Form_Properties_Sections.png](https://devnet.logianalytics.com/hc/article_attachments/4415504478231/form_properties_sections_218x393.png)](https://devnet.logianalytics.com/hc/article_attachments/4415511820183/form_properties_sections.png)
...
![../_images/Form_Border_Settings.png](https://devnet.logianalytics.com/hc/article_attachments/4415511820439/form_border_settings_458x339.png)
...
* Form border
  ...
  > [![../_images/Form_Border_Settings_No_Review.PNG](https://devnet.logianalytics.com/hc/article_attachments/4415492566423/form_border_settings_no_review_458x332.png)](https://devnet.logianalytics.com/hc/article_attachments/4415504478487/form_border_settings_no_review.png)
...
* Link
  ...
  ![../_images/Form_Insert_Link_Pop-up.png](https://devnet.logianalytics.com/hc/article_attachments/4415504479511/form_insert_link_pop-up_324x192.png)

  The link is displayed as ![Form Link Display.png](https://devnet.logianalytics.com/hc/article_attachments/4415492566807/form_link_display.png).
* Image

  ![../_images/Form_Insert_Image_Pop-up.png](https://devnet.logianalytics.com/hc/article_attachments/4415492567191/form_insert_image_pop-up_376x194.png)
* Anchor
* Special character
* Current date value
* Horizontal line
...
* Data Source Field
  ...
  ![../_images/Form_Insert_Field.png](https://devnet.logianalytics.com/hc/article_attachments/4415504480151/form_insert_field_454x189.png)
...
1. Click the Insert Table icon in Table section, then interactively select the number of columns and rows.
   ...
   ![../_images/Form_Table_Insert.png](https://devnet.logianalytics.com/hc/article_attachments/4415511820823/form_table_insert_180x211.png)
2. Click inside the table in Visual mode to see more icons in Table section, divided into Table, Cell,
   Row and Column groups.

   ![../_images/Form_Table_Properties_Icons.png](https://devnet.logianalytics.com/hc/article_attachments/4415511821207/form_table_properties_icons_250x213.png)
3. Configure table-wide settings in Table Properties pop-up.

   [![../_images/Form_Table_General_Properties.png](https://devnet.logianalytics.com/hc/article_attachments/4415504480535/form_table_general_properties_631x259.png)](https://devnet.logianalytics.com/hc/article_attachments/4415492567831/form_table_general_properties.png)

   [![../_images/Form_Table_Advanced_Properties.png](https://devnet.logianalytics.com/hc/article_attachments/4415504480791/form_table_advanced_properties_631x257.png)](https://devnet.logianalytics.com/hc/article_attachments/4415492568087/form_table_advanced_properties.png)
4. Configure each cell in Cell
   Properties pop-up.

   ![../_images/Form_Table_Cell_General_Properties.png](https://devnet.logianalytics.com/hc/article_attachments/4415504481047/form_table_cell_general_properties_552x222.png)

   ![../_images/Form_Table_Cell_Advanced_Properties.png](https://devnet.logianalytics.com/hc/article_attachments/4415504481303/form_table_cell_advanced_properties_555x222.png)
5. Configure each row in Row
   Properties pop-up.

   ![../_images/Form_Table_Row_Properties.png](https://devnet.logianalytics.com/hc/article_attachments/4415504481559/form_table_row_properties_228x206.png)
...
[![../_images/Form_Table_Floating_Toolbar.png](https://devnet.logianalytics.com/hc/article_attachments/4415492568599/form_table_floating_toolbar_236x64.png)](https://devnet.logianalytics.com/hc/article_attachments/4415504481815/form_table_floating_toolbar.png)
...
![../_images/Report_Form_Spell_Checker.png](https://devnet.logianalytics.com/hc/article_attachments/4415511821719/report_form_spell_checker_344x297.png)
...
* User can use the now visible HTML
  ...
  [![../_images/Report_Form_HTML_tab.png](https://devnet.logianalytics.com/hc/article_attachments/4415511821975/report_form_html_tab_697x278.png)](https://devnet.logianalytics.com/hc/article_attachments/4415492568983/report_form_html_tab.png)
...
[![../_images/Form_ShipCountry_Repeater_ShipCity_SumFreight_Preview.png](https://devnet.logianalytics.com/hc/article_attachments/4415492569239/form_shipcountry_repeater_shipcity_sumfreight_preview_205x249.png)](https://devnet.logianalytics.com/hc/article_attachments/4415511822231/form_shipcountry_repeater_shipcity_sumfreight_preview.png)
...
[![../_images/Form_ShipCountry_Repeater_ShipCity_SumFreight_Visual.png](https://devnet.logianalytics.com/hc/article_attachments/4415511822615/form_shipcountry_repeater_shipcity_sumfreight_visual_221x81.png)](https://devnet.logianalytics.com/hc/article_attachments/4415492572695/form_shipcountry_repeater_shipcity_sumfreight_visual.png)
...
5. Switch to HTML view to easily enter `<repeater>` and `</repeater>` tags in correct position.
   ...
   [![../_images/Form_ShipCountry_Repeater_ShipCity_SumFreight_HTML.png](https://devnet.logianalytics.com/hc/article_attachments/4415492573719/form_shipcountry_repeater_shipcity_sumfreight_html_923x298.png)](https://devnet.logianalytics.com/hc/article_attachments/4415492573463/form_shipcountry_repeater_shipcity_sumfreight_html.png)

From version 2.12.0, Izenda supports the form report part containing subtotal inside repeater(s).

For example:

> ![../_images/Form_Subtotal_Inside_Repeater_Designer.png](https://devnet.logianalytics.com/hc/article_attachments/4415492573975/form_subtotal_inside_repeater_designer.png)
>
> ![../_images/Form_Subtotal_Inside_Repeater_View.png](https://devnet.logianalytics.com/hc/article_attachments/4415504482839/form_subtotal_inside_repeater_view.png)
