...
section: "User Guide"
category: "Izenda"
url: https://devnet.logianalytics.com/hc/en-us/articles/4415504844823-Report-Designer-Access
...
1. Open an existing report if not
   already open.
2. Click Access in the left menu.
3. Report’s current sharings will be listed, showing the people being
   shared with and the access rights.

   [![../_images/Report_Designer_Access.png](https://devnet.logianalytics.com/hc/article_attachments/4415492525207/report_designer_access.png)](https://devnet.logianalytics.com/hc/article_attachments/4415492525207/report_designer_access.png)
...
1. Click the Add Sharing button above the list to add a new row in the
   list:
...
3. Select the specific Tenant, Role or User (not applied for Everyone option).
   ...
   * For Tenant, click the plus icon to open Select Tenant pop-up.
     ...
     [![../_images/Access_Rights_Tenants.png](https://devnet.logianalytics.com/hc/article_attachments/4415492525463/access_rights_tenants.png)](https://devnet.logianalytics.com/hc/article_attachments/4415492525463/access_rights_tenants.png)
   ...
   * For Role, click the plus icon to open All Roles pop-up.
     ...
     [![../_images/Access_Rights_Roles.png](https://devnet.logianalytics.com/hc/article_attachments/4415504434711/access_rights_roles.png)](https://devnet.logianalytics.com/hc/article_attachments/4415504434711/access_rights_roles.png)

     1. Type a partial name into the search box and click the search
        icon (🔍).
   ...
   * For User, click the plus icon to open All User pop-up.
     ...
     [![../_images/Access_Rights_Users.png](https://devnet.logianalytics.com/hc/article_attachments/4415504434967/access_rights_users.png)](https://devnet.logianalytics.com/hc/article_attachments/4415504434967/access_rights_users.png)

     1. Select either User Name, Email Address or Role to search for.
        Select All to search for all fields.
     2. Type a partial name into the search box and click the search
        icon (🔍).
     3. Only matching users will be displayed.
     4. Select one or more users then click OK to close the pop-up.
4. Select an Access Right (See details in List of Access Rights table
   below).
...
2. Select either User Name, Email Address or Role to search for. Select
...
6. Click Save button at the top to save the report together with the
   owner.
