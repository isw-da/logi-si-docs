...
section: "User Guide"
category: "Izenda"
url: https://devnet.logianalytics.com/hc/en-us/articles/12528299472663-Dashboard-Designer
updated_at: 2023-02-23T15:04:32Z
---
...
2. Select a preset layout from the pop-up.
   ...
   >
   > [![../_images/Dashboard_Add_Icon_and_Preset_Layout.png](https://devnet.logianalytics.com/hc/article_attachments/12528166291607/dashboard_add_icon_and_preset_layout_635x344.png)](https://devnet.logianalytics.com/hc/article_attachments/12528166260759/dashboard_add_icon_and_preset_layout.png)
3. Select to either create a “text” dashboard tile or include an existing report part in each one.

   [![../_images/Dashboard_Tiles_Report_Part_or_Text.png](https://devnet.logianalytics.com/hc/article_attachments/12528150233879/dashboard_tiles_report_part_or_text_600x200.png)](https://devnet.logianalytics.com/hc/article_attachments/12528166300311/dashboard_tiles_report_part_or_text.png)
4. For a “text” dashboard tile, click the Configuration mode (page flip) icon to input the content.

   [![../_images/Text_Dashboard_Tile.png](https://devnet.logianalytics.com/hc/article_attachments/12528150247959/text_dashboard_tile_600x228.png)](https://devnet.logianalytics.com/hc/article_attachments/12528166318231/text_dashboard_tile.png)
...
5. For existing report part option, use the Report Part Selection pop-up to search and use an existing report part:
   ...
   [![../_images/Dashboard_Report_Part_Selection.png](https://devnet.logianalytics.com/hc/article_attachments/12528166330519/dashboard_report_part_selection_600x220.png)](https://devnet.logianalytics.com/hc/article_attachments/12528150263191/dashboard_report_part_selection.png)
...
[![../_images/Dashboard_Sample.png](https://devnet.logianalytics.com/hc/article_attachments/12528166339607/dashboard_sample_767x332.png)](https://devnet.logianalytics.com/hc/article_attachments/12528150273047/dashboard_sample.png)
...
![../_images/Dashboard_Tile_Title_Bar.png](https://devnet.logianalytics.com/hc/article_attachments/12528166342679/dashboard_tile_title_bar_405x43.png)

## Edit Dashboard

[![../_images/Dashboard_Edit_Menu.png](https://devnet.logianalytics.com/hc/article_attachments/12528150316311/dashboard_edit_menu_182x157.png)](https://devnet.logianalytics.com/hc/article_attachments/12528150309399/dashboard_edit_menu.png)
...
* Copy or Move dashboard, this is similar to Report ([Copy a Report](https://devnet.logianalytics.com/hc/en-us/articles/12528299853335-Report-List#copy-a-report) and [Move a Report](https://devnet.logianalytics.com/hc/en-us/articles/12528299853335-Report-List#move-a-report)).
...
> [![../_images/Dashboard_Presentation_Mode.png](https://devnet.logianalytics.com/hc/article_attachments/12528166374039/dashboard_presentation_mode_600x377.png)](https://devnet.logianalytics.com/hc/article_attachments/12528150321559/dashboard_presentation_mode.png)
...
[![../_images/Dashboard_Sharing_Access.png](https://devnet.logianalytics.com/hc/article_attachments/12528166408471/dashboard_sharing_access_600x166.png)](https://devnet.logianalytics.com/hc/article_attachments/12528150331927/dashboard_sharing_access.png)
...
2. Dashboard Subscription is similar to [Report List](https://devnet.logianalytics.com/hc/en-us/articles/12528299853335-Report-List#add-report-subscriptions-for-current-user).
...
2. Dashboard Schedule is similar to [Report Schedule](https://devnet.logianalytics.com/hc/en-us/articles/12528299836311-Report-Designer-Schedule).
...
2. Select print options in the left menu while the print preview is reflected on the right:
   ...
   * Select a paper size.
     ...
     ![../_images/Dashboard_Print_Options.png](https://devnet.logianalytics.com/hc/article_attachments/12528150353047/dashboard_print_options_233x608.png)
   * Select a margin option. In Custom mode, the margins in preview pane can be resized interactively.

     ![../_images/Dashboard_Print_Custom_Margins.png](https://devnet.logianalytics.com/hc/article_attachments/12528150360343/dashboard_print_custom_margins_500x211.png)
...
3. For more advanced options, click the link Print using system dialog… to use the system Print dialog.
