...
section: "User Guide"
category: "Izenda"
url: https://devnet.logianalytics.com/hc/en-us/articles/12528299998231-Natural-Language-Query
updated_at: 2023-02-23T15:05:41Z
---
...
> [![../_images/nlq_connectors.png](https://devnet.logianalytics.com/hc/article_attachments/12528221587095/nlq_connectors_1404x594.png)](https://devnet.logianalytics.com/hc/article_attachments/12528221581719/nlq_connectors.png)
...
* **Synonyms:** Izenda’s NLQ engine will save hours of your effort to add tags and keywords to column names. When you type a keyword which is not a part of the data model, the synonyms of the column names will be automatically recognized by Izenda’s model. The engine will pick the matching columns from the data model and help you build your query.
  ...
  > [![../_images/nlq_synonyms.gif](https://devnet.logianalytics.com/hc/article_attachments/12528205705495/nlq_synonyms_1404x601.gif)](https://devnet.logianalytics.com/hc/article_attachments/12528205687831/nlq_synonyms.gif)
...
* **Relationships:** Izenda’s NLQ engine identifies relationships in the DB and intelligently suggests columns from the related data sources. When you type a keyword which matches a column in another table with which relationship exists, the engine will suggest and help you build your query.
  ...
  > [![../_images/nlq_relationships.gif](https://devnet.logianalytics.com/hc/article_attachments/12528221631511/nlq_relationships_1404x599.gif)](https://devnet.logianalytics.com/hc/article_attachments/12528221620503/nlq_relationships.gif)
...
* **Column Values**: Izenda’s NLQ engine indexes the data connectors and helps in suggesting column values. When you type keywords ‘IS’ or ‘LIKE’, the engine will auto-populate values to easily select from.
  ...
  > [![../_images/nlq_value_suggestion.gif](https://devnet.logianalytics.com/hc/article_attachments/12528205756951/nlq_value_suggestion_1404x599.gif)](https://devnet.logianalytics.com/hc/article_attachments/12528221677207/nlq_value_suggestion.gif)
...
> [![../_images/nlq_grid_Enhancements.gif](https://devnet.logianalytics.com/hc/article_attachments/12528221707031/nlq_grid_enhancements_1404x562.gif)](https://devnet.logianalytics.com/hc/article_attachments/12528205763223/nlq_grid_enhancements.gif)
