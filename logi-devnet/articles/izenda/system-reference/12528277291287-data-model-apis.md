...
category: "Izenda"
url: https://devnet.logianalytics.com/hc/en-us/articles/12528277291287-Data-Model-APIs
updated_at: 2023-02-23T15:59:01Z
---
...
| [POST dataModel/connectionsInfo](#post-datamodel-connectionsinfo) | Returns an array of [Connection](https://devnet.logianalytics.com/hc/en-us/articles/12528281159575-Connection) objects. |
| [GET dataModel/basicQuerySourceCategoriesInfo/{connection\_id}](#get-datamodel-basicquerysourcecategoriesinfo-connection-id) | Returns an array of the [query source categories](https://devnet.logianalytics.com/hc/en-us/articles/12528224699927-Glossary#term-query-source-category) in the specified connection.  New in version 2.0.3. |
| [`POST dataModel/basicQuerySourceCategoriesInfo`\_](#id4) | Returns an array of the [query source categories](https://devnet.logianalytics.com/hc/en-us/articles/12528224699927-Glossary#term-query-source-category) with paging in the specified connection.  New in version 2.4.0. |
...
> Payload: a [QuerySourcePagedRequest](https://devnet.logianalytics.com/hc/en-us/articles/12528297670039-QuerySourcePagedRequest) object
>
> Note
>
...
> A [PagedResult](https://devnet.logianalytics.com/hc/en-us/articles/12528282006423-PagedResult) object, with **result** field containing an array of [QuerySource](https://devnet.logianalytics.com/hc/en-us/articles/12528297595799-QuerySource) objects
...
> Payload: a [QuerySourceFieldPagedRequest](https://devnet.logianalytics.com/hc/en-us/articles/12528282136855-QuerySourceFieldPagedRequest) object
>
> Note
>
> The keys for [SearchCriteria](https://devnet.logianalytics.com/hc/en-us/articles/12528283106455-SearchCriteria) that this API support:   
...
> A [PagedResult](https://devnet.logianalytics.com/hc/en-us/articles/12528282006423-PagedResult) object, with **result** field containing an array of [QuerySourceField](https://devnet.logianalytics.com/hc/en-us/articles/12528282117399-QuerySourceField) objects
...
The same as [GET connection/basicInfo/(tenant\_id)](https://devnet.logianalytics.com/hc/en-us/articles/12528209065239-Connection-APIs#get-connection-basicinfo-tenant-id)
...
> An array of [Item](https://devnet.logianalytics.com/hc/en-us/articles/12528297391895-Item) objects with:
>
...
> Payload: a [PagedRequest](https://devnet.logianalytics.com/hc/en-us/articles/12528297501463-PagedRequest) object.
>
> Note
>
> The keys for [SearchCriteria](https://devnet.logianalytics.com/hc/en-us/articles/12528283106455-SearchCriteria) that this API support:   
...
> A [PagedResult](https://devnet.logianalytics.com/hc/en-us/articles/12528282006423-PagedResult) object with **result** field containing a list of [Item](https://devnet.logianalytics.com/hc/en-us/articles/12528297391895-Item) objects whose each **key** is the connectionsId and **value** is the connectionName.
...
Returns an array of [Connection](https://devnet.logianalytics.com/hc/en-us/articles/12528281159575-Connection) objects.
...
> A [PagedResult](https://devnet.logianalytics.com/hc/en-us/articles/12528282006423-PagedResult) object with **result** field containing a list of [Connection](https://devnet.logianalytics.com/hc/en-us/articles/12528281159575-Connection) objects.
...
Returns an array of the [query source categories](https://devnet.logianalytics.com/hc/en-us/articles/12528224699927-Glossary#term-query-source-category) in the specified connection.
...
> An array of [Item](https://devnet.logianalytics.com/hc/en-us/articles/12528297391895-Item) objects with:
>
> > - **key** is the id of the [QuerySourceCategory](https://devnet.logianalytics.com/hc/en-us/articles/12528282094359-QuerySourceCategory)  
> > - **value** is the name of the [QuerySourceCategory](https://devnet.logianalytics.com/hc/en-us/articles/12528282094359-QuerySourceCategory)
...
Returns an array of the [query source categories](https://devnet.logianalytics.com/hc/en-us/articles/12528224699927-Glossary#term-query-source-category) with paging.

New in version 2.4.0.

**Request**

> Payload: a [QuerySourceCategoryPagedRequest](https://devnet.logianalytics.com/hc/en-us/articles/12528282108439-QuerySourceCategoryPagedRequest) object.
>
> Note
>
> The keys for [SearchCriteria](https://devnet.logianalytics.com/hc/en-us/articles/12528283106455-SearchCriteria) that this API support:   
...
> A [PagedResult](https://devnet.logianalytics.com/hc/en-us/articles/12528282006423-PagedResult) object with **result** field containing a list of [Item](https://devnet.logianalytics.com/hc/en-us/articles/12528297391895-Item) objects whose each **key** is the id of the [QuerySourceCategory](https://devnet.logianalytics.com/hc/en-us/articles/12528282094359-QuerySourceCategory) and **value** is the name of the the [QuerySourceCategory](https://devnet.logianalytics.com/hc/en-us/articles/12528282094359-QuerySourceCategory).
...
> An array of [Item](https://devnet.logianalytics.com/hc/en-us/articles/12528297391895-Item) objects with:
>
> > - **key** is the id of the [QuerySource](https://devnet.logianalytics.com/hc/en-us/articles/12528297595799-QuerySource)  
> > - **value** is the name of the [QuerySource](https://devnet.logianalytics.com/hc/en-us/articles/12528297595799-QuerySource)
...
> An array of [QuerySourceInfo](https://devnet.logianalytics.com/hc/en-us/articles/12528282182807-QuerySourceInfo) objects
...
> An array of [Item](https://devnet.logianalytics.com/hc/en-us/articles/12528297391895-Item) objects with:
>
> > - **key** is the id of the [QuerySourceField](https://devnet.logianalytics.com/hc/en-us/articles/12528282117399-QuerySourceField)  
> > - **value** if the name of the [QuerySourceField](https://devnet.logianalytics.com/hc/en-us/articles/12528282117399-QuerySourceField)
...
> Payload: a [DataModel](https://devnet.logianalytics.com/hc/en-us/articles/12528296931095-DataModel) object
...
> Payload: a [ReloadQuerySourceRequest](https://devnet.logianalytics.com/hc/en-us/articles/12528282278167-ReloadQuerySourceRequest) object
>
> Note
>
> The keys for [SortOrder](https://devnet.logianalytics.com/hc/en-us/articles/12528298506903-SortOrder) that this API support:   
> - ColumnName   
> - ColumnAlias

**Response**

> A [DataResult](https://devnet.logianalytics.com/hc/en-us/articles/12528281473943-DataResult) object, with **data** field containing a [PagedResult](https://devnet.logianalytics.com/hc/en-us/articles/12528282006423-PagedResult) object whose **result** field containing a list of [QuerySourceField](https://devnet.logianalytics.com/hc/en-us/articles/12528282117399-QuerySourceField) objects
...
> Payload: a [QuerySourceField](https://devnet.logianalytics.com/hc/en-us/articles/12528282117399-QuerySourceField) object
...
> A [CalculatedFieldFunctionParam](https://devnet.logianalytics.com/hc/en-us/articles/12528296616983-CalculatedFieldFunctionParam) object.
...
> A [PagedResult](https://devnet.logianalytics.com/hc/en-us/articles/12528282006423-PagedResult) object with **result** field containing an array of [Relationship](https://devnet.logianalytics.com/hc/en-us/articles/12528282213015-Relationship) objects
...
> Payload: an array of [Relationship](https://devnet.logianalytics.com/hc/en-us/articles/12528282213015-Relationship) objects
...
> An [OperationResult](https://devnet.logianalytics.com/hc/en-us/articles/12528297472791-OperationResult) object with **success** field true if deletion is successful
...
> A [DataModelSchema](https://devnet.logianalytics.com/hc/en-us/articles/12528296946839-DataModelSchema) object
...
> A [ConnectionColor](https://devnet.logianalytics.com/hc/en-us/articles/12528296713623-ConnectionColor) object.
...
> An array of [GlobalDatabaseMapping](https://devnet.logianalytics.com/hc/en-us/articles/12528281761431-GlobalDatabaseMapping) objects
...
> A [DatabaseMappingPagedRequest](https://devnet.logianalytics.com/hc/en-us/articles/12528296881175-DatabaseMappingPagedRequest) object
>
> **Notes:** Key for [SearchCriteria](https://devnet.logianalytics.com/hc/en-us/articles/12528283106455-SearchCriteria) support to search: “databaseName”

**Response**

> A [PagedResult](https://devnet.logianalytics.com/hc/en-us/articles/12528282006423-PagedResult) object, with **result** field containing an array of the following object:
>
...
> A [PagedResult](https://devnet.logianalytics.com/hc/en-us/articles/12528282006423-PagedResult) object, with **result** field containing an array of strings.
>
> If [DatabaseMappingPagedRequest](https://devnet.logianalytics.com/hc/en-us/articles/12528296881175-DatabaseMappingPagedRequest).``type`` is `2` (Database), return connection names, else return schema names.
>
> **Notes:** Key for [SearchCriteria](https://devnet.logianalytics.com/hc/en-us/articles/12528283106455-SearchCriteria) support to search: “objectName”
...
> A [QuerySource](https://devnet.logianalytics.com/hc/en-us/articles/12528297595799-QuerySource) object

**Response**

> The saved [QuerySource](https://devnet.logianalytics.com/hc/en-us/articles/12528297595799-QuerySource) object.
...
> A [QuerySource](https://devnet.logianalytics.com/hc/en-us/articles/12528297595799-QuerySource) object, with **name** and **categoryId** fields populated.

**Response**

> An [OperationResult](https://devnet.logianalytics.com/hc/en-us/articles/12528297472791-OperationResult) object, with **success** field true if View Name is unique and other custom view contents are valid.
...
> A [QuerySource](https://devnet.logianalytics.com/hc/en-us/articles/12528297595799-QuerySource) object, with **id** field populated.

**Response**

> An [OperationResult](https://devnet.logianalytics.com/hc/en-us/articles/12528297472791-OperationResult) object, with **success** true if the deletion is successful.
...
> An array of [Relationship](https://devnet.logianalytics.com/hc/en-us/articles/12528282213015-Relationship) object.
