...
category: "Izenda"
url: https://devnet.logianalytics.com/hc/en-us/articles/4415492699927-Copy-Console-APIs
...
[![../_images/Copy_Console_API_Workflow.png](https://devnet.logianalytics.com/hc/article_attachments/4415492448919/copy_console_api_workflow_428x635.png)](https://devnet.logianalytics.com/hc/article_attachments/4415492448663/copy_console_api_workflow.png)
...
> Payload: an [InputWorkspace](https://devnet.logianalytics.com/hc/en-us/articles/4415512012439-InputWorkspace) object with **sourceTenantId**, **reportIds**, **templateIds** and **dashboardIds** fields populated

**Response**

> An [InputWorkspace](https://devnet.logianalytics.com/hc/en-us/articles/4415512012439-InputWorkspace) object with **dataInSource** field populated
...
> Payload: an [InputWorkspace](https://devnet.logianalytics.com/hc/en-us/articles/4415512012439-InputWorkspace) object with **dataInSource** field populated
...
> Payload: an [InputWorkspace](https://devnet.logianalytics.com/hc/en-us/articles/4415512012439-InputWorkspace) object
...
> Payload: an array of [DestinationTenant](https://devnet.logianalytics.com/hc/en-us/articles/4415504719255-DestinationTenant) objects
...
> A [WorkspaceDetailConsole](https://devnet.logianalytics.com/hc/en-us/articles/4415492905111-WorkspaceDetailConsole) object with **reportDefinition**, **sourceTenantConnections**, **dataSourceConnections**, **sourceRoles** and **sourceUserPermissions** fields populated
...
> Payload: a [WorkspaceDetailConsole](https://devnet.logianalytics.com/hc/en-us/articles/4415492905111-WorkspaceDetailConsole) object, which has been fully-populated from [POST copyManagement/console/loadreport](#post-copymanagement-console-loadreport)

**Response**

> An array of [CopyStatus](https://devnet.logianalytics.com/hc/en-us/articles/4415492777879-CopyStatus) objects
...
> Payload: an [UpdateSubReportInput](https://devnet.logianalytics.com/hc/en-us/articles/4415504802711-UpdateSubReportInput) object, with **copyStatus** field populated from the result of [POST copyManagement/console/copyreport](#post-copymanagement-console-copyreport)

**Response**

> An array of [UpdateSubReportStatus](https://devnet.logianalytics.com/hc/en-us/articles/4415504803735-UpdateSubReportStatus) objects
...
> Payload: a [LoadDashboard](https://devnet.logianalytics.com/hc/en-us/articles/4415492822935-LoadDashboard) object

**Response**

> A [WorkspaceDetailConsole](https://devnet.logianalytics.com/hc/en-us/articles/4415492905111-WorkspaceDetailConsole) object with **dashBoardDefinition**, **sourceReports**, **reportDefinitions**, **sourceRoles** and **sourceUserPermissions** fields populated
...
> Payload: a fully-populated [WorkspaceDetailConsole](https://devnet.logianalytics.com/hc/en-us/articles/4415492905111-WorkspaceDetailConsole) object
...
> Payload: an array of [ReportKey](https://devnet.logianalytics.com/hc/en-us/articles/4415512035863-ReportKey) objects

**Response**

> An array of [ReportDefinition](https://devnet.logianalytics.com/hc/en-us/articles/4415492852759-ReportDefinition) objects
