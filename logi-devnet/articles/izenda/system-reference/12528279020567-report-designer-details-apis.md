...
category: "Izenda"
url: https://devnet.logianalytics.com/hc/en-us/articles/12528279020567-Report-Designer-Details-APIs
updated_at: 2023-02-23T16:01:25Z
---
...
| [POST report/search2](#post-report-search2) | Searches for reports, with total number of items. | Not used, replaced by [POST report/list2(?includeHashCode=true)](https://devnet.logianalytics.com/hc/en-us/articles/12528296283287-Report-List-APIs#post-report-list2) |
| [POST report/advancedSearch](#post-report-advancedsearch) | Searches for reports with advanced options. | Not used, replaced by [POST report/list2(?includeHashCode=true)](https://devnet.logianalytics.com/hc/en-us/articles/12528296283287-Report-List-APIs#post-report-list2) |
...
> Payload: a [ReportDashboardSearchCriteria](https://devnet.logianalytics.com/hc/en-us/articles/12528297833495-ReportDashboardSearchCriteria) object
...
> > | --- | --- | --- |
> > | **data** array of objects | An array of [Category](https://devnet.logianalytics.com/hc/en-us/articles/12528296623255-Category) objects |  |
...
> A [Category](https://devnet.logianalytics.com/hc/en-us/articles/12528296623255-Category) object
...
> An [OperationResult](https://devnet.logianalytics.com/hc/en-us/articles/12528297472791-OperationResult) object with the **success** field populated:
>
> | Field | Description | Note |
> | --- | --- | --- |
> | **success**  boolean | Is the rename successful |  |
...
> Payload: a [Category](https://devnet.logianalytics.com/hc/en-us/articles/12528296623255-Category) object
...
> A [ReportDefinition](https://devnet.logianalytics.com/hc/en-us/articles/12528297929111-ReportDefinition) object
...
> A [ReportSavingResult](https://devnet.logianalytics.com/hc/en-us/articles/12528282949143-ReportSavingResult) object
...
[![../_images/POST_report_properties_not_match.png](https://devnet.logianalytics.com/hc/article_attachments/12528148338711/post_report_properties_not_match.png)](https://devnet.logianalytics.com/hc/article_attachments/12528148338711/post_report_properties_not_match.png)
...
> An [OperationResult](https://devnet.logianalytics.com/hc/en-us/articles/12528297472791-OperationResult) object
...
> A [ReportSavingParameter](https://devnet.logianalytics.com/hc/en-us/articles/12528282939799-ReportSavingParameter) object, with the **report** field fully populated
...
> Payload: a [ReportDefinition](https://devnet.logianalytics.com/hc/en-us/articles/12528297929111-ReportDefinition) object, with **name**, **type**, **category** and **subCategory** fields populated.

**Response**

> A [OperationResult](https://devnet.logianalytics.com/hc/en-us/articles/12528297472791-OperationResult) object, with **success** field means whether the report name is unique (in the specified category and sub-category)
...
> An [OperationResult](https://devnet.logianalytics.com/hc/en-us/articles/12528297472791-OperationResult) object, with **success** field means whether the validation is successful
...
> Payload: a [ReportPagedRequest](https://devnet.logianalytics.com/hc/en-us/articles/12528282653207-ReportPagedRequest) object
>
> Note
>
...
> A [PagedResult](https://devnet.logianalytics.com/hc/en-us/articles/12528282006423-PagedResult) object, with **result** field containing an array of [ReportDefinition](https://devnet.logianalytics.com/hc/en-us/articles/12528297929111-ReportDefinition) objects
...
> Payload: a [ReportSavingParameter](https://devnet.logianalytics.com/hc/en-us/articles/12528282939799-ReportSavingParameter) object, with **section** field specifies where to detect changes
>
> > * 0 = All
> > * 1 = DataSource
> > * 2 = Fields
...
> An [OperationResult](https://devnet.logianalytics.com/hc/en-us/articles/12528297472791-OperationResult) object, with **success** field means whether the report is up to date, without physical changes, and valid
...
> An array of [ReportFunction](https://devnet.logianalytics.com/hc/en-us/articles/12528282598295-ReportFunction) objects
...
> | **filterFields** array of objects | R | An array of [ReportFilterField](https://devnet.logianalytics.com/hc/en-us/articles/12528297961495-ReportFilterField) objects |  |
...
> Payload: an [AccessPagedRequest](https://devnet.logianalytics.com/hc/en-us/articles/12528296582167-AccessPagedRequest) object

**Response**

> A [PagedResult](https://devnet.logianalytics.com/hc/en-us/articles/12528282006423-PagedResult) object, with **result** field containing an array of [UserPermission](https://devnet.logianalytics.com/hc/en-us/articles/12528298721047-UserPermission) objects
...
> Payload: an [SubscriptionPagedRequest](https://devnet.logianalytics.com/hc/en-us/articles/12528283218839-SubscriptionPagedRequest) object
>
> Note
>
> The keys for [SearchCriteria](https://devnet.logianalytics.com/hc/en-us/articles/12528283106455-SearchCriteria) that this API support:   
...
> A [PagedResult](https://devnet.logianalytics.com/hc/en-us/articles/12528282006423-PagedResult) object, with **result** field containing an array of [Subscription](https://devnet.logianalytics.com/hc/en-us/articles/12528298529687-Subscription) objects
...
> A [ReportPartDefinition](https://devnet.logianalytics.com/hc/en-us/articles/12528298143639-ReportPartDefinition) object.
...
> Payload: a [ReportValidation](https://devnet.logianalytics.com/hc/en-us/articles/12528298376215-ReportValidation) object.

**Response**

> An [OperationResult](https://devnet.logianalytics.com/hc/en-us/articles/12528297472791-OperationResult) object with the **data** field populated:
>
...
> An [OperationResult](https://devnet.logianalytics.com/hc/en-us/articles/12528297472791-OperationResult) object with **data** field populated with the id of the report if found.
...
> An [OperationResult](https://devnet.logianalytics.com/hc/en-us/articles/12528297472791-OperationResult) object with **data** field populated
>
...
> An array of [ReportPartDefinition](https://devnet.logianalytics.com/hc/en-us/articles/12528298143639-ReportPartDefinition) objects.
...
> Payload: a [ReportDefinition](https://devnet.logianalytics.com/hc/en-us/articles/12528297929111-ReportDefinition) object.
...
> An array of [OperationResult](https://devnet.logianalytics.com/hc/en-us/articles/12528297472791-OperationResult) objects, with **success** field true if that report is valid.
...
> A list of [ReportDefinition](https://devnet.logianalytics.com/hc/en-us/articles/12528297929111-ReportDefinition) objects.
...
> A list of [ReportPartDefinition](https://devnet.logianalytics.com/hc/en-us/articles/12528298143639-ReportPartDefinition) objects.
