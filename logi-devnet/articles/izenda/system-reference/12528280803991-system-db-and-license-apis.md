...
category: "Izenda"
url: https://devnet.logianalytics.com/hc/en-us/articles/12528280803991-System-DB-and-License-APIs
updated_at: 2023-02-23T15:58:35Z
---
...
| --- | --- | --- |
| [GET databaseSetup/supportedDatabaseType](#id1) | Returns an array of database server types currently supported for installation.  See also: [GET dataAdaptor](https://devnet.logianalytics.com/hc/en-us/articles/12528209065239-Connection-APIs#get-dataadaptor) | Settings > System DB & License > populate Data Server Type box |
| [POST databaseSetup/testConnection](#id2) | Tests the database connection and license validity if existing.  See also: [POST connection/verify](https://devnet.logianalytics.com/hc/en-us/articles/12528209065239-Connection-APIs#post-connection-verify) | Settings > System DB & License > Connect |
...
> An array of [DatabaseType](https://devnet.logianalytics.com/hc/en-us/articles/12528296888215-DatabaseType) objects
...
> Payload: a [DBSetupInfo](https://devnet.logianalytics.com/hc/en-us/articles/12528297063447-DBSetupInfo) object

**Response**

> A [ConnectionVerificationResult](https://devnet.logianalytics.com/hc/en-us/articles/12528296727575-ConnectionVerificationResult) object
...
> A [DBSetupInfo](https://devnet.logianalytics.com/hc/en-us/articles/12528297063447-DBSetupInfo) object
...
> An [OperationResult](https://devnet.logianalytics.com/hc/en-us/articles/12528297472791-OperationResult) object with **success** field true if the setup is successful
...
> An array of [City](https://devnet.logianalytics.com/hc/en-us/articles/12528296656023-City) objects
...
> An array of [PostCode](https://devnet.logianalytics.com/hc/en-us/articles/12528282065303-PostCode) objects
...
> A [LicenseStatusResult](https://devnet.logianalytics.com/hc/en-us/articles/12528297421079-LicenseStatusResult) object
...
> A [ValidateTokenResult](https://devnet.logianalytics.com/hc/en-us/articles/12528298784151-ValidateTokenResult) object
...
> Payload: a [TokenRequest](https://devnet.logianalytics.com/hc/en-us/articles/12528283310743-TokenRequest) object
