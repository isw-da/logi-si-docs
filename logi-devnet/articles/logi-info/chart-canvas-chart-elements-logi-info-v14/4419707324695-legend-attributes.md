...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4419707324695-Legend-Attributes
updated_at: 2022-07-17T02:09:14Z
---
...
| Background Color | Sets the legend background color. Enter a color by name, decimal RGB value, or hex RGB value. Prefix hex values with the pound sign, e.g. *#112233*.  New for 14.1 Or, enter the token @Gradient to use a gradient fill to represent the data. |
...
| Border Color | Sets the legend border line color. Enter a color by name, decimal RGB value, or hex RGB value. Prefix hex values with the pound sign, e.g. *#112233*.  New for 14.1 Or, enter the token @Gradient to use a gradient fill to represent the data. |
