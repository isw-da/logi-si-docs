---
title: "Series.Spline - Attributes"
id: 4419715139607
section: "Chart Canvas Chart Elements - Logi Info v14"
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4419715139607-Series-Spline-Attributes
updated_at: 2022-07-17T02:08:53Z
---

# Series.Spline - Attributes
...
| Color | Sets the line color. Enter a color by name, decimal RGB value, or hex RGB value. Prefix hex values with the pound sign, e.g. #112233. @Chart tokens may be used here to provide dynamic, data-driven line segment colors. New for 14.1 For example, the token @Gradient can be used to represent the data with a gradient fill. |
