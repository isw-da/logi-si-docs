...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4419715487383-Thinkspace-Grouping-Rows
updated_at: 2022-07-17T01:37:14Z
---
...
![](https://devnet.logianalytics.com/hc/article_attachments/4419699907735/dm30_workcols_18.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/4419714901143/dm30_workcols_19.png)
...
* *Automatic* - The "best fit" grouping model for the data will be applied automatically, using a default number of bins, based on the key elements mentioned earlier.  
  ...
  ![](https://devnet.logianalytics.com/hc/article_attachments/4419699908759/dm30_workcols_20.png)
...
* *Width of Groups -* For Numeric data, this option allows you to define the "width" of your groups. The number you enter is always an *approximate* value, as the algorithm will try to create groups based on both the number of groups desired, the data distribution, and the precision of the data.   
  ...
  ![](https://devnet.logianalytics.com/hc/article_attachments/4419706599575/noteicon.png) The grouped rows are retained and you can view them by clicking the "+" icon in the table.  
    
    
  ![](https://devnet.logianalytics.com/hc/article_attachments/4419707079063/dm30_workcols_21.png)
...
* *Number of Groups* - This option allows you to specify an *approximate* number of groupings. This will be an approximate
  ...
  ![](https://devnet.logianalytics.com/hc/article_attachments/4419714901911/dm30_workcols_22.png)
