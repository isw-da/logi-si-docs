---
title: "Logi Studio Ribbon Menu"
id: 4419707683735
section: "Introduction to Logi Info v14"
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4419707683735-Logi-Studio-Ribbon-Menu
updated_at: 2022-07-17T01:44:35Z
---
...
![](https://devnet.logianalytics.com/hc/article_attachments/5163540682391/introstudio_09.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/5163472728599/introstudio_10.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/5163540697623/introstudio_11.png)
...
| Database Browser | View schema, stored procedures, and basic data samples from databases with connections in the \_Settings file. |
...
| Dataview Authoring | Create, edit, and manage Dataviews - representations of data that can be used and re-used throughout an application. *Menu item is only visible when Discovery v3.x is installed.  Deprecated in Info v12.6+.* |
| SuperWidget Authoring | Create, edit, and manage client-side components, such as charts and Dashboards, to create single-page applications that make use of Dataviews. *Menu item is only visible when Discovery v3.x is installed.  Deprecated in Info v12.6+.* |
...
![](https://devnet.logianalytics.com/hc/article_attachments/5163512424983/introstudio_11a.png)
