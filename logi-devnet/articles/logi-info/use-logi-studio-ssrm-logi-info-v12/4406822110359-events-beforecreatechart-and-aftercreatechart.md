...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4406822110359-Events-beforeCreateChart-and-afterCreateChart
...
Here's an example that uses the *beforeCreateChart* event to cause the text "n/a" to appear on two charts when there are null data values.
First, here's the Logi element source code (![](https://devnet.logianalytics.com/hc/article_attachments/4417583587863/noteicon.png) the JavaScript code is follows separately):

<Division ID="divNewAPI\_Events" >  
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417584166295/javascriptapi_01.png)
