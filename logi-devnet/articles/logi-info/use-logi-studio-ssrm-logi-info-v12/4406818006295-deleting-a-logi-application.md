...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4406818006295-Deleting-a-Logi-Application
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417583587863/noteicon.png) Your web server may hold some application files open to improve performance and you may receive an "Access Denied" type error when you try the folder deletion. If this happens, try stopping and restarting the web server. For IIS, this can be done very easily by running iisreset.exe from the Start Menu ![](https://devnet.logianalytics.com/hc/article_attachments/4417575446295/menuarrow.gif) Run option or
from a
