...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4406817944983-InfoGo-Creating-Charts-and-Gauges
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417563058839/usinginfogo125_30.png)

Here's how to use this feature:

1. Click the option item for the type of chart to be created.
2. Assuming a **Bar** chart was selected, select the **Label Column**. This provides data for the X-axis of the chart. If the column selected is a date-type column, an interval control (*Year*, *Quarter*, *Month*, *Day*, *Hour, Minute*) will be displayed.  
...
4. The **Additional Column** specifies a second data series that
   ...
   series, including aggregation options and charting types.
5. Data **Forecasting** is available for Bar, Line, Curved Line, and Scatter Plot charts. See the section below for more information.
...
Hide the chart configuration area by clicking the gear icon, or delete the chart entirely by clicking the trash canicon.
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417583706647/usinginfogo125_31.png)
...
More information about forecasting in InfoGo can be found in [Forecast Methodologies](https://devnet.logianalytics.com/hc/en-us/articles/4406817468567-Forecast-Methodologies).
