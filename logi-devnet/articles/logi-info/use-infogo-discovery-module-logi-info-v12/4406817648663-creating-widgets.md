...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4406817648663-Creating-Widgets
updated_at: 2022-04-06T06:07:23Z
---
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417563176855/introsuperwidgets_06_538x125.png)

Your first task is to select a Dataview to work with. Pick one from the list and click **Select**.

![](https://devnet.logianalytics.com/hc/article_attachments/4417563176983/introsuperwidgets_07_508x423.png)

The Thinkspace tool will open, with the data from the Dataview you selected, as shown above. Detailed instructions for using the Thinkspace can be found in [Use the Thinkspace
- 3.x](https://devnet.logianalytics.com/hc/en-us/articles/4406818041623-Use-the-Thinkspace-3-x).
In addition to the Dataview selection controls, this interface includes several special buttons.
...
2. **Properties Editor** - Click to edit the widget properties, including title, header, and styling, and to control the visibility of individual Thinkspace controls:  
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417575611031/introsuperwidgets_08_406x301.png)
