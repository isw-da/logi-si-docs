...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4419707708183-Using-Local-Data
updated_at: 2022-07-17T02:24:01Z
---
...
![](https://devnet.logianalytics.com/hc/article_attachments/7522812013079/introdl_06.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/7522725179159/noteicon.png) Developers often use this technique (linked Local Data datalayers) to reduce data retrieval to one query, which is then re-used via linking in multiple places in the report, for best performance.
...
![](https://devnet.logianalytics.com/hc/article_attachments/7522725179159/noteicon.png) This can be very useful, for example, if you just want to run the Local Data datalayer *once* when the report is first loaded.
...
![](https://devnet.logianalytics.com/hc/article_attachments/7522822602263/introdl_16.png)

In the example shown above, suppose that LocalData1![](https://devnet.logianalytics.com/hc/article_attachments/7522812060695/menuarrowrt_26x13.png)DataLayer.SQL retrieves a column named "EmployeeID" and LocalData2 ![](https://devnet.logianalytics.com/hc/article_attachments/7522812060695/menuarrowrt_26x13.png)DataLayer.XML does too. What will happen? When the data from both datalayers is combined, the values for EmployeeID from the first datalayer will be *overwritten*
by the values
...
![](https://devnet.logianalytics.com/hc/article_attachments/7522812104087/introdl_17.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/7522725179159/noteicon.png) If the EmployeeID column contains string values, in the Formula attribute you'll need to enclose the @Data.EmployeeID~ token in double-quotes.
