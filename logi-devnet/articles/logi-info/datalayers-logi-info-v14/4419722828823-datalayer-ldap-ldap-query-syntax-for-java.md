...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4419722828823-DataLayer-LDAP-LDAP-Query-Syntax-for-Java
updated_at: 2022-07-17T01:53:16Z
---
...
| Keyword | Description |
| --- | --- |
 **Description** || SELECT | Specifies a comma-separated list of attributes to be retrieved for each object and can include "\*" to retrieve all attributes. All other "column" operations of the type found in SQL queries (functions, AS, expressions, etc.) are *not* available. |
