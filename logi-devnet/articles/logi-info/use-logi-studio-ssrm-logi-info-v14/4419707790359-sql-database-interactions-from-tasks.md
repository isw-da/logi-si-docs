...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4419707790359-SQL-Database-Interactions-from-Tasks
...
![](https://devnet.logianalytics.com/hc/article_attachments/7522806462231/workproctask_13.png)
...
Procedure.SQL elements can also be used beneath Procedure.Run Data Table Rows, Procedure.Run DataLayer Rows, which are discussed in [Running Datalayer and Data Table Rows](https://devnet.logianalytics.com/hc/en-us/articles/4419707789335-Running-Datalayer-and-Data-Table-Rows).
...
![](https://devnet.logianalytics.com/hc/article_attachments/7522725179159/noteicon.png) There is no need to surround the placeholder with quotes, even if it represents string data. The Logi Engine sees the parameter data type in the element attributes and handles it appropriately.
...
![](https://devnet.logianalytics.com/hc/article_attachments/7522820775447/workproctask_14.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/7522725179159/noteicon.png) SQL Parameters are especially useful if you're *writing* string data that includes embedded single quotes to the database. The Logi Engine automatically handles escaping the single quotes in the SQL statement sent to the database server.
...
![](https://devnet.logianalytics.com/hc/article_attachments/7522795535639/workproctask_15.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/7522795549847/workproctask_16.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/7522725179159/noteicon.png) The relationship between parameters in the task definition and the parameters in the stored procedure is determined solely by their *order*, not by their IDs.
...
![](https://devnet.logianalytics.com/hc/article_attachments/7522795558167/workproctask_17.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/7522725232151/criticalicon.png) Once again, the relationship of parameter elements in the task and the stored procedure's output parameters is determined solely by their *order*, not their IDs.

The value returned in the output parameter is available using a special token, shown below:

![](https://devnet.logianalytics.com/hc/article_attachments/7522795576087/workproctask_18.png)
