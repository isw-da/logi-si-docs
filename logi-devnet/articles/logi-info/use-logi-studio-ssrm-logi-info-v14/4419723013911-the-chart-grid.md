...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4419723013911-The-Chart-Grid
updated_at: 2022-07-17T01:44:50Z
---
...
* [Chart Grid Element](https://devnet.logianalytics.com/hc/en-us/articles/4419715366039-Chart-Grid-Element#CGElement)
* [Chart Grid Settings Panels](https://devnet.logianalytics.com/hc/en-us/articles/4419707680279-Chart-Grid-Settings-Panel#Panels)
* [Configuring the Data](https://devnet.logianalytics.com/hc/en-us/articles/4419723013015-Configuring-the-Data#Data)
* [Chart Zoom and Drill-through](https://devnet.logianalytics.com/hc/en-us/articles/4419715367063-Chart-Zoom-and-Drill-through#Zoom)
* [Refresh, Reset, and Save Grid Settings](https://devnet.logianalytics.com/hc/en-us/articles/4419723014807-Refresh-Reset-and-Save-Grid-Settings#Settings)
...
![](https://devnet.logianalytics.com/hc/article_attachments/4419706691223/chartgrid_01.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/4419706599575/noteicon.png) Chart Y-axis labels only appear in the first chart column and the X-axis labels only appear in the bottom row.
...
![](https://devnet.logianalytics.com/hc/article_attachments/4419706599319/criticalicon.png) Chart Canvas charts are used by default by the Chart Grid, in all *new applications*. Older Logi applications that are *upgraded* to v12 will use the classic static charts for their Chart Grids. To force upgraded apps to use Chart Canvas charts, add the constant rdFavorChartCanvas
= True
to your \_Settings definition.

![](https://devnet.logianalytics.com/hc/article_attachments/4419706916503/chartgrid_02.png)

Clicking on an individual chart "zooms" the chart in a popup window, as shown above,

![](https://devnet.logianalytics.com/hc/article_attachments/4419714828055/chartgrid_03_720x335.png)
...
Logi Studio contains a Chart Grid wizard that will walk developers through creating and configuring the grid. For information about this wizard, see [The Chart Grid Wizard](https://devnet.logianalytics.com/hc/en-us/articles/4419722740247-The-Chart-Grid-Wizard).
