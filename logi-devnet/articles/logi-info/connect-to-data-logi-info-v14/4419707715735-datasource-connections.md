...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4419707715735-Datasource-Connections
updated_at: 2022-07-17T02:07:08Z
---
...
* [Using the Connection Wizard](https://devnet.logianalytics.com/hc/en-us/articles/4419707718807-Using-the-Connection-Wizard)
* [Using Vendor-Specific Connections](https://devnet.logianalytics.com/hc/en-us/articles/4419707719831-Using-Vendor-Specific-Connections)
* [Using Generic Connections and Connection Strings](https://devnet.logianalytics.com/hc/en-us/articles/4419723045911-Using-Generic-Connections-and-Connection-Strings)
* [Using Special-Purpose Connections](https://devnet.logianalytics.com/hc/en-us/articles/4419715395863-Using-Special-Purpose-Connections)
* [Creating Dynamic Connections](https://devnet.logianalytics.com/hc/en-us/articles/4419723039767-Creating-Dynamic-Connections)
* [Connecting with Metadata](https://devnet.logianalytics.com/hc/en-us/articles/4419723037591-Connecting-with-Metadata)
  + [1010data](https://devnet.logianalytics.com/hc/en-us/articles/4419715391639-1010data)
  + [Amazon Redshift](https://devnet.logianalytics.com/hc/en-us/articles/4419707709207-Amazon-Redshift)
  + [Connection.ADO Configuration](https://devnet.logianalytics.com/hc/en-us/articles/4419715392663-Connection-ADO)
  + [Connection.JDBC and SQL Server 2008](https://devnet.logianalytics.com/hc/en-us/articles/4419723038615-Connection-JDBC-and-SQL-Server-2008)
  + [Connection.LDAP Configuration](https://devnet.logianalytics.com/hc/en-us/articles/4419715394071-Configuring-Connection-LDAP)
  + [Database Browser and SQL Builder](https://devnet.logianalytics.com/hc/en-us/articles/4419707712791-Database-Browser-and-Query-Builder-Connections)
  + [HP Vertica](https://devnet.logianalytics.com/hc/en-us/articles/4419707713815-HP-Vertica)
  + [DB2 Universal](https://devnet.logianalytics.com/hc/en-us/articles/4419707714711-IBM-DB2-Universal)
  + [DB2 on iSeries](https://devnet.logianalytics.com/hc/en-us/articles/4419723042583-IBM-DB2-on-iSeries)
  + [Microsoft SQL Server](https://devnet.logianalytics.com/hc/en-us/articles/4419707716631-Microsoft-SQL-Server)
  + [MongoDB](https://devnet.logianalytics.com/hc/en-us/articles/4419723043607-MongoDB)
  + [Oracle](https://devnet.logianalytics.com/hc/en-us/articles/4419707717655-Oracle)
  + [SAP Sybase](https://devnet.logianalytics.com/hc/en-us/articles/4419723045015-SAP-Sybase)
...
MySQL 5.5 is not supported for use with our [DataLayer.ActiveSQL](https://devnet.logianalytics.com/hc/en-us/articles/4419722806807-DataLayer-ActiveSQL) technology.

The configuration of **Connection.Google Docs** and **Connection.Google Maps** is discussed in [Google Connections](https://devnet.logianalytics.com/hc/en-us/articles/4419707607703-Google-Connections).

![](https://devnet.logianalytics.com/hc/article_attachments/7522725232151/criticalicon.png) Salesforce.com has discontinued support for the TLS 1.0 protocol. If you're using **Connection.Salesforce**, or REST or SOAP API connections to Salesforce, you must be using Logi Info v12.2-SP4 or later, which supports the TLS 1.1 and 1.2 protocols. In addition, Login Java applications
must use JDK or OpenJDK 8 or later to use the appropriate protocol
version.
For more information about which versions of JDK works with Info, see [Java Usage Policy](https://devnet.logianalytics.com/hc/en-us/articles/4419723053335-Java-Usage-Policy).
...
![](https://devnet.logianalytics.com/hc/article_attachments/7522725179159/noteicon.png) Microsoft elected not to include the MS Jet driver in its 64-bit OS versions, but it is possible to use the "MS Ace" OLEDB driver, distributed with Office 2007, instead.
...
**Connection.Leaflet Map** is used to connect to a Leaflet API-compatible map server. See [Leaflet Maps](https://devnet.logianalytics.com/hc/en-us/articles/4419707730327-Leaflet-Maps) for more information.

The **Connection.Logi Application Service** element is used to connect to a special service installed with the Discovery Module and is only availablein Logi Info if the add-on moduleis installed. Connection configuration details are available in [Develop with the Discovery Module 3.2](https://devnet.logianalytics.com/hc/en-us/articles/4419707532055-Develop-with-the-Discovery-Module-3-2).
