...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4419722800023-Add-a-Data-Table
updated_at: 2022-07-17T01:54:24Z
---
...
![](https://devnet.logianalytics.com/hc/article_attachments/4419714712087/datatableman_06.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/4419706738839/datatableman_07.png)  
...
7. In the second context menu, click the **DataLayer.SQL** element to add it as a child of the Data Table element.  
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4419714712343/datatableman_08.png)
8. Select the newly-added datalayer and set its attributes as shown above. The **Connection ID** can be selected from a pull-down list of choices. The **Source** attribute value is, obviously, the actual SQL query used to get data from the database and, if you're using a different database, you'll need to alter it.  
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4419706739095/datatableman_09.png)
...
9. Select the **Data Table** element ("dtEmployees") again and below it add a **Data Table Column** element, as shown above. Set its **ID** attribute to *colEmployeeID* and its **Column Header** attribute to *Employee ID*.  
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4419714712599/datatableman_10.png)
10. Select the newly-added Data Table Column element and, below it, add **Label** and **Sort** child elements, as shown above.  
      
      
      
    ![](https://devnet.logianalytics.com/hc/article_attachments/4419699637911/datatableman_11.png)  
...
12. Now press the Period key and Studio will attempt to retrieve a list of the data columns returned by our SQL query. Use your arrow keys or the mouse to select *EmployeeID~,* as shown above left, and, again, press the Space Bar.   
    ...
    ![](https://devnet.logianalytics.com/hc/article_attachments/4419706739607/datatableman_12.png)
13. Studio enters the column name in the Caption attribute, as shown above, and adds the trailing tilde ("~") character which is the required terminator for tokens. Here's another important fact about tokens: they're *case-sensitive*, so you must take care to spell them, and related identifiers such as column names, correctly.  
    ...
    ![](https://devnet.logianalytics.com/hc/article_attachments/4419699638167/datatableman_13.png)  
    ...
    ![](https://devnet.logianalytics.com/hc/article_attachments/4419714712983/datatableman_14.png)
14. The **Sort** element causes the column header text in the table to become a link that will sort the data based on the column clicked. Select it and set its **Data Column** attribute to the column name: *EmployeeID*.   
    ...
    ![](https://devnet.logianalytics.com/hc/article_attachments/4419699638935/datatableman_15.png)
...
16. In the second context menu, click **Add Data Columns**, as shown above.  
    ...
    ![](https://devnet.logianalytics.com/hc/article_attachments/4419699640343/datatableman_16.png)
