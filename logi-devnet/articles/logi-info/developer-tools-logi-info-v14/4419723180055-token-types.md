...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4419723180055-Token-Types
updated_at: 2022-10-14T17:02:57Z
---
...
| @Date | Represents relative dates for reports and report scheduling (see [@Date Tokens](https://devnet.logianalytics.com/hc/en-us/articles/4419707849879--Date-Tokens)).  Format: @Date.<*date identifier*>~ Example: @Date.Yesterday~ |
| @FileUpload | Returns information in a procedure task about a file upload process (see [@File Upload Tokens](https://devnet.logianalytics.com/hc/en-us/articles/4419715491351--File-Upload-Tokens)). |
| @Function | Represents the value of predefined functions (see [@Function Tokens](https://devnet.logianalytics.com/hc/en-us/articles/4419723177111--Function-Tokens))  Format: @Function.<*function name*>~ Example: @Function.DateTime~ |
| @Input | Input parameter variable, used inside external JavaScript files.  Format: @Input.<*value ID*>~ Example: @Input.FileName~ |
| @Local | Represents a data value from the *first* row of the child datalayer of a Local Data element, see [Datalayers](https://devnet.logianalytics.com/hc/en-us/articles/4419707706135-Datalayers). Local data is accessible anywhere within the report definition.  Child elements of this datalayer, such as a Calculated Column or Condition Filter, reference the data with @Data tokens.  Format: @Local.<*value ID*>~ Example: @Local.ReportTitle~ |
...
| @Procedure | Represents results of operations by Process task procedures, including datasource interactions, file system and email operations, and associated error messages (see [@Procedure Tokens](https://devnet.logianalytics.com/hc/en-us/articles/4419707852055--Procedure-Tokens)).  Format: @Procedure.<*procedure ID*>.<*value ID*>~ Example: @Procedure.GetTaxes.SalesTax~ |
