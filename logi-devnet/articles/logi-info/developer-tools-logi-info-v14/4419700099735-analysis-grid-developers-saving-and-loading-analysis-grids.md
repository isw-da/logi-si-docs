...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4419700099735-Analysis-Grid-Developers-Saving-and-Loading-Analysis-Grids
...
![](https://devnet.logianalytics.com/hc/article_attachments/7522834225815/workag_25.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/7522856531479/workag_26.png)

To create the task:

1. In a Process definition, add a **Task** element ("tskSaveAg").
2. Below it, add a **Procedure.Set Session Vars** element ("getAgID").
3. Below that, add a **Session Parameters** element and set its attributes as shown above. The GUID token provides a random 48-character number for use as a unique identifier. ![](https://devnet.logianalytics.com/hc/article_attachments/7522774430103/noteicon.jpg) The session parameter name is **case-sensitive**!

![](https://devnet.logianalytics.com/hc/article_attachments/7522819438103/workag_27.png)

4. Next, add to the task a **Procedure.Create Folder** element and set its attributes as shown above.

![](https://devnet.logianalytics.com/hc/article_attachments/7522856559255/workag_28.png)
...
5. Add a **Procedure.Save Analysis Grid** element to the task and set its attributes as shown above. The full **Filename** value is:  
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/7522774430103/noteicon.jpg) The session variable created from the GUID token earlier is now being used as the file name; use of a session variable allowed us to "pass" the value through the task from an earlier procedure to this one.

![](https://devnet.logianalytics.com/hc/article_attachments/7522856568599/workag_29.png)
