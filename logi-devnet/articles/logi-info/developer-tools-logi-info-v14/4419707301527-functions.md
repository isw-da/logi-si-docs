...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4419707301527-Functions
updated_at: 2024-03-13T23:14:16Z
---
...
| Rnd | Returns a random number between 0 and 1. | Rnd([*number*]) | If *number* is: not supplied - returns the next random number in the sequence  < 0 - returns the same number every time  > 0 - returns the same number every time = 0 - returns the most recently generated number |
