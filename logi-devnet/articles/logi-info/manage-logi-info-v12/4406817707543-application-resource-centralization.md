...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4406817707543-Application-Resource-Centralization
...
You have options on how you can centralize the Bookmark, Dashboard, and SecureKey files in a database. For more information, see [File To Database Mapping Element](https://devnet.logianalytics.com/hc/en-us/articles/4406822512279-File-To-Database-Mapping-Element).

![](https://devnet.logianalytics.com/hc/article_attachments/4417583587863/noteicon.png) You will also want to centralize your Error log files, but you cannot put them in a database.
...
 
 
![](https://devnet.logianalytics.com/hc/article_attachments/4417563154327/loadbal_02_422x182.png)
...
 
![](https://devnet.logianalytics.com/hc/article_attachments/4417583805847/loadbal_03_823x167.png)
...
* You can also store your Bookmarks and Save files in a SQL database. See [Bookmarks](https://devnet.logianalytics.com/hc/en-us/articles/4406822405143-Bookmarks) for more information.

* You also have options on how you can centralize the Bookmark, Dashboard, and SecureKey files in a database for non-sticky sessions; see [File To Database Mapping Element](https://devnet.logianalytics.com/hc/en-us/articles/4406822512279-File-To-Database-Mapping-Element).

If you're using Logi SecureKey security in a load-balanced environment, you need to configure security to share requests.  
 
![](https://devnet.logianalytics.com/hc/article_attachments/4417563154711/loadbal_04_816x228.png)
