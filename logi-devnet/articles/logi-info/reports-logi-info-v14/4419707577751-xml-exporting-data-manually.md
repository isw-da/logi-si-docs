...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4419707577751-XML-Exporting-Data-Manually
updated_at: 2022-07-17T01:49:21Z
---
...
![](https://devnet.logianalytics.com/hc/article_attachments/4419706599575/noteicon.png) XML files opened in a browser are usually formatted for easier viewing, which may introduce extraneous characters. If you want to save a "clean" copy of the XML (which is necessary if you want to use the file as a data source later), right-click the displayed XML and select your browser's "View source" option, then save that display to a file.
