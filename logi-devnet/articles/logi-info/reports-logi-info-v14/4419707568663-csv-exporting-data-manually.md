...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4419707568663-CSV-Exporting-Data-Manually
...
![](https://devnet.logianalytics.com/hc/article_attachments/7522841539863/rapid_csv_1267x653.png)
...
| --- | --- |
| Export Data Preference | Specifies the export preference. Options include Empty (default), Rapid, and Formatted. For more information on Rapid CSV Export, see [Rapid CSV Export](https://devnet.logianalytics.com/hc/en-us/articles/4419723125655-Rapid-CSV-Export). |
...
![](https://devnet.logianalytics.com/hc/article_attachments/7522800016663/exportcsv_03.png)

As shown above, when you run the report and export the data, it will be Tab delimited and have no double-quotes.

![](https://devnet.logianalytics.com/hc/article_attachments/7522725179159/noteicon.png) Using the ASCII code for a Tab delimiter is the *only* way to remove the double-quotes from the standard CSV format output. Entering other characters or ASCII codes in the Field Delimiter attribute will not remove them.
