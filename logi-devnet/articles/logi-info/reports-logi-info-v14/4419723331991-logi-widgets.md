...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4419723331991-Logi-Widgets
...
* [Creating a Widget Definition](https://devnet.logianalytics.com/hc/en-us/articles/4419715616151-Creating-a-Widget-Definition#Definition)
* [Embedding the Widget Code in an HTML Page](https://devnet.logianalytics.com/hc/en-us/articles/4419715618071-Embedding-the-Widget-Code-in-an-HTML-Page#Embedding)
* [Current Widget Limitations](https://devnet.logianalytics.com/hc/en-us/articles/4419715617047-Current-Widget-Code-in-an-HTML-Page#Limitations)
* [Widgets and Load-Balancing](https://devnet.logianalytics.com/hc/en-us/articles/4419723330711-Widgets-and-Load-Balancing#Balancing)
* [Sample Definition](https://devnet.logianalytics.com/hc/en-us/articles/4419707984151-Sample-Definition#Sample)
...
![](https://devnet.logianalytics.com/hc/article_attachments/7522725232151/criticalicon.png) Our JavaScript-based [Embedded Reports API](https://devnet.logianalytics.com/hc/en-us/articles/4419715274135-Embedded-Reports-API) is now the recommended technology for embedding Logi reports into other web pages and applications. Logi Widgets continue to be supported for backward compatibility.
...
As we have seen, the HTML and JavaScript required to **integrate** a widget into an HTML page is **simple** and **straightforward**. In [Creating a Widget Definition](https://devnet.logianalytics.com/hc/en-us/articles/4419715616151-Creating-a-Widget-Definition), we'll explore how a widget definition is created.
