...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4406822348951-Configuring-for-Google-Docs
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417583927575/googleconn_09_886x522.png)
...
1. Click **ENABLE APIS AND SERVICES** in the *Dashboard* page, which takes you to the *Library* page. In the G Suite section, find and click the *Google Drive API*, as shown above.  
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417583927703/googleconn_10.png)
...
3. Return to the library and repeat the process for the *Google Sheets API*.   
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417583927959/googleconn_11.png)
4. Return to the *Dashboard* page of the console, as shown above, and you should see the two newly-enabled APIs.  
     
     
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417583928215/googleconn_12.png)
5. If you already have credentials, skip to Step 10. To create new credentials, go to the Credentials page, as shown above, and click **Create credentials**. Select the *OAuth client ID* option.  
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417583928343/googleconn_12a.png)
6. If you see the warning shown above, click **Configure consent screen** and provide an application name. You do not need to provide any other information. Click **Save** at the bottom of the page.  
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417563279127/googleconn_13.png)
7. In the Application Type list, select the *Other* application type and provide an arbitrary name for the client. Click **Create** to continue.  
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417583928727/googleconn_14.png)
8. Your new credentials will be displayed, as shown above. Copy the values...  
     
     
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417563279383/googleconn_15.png)
9. ...and paste them into the Connection.Google Docs element's **Client ID** and **Client Secret** attributes, as shown above.  
     
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417562936855/criticalicon.png) Be sure that there are *no leading* or *trailing spaces* in the values you paste into these attributes, especially if you use the Google-supplied Copy icons.  
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417563279767/googleconn_16.png)
10. **If you already have OAuth client credentials**  and just need the Client security values, in the Credentials page click the name of the client ID, as shown above, to see them:  
    ...
    ![](https://devnet.logianalytics.com/hc/article_attachments/4417583929367/googleconn_17.png)  
    ...
    ![](https://devnet.logianalytics.com/hc/article_attachments/4417563280151/googleconn_18.png)
11. Next, in Logi Studio, click the Browse button in the Connection.Google Docs element's **GoogleOAuth2Json** attribute, as shown above. If you don't see the button, click the blank attribute value first. This dialog box will appear:  
    ...
    ![](https://devnet.logianalytics.com/hc/article_attachments/4417575694615/googleconn_19.png)  
    Click **OK** to continue.  
      
      
    ![](https://devnet.logianalytics.com/hc/article_attachments/4417583930775/googleconn_20.png)
12. Your browser will open, requesting a login to Google. After a successful login, the page shown above will be displayed; click **Allow** to consent to access.  
    ...
    ![](https://devnet.logianalytics.com/hc/article_attachments/4417563281815/googleconn_21.png)
13. In Logi Studio, the dialog box shown above will appear. Click **OK** to continue.  
      
      
    ![](https://devnet.logianalytics.com/hc/article_attachments/4417563282199/googleconn_22.png)  
