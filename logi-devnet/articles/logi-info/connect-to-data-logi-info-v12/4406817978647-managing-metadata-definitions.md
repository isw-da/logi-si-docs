...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4406817978647-Managing-Metadata-Definitions
updated_at: 2022-04-06T06:09:25Z
---
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417563031447/usingwmb_08.png)

![](https://devnet.logianalytics.com/hc/article_attachments/4417575435927/notev12.7base.png)The Metadata Definition column will display the Metadata *name*, if available; otherwise it will display the Metadata *ID*.

To create a new metadata definition, click the **Add New** icon, then click **OK** in the confirmation panel that appears.

![](https://devnet.logianalytics.com/hc/article_attachments/4417575503895/usingwmb_09.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417575504023/usingwmb_10.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417575504279/usingwmb_11.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417583679895/usingwmb_12.png)
...
2. **SQL** **Query**- (Required) The SQL query that will retrieve data for your custom table. If your query includes Joins, you may not use wildcards as columns must be specifically named. You may not include an ORDER BY clause in any query. Session tokens may
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417562936855/criticalicon.png) You may not use an EXEC statement to call a Stored Procedure in order to create the custom table.
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417575505047/usingwmb_13.png)
...
By default, all columns in visible tables are included in the metadata, using standard properties. If you want to specify their properties more exactly, click the **Edit Columns** icon ![](https://devnet.logianalytics.com/hc/article_attachments/4417583680151/usingwmb_14.png) for the desired table and the Column Properties Editor page will be displayed:

![](https://devnet.logianalytics.com/hc/article_attachments/4417583681687/usingwmb_15.png)
...
2. **Filter List** - Allows you to filter the list of columns, based on a variety of criteria, in order to work with it more easily. The list is initially filtered on the name of the table whose icon you clicked in the list of tables on the previous page. The filter controls work like this:  
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417575505175/usingwmb_16.png)
...
8. **Format** - Specifies the display format for each column. The default format is based on the column data type. Click this link to select the format in a pop-up panel and 20 options are available. Leave this blank ("---") to use the data type default.   
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417583682071/usingwmb_17.png)
...
15. **Link URL** - Specifies that the data in this column will be a link, with a dynamic URL associated with it. Click to open a pop-up panel where you can enter the URL code and select a destination window (*New*, *Parent*, or *Top*).   
    ...
    ![](https://devnet.logianalytics.com/hc/article_attachments/4417562936855/criticalicon.png) The data will *not* be rendered as a live link in any tables or visualizations created using the Thinkspace.  
...
To manage Joins, click the **Edit Joins** icon ![](https://devnet.logianalytics.com/hc/article_attachments/4417583682199/usingwmb_18.png) for one of the tables:

![](https://devnet.logianalytics.com/hc/article_attachments/4417583682455/usingwmb_19.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417583682711/usingwmb_20.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417563035031/usingwmb_21.png)
