...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4406818131223-Menu-Tree-Attributes
...
| Menu Mode | Specifies the type of menu to be displayed: *HorizontalPopup*, *Vertical*, or *VerticalPopup*. See the About the Menu Tree section of [Menu Tree Menus](https://devnet.logianalytics.com/hc/en-us/articles/4406822648983-Menu-Tree-Menus) for a visual example of each mode. |
