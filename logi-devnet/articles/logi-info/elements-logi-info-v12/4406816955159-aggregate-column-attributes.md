...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4406816955159-Aggregate-Column-Attributes
...
| Aggregate Function | (Required) The aggregating function to be applied to the column named in the previous attribute. The available functions include:  * Average * Concat (see section below) * Count * Distinct Count * Max * Median * Min * Mode * Std Deviation * Sum    Columns with Null values are *excluded* by default.If you want them to be included, create theconstant rdCalculationsIncludeNulls and set it to *True.* |
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417575918231/aggrcol_04.png)
