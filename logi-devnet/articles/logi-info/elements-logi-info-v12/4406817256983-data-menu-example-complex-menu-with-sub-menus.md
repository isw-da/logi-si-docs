...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4406817256983-Data-Menu-Example-Complex-Menu-with-sub-menus
updated_at: 2022-04-06T06:04:58Z
---
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417584047255/datamenu_07.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417563405847/datamenu_02.png)![](https://devnet.logianalytics.com/hc/article_attachments/4417575786263/datamenu_02a.png)
...
2. Add a **Division** element and set its attributes as shown above. Beneath it add **New Line** and **Label** elements to provide a menu title.  
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417575786391/datamenu_03.png)![](https://devnet.logianalytics.com/hc/article_attachments/4417584047767/datamenu_03b.png)
3. Add a **Data Menu** element beneath the Body element and set its attributes as shown above.   
     
     
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417563408663/datamenu_08.png)![](https://devnet.logianalytics.com/hc/article_attachments/4417584048407/datamenu_08a.png)
...
5. Add a **Static Data Row** element beneath the datalayer, and set its dynamic attributes as shown above. The data for this menu item is similar to that used for the Simple Menu example. This completes the first main menu item.  
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417575789335/datamenu_09.png)![](https://devnet.logianalytics.com/hc/article_attachments/4417584048791/datamenu_09a.png)
6. Add a second Static Data Row and set its column data as shown above. This item will point to a sub-menu, so note that its **ItemActionTarget** column is set to a value, "Development", that we'll use in the next steps to identify the sub-menu.  
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417563409431/datamenu_10.png)![](https://devnet.logianalytics.com/hc/article_attachments/4417575790231/datamenu_10a.png)
7. Add another Static Data Row and set its column data as shown above. ![](https://devnet.logianalytics.com/hc/article_attachments/4417583587863/noteicon.png) The **ID** column contains a "dot" in it - this will make things easier to read in the Element Tree - and that the **MenuID** column is used to indicate that this item is in a sub-menu called "Development", which relates to the ItemActionTarget discussed in the previous step.   
     
     
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417563409687/datamenu_11.png)
8. Add two more Static Data Rows and set their columns data in the same fashion as the previous row. These become the menu items in the sub-menu. This completes the second main menu item and its sub-menu.  
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417575790359/datamenu_12.png)
9. Repeat the last three steps to add three Static Data Rows for the Search Engines main menu item and two of its sub-menu items. Their column data values will be similar to those set previously. At this point, you can see the value of the "dotted" element IDs.  
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417563409943/datamenu_13.png)![](https://devnet.logianalytics.com/hc/article_attachments/4417584049687/datamenu_13a.png)
10. Add another Static Data Row and set its column data as shown above. This sub-menu item is going to point to another sub-menu, so note that its ItemActionTarget column value is "Bing", the ID of the next sub-menu.  
    ...
    ![](https://devnet.logianalytics.com/hc/article_attachments/4417563410455/datamenu_14.png)![](https://devnet.logianalytics.com/hc/article_attachments/4417575791511/datamenu_14a.png)
11. Add another Static Data Row and set its column data as shown above. This is the first menu item in the second-level sub-menu. Its ItemActionID and ItemActionTarget column values will be used by the Action elements we'll add in a few steps.  
    ...
    ![](https://devnet.logianalytics.com/hc/article_attachments/4417575791639/datamenu_15.png)
12. Repeat the last step to add Static Data Rows for three more Bing sub-menu items. Their column data values will be similar to those set previously.  
    ...
    ![](https://devnet.logianalytics.com/hc/article_attachments/4417575792023/datamenu_16.png)
