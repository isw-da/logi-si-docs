...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4406817620119-Logi-OLAP-Other-OLAP-Grid-related-Elements
...
In [Logi OLAP - Creating a Basic OLAP Grid](https://devnet.logianalytics.com/hc/en-us/articles/4406817616919-Logi-OLAP-Creating-a-Basic-OLAP-Grid), we saw that the **MDX Query** element was used to automatically build the OLAP MDX query. These child elements can be used with it to customize the query:
