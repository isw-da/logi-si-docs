...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4419715045655-Analysis-Filter-Attributes
...
| Template Modifier File | Specifies the full name of a template modifier file to be used to alter the Analysis Filter element. See [Analysis Filter - Using the Analysis Filter Elements](https://devnet.logianalytics.com/hc/en-us/articles/4419700094871-Analysis-Filter-Using-the-Analysis-Filter-Elements) for more information about template modifiers. The template modifier file can be in any folder accessible to the web application; if a fully-qualified file path is not provided in this attribute value, then the application expects it to be in your project's \_SupportFiles folder. |
