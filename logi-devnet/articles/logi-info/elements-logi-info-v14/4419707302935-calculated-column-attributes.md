...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4419707302935-Calculated-Column-Attributes
updated_at: 2022-07-17T02:09:17Z
---
...
| ID | (Required) Specifies a unique ID for the Calculated Column element, and becomes the name of the column added to the datalayer. |
| Error Limit | Specifies the maximum number of times (datalayer rows) evaluating an expression will be allowed to produce an error before the value specified in the Error Result attribute will be used instead. |
