...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4406817775383-Using-Request-Parameters
...
[Token Reference](https://devnet.logianalytics.com/hc/en-us/articles/4406817899415-Token-Reference) provides additional general information about tokens.

![](https://devnet.logianalytics.com/hc/article_attachments/4417583780759/passinfo_02.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417562936855/criticalicon.png) Although Link Parameter values will resolve tokens, as shown above, they *will not* evaluate expressions. For example, if you create a parameter with the value of "=1+1" and submit the report, in the next report or process task its @Request token will have a value of the string *"=1+1"*, not a numeric value of *2*.
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417575575575/passinfo_02a.png)
