...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4406817435799-Excel-Exporting-a-Report-Manually
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417563300887/rapid_excel_1518x512.png)

1. In your report definition, add an **Action.Export Native Excel** element beneatha Label, Image, Button, or Chart element, as shown above.
...
| Export Data Preference | Specifies the export preference. Options include Empty (default), Rapid, and Formatted. For more information on Rapid Excel Export, see [Rapid Excel Export](https://devnet.logianalytics.com/hc/en-us/articles/4406822485527-Rapid-Excel-Export). |
...
| Report Show Modes | Specifies the Show Modes strings to be passed to the report when it's rendered for export; makes it possible to hide elements in reports. See [Excel - Hiding Elements When Exporting](https://devnet.logianalytics.com/hc/en-us/articles/4406822321943-Excel-Hiding-Elements-When-Exporting). |
