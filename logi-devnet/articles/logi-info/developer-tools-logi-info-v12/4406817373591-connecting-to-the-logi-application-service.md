...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4406817373591-Connecting-to-the-Logi-Application-Service
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417563329943/devdm31_01.png)
...
## Using TrustedAccess Authentication
...
3. Log into the tool with an administrator account. This is typically *admin* and the password that was established when Logi Platform Services was installed.  
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417563330199/devdm31_04.png)
4. Pull-down the submenu under your username in the menu bar, as shown above, and select *Client Credentials*.  
     
     
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417575732503/devdm31_05.png)
5. The Generate Client Secret dialog box, shown above, will appear. Enter an arbitrary string for the Client ID and click the **Generate** button. The Client Secret code will be generated and displayed. Click **Copy** to copy the code to your Clipboard. Click **Close** and logout of the Dataview Authoring tool.  
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417575732759/devdm31_06.png)
...
9. Save your definition. ![](https://devnet.logianalytics.com/hc/article_attachments/4417583587863/noteicon.png) Any values in the Username and Password attributes will now be ignored.
