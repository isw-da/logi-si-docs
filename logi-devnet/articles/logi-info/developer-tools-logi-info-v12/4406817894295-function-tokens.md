...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4406817894295--Function-Tokens
...
| @Function.UserID~ @Function.UserName~ | The current, logged-in user ID or name, when Logi Security (see [Logi Security](https://devnet.logianalytics.com/hc/en-us/articles/4406822422295-Logi-Security)) is in use. |
| @Function.UserRights~ | A comma-delimited list of the current, logged-in user's security rights, when Logi Security (see [Logi Security](https://devnet.logianalytics.com/hc/en-us/articles/4406822422295-Logi-Security)) is in use. The token value is not available until the Security element has been processed completely. |
