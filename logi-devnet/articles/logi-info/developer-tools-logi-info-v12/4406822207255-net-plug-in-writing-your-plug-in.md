...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4406822207255--NET-Plug-in-Writing-Your-Plug-in
updated_at: 2022-08-03T20:30:46Z
---
...
4. Add a reference to the file *yourLogiApp*/bin/rdPlugin.dll distributed with your Logi product.  A "strongly-signed" plug-in can be created by referencing *yourLogiApp*/bin/rdPluginSigned.dll *![](https://devnet.logianalytics.com/hc/article_attachments/4417562936855/criticalicon.png) Be sure* to use the file found in the bin folder of the Logi application that will use this plug-in. It's version-specific so don't refer to it in the bin folder of some other Logi application.
