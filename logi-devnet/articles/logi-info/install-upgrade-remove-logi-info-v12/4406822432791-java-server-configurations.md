...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4406822432791-Java-Server-Configurations
...
* [Setting Java Options](https://devnet.logianalytics.com/hc/en-us/articles/4406817686551-Setting-Java-Options#Options)
* [Apache-Tomcat 5.5 / 6 / 7 / 8](https://devnet.logianalytics.com/hc/en-us/articles/4406817680663-Apache-Tomcat-5-5-6-7-8-9#Apache)/ 9
* [JBoss 7.1](https://devnet.logianalytics.com/hc/en-us/articles/4406817685399-JBoss-7-1#JBoss7)
* [JBoss 5.1](https://devnet.logianalytics.com/hc/en-us/articles/4406817684119-JBoss-5-1#JBoss51)
* [JBoss 4](https://devnet.logianalytics.com/hc/en-us/articles/4406817683095-JBoss-4#JBoss4)
* [Glassfish 4.1](https://devnet.logianalytics.com/hc/en-us/articles/4406817681943-Glassfish-4-1-#GF41)
* [Glassfish 3.0 / 3.1/ 4.0](https://devnet.logianalytics.com/hc/en-us/articles/4406822431639-Glassfish-3-0-3-1-4-0#GF3)
* [Glassfish 2.1](https://devnet.logianalytics.com/hc/en-us/articles/4406822430103-Glassfish-2-1#GF21)
* [WebLogic 12c](https://devnet.logianalytics.com/hc/en-us/articles/4406817687703-WebLogic-12c#WebLogi12c)
* [WebLogic 10](https://devnet.logianalytics.com/hc/en-us/articles/4406822433943-WebLogic-10#WebLogi10)
* [Websphere 7 / 8.5](https://devnet.logianalytics.com/hc/en-us/articles/4406817688855-Websphere-7-8-5#Websphere)
* [WildFly 8 / 9 / 10](https://devnet.logianalytics.com/hc/en-us/articles/4406817690007-WildFly-8-9-10#WildFly)
...
* The Oracle JDK or OpenJDK 8, 11, 12, 13, or 14 is *required* for non-Apple platforms, or as noted in individual configuration topics linked above. JDK 8+ is *required* for Apple platforms. The JRE is not sufficient.
...
* ![](https://devnet.logianalytics.com/hc/article_attachments/4417575410199/__new12.8.png) We no longer distribute the ojdbc6.jar. Info Java includes hardcoded references to certain Oracle datatypes, which are referenced in the Oracle JDBC driver. To allow Info Java to compile we included LogiSTUB.jar. This jar replaces ojdbc6.jar, but only to allow Info to run; it does not allow Oracle data to actually be retrieved. To retrieve Oracle data, download ojdbc8.jar and delete LogiSTUB.jar.
