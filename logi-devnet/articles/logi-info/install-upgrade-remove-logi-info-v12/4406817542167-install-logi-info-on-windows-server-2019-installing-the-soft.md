---
title: "Install Logi Info on Windows Server 2019 - Installing the Software"
id: 4406817542167
section: "Install, Upgrade, & Remove - Logi Info v12"
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4406817542167-Install-Logi-Info-on-Windows-Server-2019-Installing-the-Software
updated_at: 2022-04-06T06:06:46Z
---

# Install Logi Info on Windows Server 2019 - Installing the Software
...
If you selected a "Custom" setup, the dialog box shown below appears. The following components are available during a Custom setup:
...
Click any of the components shown and make a selection from the pop-up menu to include them in the installation. If desired, click **Space** to review the disk space requirements for the Custom setup you've selected.

6. Click **Next** to proceed without the review:

![](https://devnet.logianalytics.com/hc/article_attachments/4417575653527/installinfo12ws2016_12.png)

The Disk Space Requirements display will give you information about the available storage space and warn you if there is not enough space to complete the installation, You can repeatedly adjust the components in the Custom setup and see the effect on storage here, if necessary.
...
The physical installation will begin and you'll see several progress indicators for different tasks, as shown below:
...
9. If you left the "Launch Logi Studio" check box checked, Studio will now launch and you should see a splash screen, like the one shown below:
