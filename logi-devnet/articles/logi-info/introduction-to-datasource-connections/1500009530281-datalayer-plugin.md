...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/1500009530281-DataLayer-Plugin
...
The **DataLayer.Plugin** element gives developers the ability to retrieve data from datasources not otherwise supported with standard connection and datalayer elements, using **custom-written** code. The code, known as a plug-in, is either a Windows .dll or a Java .java file. The returned data is XML in a rowset format; @Data tokens can be used to retrieve the data for each column.

* Attributes
* [DataLayer.Plugin](#sec1)
...
![](https://logianalytics.zendesk.com/hc/article_attachments/4402771861015/dlplugin_01.png)![](https://logianalytics.zendesk.com/hc/article_attachments/4402771861271/dlplugin_01a.png)

1. Add a **DataLayer.Plugin** element to the definition, as shown above, and configure its attributes per the attribute table in the previous section. Remember that the **Class Type Name** attribute is *required* for .NET
...
For information about writing a plug-in, see [Logi Plug-ins](https://devnet.logianalytics.com/hc/en-us/articles/1500009531221-Logi-Plug-ins).
