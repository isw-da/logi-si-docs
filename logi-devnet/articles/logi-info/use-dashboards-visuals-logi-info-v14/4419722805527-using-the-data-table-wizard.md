...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4419722805527-Using-the-Data-Table-Wizard
updated_at: 2022-07-17T02:24:40Z
---
...
![](https://devnet.logianalytics.com/hc/article_attachments/7522815411863/createtable_04_442x367.png)
...
1. As shown above, in a definition in Logi Studio, select an element and either click the Data Table item in the main menu's Wizards tab, or right-click the element and select *Element Wizards*, and then select *Add a Data Table* from the secondary menu.  
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/7522830242839/createtable_08_481x439.png)
2. A series of dialog boxes, shown above, will be displayed. These all relate to the retrieval of the data. Make appropriate selections for your application and click **Next** to move to the next dialog box.  
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/7522830259351/createtable_09_546x306.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/7522826513175/createtable_10_533x343.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/7522843157271/createtable_11_525x407.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/7522725232151/criticalicon.png) Only the elements for the table itself will be added, *not* any of the wizard's configuration controls you've just worked with.
