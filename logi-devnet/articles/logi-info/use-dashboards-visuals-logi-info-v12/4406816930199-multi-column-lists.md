...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4406816930199-Multi-Column-Lists
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417584218007/multicol_01_562x261.png)

As shown above, *all* of the data from **one record** is available
in **one cell** of the multi-column list.

![](https://devnet.logianalytics.com/hc/article_attachments/4417575922583/multicol_02_336x426.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417592001303/multicol_03_378x329.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417592001687/multicol_04_593x262.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417592001943/multicol_05_623x240.png)
...
4. Set **Multi-list Direction** attribute to control the data layout.
   ...
   *Down*, to display data top-to-bottom.
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417592002455/multicol_06_602x206.png)
...
6. Beneath the Data Multi-Column List element, add **Label** elements,
   **New Lines**, etc. as needed. ![](https://devnet.logianalytics.com/hc/article_attachments/4417583587863/noteicon.png) Data Table Column elements
   are *not* necessary. Use a standard **@Data** token
   for the Label element's Caption attributes to display the data.  
     
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417592002711/multicol_07_444x287.png)
7. In the example shown above, multiple Label and New Line elements have
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417584218519/multicol_08_564x348.png)
