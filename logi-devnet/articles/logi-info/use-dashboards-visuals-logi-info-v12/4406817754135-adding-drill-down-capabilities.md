...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4406817754135-Adding-Drill-down-Capabilities
updated_at: 2022-04-06T06:07:59Z
---
...
the data. Continuing with the previous example, found in [Creating a Map with Polygons](https://devnet.logianalytics.com/hc/en-us/articles/4406817755159-Creating-a-Map-with-Polygons), here's how this capability
is added:

![](https://devnet.logianalytics.com/hc/article_attachments/4417575582743/gmpoly_11.png)
...
1. In the report definition, start by selecting the Map Polygons element.
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417583789335/gmpoly_12.png)
...
2. Beneath the Map Marker Info element, add a **Division** element and
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417563138327/gmpoly_13.png)
...
3. Next select the Map Marker Info element again and beneath it add
   **SubReport** and **Target.Report** elements, as shown above. This
   ...
   definition, to the pop-up info panel. ![](https://devnet.logianalytics.com/hc/article_attachments/4417583587863/noteicon.png) The
   **Frame Border** and **Scrolling** attributes are set to
   *False* so that the chart or table will embed smoothly into the
   pop-up panel.  
     
     
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417563138455/gmpoly_14.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417575583127/gmpoly_15.png)
