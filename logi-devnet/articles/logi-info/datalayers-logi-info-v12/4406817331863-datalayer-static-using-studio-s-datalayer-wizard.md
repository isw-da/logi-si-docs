---
title: "DataLayer.Static - Using Studio's DataLayer Wizard"
id: 4406817331863
section: "Datalayers - Logi Info v12"
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4406817331863-DataLayer-Static-Using-Studio-s-DataLayer-Wizard
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417584017175/dlstatic_05.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417563376791/dlstatic_06.png)

The wizard will open, as shown above. Use the wizard as follows:

![](https://devnet.logianalytics.com/hc/article_attachments/4417575767575/dlstatic_07.png)
...
1. Right-click the column headers, one-by-one, select **Rename Column** from the pop-up menu, and change the column names to names appropriate for your purpose. You can drag the column header borders to widen the columns, if desired. Add or delete columns as necessary, until you have just those you need.  
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417563377303/dlstatic_08_653x365.png)
2. Click the first column and enter the desired data value. Press **Tab** to move to the next column and enter its data, then repeat for all columns. *Do not press Enter*!  
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417563377559/dlstatic_09.png)
3. Right-click the small arrow icon to the left of the first column and select **New Row** from the pop-up menu that appears. Repeat Steps 2 and 3 as many times as necessary to enter data for all static rows.  
   ...
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417575767959/dlstatic_10.png)
4. When the data for all rows and columns has been entered, click **Next** to insert the elements.  
     
     
   ![](https://devnet.logianalytics.com/hc/article_attachments/4417563378071/dlstatic_11.png)
5. Click **Finish** to close the wizard.

![](https://devnet.logianalytics.com/hc/article_attachments/4417575768215/dlstatic_12.png)
