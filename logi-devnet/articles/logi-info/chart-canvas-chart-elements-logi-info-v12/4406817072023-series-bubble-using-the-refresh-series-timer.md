---
title: "Series.Bubble - Using the Refresh Series Timer"
id: 4406817072023
section: "Chart Canvas Chart Elements - Logi Info v12"
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4406817072023-Series-Bubble-Using-the-Refresh-Series-Timer
updated_at: 2022-04-06T06:03:49Z
---
...
The **Refresh Series Timer**, added as a Series child element, updates
charts automatically, based on a time interval. When the interval is
reached, a request is sent back to the web server for updated data. Series
are updated with a smooth animation.

![](https://devnet.logianalytics.com/hc/article_attachments/4417563526167/series_bubble_10.png)
The **Refresh Interval** attribute specifies the number of seconds to
wait before refreshing the series data. A value is required and must be an
...
For best performance, avoid setting a very short refresh interval if a very
large number of users will be displaying the report.
