...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4406822330775-Working-with-Data
...
[Data Table Tutorial - Manual](https://devnet.logianalytics.com/hc/en-us/articles/4406822240407-Data-Table-Tutorial-Manual) for an example of how to create a definition that does this.
...
[Special Functions and Attributes](https://devnet.logianalytics.com/hc/en-us/articles/4406822525079-Special-Functions-and-Attributes). We also offer the
[Time Period Columns](https://devnet.logianalytics.com/hc/en-us/articles/4406818047511-Time-Period-Columns) element, which makes it easy to parse data, such as hours or months, from
this format.
...
columns to be retrieved and used. For more information, see [The File Column (BLOBs)](https://devnet.logianalytics.com/hc/en-us/articles/4406822333847-The-File-Column-BLOBs-).
...
Sum functions.
Aggregations caninclude or exclude columns with Null values. By
...
*Minute*, *Second*, and many more. For more information, see [Time Period Columns](https://devnet.logianalytics.com/hc/en-us/articles/4406818047511-Time-Period-Columns).
...
For more information, see [DataLayer.Definition List](https://devnet.logianalytics.com/hc/en-us/articles/4406822249879-DataLayer-Definition-List).
