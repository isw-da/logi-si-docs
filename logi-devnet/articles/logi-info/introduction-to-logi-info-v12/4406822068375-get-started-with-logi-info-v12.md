---
title: "Get Started with Logi Info v12"
id: 4406822068375
section: "Introduction to Logi Info v12"
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4406822068375-Get-Started-with-Logi-Info-v12
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417583762071/triallicensemsg.png)
...
![](https://devnet.logianalytics.com/hc/article_attachments/4417583587863/noteicon.png) Prior to developing your Logi application, it is imperative to read [Development Best Practices](https://devnet.logianalytics.com/hc/en-us/articles/4406816915351-Development-Best-Practices) to set up a good development foundation.
...
Once you build your application, connect to your own data and build you own dashboards. See [Data Table Tutorial - Manual](https://devnet.logianalytics.com/hc/en-us/articles/4406822240407-Data-Table-Tutorial-Manual).

Here is an overview for designing Logi reports: [Design a Logi Report](https://devnet.logianalytics.com/hc/en-us/articles/4406822288535-Design-a-Logi-Report). For customization and styling resources, see: [Using Style Sheets](https://devnet.logianalytics.com/hc/en-us/articles/4406822553367-Using-Style-Sheets), [Themes](https://devnet.logianalytics.com/hc/en-us/articles/4406818168855-Themes), and [Using the Theme Editor](https://devnet.logianalytics.com/hc/en-us/articles/4406818044055-Using-the-Theme-Editor).
...
from adversely affecting the system. See [Secure Logi Info Applications](https://devnet.logianalytics.com/hc/en-us/articles/4406822497175-Secure-Logi-Info-Applications), [Logi Security](https://devnet.logianalytics.com/hc/en-us/articles/4406822422295-Logi-Security), and [Working with Logi Security](https://devnet.logianalytics.com/hc/en-us/articles/4406818124567-Working-with-Logi-Security).
...
Logi provides the following four mechanisms: NT Authentication, Session Variable Authentication, Standard Authentication, and SecureKey Authentication. For more information, see [Logi Security Scenarios](https://devnet.logianalytics.com/hc/en-us/articles/4406817836055-Logi-Security-Scenarios-).
...
The **Embedded Reports API** provides developers with easy and agile methods for embedding Logi report components into other, non-Logi web pages. For more information, see [Embedded Reports API](https://devnet.logianalytics.com/hc/en-us/articles/4406822311575-Embedded-Reports-API-).

See [this video](https://devnet.logianalytics.com/hc/en-us/articles/360051301114-Logi-Info-Video-Tutorial-Embedding-Using-The-API) for a demonstration on embedding using the API. For more information on how to pass info between embedded report API and the parent application, see the Using the get() Method section in [Embedding Dynamic Reports using JavaScript](https://devnet.logianalytics.com/hc/en-us/articles/4406817405975-Embedding-Dynamic-Reports-using-JavaScript).

[Next Steps](#)

1. Set up your production server environment. See [Production Server Considerations](https://devnet.logianalytics.com/hc/en-us/articles/4406822287639-Production-Server-Considerations).
