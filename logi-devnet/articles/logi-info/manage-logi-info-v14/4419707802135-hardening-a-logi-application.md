...
category: "Logi Info"
url: https://devnet.logianalytics.com/hc/en-us/articles/4419707802135-Hardening-a-Logi-Application
...
* When retrieving SQL data, use the
  **Handle Quotes in Tokens** attribute available in DataLayer.SQL and
  ...
  [DataLayer.SQL](https://devnet.logianalytics.com/hc/en-us/articles/4419722842263-DataLayer-SQL).
...
* Use stored procedures, whenever available, to enable applications to
  ...
  [DataLayer.SP](https://devnet.logianalytics.com/hc/en-us/articles/4419715229335-DataLayer-SP).
...
* Validate user input to ensure it is in the proper format. Validation
  ...
  [Working with User Input Elements](https://devnet.logianalytics.com/hc/en-us/articles/4419715630487-Working-with-User-Input-Elements). Any custom JavaScript used in validations should
