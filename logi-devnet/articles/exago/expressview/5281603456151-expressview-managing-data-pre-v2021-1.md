...
section: "ExpressView"
category: "Exago"
url: https://devnet.logianalytics.com/hc/en-us/articles/5281603456151-ExpressView-Managing-Data-pre-v2021-1
...
1. Click the **Formatting and Style** icon in the pane on the right to open the Formatting page.
...
3. Choose a filter operator from the list.
4. Enter a filter value or values by either
   ...
   * Click the **Filter Function** icon to choose a pre-defined value based on a formula programmed by the system administrator. (For example, *First Day of Current Month* or *Friday of Last Week*).
