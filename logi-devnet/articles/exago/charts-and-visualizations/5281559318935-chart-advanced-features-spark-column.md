---
title: "Chart Advanced Features: Spark Column"
id: 5281559318935
section: "Charts and Visualizations"
category: "Exago"
url: https://devnet.logianalytics.com/hc/en-us/articles/5281559318935-Chart-Advanced-Features-Spark-Column
...
The following sections provide a list of available advanced attributes available for controlling and customizing **Spark Column** chart elements.
...
| useRoundEdges | True/False | 0/1 | If you wish to plot columns with round edges and fill them with a glass effect gradient, set this attribute to 1. `showShadow` attribute doesn’t work anymore when this attribute is set to 1. |
...
| Attribute | Type | Value | Description |
| --- | --- | --- | --- |
| plotFillColor | Color | Hex Color Code | Color using which the column on the chart will be drawn. |
| plotFillAlpha | Number | In pixels | Alpha of column. |
| highColor | Color | Hex Color Code | Color using which the column having highest value will be filled. |
| lowColor | Color | Hex Color Code | Color using which the column having lowest value will be filled. |
...
| Attribute | Type | Value | Description |
| --- | --- | --- | --- |
| showToolTip | True/False | 0/1 | Whether to show tooltip for the chart? |
