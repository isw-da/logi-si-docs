---
title: "Chart Advanced Features: Combination 2D"
id: 5281565991703
section: "Charts and Visualizations"
category: "Exago"
url: https://devnet.logianalytics.com/hc/en-us/articles/5281565991703-Chart-Advanced-Features-Combination-2D
...
| showPlotBorder | True/False | 0/1 | Whether the column, area border will show up. |
| plotBorderColor | Color | Hex Color Code | Color for column, area border |
| plotBorderThickness | Number | 0-5 | Thickness for column, area border |
...
| valueFontColor | Color | Hex Color Code | Sets the font color for the Y-axis value texts. Default value: #555555 |
...
| plotColorinTooltip | True/False | 0/1 | This attribute displays the color of each plot with their labels in tooltip. Default value: `1` |
| tooltipGrayoutColor | Color | Hex Color Code | This attribute sets the color of the unfocused plot in the tooltip for multi-series chart. By default it is set as gray. Default value: `#AAAAAA` |
...
| Attribute | Type | Value | Description |
| --- | --- | --- | --- |
| exportEnabled | True/False | 0/1 | Whether the chart will allow exporting to images, PDFs, SVG or XLSX. Default value: 0 |
...
| Attribute | Type | Value | Description |
| --- | --- | --- | --- |
| renderAs | Text | COLUMN, AREA, LINE, SPLINEAREA or SPLINE | This attribute defines what the particular data set will be plotted as. Valid values are COLUMN, AREA, LINE, SPLINEAREA or SPLINE. |
| parentYAxis | Text | P or S | renderAs attribute over-rides this attribute in Exago BI for Single Y Combination Charts. This attribute allows you to set the parent axis of the data set – P (primary) or S (secondary). Primary data sets are drawn as Columns and secondary data sets as lines. |
...
| color | Color | Hex Color Code | This attribute sets the color using which columns, lines, area of that data set will be drawn. For column chart, you can specify a list of comma separated hex codes to get a gradient plot. **Note:** This attribute is not applicable on spline data plots. |
...
| color | Color | Hex Color Code | For combination charts, you can define the color of data sets at data set level. However, if you wish to highlight a particular data element, you can specify its color at “set” level using this attribute. |
