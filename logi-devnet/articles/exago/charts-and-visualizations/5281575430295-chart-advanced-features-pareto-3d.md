---
title: "Chart Advanced Features: Pareto 3D"
id: 5281575430295
section: "Charts and Visualizations"
category: "Exago"
url: https://devnet.logianalytics.com/hc/en-us/articles/5281575430295-Chart-Advanced-Features-Pareto-3D
...
| use3DLineShift | True/False | 0/1 | By default, when a line data set is rendered over a column 3D data set, the line data set shifts in the z-dimension to give a 3D perspective. But, if you do not wish to add the perspective to the line data set, you may set this attribute as 0. |
...
| overlapColumns | True/False | 0/1 | Whether to overlap columns over each other to give a richer 3D look. If there are too many columns on the chart, it will automatically overlap. |
