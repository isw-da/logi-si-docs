---
title: "Chart Advanced Features: Doughnut 2D"
id: 5281558262679
section: "Charts and Visualizations"
category: "Exago"
url: https://devnet.logianalytics.com/hc/en-us/articles/5281558262679-Chart-Advanced-Features-Doughnut-2D
...
The following sections provide a list of available advanced attributes available for controlling and customizing **2D Doughnut** chart elements.
...
| animateClockwise | True/False | 0/1 | Animates the plot in clockwise direction. Default value: 0 |
| alphaAnimation | True/False | 0/1 | Instead of rotational animation, you can set alpha animation which displays your chart slowly from `0` alpha to `100`. Default value : 0 |
| palette | Number | 1-5 | Exago BI introduces the concept of Color Palettes. Each chart has 5 pre-defined color palettes which you can choose from. Each palette renders the chart in a different color theme. |
...
| showShadow | True/False | 0/1 | Whether to apply the shadow effect for pie/doughnuts. |
...
| radius3D | Number | 0-100 | You can define the 3D Radius of chart in percentage using this attribute. It basically helps you set the bevel distance for the pie/doughnut (if in 3D Lighting Mode). |
...
| labelPosition | Text | Outside, Inside | This attribute places the data labels outside/inside of the doughnut segments. Default value: Outside |
| valuePosition | Text | Outside, Inside | This attribute places the data values outside/inside of the doughnut segments. Default value: Outside |
| minAngleForLabel | Number | 0 – 360 | Set the minimum angle for a doughnut segment, above which the data labels will be visible, provided `labelPosition` is set to `inside`. Default value: 0 |
| minAngleForValue | Number | 0 – 360 | Set the minimum angle for a doughnut segment, above which the data values will be visible, provided `valuePosition` is set to `inside`. Default value: 0 |
...
| Attribute | Type | Value | Description |
| --- | --- | --- | --- |
| centerlabel | Text | Any | This attribute sets the label at the center if we hover the cursor over the chart. It will display the value for that particular area which has been hovered. |
| centerLabelFont | Text | Font name | Sets the center label font family for the text. |
| centerLabelFontSize | Number | 6 – 72 | Specifies the label font size. |
| centerLabelColor | Color | Hex color code | Sets the center label font color. |
| centerLabelAlpha | Number | 0 – 100 | Sets the transparency of the center label. |
| centerLabelBold | True/False | 0/1 | Sets whether the center label value will be bold formatted. Default value: 1 |
| centerLabelItalic | True/False | 0/1 | This attribute sets whether center label font should be italicized or not. Default value: 0 |
| centerLabelBgColor | Color | Hex color code | Sets the background color for center label text. |
| centerLabelBgAlpha | Number | 0 – 100 | Sets the background transparency of the center label. |
| centerLabelBorderColor | Color | Hex color code | Sets the color of the border around the center label text. |
| centerLabelBorderAlpha | Number | 0 – 100 | Sets the transparency of the border around the center label text. |
| centerLabelBorderThickness | Number | In pixels | Sets the center label border thickness. |
| centerLabelBorderRadius | Number | In pixels | Sets the center label border radius. |
| centerLabelTextPadding | Number | In pixels | Sets the center label text padding. |
| centerLabelPadding | Number | In pixels | Sets the center label padding. |
| centerLabelBgOval | True/False | 0/1 | Sets the background of the center label in oval shape. Default value: 0 |
| showCenterLabelShadow | True/False | 0/1 | Whether to apply the shadow effect for the center label. Default value: 0 |
| centerLabelHoverColor | Color | Hex color code | This attribute can set the hover color for the center label text. |
| centerLabelHoverAlpha | Number | 0 – 100 | This attribute sets the transparency for the center label text when hovered. |
| centerLabelToolText | Text | Any | You can define the tooltip for a center label using this attribute. |
| defaultcenterlabel | Text | Any | Sets the default label for the chart. This label can be seen at the center of the chart. |
...
| Attribute | Type | Value | Description |
| --- | --- | --- | --- |
| showLegend | True/False | 0/1 | Whether to show legend for the chart (only multi-series and combination charts). |
...
| borderAlpha | Color | Hex Color Code | If you want to set border alpha of individual pie/doughnut data items, you can specify using this attribute. |
...
| labelPosition | Text | Outside, Inside | This attribute places the data label outside/inside of a doughnut segment. Default value: Outside |
| valuePosition | Text | Outside, Inside | This attribute places the data values outside/inside of a doughnut segment. Default value: Outside |
