---
title: "Chart Advanced Features: Bar 2D"
id: 5281574106263
section: "Charts and Visualizations"
category: "Exago"
url: https://devnet.logianalytics.com/hc/en-us/articles/5281574106263-Chart-Advanced-Features-Bar-2D
...
The following sections provide a list of available advanced attributes available for controlling and customizing **2D Bar** chart elements.
...
| showShadow | True/False | 0/1 | Whether to show bar shadows. |
...
| xAxisPosition | Text | Left, Right | This attribute sets the position of the x-axis in the chart. Default value: Left |
| yAxisPosition | Text | Top, Bottom | This attribute sets the position of the y-axis in the chart. Default value: Bottom |
...
| exportHandler | Text | Any | In case of server side exporting, this refers to the path of the server-side export handler (the ready-to-use scripts that we provide).In case of client-side exporting, this refers to the DOM-Id of Exago BI Export component that is embedded in your web page, along with the chart. |
...
| exportCallback | Text | Any | Name of JavaScript function that will be called back when export process has finished in case of:Client side exportBatch exportServer-side export using ‘save’ as action |
...
| valuePadding | Number | In Pixels | It sets the horizontal space between the end of bars and start of value textboxes. This basically helps you control the space you want between your bars and the value textboxes. |
