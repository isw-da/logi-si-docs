---
title: "Chart Advanced Features: Stacked Bar 3D"
id: 5281587398167
section: "Charts and Visualizations"
category: "Exago"
url: https://devnet.logianalytics.com/hc/en-us/articles/5281587398167-Chart-Advanced-Features-Stacked-Bar-3D
...
| animationDuration | Number | In seconds | This attribute sets the animation duration, if `animation` is set to `1`. Default value: 1 sec |
...
| formatNumberScale | True/False | 0/1 | Configuration whether to add K (thousands) and M (millions) to a number after truncating and rounding it – for example, if `formatNumberScale` is set to 1, 10434 will become 1.04K (with decimalPrecision set to 2 places). Same with numbers in millions – an M will be added at the end. |
...
| --- | --- | --- | --- |
| **Attribute** | **Type** | **Value** | **Description** |
| exportEnabled | True/False | 0/1 | Whether the chart will allow exporting to images, PDFs, SVG or XLS. Default value: 0 |
...
| exportAtClientSide | True/False | 0/1 | This attribute when set to `1`, enables the client-side export feature. Default value: 0 |
...
| exportTargetWindow | Text | ‘\_self’ or ‘\_blank’ | In case of server-side exporting and when using download as action, this lefts you configure whether the return image, PDF, SVG or XLS will open in same window (as an attachment for download), or whether it will open in a new window. Default value: \_self |
