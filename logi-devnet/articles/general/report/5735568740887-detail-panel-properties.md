...
| Others | | |
| Cache Section | Page Report, Web Report | Specifies whether to cache the objects in the panel. Data type: Boolean  Note icon This property doesn't work if there is a crosstab, chart, and so on in the panel, because these objects contain child DBFields. |
| Cross Page | Page Report, Web Report | Specifies whether the panel can be split across a page break. Default is to display the panel on the next page when it spans a large space vertically and cannot completely show on a page. When you set this property to "true", Designer splits the panel across a page break when it exceeds the page height. Data type: Boolean  Note icon This property cannot take effect if you disable [Page Layout](https://devnet.logianalytics.com/hc/en-us/articles/5735569908631-Designing-the-Report-Pages#Mode) for the report, meaning, the report is in continuous page mode. |
...
| [Remove Blank Row](https://devnet.logianalytics.com/hc/en-us/articles/5735585151639-Banded-Page-Header-Properties#Panel) | Page Report, Web Report | Specifies whether to remove the blank rows in the panel in the Excel output. Data type: Boolean |
